...
public final  class serviciocategprompt_impl extends GXDataArea
{
   public serviciocategprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public serviciocategprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( serviciocategprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutServicioCategId") ;
         ...
         {
            AV8InOutServicioCategId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutServicioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutServicioCategId), 4, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutServicioCategNombre = httpContext.GetPar( "InOutServicioCategNombre") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutServicioCategNombre", AV9InOutServicioCategNombre);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511034055", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.serviciocategprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutServicioCategId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutServicioCategNombre))}, new String[] {"InOutServicioCategId","InOutServicioCategNombre"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTSERVICIOCATEGID", GXutil.ltrim( localUtil.ntoc( AV8InOutServicioCategId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTSERVICIOCATEGNOMBRE", AV9InOutServicioCategNombre);
   ...
   {
      return formatLink("com.projectthani.serviciocategprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutServicioCategId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutServicioCategNombre))}, new String[] {"InOutServicioCategId","InOutServicioCategNombre"})  ;
   }

   public String getPgmname( )
   {
      return "ServicioCategPrompt" ;
   }

   public String getPgmdesc( )
   {
      return "Selecciona Servicio Categ" ;
   }
   ...
   public void wb660( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_662( true) ;
      }
      else
      {
         wb_table1_12_662( false) ;
      }
      return  ;
   }

   public void wb_table1_12_662e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start662( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Servicio Categ", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtServicioCategImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A289ServicioCategImagen)==0) ? A40000ServicioCategImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A289ServicioCategImagen))), !bGXsfl_24_Refreshing);
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_SERVICIOCATEGNOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A287ServicioCategNombre, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "SERVICIOCATEGNOMBRE", A287ServicioCategNombre);
   }
   ...
   public void rf662( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                              }
         });
         ...
         lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
         /* Using cursor H00662 */
         pr_default.execute(0, new Object[] {lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_24_idx = 1 ;
         sGXsfl_24_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_24_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_242( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A290ServicioCategEstado = H00662_A290ServicioCategEstado[0] ;
            A289ServicioCategImagen = H00662_A289ServicioCategImagen[0] ;
            n289ServicioCategImagen = H00662_n289ServicioCategImagen[0] ;
            httpContext.ajax_rsp_assign_prop("", false, edtServicioCategImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A289ServicioCategImagen)==0) ? A40000ServicioCategImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A289ServicioCategImagen))), !bGXsfl_24_Refreshing);
            httpContext.ajax_rsp_assign_prop("", false, edtServicioCategImagen_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A289ServicioCategImagen), true);
            A40000ServicioCategImagen_GXI = H00662_A40000ServicioCategImagen_GXI[0] ;
            n40000ServicioCategImagen_GXI = H00662_n40000ServicioCategImagen_GXI[0] ;
            httpContext.ajax_rsp_assign_prop("", false, edtServicioCategImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A289ServicioCategImagen)==0) ? A40000ServicioCategImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A289ServicioCategImagen))), !bGXsfl_24_Refreshing);
            httpContext.ajax_rsp_assign_prop("", false, edtServicioCategImagen_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A289ServicioCategImagen), true);
            A288ServicioCategDescripcion = H00662_A288ServicioCategDescripcion[0] ;
            n288ServicioCategDescripcion = H00662_n288ServicioCategDescripcion[0] ;
            A287ServicioCategNombre = H00662_A287ServicioCategNombre[0] ;
            A165LaboratorioNombre = H00662_A165LaboratorioNombre[0] ;
            A40LaboratorioId = H00662_A40LaboratorioId[0] ;
            A52ServicioCategId = H00662_A52ServicioCategId[0] ;
            A165LaboratorioNombre = H00662_A165LaboratorioNombre[0] ;
            e17662 ();
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_SERVICIOCATEGID"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, localUtil.format( DecimalUtil.doubleToDec(A52ServicioCategId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_SERVICIOCATEGNOMBRE"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, GXutil.rtrim( localUtil.format( A287ServicioCategNombre, ""))));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
      /* Using cursor H00663 */
      pr_default.execute(1, new Object[] {lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText});
   ...
   public void e15662( )
   {
      ...
      Form.setCaption( "Selecciona Servicio Categ" );
   ...
   public void e18662( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutServicioCategId = A52ServicioCategId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutServicioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutServicioCategId), 4, 0));
      AV9InOutServicioCategNombre = A287ServicioCategNombre ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutServicioCategNombre", AV9InOutServicioCategNombre);
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV8InOutServicioCategId),AV9InOutServicioCategNombre});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutServicioCategId","AV9InOutServicioCategNombre"});
   ...
   public void wb_table1_12_662( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_ServicioCategPrompt.htm");
   ...
   {
      AV8InOutServicioCategId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutServicioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutServicioCategId), 4, 0));
      AV9InOutServicioCategNombre = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutServicioCategNombre", AV9InOutServicioCategNombre);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511034123", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("serviciocategprompt.js", "?2022511034123", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_242( )
   {
      ...
      edtServicioCategId_Internalname = "SERVICIOCATEGID_"+sGXsfl_24_idx ;
      ...
      edtServicioCategNombre_Internalname = "SERVICIOCATEGNOMBRE_"+sGXsfl_24_idx ;
      edtServicioCategDescripcion_Internalname = "SERVICIOCATEGDESCRIPCION_"+sGXsfl_24_idx ;
      edtServicioCategImagen_Internalname = "SERVICIOCATEGIMAGEN_"+sGXsfl_24_idx ;
      cmbServicioCategEstado.setInternalname( "SERVICIOCATEGESTADO_"+sGXsfl_24_idx );
   }

   public void subsflControlProps_fel_242( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_24_fel_idx ;
      edtServicioCategId_Internalname = "SERVICIOCATEGID_"+sGXsfl_24_fel_idx ;
      ...
      edtServicioCategNombre_Internalname = "SERVICIOCATEGNOMBRE_"+sGXsfl_24_fel_idx ;
      edtServicioCategDescripcion_Internalname = "SERVICIOCATEGDESCRIPCION_"+sGXsfl_24_fel_idx ;
      edtServicioCategImagen_Internalname = "SERVICIOCATEGIMAGEN_"+sGXsfl_24_fel_idx ;
      cmbServicioCategEstado.setInternalname( "SERVICIOCATEGESTADO_"+sGXsfl_24_fel_idx );
   }
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         {
            GXCCtl = "SERVICIOCATEGESTADO_" + sGXsfl_24_idx ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbServicioCategEstado.getInternalname(), "Values", cmbServicioCategEstado.ToJavascriptSource(), !bGXsfl_24_Refreshing);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:ServicioCategId|2:LaboratorioId|3:LaboratorioNombre|4:ServicioCategNombre|5:ServicioCategDescripcion|7:ServicioCategEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11662',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12662',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e13662',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e17662',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e18662',iparms:[{av:'A52ServicioCategId',fld:'SERVICIOCATEGID',pic:'ZZZ9',hsh:true},{av:'A287ServicioCategNombre',fld:'SERVICIOCATEGNOMBRE',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutServicioCategId',fld:'vINOUTSERVICIOCATEGID',pic:'ZZZ9'},{av:'AV9InOutServicioCategNombre',fld:'vINOUTSERVICIOCATEGNOMBRE',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e14662',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
   ...
   {
      wcpOAV9InOutServicioCategNombre = "" ;
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H00662_A290ServicioCategEstado = new String[] {""} ;
      H00662_A289ServicioCategImagen = new String[] {""} ;
      H00662_n289ServicioCategImagen = new boolean[] {false} ;
      H00662_A40000ServicioCategImagen_GXI = new String[] {""} ;
      H00662_n40000ServicioCategImagen_GXI = new boolean[] {false} ;
      H00662_A288ServicioCategDescripcion = new String[] {""} ;
      H00662_n288ServicioCategDescripcion = new boolean[] {false} ;
      H00662_A287ServicioCategNombre = new String[] {""} ;
      H00662_A165LaboratorioNombre = new String[] {""} ;
      H00662_A40LaboratorioId = new short[1] ;
      H00662_A52ServicioCategId = new short[1] ;
      ...
      sImgUrl = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.serviciocategprompt__default(),
         new Object[] {
             new Object[] {
            H00662_A290ServicioCategEstado, H00662_A289ServicioCategImagen, H00662_n289ServicioCategImagen, H00662_A40000ServicioCategImagen_GXI, H00662_n40000ServicioCategImagen_GXI, H00662_A288ServicioCategDescripcion, H00662_n288ServicioCategDescripcion, H00662_A287ServicioCategNombre, H00662_A165LaboratorioNombre, H00662_A40LaboratorioId,
            H00662_A52ServicioCategId
            }
            , new Object[] {
   ...
   private short wcpOAV8InOutServicioCategId ;
   private short AV8InOutServicioCategId ;
   ...
   private String wcpOAV9InOutServicioCategNombre ;
   private String AV13FilterFullText ;
   private String AV9InOutServicioCategNombre ;
   ...
   private String[] H00662_A290ServicioCategEstado ;
   private String[] H00662_A289ServicioCategImagen ;
   private boolean[] H00662_n289ServicioCategImagen ;
   private String[] H00662_A40000ServicioCategImagen_GXI ;
   private boolean[] H00662_n40000ServicioCategImagen_GXI ;
   private String[] H00662_A288ServicioCategDescripcion ;
   private boolean[] H00662_n288ServicioCategDescripcion ;
   private String[] H00662_A287ServicioCategNombre ;
   private String[] H00662_A165LaboratorioNombre ;
   private short[] H00662_A40LaboratorioId ;
   private short[] H00662_A52ServicioCategId ;
...
final  class serviciocategprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00662( ModelContext context ,
                                          int remoteHandle ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00662(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , ((Number) dynConstraints[7]).shortValue() , ((Boolean) dynConstraints[8]).booleanValue() );
            case 1 :
                  return conditional_H00663(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , ((Number) dynConstraints[7]).shortValue() , ((Boolean) dynConstraints[8]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00662", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00663", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
