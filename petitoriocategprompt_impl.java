...
public final  class petitoriocategprompt_impl extends GXDataArea
{
   public petitoriocategprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public petitoriocategprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( petitoriocategprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutPetitorioCategId") ;
         ...
         {
            AV8InOutPetitorioCategId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutPetitorioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutPetitorioCategId), 4, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutPetitorioCategNombre = httpContext.GetPar( "InOutPetitorioCategNombre") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutPetitorioCategNombre", AV9InOutPetitorioCategNombre);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110335947", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.petitoriocategprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutPetitorioCategId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutPetitorioCategNombre))}, new String[] {"InOutPetitorioCategId","InOutPetitorioCategNombre"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTPETITORIOCATEGID", GXutil.ltrim( localUtil.ntoc( AV8InOutPetitorioCategId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTPETITORIOCATEGNOMBRE", AV9InOutPetitorioCategNombre);
   ...
   {
      return formatLink("com.projectthani.petitoriocategprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutPetitorioCategId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutPetitorioCategNombre))}, new String[] {"InOutPetitorioCategId","InOutPetitorioCategNombre"})  ;
   }

   public String getPgmname( )
   {
      return "PetitorioCategPrompt" ;
   }

   public String getPgmdesc( )
   {
      return "Selecciona Petitorio Categ" ;
   }
   ...
   public void wb640( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_642( true) ;
      }
      else
      {
         wb_table1_12_642( false) ;
      }
      return  ;
   }

   public void wb_table1_12_642e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start642( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Petitorio Categ", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_PETITORIOCATEGNOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A266PetitorioCategNombre, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "PETITORIOCATEGNOMBRE", A266PetitorioCategNombre);
   }
   ...
   public void rf642( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                              }
         });
         ...
         {
            A266PetitorioCategNombre = H00642_A266PetitorioCategNombre[0] ;
            A49PetitorioCategId = H00642_A49PetitorioCategId[0] ;
            e17642 ();
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_PETITORIOCATEGID"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, localUtil.format( DecimalUtil.doubleToDec(A49PetitorioCategId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_PETITORIOCATEGNOMBRE"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, GXutil.rtrim( localUtil.format( A266PetitorioCategNombre, ""))));
   }
   ...
   public void e15642( )
   {
      ...
      Form.setCaption( "Selecciona Petitorio Categ" );
   ...
   public void e18642( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutPetitorioCategId = A49PetitorioCategId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutPetitorioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutPetitorioCategId), 4, 0));
      AV9InOutPetitorioCategNombre = A266PetitorioCategNombre ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutPetitorioCategNombre", AV9InOutPetitorioCategNombre);
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV8InOutPetitorioCategId),AV9InOutPetitorioCategNombre});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutPetitorioCategId","AV9InOutPetitorioCategNombre"});
   ...
   public void wb_table1_12_642( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_PetitorioCategPrompt.htm");
   ...
   {
      AV8InOutPetitorioCategId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutPetitorioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutPetitorioCategId), 4, 0));
      AV9InOutPetitorioCategNombre = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutPetitorioCategNombre", AV9InOutPetitorioCategNombre);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202251103407", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("petitoriocategprompt.js", "?202251103407", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:PetitorioCategId|2:PetitorioCategNombre" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11642',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12642',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      ...
      setEventMetadata("ENTER","{handler:'e18642',iparms:[{av:'A49PetitorioCategId',fld:'PETITORIOCATEGID',pic:'ZZZ9',hsh:true},{av:'A266PetitorioCategNombre',fld:'PETITORIOCATEGNOMBRE',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutPetitorioCategId',fld:'vINOUTPETITORIOCATEGID',pic:'ZZZ9'},{av:'AV9InOutPetitorioCategNombre',fld:'vINOUTPETITORIOCATEGNOMBRE',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e14642',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
   ...
   {
      wcpOAV9InOutPetitorioCategNombre = "" ;
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H00642_A266PetitorioCategNombre = new String[] {""} ;
      H00642_A49PetitorioCategId = new short[1] ;
      ...
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.petitoriocategprompt__default(),
         new Object[] {
             new Object[] {
            H00642_A266PetitorioCategNombre, H00642_A49PetitorioCategId
            }
            , new Object[] {
   ...
   private short wcpOAV8InOutPetitorioCategId ;
   private short AV8InOutPetitorioCategId ;
   ...
   private String wcpOAV9InOutPetitorioCategNombre ;
   private String AV13FilterFullText ;
   private String AV9InOutPetitorioCategNombre ;
   ...
   private String[] H00642_A266PetitorioCategNombre ;
   private short[] H00642_A49PetitorioCategId ;
...
final  class petitoriocategprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00642(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
            case 1 :
                  return conditional_H00643(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() );
      }
   ...
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("H00643", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
