...
public final  class laboratoriolaboratoriousuarioswc_impl extends GXWebComponent
{
   public laboratoriolaboratoriousuarioswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public laboratoriolaboratoriousuarioswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( laboratoriolaboratoriousuarioswc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV8LaboratorioId, AV25Pgmname, AV14OrderedBy, AV15OrderedDsc, AV22IsAuthorized_SecUserName, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Laboratorio Laboratorio Usuarios WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110312767", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   public void renderHtmlCloseForm3L2( )
   {
   ...
   {
      return "LaboratorioLaboratorioUsuariosWC" ;
   }
   ...
   public void wb3L0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.laboratoriolaboratoriousuarioswc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      if ( wbEnd == 15 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtLaboratorioId_Internalname, GXutil.ltrim( localUtil.ntoc( A40LaboratorioId, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A40LaboratorioId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLaboratorioId_Jsonclick, 0, "Attribute", "", "", "", "", edtLaboratorioId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id4", "right", false, "", "HLP_LaboratorioLaboratorioUsuariosWC.htm");
         /* User Defined Control */
   ...
   public void start3L2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Laboratorio Laboratorio Usuarios WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV25Pgmname = "LaboratorioLaboratorioUsuariosWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf3L2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H003L2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8LaboratorioId), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_15_idx = 1 ;
         sGXsfl_15_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_15_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_152( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A40LaboratorioId = H003L2_A40LaboratorioId[0] ;
            ...
            A14SecUserName = H003L2_A14SecUserName[0] ;
            A6SecUserId = H003L2_A6SecUserId[0] ;
            A14SecUserName = H003L2_A14SecUserName[0] ;
            e163L2 ();
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      /* Using cursor H003L3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8LaboratorioId)});
   ...
   public void e143L2( )
   {
      ...
      laboratoriolaboratoriousuarioswc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "laboratoriolaboratoriousuarioswc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110312877", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("laboratoriolaboratoriousuarioswc.js", "?20225110312878", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8LaboratorioId',fld:'vLABORATORIOID',pic:'ZZZ9'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV25Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV22IsAuthorized_SecUserName',fld:'vISAUTHORIZED_SECUSERNAME',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e113L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8LaboratorioId',fld:'vLABORATORIOID',pic:'ZZZ9'},{av:'AV25Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV22IsAuthorized_SecUserName',fld:'vISAUTHORIZED_SECUSERNAME',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e163L2',iparms:[{av:'AV22IsAuthorized_SecUserName',fld:'vISAUTHORIZED_SECUSERNAME',pic:'',hsh:true},{av:'A6SecUserId',fld:'SECUSERID',pic:'ZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      sEvtType = "" ;
      scmdbuf = "" ;
      H003L2_A40LaboratorioId = new short[1] ;
      H003L2_A14SecUserName = new String[] {""} ;
      H003L2_A6SecUserId = new short[1] ;
      ...
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.laboratoriolaboratoriousuarioswc__default(),
         new Object[] {
             new Object[] {
            H003L2_A40LaboratorioId, H003L2_A14SecUserName, H003L2_A6SecUserId
            }
            , new Object[] {
   ...
   private short[] H003L2_A40LaboratorioId ;
   private String[] H003L2_A14SecUserName ;
   private short[] H003L2_A6SecUserId ;
...
final  class laboratoriolaboratoriousuarioswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H003L2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          short A40LaboratorioId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[LaboratorioId], T2.[SecUserName], T1.[SecUserId]" ;
      sFromString = " FROM ([LaboratorioLaboratorioUsuarios] T1 INNER JOIN [SecUser] T2 ON T2.[SecUserId] = T1.[SecUserId])" ;
      sOrderString = "" ;
      ...
      {
         sOrderString += " ORDER BY T1.[LaboratorioId] DESC, T1.[SecUserId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[LaboratorioId], T2.[SecUserName]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[LaboratorioId] DESC, T2.[SecUserName] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[LaboratorioId], T1.[SecUserId]" ;
   ...
   protected Object[] conditional_H003L3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          short AV14OrderedBy ,
                                          boolean AV15OrderedDsc ,
                                          ...
                                          short A40LaboratorioId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([LaboratorioLaboratorioUsuarios] T1 INNER JOIN [SecUser] T2 ON T2.[SecUserId] = T1.[SecUserId])" ;
      addWhere(sWhereString, "(T1.[LaboratorioId] = ?)");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H003L2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).shortValue() , ((Number) dynConstraints[3]).shortValue() );
            case 1 :
                  return conditional_H003L3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).shortValue() , ((Number) dynConstraints[3]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H003L2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H003L3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
