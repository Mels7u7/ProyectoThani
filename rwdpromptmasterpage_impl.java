...
public final  class rwdpromptmasterpage_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm062( )
   {
      ...
      httpContext.AddJavascriptSource("rwdpromptmasterpage.js", "?2022511033690", false, true);
   ...
   public void wb060( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divMaintable_Internalname, 1, 0, "px", 0, "px", "PromptMainTable", "left", "top", "", "", "div");
         /* Div Control */
   ...
   public void e11062( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( Contentholder.getPgmname()), "wwpbaseobjects.notauthorized") != 0 )
      {
         ...
         rwdpromptmasterpage_impl.this.AV5IsAuthorized = GXv_boolean1[0] ;
         if ( ! AV5IsAuthorized )
         {
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?2022511033694", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("rwdpromptmasterpage.js", "?2022511033694", false, true);
      }
