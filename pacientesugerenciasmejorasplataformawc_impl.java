...
public final  class pacientesugerenciasmejorasplataformawc_impl extends GXWebComponent
{
   public pacientesugerenciasmejorasplataformawc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public pacientesugerenciasmejorasplataformawc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( pacientesugerenciasmejorasplataformawc_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = httpContext.GetFirstPar( "SGPacientePacienteId") ;
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8SGPacientePacienteId = (int)(GXutil.lval( httpContext.GetPar( "SGPacientePacienteId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8SGPacientePacienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8SGPacientePacienteId), 8, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Integer.valueOf(AV8SGPacientePacienteId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8SGPacientePacienteId, AV20ManageFiltersExecutionStep, AV33Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, A20PacienteId, AV29IsAuthorized_Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Paciente Sugerencias Mejoras Plataforma WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110322020", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.pacientesugerenciasmejorasplataformawc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8SGPacientePacienteId,8,0))}, new String[] {"SGPacientePacienteId"}) +"\">") ;
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV33Pgmname, ""))));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8SGPacientePacienteId", GXutil.ltrim( localUtil.ntoc( wcpOAV8SGPacientePacienteId, (byte)(8), (byte)(0), ",", "")));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV33Pgmname));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV33Pgmname, ""))));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSGPACIENTEPACIENTEID", GXutil.ltrim( localUtil.ntoc( AV8SGPacientePacienteId, (byte)(8), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm7H2( )
   {
   ...
   {
      return "PacienteSugerenciasMejorasPlataformaWC" ;
   }

   public String getPgmdesc( )
   {
      return "Paciente Sugerencias Mejoras Plataforma WC" ;
   }
   ...
   public void wb7H0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.pacientesugerenciasmejorasplataformawc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_7H2( true) ;
      }
      else
      {
         wb_table1_22_7H2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_7H2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeValue( "Plataforma Id") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Cita Id") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Plataforma Op") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Plataforma Mej") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Fec Registro") ;
            httpContext.writeTextNL( "</th>") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A397SugerenciasMejorasPlataformaId, (byte)(8), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A403SugerenciasMejorasPlataformaCitaId, (byte)(4), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A400SugerenciasMejorasPlataformaOp);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A402SugerenciasMejorasPlataformaMej);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.format(A399SugerenciasMejorasPlataformaFecRegistro, "99/99/99"));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtSGPacientePacienteId_Internalname, GXutil.ltrim( localUtil.ntoc( A61SGPacientePacienteId, (byte)(8), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A61SGPacientePacienteId), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSGPacientePacienteId_Jsonclick, 0, "Attribute", "", "", "", "", edtSGPacientePacienteId_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id", "right", false, "", "HLP_PacienteSugerenciasMejorasPlataformaWC.htm");
         /* User Defined Control */
   ...
   public void start7H2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Paciente Sugerencias Mejoras Plataforma WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           A399SugerenciasMejorasPlataformaFecRegistro = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtSugerenciasMejorasPlataformaFecRegistro_Internalname), 0)) ;
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
   ...
   {
      /* GeneXus formulas. */
      AV33Pgmname = "PacienteSugerenciasMejorasPlataformaWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf7H2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV16FilterFullText ,
                                              Integer.valueOf(A397SugerenciasMejorasPlataformaId) ,
                                              Short.valueOf(A403SugerenciasMejorasPlataformaCitaId) ,
                                              A400SugerenciasMejorasPlataformaOp ,
                                              A402SugerenciasMejorasPlataformaMej ,
                                              Short.valueOf(AV14OrderedBy) ,
                                              Boolean.valueOf(AV15OrderedDsc) ,
                                              Integer.valueOf(AV8SGPacientePacienteId) ,
                                              Integer.valueOf(A61SGPacientePacienteId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.INT
                                              }
         });
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H007H2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV8SGPacientePacienteId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A61SGPacientePacienteId = H007H2_A61SGPacientePacienteId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A61SGPacientePacienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A61SGPacientePacienteId), 8, 0));
            A399SugerenciasMejorasPlataformaFecRegistro = H007H2_A399SugerenciasMejorasPlataformaFecRegistro[0] ;
            A402SugerenciasMejorasPlataformaMej = H007H2_A402SugerenciasMejorasPlataformaMej[0] ;
            A400SugerenciasMejorasPlataformaOp = H007H2_A400SugerenciasMejorasPlataformaOp[0] ;
            A403SugerenciasMejorasPlataformaCitaId = H007H2_A403SugerenciasMejorasPlataformaCitaId[0] ;
            A397SugerenciasMejorasPlataformaId = H007H2_A397SugerenciasMejorasPlataformaId[0] ;
            e187H2 ();
   ...
   public void send_integrity_lvl_hashes7H2( )
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV33Pgmname));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV33Pgmname, ""))));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_UPDATE", AV27IsAuthorized_Update);
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H007H3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV8SGPacientePacienteId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void strup7H0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8SGPacientePacienteId = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8SGPacientePacienteId"), ",", ".")) ;
   ...
   public void e167H2( )
   {
      ...
      edtSGPacientePacienteId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtSGPacientePacienteId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtSGPacientePacienteId_Visible), 5, 0), true);
   ...
   public void e117H2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("PacienteSugerenciasMejorasPlataformaWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV33Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("PacienteSugerenciasMejorasPlataformaWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "PacienteSugerenciasMejorasPlataformaWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         pacientesugerenciasmejorasplataformawc_impl.this.GXt_char4 = GXv_char5[0] ;
         ...
         else
         {
            ...
            S172 ();
            if (returnInSub) return;
            new com.projectthani.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV33Pgmname+"GridState", AV19ManageFiltersXml) ;
   ...
   public void S152( )
   {
      ...
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPaciente_Update", GXv_boolean7) ;
      pacientesugerenciasmejorasplataformawc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPaciente_Delete", GXv_boolean7) ;
      pacientesugerenciasmejorasplataformawc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPaciente_Insert", GXv_boolean7) ;
      pacientesugerenciasmejorasplataformawc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "PacienteSugerenciasMejorasPlataformaWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S132( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV17Session.getValue(AV33Pgmname+"GridState"), "") == 0 )
      {
         AV12GridState.fromxml(new com.projectthani.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( AV33Pgmname+"GridState"), null, null);
      }
      else
      {
         AV12GridState.fromxml(AV17Session.getValue(AV33Pgmname+"GridState"), null, null);
      }
      AV14OrderedBy = AV12GridState.getgxTv_SdtWWPGridState_Orderedby() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV14OrderedBy", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV14OrderedBy), 4, 0));
      AV15OrderedDsc = AV12GridState.getgxTv_SdtWWPGridState_Ordereddsc() ;
   ...
   public void S182( )
   {
      ...
      returnInSub = false ;
      AV34GXV1 = 1 ;
      while ( AV34GXV1 <= AV12GridState.getgxTv_SdtWWPGridState_Filtervalues().size() )
      {
         AV13GridStateFilterValue = (com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue)((com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue)AV12GridState.getgxTv_SdtWWPGridState_Filtervalues().elementAt(-1+AV34GXV1));
   ...
   public void S162( )
   {
      ...
      new com.projectthani.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV33Pgmname+"GridState", AV12GridState.toxml(false, true, "WWPGridState", "ProjectThani")) ;
   }
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Callerobject( AV33Pgmname );
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "SGPacientePacienteId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8SGPacientePacienteId, 8, 0) );
   ...
   public void wb_table1_22_7H2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_7H2( true) ;
      }
      else
      {
         wb_table2_27_7H2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_7H2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_7H2e( true) ;
      }
      else
      {
         wb_table1_22_7H2e( false) ;
      }
   }

   public void wb_table2_27_7H2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8SGPacientePacienteId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.INT), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8SGPacientePacienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8SGPacientePacienteId), 8, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8SGPacientePacienteId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "pacientesugerenciasmejorasplataformawc", GetJustCreated( ));
      ...
      {
         AV8SGPacientePacienteId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.INT), TypeConstants.INT)).intValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8SGPacientePacienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8SGPacientePacienteId), 8, 0));
      }
      wcpOAV8SGPacientePacienteId = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8SGPacientePacienteId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV8SGPacientePacienteId != wcpOAV8SGPacientePacienteId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8SGPacientePacienteId = AV8SGPacientePacienteId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8SGPacientePacienteId = httpContext.cgiGet( sPrefix+"AV8SGPacientePacienteId_CTRL") ;
      if ( GXutil.len( sCtrlAV8SGPacientePacienteId) > 0 )
      {
         AV8SGPacientePacienteId = (int)(localUtil.ctol( httpContext.cgiGet( sCtrlAV8SGPacientePacienteId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8SGPacientePacienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8SGPacientePacienteId), 8, 0));
      }
      else
      {
         AV8SGPacientePacienteId = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8SGPacientePacienteId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8SGPacientePacienteId_PARM", GXutil.ltrim( localUtil.ntoc( AV8SGPacientePacienteId, (byte)(8), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8SGPacientePacienteId)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8SGPacientePacienteId_CTRL", GXutil.rtrim( sCtrlAV8SGPacientePacienteId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110322199", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("pacientesugerenciasmejorasplataformawc.js", "?20225110322199", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtSugerenciasMejorasPlataformaId_Internalname = sPrefix+"SUGERENCIASMEJORASPLATAFORMAID_"+sGXsfl_37_idx ;
      edtSugerenciasMejorasPlataformaCitaId_Internalname = sPrefix+"SUGERENCIASMEJORASPLATAFORMACITAID_"+sGXsfl_37_idx ;
      edtSugerenciasMejorasPlataformaOp_Internalname = sPrefix+"SUGERENCIASMEJORASPLATAFORMAOP_"+sGXsfl_37_idx ;
      edtSugerenciasMejorasPlataformaMej_Internalname = sPrefix+"SUGERENCIASMEJORASPLATAFORMAMEJ_"+sGXsfl_37_idx ;
      edtSugerenciasMejorasPlataformaFecRegistro_Internalname = sPrefix+"SUGERENCIASMEJORASPLATAFORMAFECREGISTRO_"+sGXsfl_37_idx ;
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtSugerenciasMejorasPlataformaId_Internalname = sPrefix+"SUGERENCIASMEJORASPLATAFORMAID_"+sGXsfl_37_fel_idx ;
      edtSugerenciasMejorasPlataformaCitaId_Internalname = sPrefix+"SUGERENCIASMEJORASPLATAFORMACITAID_"+sGXsfl_37_fel_idx ;
      edtSugerenciasMejorasPlataformaOp_Internalname = sPrefix+"SUGERENCIASMEJORASPLATAFORMAOP_"+sGXsfl_37_fel_idx ;
      edtSugerenciasMejorasPlataformaMej_Internalname = sPrefix+"SUGERENCIASMEJORASPLATAFORMAMEJ_"+sGXsfl_37_fel_idx ;
      edtSugerenciasMejorasPlataformaFecRegistro_Internalname = sPrefix+"SUGERENCIASMEJORASPLATAFORMAFECREGISTRO_"+sGXsfl_37_fel_idx ;
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSugerenciasMejorasPlataformaId_Internalname,GXutil.ltrim( localUtil.ntoc( A397SugerenciasMejorasPlataformaId, (byte)(8), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A397SugerenciasMejorasPlataformaId), "ZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSugerenciasMejorasPlataformaId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSugerenciasMejorasPlataformaCitaId_Internalname,GXutil.ltrim( localUtil.ntoc( A403SugerenciasMejorasPlataformaCitaId, (byte)(4), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A403SugerenciasMejorasPlataformaCitaId), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSugerenciasMejorasPlataformaCitaId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSugerenciasMejorasPlataformaOp_Internalname,A400SugerenciasMejorasPlataformaOp,A400SugerenciasMejorasPlataformaOp,"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSugerenciasMejorasPlataformaOp_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(2097152),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSugerenciasMejorasPlataformaMej_Internalname,A402SugerenciasMejorasPlataformaMej,A402SugerenciasMejorasPlataformaMej,"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSugerenciasMejorasPlataformaMej_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(2097152),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSugerenciasMejorasPlataformaFecRegistro_Internalname,localUtil.format(A399SugerenciasMejorasPlataformaFecRegistro, "99/99/99"),localUtil.format( A399SugerenciasMejorasPlataformaFecRegistro, "99/99/99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSugerenciasMejorasPlataformaFecRegistro_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
   ...
   public void init_default_properties( )
   {
      ...
      edtSugerenciasMejorasPlataformaId_Internalname = sPrefix+"SUGERENCIASMEJORASPLATAFORMAID" ;
      edtSugerenciasMejorasPlataformaCitaId_Internalname = sPrefix+"SUGERENCIASMEJORASPLATAFORMACITAID" ;
      edtSugerenciasMejorasPlataformaOp_Internalname = sPrefix+"SUGERENCIASMEJORASPLATAFORMAOP" ;
      edtSugerenciasMejorasPlataformaMej_Internalname = sPrefix+"SUGERENCIASMEJORASPLATAFORMAMEJ" ;
      edtSugerenciasMejorasPlataformaFecRegistro_Internalname = sPrefix+"SUGERENCIASMEJORASPLATAFORMAFECREGISTRO" ;
      Gridpaginationbar_Internalname = sPrefix+"GRIDPAGINATIONBAR" ;
      divGridtablewithpaginationbar_Internalname = sPrefix+"GRIDTABLEWITHPAGINATIONBAR" ;
      divTablegridheader_Internalname = sPrefix+"TABLEGRIDHEADER" ;
      Ddo_grid_Internalname = sPrefix+"DDO_GRID" ;
      edtSGPacientePacienteId_Internalname = sPrefix+"SGPACIENTEPACIENTEID" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtSugerenciasMejorasPlataformaMej_Jsonclick = "" ;
      edtSugerenciasMejorasPlataformaOp_Jsonclick = "" ;
      ...
      edtSGPacientePacienteId_Visible = 1 ;
      ...
      Ddo_grid_Columnids = "2:SugerenciasMejorasPlataformaId|3:SugerenciasMejorasPlataformaCitaId|4:SugerenciasMejorasPlataformaOp|5:SugerenciasMejorasPlataformaMej|6:SugerenciasMejorasPlataformaFecRegistro" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e127H2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8SGPacientePacienteId',fld:'vSGPACIENTEPACIENTEID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A20PacienteId',fld:'PACIENTEID',pic:'ZZZZZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e137H2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8SGPacientePacienteId',fld:'vSGPACIENTEPACIENTEID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A20PacienteId',fld:'PACIENTEID',pic:'ZZZZZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e147H2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8SGPacientePacienteId',fld:'vSGPACIENTEPACIENTEID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A20PacienteId',fld:'PACIENTEID',pic:'ZZZZZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e187H2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A20PacienteId',fld:'PACIENTEID',pic:'ZZZZZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e117H2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8SGPacientePacienteId',fld:'vSGPACIENTEPACIENTEID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A20PacienteId',fld:'PACIENTEID',pic:'ZZZZZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e157H2',iparms:[{av:'A20PacienteId',fld:'PACIENTEID',pic:'ZZZZZZZ9',hsh:true}]");
      setEventMetadata("'DOINSERT'",",oparms:[]}");
      setEventMetadata("NULL","{handler:'valid_Sugerenciasmejorasplataformafecregistro',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H007H2_A61SGPacientePacienteId = new int[1] ;
      H007H2_A399SugerenciasMejorasPlataformaFecRegistro = new java.util.Date[] {GXutil.nullDate()} ;
      H007H2_A402SugerenciasMejorasPlataformaMej = new String[] {""} ;
      H007H2_A400SugerenciasMejorasPlataformaOp = new String[] {""} ;
      H007H2_A403SugerenciasMejorasPlataformaCitaId = new short[1] ;
      H007H2_A397SugerenciasMejorasPlataformaId = new int[1] ;
      ...
      sCtrlAV8SGPacientePacienteId = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.pacientesugerenciasmejorasplataformawc__default(),
         new Object[] {
             new Object[] {
            H007H2_A61SGPacientePacienteId, H007H2_A399SugerenciasMejorasPlataformaFecRegistro, H007H2_A402SugerenciasMejorasPlataformaMej, H007H2_A400SugerenciasMejorasPlataformaOp, H007H2_A403SugerenciasMejorasPlataformaCitaId, H007H2_A397SugerenciasMejorasPlataformaId
            }
            , new Object[] {
   ...
   private int wcpOAV8SGPacientePacienteId ;
   private int subGrid_Rows ;
   private int Gridpaginationbar_Rowsperpageselectedvalue ;
   private int nRC_GXsfl_37 ;
   private int AV8SGPacientePacienteId ;
   ...
   private int edtSGPacientePacienteId_Visible ;
   ...
   private String sCtrlAV8SGPacientePacienteId ;
   ...
   private String edtSugerenciasMejorasPlataformaOp_Jsonclick ;
   private String edtSugerenciasMejorasPlataformaMej_Jsonclick ;
   ...
   private int[] H007H2_A61SGPacientePacienteId ;
   private java.util.Date[] H007H2_A399SugerenciasMejorasPlataformaFecRegistro ;
   private String[] H007H2_A402SugerenciasMejorasPlataformaMej ;
   private String[] H007H2_A400SugerenciasMejorasPlataformaOp ;
   private short[] H007H2_A403SugerenciasMejorasPlataformaCitaId ;
   private int[] H007H2_A397SugerenciasMejorasPlataformaId ;
...
final  class pacientesugerenciasmejorasplataformawc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H007H2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A397SugerenciasMejorasPlataformaId ,
                                          short A403SugerenciasMejorasPlataformaCitaId ,
                                          String A400SugerenciasMejorasPlataformaOp ,
                                          String A402SugerenciasMejorasPlataformaMej ,
                                          short AV14OrderedBy ,
                                          boolean AV15OrderedDsc ,
                                          int AV8SGPacientePacienteId ,
                                          int A61SGPacientePacienteId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [SGPacientePacienteId], [SugerenciasMejorasPlataformaFecRegistro], [SugerenciasMejorasPlataformaMej], [SugerenciasMejorasPlataformaOp], [SugerenciasMejorasPlataformaCitaId]," ;
      sSelectString += " [SugerenciasMejorasPlataformaId]" ;
      sFromString = " FROM [SugerenciasMejorasPlataforma]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([SGPacientePacienteId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([SugerenciasMejorasPlataformaId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(4), CAST([SugerenciasMejorasPlataformaCitaId] AS decimal(4,0))) like '%' + ?) or ( [SugerenciasMejorasPlataformaOp] like '%' + ?) or ( [SugerenciasMejorasPlataformaMej] like '%' + ?))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [SugerenciasMejorasPlataformaCitaId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [SugerenciasMejorasPlataformaCitaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [SugerenciasMejorasPlataformaId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [SugerenciasMejorasPlataformaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [SugerenciasMejorasPlataformaOp]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [SugerenciasMejorasPlataformaOp] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [SugerenciasMejorasPlataformaMej]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [SugerenciasMejorasPlataformaMej] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [SugerenciasMejorasPlataformaFecRegistro]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [SugerenciasMejorasPlataformaFecRegistro] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [SugerenciasMejorasPlataformaId]" ;
      }
   ...
   protected Object[] conditional_H007H3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A397SugerenciasMejorasPlataformaId ,
                                          ...
                                          int A61SGPacientePacienteId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [SugerenciasMejorasPlataforma]" ;
      addWhere(sWhereString, "([SGPacientePacienteId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([SugerenciasMejorasPlataformaId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(4), CAST([SugerenciasMejorasPlataformaCitaId] AS decimal(4,0))) like '%' + ?) or ( [SugerenciasMejorasPlataformaOp] like '%' + ?) or ( [SugerenciasMejorasPlataformaMej] like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H007H2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() , ((Number) dynConstraints[7]).intValue() , ((Number) dynConstraints[8]).intValue() );
            case 1 :
                  return conditional_H007H3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() , ((Number) dynConstraints[7]).intValue() , ((Number) dynConstraints[8]).intValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H007H2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H007H3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
