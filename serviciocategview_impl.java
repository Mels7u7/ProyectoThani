...
public final  class serviciocategview_impl extends GXDataArea
{
   public serviciocategview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public serviciocategview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( serviciocategview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10ServicioCategId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10ServicioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10ServicioCategId), 4, 0));
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSERVICIOCATEGID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10ServicioCategId), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511033477", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.serviciocategview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10ServicioCategId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"ServicioCategId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vSERVICIOCATEGID", GXutil.ltrim( localUtil.ntoc( AV10ServicioCategId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSERVICIOCATEGID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10ServicioCategId), "ZZZ9")));
   ...
   public void renderHtmlCloseForm( )
   {
      ...
      if ( ! ( WebComp_Serviciowc == null ) )
      {
         WebComp_Serviciowc.componentjscripts();
      }
   }
   ...
   {
      return formatLink("com.projectthani.serviciocategview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10ServicioCategId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"ServicioCategId","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "ServicioCategView" ;
   }

   public String getPgmdesc( )
   {
      return "Servicio Categ View" ;
   }
   ...
   public void wb3N0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, "Ir a Servicio Categ", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_ServicioCategView.htm");
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divServiciocateggeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblServicio_title_Internalname, "Servicio", "", "", lblServicio_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ServicioCategView.htm");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         httpContext.writeText( "Servicio") ;
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         httpContext.writeText( "</div>") ;
         httpContext.writeText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel1"+"\" style=\"display:none;\">") ;
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divUnnamedtableservicio_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         {
            /* WebComponent */
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "W0033"+"", GXutil.rtrim( WebComp_Serviciowc_Component));
            httpContext.writeText( "<div") ;
            com.projectthani.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
            httpContext.writeText( " id=\""+"gxHTMLWrpW0033"+""+"\""+"") ;
            httpContext.writeText( ">") ;
            if ( GXutil.len( WebComp_Serviciowc_Component) != 0 )
            {
               if ( GXutil.strcmp(GXutil.lower( OldServiciowc), GXutil.lower( WebComp_Serviciowc_Component)) != 0 )
               {
                  httpContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
               }
               WebComp_Serviciowc.componentdraw();
               if ( GXutil.strcmp(GXutil.lower( OldServiciowc), GXutil.lower( WebComp_Serviciowc_Component)) != 0 )
               {
                  httpContext.ajax_rspEndCmp();
               }
   ...
   public void start3N2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Servicio Categ View", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldServiciowc = httpContext.cgiGet( "W0033") ;
                        if ( ( GXutil.len( OldServiciowc) == 0 ) || ( GXutil.strcmp(OldServiciowc, WebComp_Serviciowc_Component) != 0 ) )
                        {
                           WebComp_Serviciowc = WebUtils.getWebComponent(getClass(), "com.projectthani." + OldServiciowc + "_impl", remoteHandle, context);
                           WebComp_Serviciowc_Component = OldServiciowc ;
                        }
                        if ( GXutil.len( WebComp_Serviciowc_Component) != 0 )
                        {
                           WebComp_Serviciowc.componentprocess("W0033", "", sEvt);
                        }
                        WebComp_Serviciowc_Component = OldServiciowc ;
                     }
                  }
   ...
   public void rf3N2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         if ( 1 != 0 )
         {
            if ( GXutil.len( WebComp_Serviciowc_Component) != 0 )
            {
               WebComp_Serviciowc.componentstart();
            }
         }
      }
   ...
   public void e123N2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.projectthani.serviciocategww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV18GXLvl9 = (byte)(0) ;
      /* Using cursor H003N2 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10ServicioCategId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A52ServicioCategId = H003N2_A52ServicioCategId[0] ;
         A287ServicioCategNombre = H003N2_A287ServicioCategNombre[0] ;
         AV18GXLvl9 = (byte)(1) ;
         Form.setCaption( A287ServicioCategNombre );
   ...
   public void S112( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( WebComp_Webcomponent_general_Component), GXutil.lower( "ServicioCategGeneral")) != 0 )
      {
         WebComp_Webcomponent_general = WebUtils.getWebComponent(getClass(), "com.projectthani.serviciocateggeneral_impl", remoteHandle, context);
         WebComp_Webcomponent_general_Component = "ServicioCategGeneral" ;
      }
      if ( GXutil.len( WebComp_Webcomponent_general_Component) != 0 )
      {
         WebComp_Webcomponent_general.setjustcreated();
         WebComp_Webcomponent_general.componentprepare(new Object[] {"W0019","",Short.valueOf(AV10ServicioCategId)});
   ...
   public void S122( )
   {
      ...
      returnInSub = false ;
      /* Using cursor H003N3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV10ServicioCategId)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A52ServicioCategId = H003N3_A52ServicioCategId[0] ;
         GXt_boolean2 = AV15TempBoolean ;
         GXv_boolean3[0] = GXt_boolean2 ;
         new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWServicio", GXv_boolean3) ;
         serviciocategview_impl.this.GXt_boolean2 = GXv_boolean3[0] ;
         AV15TempBoolean = GXt_boolean2 ;
         if ( AV15TempBoolean )
         {
            if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "Servicio") == 0 ) )
            {
               /* Object Property */
               if ( true )
               {
                  bDynCreated_Serviciowc = true ;
               }
               if ( GXutil.strcmp(GXutil.lower( WebComp_Serviciowc_Component), GXutil.lower( "ServicioCategServicioWC")) != 0 )
               {
                  WebComp_Serviciowc = WebUtils.getWebComponent(getClass(), "com.projectthani.serviciocategserviciowc_impl", remoteHandle, context);
                  WebComp_Serviciowc_Component = "ServicioCategServicioWC" ;
               }
               if ( GXutil.len( WebComp_Serviciowc_Component) != 0 )
               {
                  WebComp_Serviciowc.setjustcreated();
                  WebComp_Serviciowc.componentprepare(new Object[] {"W0033","",Short.valueOf(AV10ServicioCategId)});
                  WebComp_Serviciowc.componentbind(new Object[] {""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Serviciowc )
               {
                  httpContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
                  WebComp_Serviciowc.componentdraw();
                  httpContext.ajax_rspEndCmp();
   ...
   {
      AV10ServicioCategId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10ServicioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10ServicioCategId), 4, 0));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSERVICIOCATEGID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10ServicioCategId), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      if ( ! ( WebComp_Serviciowc == null ) )
      {
         if ( GXutil.len( WebComp_Serviciowc_Component) != 0 )
         {
            WebComp_Serviciowc.componentthemes();
         }
      }
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110334735", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("serviciocategview.js", "?20225110334735", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void init_default_properties( )
   {
      ...
      divServiciocateggeneral_cell_Internalname = "SERVICIOCATEGGENERAL_CELL" ;
      lblServicio_title_Internalname = "SERVICIO_TITLE" ;
      divUnnamedtableservicio_Internalname = "UNNAMEDTABLESERVICIO" ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Servicio Categ View" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10ServicioCategId',fld:'vSERVICIOCATEGID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("TABS.TABCHANGED","{handler:'e113N2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'A52ServicioCategId',fld:'SERVICIOCATEGID',pic:'ZZZ9'},{av:'AV10ServicioCategId',fld:'vSERVICIOCATEGID',pic:'ZZZ9',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
      setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'SERVICIOWC'}]}");
   }
   ...
   public void initialize( )
   {
      ...
      lblServicio_title_Jsonclick = "" ;
      WebComp_Serviciowc_Component = "" ;
      OldServiciowc = "" ;
      sEvt = "" ;
      EvtGridId = "" ;
      EvtRowId = "" ;
      ...
      scmdbuf = "" ;
      H003N2_A52ServicioCategId = new short[1] ;
      H003N2_A287ServicioCategNombre = new String[] {""} ;
      A287ServicioCategNombre = "" ;
      H003N3_A52ServicioCategId = new short[1] ;
      GXv_boolean3 = new boolean[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.serviciocategview__default(),
         new Object[] {
             new Object[] {
            H003N2_A52ServicioCategId, H003N2_A287ServicioCategNombre
            }
            , new Object[] {
            H003N3_A52ServicioCategId
            }
         }
      );
      /* GeneXus formulas. */
      ...
      WebComp_Serviciowc = new com.genexus.webpanels.GXWebComponentNull(remoteHandle, context);
   }
   ...
   private short wcpOAV10ServicioCategId ;
   private short nRcdExists_4 ;
   private short nIsMod_4 ;
   private short nRcdExists_3 ;
   private short nIsMod_3 ;
   private short AV10ServicioCategId ;
   ...
   private String divServiciocateggeneral_cell_Internalname ;
   ...
   private String lblServicio_title_Internalname ;
   private String lblServicio_title_Jsonclick ;
   private String divUnnamedtableservicio_Internalname ;
   private String WebComp_Serviciowc_Component ;
   private String OldServiciowc ;
   private String sEvt ;
   ...
   private boolean bDynCreated_Serviciowc ;
   private String A287ServicioCategNombre ;
   private com.genexus.internet.MsgList BackMsgLst ;
   private com.genexus.internet.MsgList LclMsgLst ;
   private GXWebComponent WebComp_Webcomponent_general ;
   private GXWebComponent WebComp_Serviciowc ;
   private com.genexus.webpanels.GXUserControl ucPanel_general ;
   private com.genexus.webpanels.GXUserControl ucTabs ;
   private IDataStoreProvider pr_default ;
   private short[] H003N2_A52ServicioCategId ;
   private String[] H003N2_A287ServicioCategNombre ;
   private short[] H003N3_A52ServicioCategId ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class serviciocategview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H003N2", "SELECT [ServicioCategId], [ServicioCategNombre] FROM [ServicioCateg] WHERE [ServicioCategId] = ? ORDER BY [ServicioCategId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H003N3", "SELECT [ServicioCategId] FROM [ServicioCateg] WHERE [ServicioCategId] = ? ORDER BY [ServicioCategId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
