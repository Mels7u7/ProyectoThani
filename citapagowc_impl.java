...
public final  class citapagowc_impl extends GXWebComponent
{
   public citapagowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public citapagowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( citapagowc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Cita Pago WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110325677", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.citapagowc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8CitaId,8,0))}, new String[] {"CitaId"}) +"\">") ;
   ...
   public void wb3F0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.citapagowc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_3F2( true) ;
      }
      else
      {
         wb_table1_22_3F2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_3F2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start3F2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Cita Pago WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_PAGOID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A47PagoId), "ZZZZZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"PAGOID", GXutil.ltrim( localUtil.ntoc( A47PagoId, (byte)(8), (byte)(0), ".", "")));
   }
   ...
   public void rf3F2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.INT, TypeConstants.DECIMAL, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT,
                                              TypeConstants.INT, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.INT, TypeConstants.INT, TypeConstants.BOOLEAN,
                                              TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.INT, TypeConstants.BOOLEAN
                                              }
         });
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H003F2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV8CitaId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A19CitaId = H003F2_A19CitaId[0] ;
            n19CitaId = H003F2_n19CitaId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A19CitaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A19CitaId), 8, 0));
            A246PagoEstadoR = H003F2_A246PagoEstadoR[0] ;
            A339PagoEnlaceXML = H003F2_A339PagoEnlaceXML[0] ;
            A338PagoEnlacePDF = H003F2_A338PagoEnlacePDF[0] ;
            A34DisponibilidadId = H003F2_A34DisponibilidadId[0] ;
            n34DisponibilidadId = H003F2_n34DisponibilidadId[0] ;
            A311PagoStatusCode = H003F2_A311PagoStatusCode[0] ;
            A310PagoPasarelaId = H003F2_A310PagoPasarelaId[0] ;
            A309PagoResponse = H003F2_A309PagoResponse[0] ;
            A308PagoRequest = H003F2_A308PagoRequest[0] ;
            A257PagoNubefactResponse = H003F2_A257PagoNubefactResponse[0] ;
            A256PagoNubefactRequest = H003F2_A256PagoNubefactRequest[0] ;
            A253PagoMoneda = H003F2_A253PagoMoneda[0] ;
            A252PagoFechaEmision = H003F2_A252PagoFechaEmision[0] ;
            A245PagoNumero = H003F2_A245PagoNumero[0] ;
            A244PagoTipoDocumento = H003F2_A244PagoTipoDocumento[0] ;
            A251PagoClienteEmail = H003F2_A251PagoClienteEmail[0] ;
            A250PagoClienteDireccion = H003F2_A250PagoClienteDireccion[0] ;
            A249PagoClienteDenominacion = H003F2_A249PagoClienteDenominacion[0] ;
            A248PagoClienteNroDocumento = H003F2_A248PagoClienteNroDocumento[0] ;
            A247PagoTipoDocumentoCliente = H003F2_A247PagoTipoDocumentoCliente[0] ;
            A243PagoToken = H003F2_A243PagoToken[0] ;
            A242PagoMonto = H003F2_A242PagoMonto[0] ;
            A47PagoId = H003F2_A47PagoId[0] ;
            e183F2 ();
   ...
   public void send_integrity_lvl_hashes3F2( )
   {
      ...
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_DELETE", AV28IsAuthorized_Delete);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( sPrefix, AV28IsAuthorized_Delete));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_PAGOID"+"_"+sGXsfl_37_idx, getSecureSignedToken( sPrefix+sGXsfl_37_idx, localUtil.format( DecimalUtil.doubleToDec(A47PagoId), "ZZZZZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H003F3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV8CitaId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void e113F2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("CitaPagoWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV34Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("CitaPagoWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "CitaPagoWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         citapagowc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPago_Update", GXv_boolean7) ;
      citapagowc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPago_Delete", GXv_boolean7) ;
      citapagowc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPago_Insert", GXv_boolean7) ;
      citapagowc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "CitaPagoWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Pago" );
   ...
   public void wb_table1_22_3F2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_3F2( true) ;
      }
      else
      {
         wb_table2_27_3F2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_3F2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_3F2e( true) ;
      }
      else
      {
         wb_table1_22_3F2e( false) ;
      }
   }

   public void wb_table2_27_3F2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "citapagowc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110325952", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("citapagowc.js", "?20225110325952", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:PagoId|3:PagoMonto|4:PagoToken|5:PagoTipoDocumentoCliente|6:PagoClienteNroDocumento|7:PagoClienteDenominacion|8:PagoClienteDireccion|9:PagoClienteEmail|10:PagoTipoDocumento|11:PagoNumero|12:PagoFechaEmision|13:PagoMoneda|14:PagoNubefactRequest|15:PagoNubefactResponse|16:PagoRequest|17:PagoResponse|18:PagoPasarelaId|19:PagoStatusCode|20:DisponibilidadId|21:PagoEnlacePDF|22:PagoEnlaceXML|23:PagoEstadoR" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e183F2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A47PagoId',fld:'PAGOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV28IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A338PagoEnlacePDF',fld:'PAGOENLACEPDF',pic:''},{av:'A339PagoEnlaceXML',fld:'PAGOENLACEXML',pic:''}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV30Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV31Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtPagoMonto_Link',ctrl:'PAGOMONTO',prop:'Link'},{av:'edtPagoEnlacePDF_Linktarget',ctrl:'PAGOENLACEPDF',prop:'Linktarget'},{av:'edtPagoEnlacePDF_Link',ctrl:'PAGOENLACEPDF',prop:'Link'},{av:'edtPagoEnlaceXML_Linktarget',ctrl:'PAGOENLACEXML',prop:'Linktarget'},{av:'edtPagoEnlaceXML_Link',ctrl:'PAGOENLACEXML',prop:'Link'}]}");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e153F2',iparms:[{av:'A47PagoId',fld:'PAGOID',pic:'ZZZZZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H003F2_A19CitaId = new int[1] ;
      H003F2_n19CitaId = new boolean[] {false} ;
      H003F2_A246PagoEstadoR = new String[] {""} ;
      H003F2_A339PagoEnlaceXML = new String[] {""} ;
      H003F2_A338PagoEnlacePDF = new String[] {""} ;
      H003F2_A34DisponibilidadId = new int[1] ;
      H003F2_n34DisponibilidadId = new boolean[] {false} ;
      H003F2_A311PagoStatusCode = new int[1] ;
      H003F2_A310PagoPasarelaId = new String[] {""} ;
      H003F2_A309PagoResponse = new String[] {""} ;
      H003F2_A308PagoRequest = new String[] {""} ;
      H003F2_A257PagoNubefactResponse = new String[] {""} ;
      H003F2_A256PagoNubefactRequest = new String[] {""} ;
      H003F2_A253PagoMoneda = new short[1] ;
      H003F2_A252PagoFechaEmision = new java.util.Date[] {GXutil.nullDate()} ;
      H003F2_A245PagoNumero = new int[1] ;
      H003F2_A244PagoTipoDocumento = new short[1] ;
      H003F2_A251PagoClienteEmail = new String[] {""} ;
      H003F2_A250PagoClienteDireccion = new String[] {""} ;
      H003F2_A249PagoClienteDenominacion = new String[] {""} ;
      H003F2_A248PagoClienteNroDocumento = new String[] {""} ;
      H003F2_A247PagoTipoDocumentoCliente = new String[] {""} ;
      H003F2_A243PagoToken = new String[] {""} ;
      H003F2_A242PagoMonto = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H003F2_A47PagoId = new int[1] ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.citapagowc__default(),
         new Object[] {
             new Object[] {
            H003F2_A19CitaId, H003F2_n19CitaId, H003F2_A246PagoEstadoR, H003F2_A339PagoEnlaceXML, H003F2_A338PagoEnlacePDF, H003F2_A34DisponibilidadId, H003F2_n34DisponibilidadId, H003F2_A311PagoStatusCode, H003F2_A310PagoPasarelaId, H003F2_A309PagoResponse,
            H003F2_A308PagoRequest, H003F2_A257PagoNubefactResponse, H003F2_A256PagoNubefactRequest, H003F2_A253PagoMoneda, H003F2_A252PagoFechaEmision, H003F2_A245PagoNumero, H003F2_A244PagoTipoDocumento, H003F2_A251PagoClienteEmail, H003F2_A250PagoClienteDireccion, H003F2_A249PagoClienteDenominacion,
            H003F2_A248PagoClienteNroDocumento, H003F2_A247PagoTipoDocumentoCliente, H003F2_A243PagoToken, H003F2_A242PagoMonto, H003F2_A47PagoId
            }
            , new Object[] {
   ...
   private int[] H003F2_A19CitaId ;
   private boolean[] H003F2_n19CitaId ;
   private String[] H003F2_A246PagoEstadoR ;
   private String[] H003F2_A339PagoEnlaceXML ;
   private String[] H003F2_A338PagoEnlacePDF ;
   private int[] H003F2_A34DisponibilidadId ;
   private boolean[] H003F2_n34DisponibilidadId ;
   private int[] H003F2_A311PagoStatusCode ;
   private String[] H003F2_A310PagoPasarelaId ;
   private String[] H003F2_A309PagoResponse ;
   private String[] H003F2_A308PagoRequest ;
   private String[] H003F2_A257PagoNubefactResponse ;
   private String[] H003F2_A256PagoNubefactRequest ;
   private short[] H003F2_A253PagoMoneda ;
   private java.util.Date[] H003F2_A252PagoFechaEmision ;
   private int[] H003F2_A245PagoNumero ;
   private short[] H003F2_A244PagoTipoDocumento ;
   private String[] H003F2_A251PagoClienteEmail ;
   private String[] H003F2_A250PagoClienteDireccion ;
   private String[] H003F2_A249PagoClienteDenominacion ;
   private String[] H003F2_A248PagoClienteNroDocumento ;
   private String[] H003F2_A247PagoTipoDocumentoCliente ;
   private String[] H003F2_A243PagoToken ;
   private java.math.BigDecimal[] H003F2_A242PagoMonto ;
   private int[] H003F2_A47PagoId ;
...
final  class citapagowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H003F2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          int A19CitaId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [CitaId], [PagoEstadoR], [PagoEnlaceXML], [PagoEnlacePDF], [DisponibilidadId], [PagoStatusCode], [PagoPasarelaId], [PagoResponse], [PagoRequest], [PagoNubefactResponse]," ;
      sSelectString += " [PagoNubefactRequest], [PagoMoneda], [PagoFechaEmision], [PagoNumero], [PagoTipoDocumento], [PagoClienteEmail], [PagoClienteDireccion], [PagoClienteDenominacion]," ;
      sSelectString += " [PagoClienteNroDocumento], [PagoTipoDocumentoCliente], [PagoToken], [PagoMonto], [PagoId]" ;
      sFromString = " FROM [Pago]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([CitaId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([PagoId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(6), CAST([PagoMonto] AS decimal(6,2))) like '%' + ?) or ( [PagoToken] like '%' + ?) or ( 'ruc' like '%' + LOWER(?) and [PagoTipoDocumentoCliente] = '6') or ( 'dni' like '%' + LOWER(?) and [PagoTipoDocumentoCliente] = '1') or ( 'carnet de ext.' like '%' + LOWER(?) and [PagoTipoDocumentoCliente] = '4') or ( 'pasaporte' like '%' + LOWER(?) and [PagoTipoDocumentoCliente] = '7') or ( 'cdi' like '%' + LOWER(?) and [PagoTipoDocumentoCliente] = 'A') or ( 'no domiciliado' like '%' + LOWER(?) and [PagoTipoDocumentoCliente] = '0') or ( [PagoClienteNroDocumento] like '%' + ?) or ( [PagoClienteDenominacion] like '%' + ?) or ( [PagoClienteDireccion] like '%' + ?) or ( [PagoClienteEmail] like '%' + ?) or ( 'factura' like '%' + LOWER(?) and [PagoTipoDocumento] = 1) or ( 'boleta' like '%' + LOWER(?) and [PagoTipoDocumento] = 2) or ( 'nota credito' like '%' + LOWER(?) and [PagoTipoDocumento] = 3) or ( 'nota debito' like '%' + LOWER(?) and [PagoTipoDocumento] = 4) or ( CONVERT( char(8), CAST([PagoNumero] AS decimal(8,0))) like '%' + ?) or ( 'soles' like '%' + LOWER(?) and [PagoMoneda] = 1) or ( 'dólares' like '%' + LOWER(?) and [PagoMoneda] = 2) or ( 'euros' like '%' + LOWER(?) and [PagoMoneda] = 3) or ( [PagoNubefactRequest] like '%' + ?) or ( [PagoNubefactResponse] like '%' + ?) or ( [PagoRequest] like '%' + ?) or ( [PagoResponse] like '%' + ?) or ( [PagoPasarelaId] like '%' + ?) or ( CONVERT( char(8), CAST([PagoStatusCode] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(8), CAST([DisponibilidadId] AS decimal(8,0))) like '%' + ?) or ( [PagoEnlacePDF] like '%' + ?) or ( [PagoEnlaceXML] like '%' + ?) or ( 'activo' like '%' + LOWER(?) and [PagoEstadoR] = 'A') or ( 'inactivo' like '%' + LOWER(?) and [PagoEstadoR] = 'I'))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [CitaId], [PagoMonto]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoMonto] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoToken]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoToken] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoTipoDocumentoCliente]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoTipoDocumentoCliente] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoClienteNroDocumento]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoClienteNroDocumento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoClienteDenominacion]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoClienteDenominacion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoClienteDireccion]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoClienteDireccion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoClienteEmail]" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoClienteEmail] DESC" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoTipoDocumento]" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoTipoDocumento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoNumero]" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoNumero] DESC" ;
      }
      else if ( ( AV14OrderedBy == 11 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoFechaEmision]" ;
      }
      else if ( ( AV14OrderedBy == 11 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoFechaEmision] DESC" ;
      }
      else if ( ( AV14OrderedBy == 12 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoMoneda]" ;
      }
      else if ( ( AV14OrderedBy == 12 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoMoneda] DESC" ;
      }
      else if ( ( AV14OrderedBy == 13 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoNubefactRequest]" ;
      }
      else if ( ( AV14OrderedBy == 13 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoNubefactRequest] DESC" ;
      }
      else if ( ( AV14OrderedBy == 14 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoNubefactResponse]" ;
      }
      else if ( ( AV14OrderedBy == 14 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoNubefactResponse] DESC" ;
      }
      else if ( ( AV14OrderedBy == 15 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoRequest]" ;
      }
      else if ( ( AV14OrderedBy == 15 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoRequest] DESC" ;
      }
      else if ( ( AV14OrderedBy == 16 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoResponse]" ;
      }
      else if ( ( AV14OrderedBy == 16 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoResponse] DESC" ;
      }
      else if ( ( AV14OrderedBy == 17 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoPasarelaId]" ;
      }
      else if ( ( AV14OrderedBy == 17 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoPasarelaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 18 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoStatusCode]" ;
      }
      else if ( ( AV14OrderedBy == 18 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoStatusCode] DESC" ;
      }
      else if ( ( AV14OrderedBy == 19 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [DisponibilidadId]" ;
      }
      else if ( ( AV14OrderedBy == 19 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [DisponibilidadId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 20 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoEnlacePDF]" ;
      }
      else if ( ( AV14OrderedBy == 20 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoEnlacePDF] DESC" ;
      }
      else if ( ( AV14OrderedBy == 21 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoEnlaceXML]" ;
      }
      else if ( ( AV14OrderedBy == 21 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoEnlaceXML] DESC" ;
      }
      else if ( ( AV14OrderedBy == 22 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [PagoEstadoR]" ;
      }
      else if ( ( AV14OrderedBy == 22 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [PagoEstadoR] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [PagoId]" ;
      }
   ...
   protected Object[] conditional_H003F3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A47PagoId ,
                                          ...
                                          int A19CitaId )
   {
      java.lang.StringBuffer sWhereString = new java.lang.StringBuffer();
      String scmdbuf;
      byte[] GXv_int13 = new byte[33];
      Object[] GXv_Object14 = new Object[2];
      scmdbuf = "SELECT COUNT(*) FROM [Pago]" ;
      addWhere(sWhereString, "([CitaId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([PagoId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(6), CAST([PagoMonto] AS decimal(6,2))) like '%' + ?) or ( [PagoToken] like '%' + ?) or ( 'ruc' like '%' + LOWER(?) and [PagoTipoDocumentoCliente] = '6') or ( 'dni' like '%' + LOWER(?) and [PagoTipoDocumentoCliente] = '1') or ( 'carnet de ext.' like '%' + LOWER(?) and [PagoTipoDocumentoCliente] = '4') or ( 'pasaporte' like '%' + LOWER(?) and [PagoTipoDocumentoCliente] = '7') or ( 'cdi' like '%' + LOWER(?) and [PagoTipoDocumentoCliente] = 'A') or ( 'no domiciliado' like '%' + LOWER(?) and [PagoTipoDocumentoCliente] = '0') or ( [PagoClienteNroDocumento] like '%' + ?) or ( [PagoClienteDenominacion] like '%' + ?) or ( [PagoClienteDireccion] like '%' + ?) or ( [PagoClienteEmail] like '%' + ?) or ( 'factura' like '%' + LOWER(?) and [PagoTipoDocumento] = 1) or ( 'boleta' like '%' + LOWER(?) and [PagoTipoDocumento] = 2) or ( 'nota credito' like '%' + LOWER(?) and [PagoTipoDocumento] = 3) or ( 'nota debito' like '%' + LOWER(?) and [PagoTipoDocumento] = 4) or ( CONVERT( char(8), CAST([PagoNumero] AS decimal(8,0))) like '%' + ?) or ( 'soles' like '%' + LOWER(?) and [PagoMoneda] = 1) or ( 'dólares' like '%' + LOWER(?) and [PagoMoneda] = 2) or ( 'euros' like '%' + LOWER(?) and [PagoMoneda] = 3) or ( [PagoNubefactRequest] like '%' + ?) or ( [PagoNubefactResponse] like '%' + ?) or ( [PagoRequest] like '%' + ?) or ( [PagoResponse] like '%' + ?) or ( [PagoPasarelaId] like '%' + ?) or ( CONVERT( char(8), CAST([PagoStatusCode] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(8), CAST([DisponibilidadId] AS decimal(8,0))) like '%' + ?) or ( [PagoEnlacePDF] like '%' + ?) or ( [PagoEnlaceXML] like '%' + ?) or ( 'activo' like '%' + LOWER(?) and [PagoEstadoR] = 'A') or ( 'inactivo' like '%' + LOWER(?) and [PagoEstadoR] = 'I'))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H003F2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , (java.math.BigDecimal)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (String)dynConstraints[8] , ((Number) dynConstraints[9]).shortValue() , ((Number) dynConstraints[10]).intValue() , ((Number) dynConstraints[11]).shortValue() , (String)dynConstraints[12] , (String)dynConstraints[13] , (String)dynConstraints[14] , (String)dynConstraints[15] , (String)dynConstraints[16] , ((Number) dynConstraints[17]).intValue() , ((Number) dynConstraints[18]).intValue() , (String)dynConstraints[19] , (String)dynConstraints[20] , (String)dynConstraints[21] , ((Number) dynConstraints[22]).shortValue() , ((Boolean) dynConstraints[23]).booleanValue() , ((Number) dynConstraints[24]).intValue() , ((Number) dynConstraints[25]).intValue() );
            case 1 :
                  return conditional_H003F3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , (java.math.BigDecimal)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (String)dynConstraints[8] , ((Number) dynConstraints[9]).shortValue() , ((Number) dynConstraints[10]).intValue() , ((Number) dynConstraints[11]).shortValue() , (String)dynConstraints[12] , (String)dynConstraints[13] , (String)dynConstraints[14] , (String)dynConstraints[15] , (String)dynConstraints[16] , ((Number) dynConstraints[17]).intValue() , ((Number) dynConstraints[18]).intValue() , (String)dynConstraints[19] , (String)dynConstraints[20] , (String)dynConstraints[21] , ((Number) dynConstraints[22]).shortValue() , ((Boolean) dynConstraints[23]).booleanValue() , ((Number) dynConstraints[24]).intValue() , ((Number) dynConstraints[25]).intValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H003F2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H003F3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
