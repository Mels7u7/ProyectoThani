...
public final  class laboratoriolaboratoriousuariosprompt_impl extends GXDataArea
{
   public laboratoriolaboratoriousuariosprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public laboratoriolaboratoriousuariosprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( laboratoriolaboratoriousuariosprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InLaboratorioId") ;
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            AV8InLaboratorioId = (short)(GXutil.lval( httpContext.GetPar( "InLaboratorioId"))) ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            {
               GxWebError = (byte)(1) ;
            ...
            gxgrgrid_refresh( subGrid_Rows, AV13FilterFullText, AV8InLaboratorioId) ;
         ...
         {
            AV8InLaboratorioId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InLaboratorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InLaboratorioId), 4, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutSecUserId = (short)(GXutil.lval( httpContext.GetPar( "InOutSecUserId"))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutSecUserId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutSecUserId), 4, 0));
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110335674", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.laboratoriolaboratoriousuariosprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InLaboratorioId,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutSecUserId,4,0))}, new String[] {"InLaboratorioId","InOutSecUserId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINLABORATORIOID", GXutil.ltrim( localUtil.ntoc( AV8InLaboratorioId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTSECUSERID", GXutil.ltrim( localUtil.ntoc( AV9InOutSecUserId, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return formatLink("com.projectthani.laboratoriolaboratoriousuariosprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InLaboratorioId,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutSecUserId,4,0))}, new String[] {"InLaboratorioId","InOutSecUserId"})  ;
   }

   public String getPgmname( )
   {
      return "LaboratorioLaboratorioUsuariosPrompt" ;
   }
   ...
   public void wb5Z0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_5Z2( true) ;
      }
      else
      {
         wb_table1_12_5Z2( false) ;
      }
      return  ;
   }

   public void wb_table1_12_5Z2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start5Z2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Laboratorio Usuarios", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf5Z2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Short.valueOf(AV8InLaboratorioId) ,
         ...
         lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
         /* Using cursor H005Z2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8InLaboratorioId), lV13FilterFullText, lV13FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_24_idx = 1 ;
         sGXsfl_24_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_24_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_242( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A40LaboratorioId = H005Z2_A40LaboratorioId[0] ;
            A165LaboratorioNombre = H005Z2_A165LaboratorioNombre[0] ;
            A14SecUserName = H005Z2_A14SecUserName[0] ;
            A6SecUserId = H005Z2_A6SecUserId[0] ;
            A165LaboratorioNombre = H005Z2_A165LaboratorioNombre[0] ;
            A14SecUserName = H005Z2_A14SecUserName[0] ;
            e175Z2 ();
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
      /* Using cursor H005Z3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8InLaboratorioId), lV13FilterFullText, lV13FilterFullText});
   ...
   public void e155Z2( )
   {
      ...
      Form.setCaption( "Selecciona Laboratorio Usuarios" );
   ...
   public void e185Z2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV9InOutSecUserId = A6SecUserId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutSecUserId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutSecUserId), 4, 0));
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV9InOutSecUserId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV9InOutSecUserId"});
   ...
   public void wb_table1_12_5Z2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_LaboratorioLaboratorioUsuariosPrompt.htm");
   ...
   {
      AV8InLaboratorioId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InLaboratorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InLaboratorioId), 4, 0));
      AV9InOutSecUserId = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutSecUserId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV9InOutSecUserId), 4, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110335739", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("laboratoriolaboratoriousuariosprompt.js", "?20225110335740", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:SecUserId|2:SecUserName" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InLaboratorioId',fld:'vINLABORATORIOID',pic:'ZZZ9'}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e115Z2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InLaboratorioId',fld:'vINLABORATORIOID',pic:'ZZZ9'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e125Z2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InLaboratorioId',fld:'vINLABORATORIOID',pic:'ZZZ9'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e135Z2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InLaboratorioId',fld:'vINLABORATORIOID',pic:'ZZZ9'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("ENTER","{handler:'e185Z2',iparms:[{av:'A6SecUserId',fld:'SECUSERID',pic:'ZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV9InOutSecUserId',fld:'vINOUTSECUSERID',pic:'ZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e145Z2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InLaboratorioId',fld:'vINLABORATORIOID',pic:'ZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H005Z2_A40LaboratorioId = new short[1] ;
      H005Z2_A165LaboratorioNombre = new String[] {""} ;
      H005Z2_A14SecUserName = new String[] {""} ;
      H005Z2_A6SecUserId = new short[1] ;
      ...
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.laboratoriolaboratoriousuariosprompt__default(),
         new Object[] {
             new Object[] {
            H005Z2_A40LaboratorioId, H005Z2_A165LaboratorioNombre, H005Z2_A14SecUserName, H005Z2_A6SecUserId
            }
            , new Object[] {
   ...
   private short wcpOAV8InLaboratorioId ;
   private short wcpOAV9InOutSecUserId ;
   private short AV8InLaboratorioId ;
   private short AV9InOutSecUserId ;
   ...
   private short[] H005Z2_A40LaboratorioId ;
   private String[] H005Z2_A165LaboratorioNombre ;
   private String[] H005Z2_A14SecUserName ;
   private short[] H005Z2_A6SecUserId ;
...
final  class laboratoriolaboratoriousuariosprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H005Z2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          short A40LaboratorioId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[LaboratorioId], T2.[LaboratorioNombre], T3.[SecUserName], T1.[SecUserId]" ;
      sFromString = " FROM (([LaboratorioLaboratorioUsuarios] T1 INNER JOIN [Laboratorio] T2 ON T2.[LaboratorioId] = T1.[LaboratorioId]) INNER JOIN [SecUser] T3 ON T3.[SecUserId] = T1.[SecUserId])" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.[LaboratorioId] = ?)");
      if ( ! (GXutil.strcmp("", AV13FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST(T1.[SecUserId] AS decimal(4,0))) like '%' + ?) or ( T3.[SecUserName] like '%' + ?))");
      }
      else
      {
         GXv_int4[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY T3.[SecUserName]" ;
      }
      else if ( ( AV11OrderedBy == 3 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY T3.[SecUserName] DESC" ;
      }
      else if ( true )
      {
   ...
   protected Object[] conditional_H005Z3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          short A6SecUserId ,
                                          ...
                                          short A40LaboratorioId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM (([LaboratorioLaboratorioUsuarios] T1 INNER JOIN [Laboratorio] T2 ON T2.[LaboratorioId] = T1.[LaboratorioId]) INNER JOIN [SecUser] T3 ON T3.[SecUserId]" ;
      scmdbuf += " = T1.[SecUserId])" ;
      addWhere(sWhereString, "(T1.[LaboratorioId] = ?)");
      if ( ! (GXutil.strcmp("", AV13FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST(T1.[SecUserId] AS decimal(4,0))) like '%' + ?) or ( T3.[SecUserName] like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005Z2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).shortValue() );
            case 1 :
                  return conditional_H005Z3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H005Z2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H005Z3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
