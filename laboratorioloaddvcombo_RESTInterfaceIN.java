...
@javax.xml.bind.annotation.XmlType(name = "laboratorioloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class laboratorioloaddvcombo_RESTInterfaceIN
{
   ...
   public short getLaboratorioId( )
   {
      return AV24LaboratorioId ;
   }

   @JsonProperty("LaboratorioId")
   public void setLaboratorioId(  short Value )
   {
      AV24LaboratorioId= Value;
   }
