...
public final  class citaencuestawc_impl extends GXWebComponent
{
   public citaencuestawc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public citaencuestawc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( citaencuestawc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Cita Encuesta WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110324812", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.citaencuestawc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8CitaId,8,0))}, new String[] {"CitaId"}) +"\">") ;
   ...
   public void renderHtmlCloseForm3E2( )
   {
   ...
   {
      return "CitaEncuestaWC" ;
   }

   public String getPgmdesc( )
   {
      return "Cita Encuesta WC" ;
   }
   ...
   public void wb3E0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.citaencuestawc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void start3E2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Cita Encuesta WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_ENCUESTAID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A37EncuestaId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"ENCUESTAID", GXutil.ltrim( localUtil.ntoc( A37EncuestaId, (byte)(4), (byte)(0), ".", "")));
   }
   ...
   public void rf3E2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.BYTE, TypeConstants.STRING,
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H003E2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV8CitaId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A19CitaId = H003E2_A19CitaId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A19CitaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A19CitaId), 8, 0));
            A153EncuestaEstado = H003E2_A153EncuestaEstado[0] ;
            n153EncuestaEstado = H003E2_n153EncuestaEstado[0] ;
            A152EncuestaRecomendacion = H003E2_A152EncuestaRecomendacion[0] ;
            A151EncuestaComentarios = H003E2_A151EncuestaComentarios[0] ;
            n151EncuestaComentarios = H003E2_n151EncuestaComentarios[0] ;
            A150EncuestaHoraAtencion = H003E2_A150EncuestaHoraAtencion[0] ;
            n150EncuestaHoraAtencion = H003E2_n150EncuestaHoraAtencion[0] ;
            A149EncuestaAtendido = H003E2_A149EncuestaAtendido[0] ;
            n149EncuestaAtendido = H003E2_n149EncuestaAtendido[0] ;
            A148EncuestaAtencion = H003E2_A148EncuestaAtencion[0] ;
            n148EncuestaAtencion = H003E2_n148EncuestaAtencion[0] ;
            A37EncuestaId = H003E2_A37EncuestaId[0] ;
            e183E2 ();
   ...
   public void send_integrity_lvl_hashes3E2( )
   {
      ...
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_DELETE", AV28IsAuthorized_Delete);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( sPrefix, AV28IsAuthorized_Delete));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_ENCUESTAID"+"_"+sGXsfl_37_idx, getSecureSignedToken( sPrefix+sGXsfl_37_idx, localUtil.format( DecimalUtil.doubleToDec(A37EncuestaId), "ZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H003E3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV8CitaId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void e113E2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("CitaEncuestaWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV34Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("CitaEncuestaWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "CitaEncuestaWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         citaencuestawc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWEncuesta_Update", GXv_boolean7) ;
      citaencuestawc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWEncuesta_Delete", GXv_boolean7) ;
      citaencuestawc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWEncuesta_Insert", GXv_boolean7) ;
      citaencuestawc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "CitaEncuestaWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Encuesta" );
   ...
   public void wb_table1_22_3E2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_3E2( true) ;
      }
      else
      {
         wb_table2_27_3E2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_3E2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table2_27_3E2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "citaencuestawc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511032504", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("citaencuestawc.js", "?2022511032505", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtEncuestaId_Internalname = sPrefix+"ENCUESTAID_"+sGXsfl_37_idx ;
      cmbEncuestaAtencion.setInternalname( sPrefix+"ENCUESTAATENCION_"+sGXsfl_37_idx );
      cmbEncuestaAtendido.setInternalname( sPrefix+"ENCUESTAATENDIDO_"+sGXsfl_37_idx );
      edtEncuestaHoraAtencion_Internalname = sPrefix+"ENCUESTAHORAATENCION_"+sGXsfl_37_idx ;
      edtEncuestaComentarios_Internalname = sPrefix+"ENCUESTACOMENTARIOS_"+sGXsfl_37_idx ;
      edtEncuestaRecomendacion_Internalname = sPrefix+"ENCUESTARECOMENDACION_"+sGXsfl_37_idx ;
      cmbEncuestaEstado.setInternalname( sPrefix+"ENCUESTAESTADO_"+sGXsfl_37_idx );
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtEncuestaId_Internalname = sPrefix+"ENCUESTAID_"+sGXsfl_37_fel_idx ;
      cmbEncuestaAtencion.setInternalname( sPrefix+"ENCUESTAATENCION_"+sGXsfl_37_fel_idx );
      cmbEncuestaAtendido.setInternalname( sPrefix+"ENCUESTAATENDIDO_"+sGXsfl_37_fel_idx );
      edtEncuestaHoraAtencion_Internalname = sPrefix+"ENCUESTAHORAATENCION_"+sGXsfl_37_fel_idx ;
      edtEncuestaComentarios_Internalname = sPrefix+"ENCUESTACOMENTARIOS_"+sGXsfl_37_fel_idx ;
      edtEncuestaRecomendacion_Internalname = sPrefix+"ENCUESTARECOMENDACION_"+sGXsfl_37_fel_idx ;
      cmbEncuestaEstado.setInternalname( sPrefix+"ENCUESTAESTADO_"+sGXsfl_37_fel_idx );
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtEncuestaId_Internalname,GXutil.ltrim( localUtil.ntoc( A37EncuestaId, (byte)(4), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A37EncuestaId), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtEncuestaId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id4","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         {
            GXCCtl = "ENCUESTAATENCION_" + sGXsfl_37_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbEncuestaAtencion.getInternalname(), "Values", cmbEncuestaAtencion.ToJavascriptSource(), !bGXsfl_37_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         {
            GXCCtl = "ENCUESTAATENDIDO_" + sGXsfl_37_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbEncuestaAtendido.getInternalname(), "Values", cmbEncuestaAtendido.ToJavascriptSource(), !bGXsfl_37_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         {
            GXCCtl = "ENCUESTAESTADO_" + sGXsfl_37_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbEncuestaEstado.getInternalname(), "Values", cmbEncuestaEstado.ToJavascriptSource(), !bGXsfl_37_Refreshing);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:EncuestaId|3:EncuestaAtencion|4:EncuestaAtendido|5:EncuestaHoraAtencion|6:EncuestaComentarios|7:EncuestaRecomendacion|8:EncuestaEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e183E2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A37EncuestaId',fld:'ENCUESTAID',pic:'ZZZ9',hsh:true},{av:'AV28IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e153E2',iparms:[{av:'A37EncuestaId',fld:'ENCUESTAID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H003E2_A19CitaId = new int[1] ;
      H003E2_A153EncuestaEstado = new String[] {""} ;
      H003E2_n153EncuestaEstado = new boolean[] {false} ;
      H003E2_A152EncuestaRecomendacion = new byte[1] ;
      H003E2_A151EncuestaComentarios = new String[] {""} ;
      H003E2_n151EncuestaComentarios = new boolean[] {false} ;
      H003E2_A150EncuestaHoraAtencion = new java.util.Date[] {GXutil.nullDate()} ;
      H003E2_n150EncuestaHoraAtencion = new boolean[] {false} ;
      H003E2_A149EncuestaAtendido = new String[] {""} ;
      H003E2_n149EncuestaAtendido = new boolean[] {false} ;
      H003E2_A148EncuestaAtencion = new String[] {""} ;
      H003E2_n148EncuestaAtencion = new boolean[] {false} ;
      H003E2_A37EncuestaId = new short[1] ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.citaencuestawc__default(),
         new Object[] {
             new Object[] {
            H003E2_A19CitaId, H003E2_A153EncuestaEstado, H003E2_n153EncuestaEstado, H003E2_A152EncuestaRecomendacion, H003E2_A151EncuestaComentarios, H003E2_n151EncuestaComentarios, H003E2_A150EncuestaHoraAtencion, H003E2_n150EncuestaHoraAtencion, H003E2_A149EncuestaAtendido, H003E2_n149EncuestaAtendido,
            H003E2_A148EncuestaAtencion, H003E2_n148EncuestaAtencion, H003E2_A37EncuestaId
            }
            , new Object[] {
   ...
   private int[] H003E2_A19CitaId ;
   private String[] H003E2_A153EncuestaEstado ;
   private boolean[] H003E2_n153EncuestaEstado ;
   private byte[] H003E2_A152EncuestaRecomendacion ;
   private String[] H003E2_A151EncuestaComentarios ;
   private boolean[] H003E2_n151EncuestaComentarios ;
   private java.util.Date[] H003E2_A150EncuestaHoraAtencion ;
   private boolean[] H003E2_n150EncuestaHoraAtencion ;
   private String[] H003E2_A149EncuestaAtendido ;
   private boolean[] H003E2_n149EncuestaAtendido ;
   private String[] H003E2_A148EncuestaAtencion ;
   private boolean[] H003E2_n148EncuestaAtencion ;
   private short[] H003E2_A37EncuestaId ;
...
final  class citaencuestawc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          int A19CitaId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [CitaId], [EncuestaEstado], [EncuestaRecomendacion], [EncuestaComentarios], [EncuestaHoraAtencion], [EncuestaAtendido], [EncuestaAtencion], [EncuestaId]" ;
      sFromString = " FROM [Encuesta]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([CitaId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([EncuestaId] AS decimal(4,0))) like '%' + ?) or ( 'buena' like '%' + LOWER(?) and [EncuestaAtencion] = 'B') or ( 'regular' like '%' + LOWER(?) and [EncuestaAtencion] = 'R') or ( 'mala' like '%' + LOWER(?) and [EncuestaAtencion] = 'M') or ( 'si' like '%' + LOWER(?) and [EncuestaAtendido] = 'S') or ( 'no' like '%' + LOWER(?) and [EncuestaAtendido] = 'N') or ( [EncuestaComentarios] like '%' + ?) or ( CONVERT( char(2), CAST([EncuestaRecomendacion] AS decimal(2,0))) like '%' + ?) or ( 'pendiente' like '%' + LOWER(?) and [EncuestaEstado] = 'P') or ( 'realizada' like '%' + LOWER(?) and [EncuestaEstado] = 'R'))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [CitaId], [EncuestaAtencion]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [EncuestaAtencion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [EncuestaId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [EncuestaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [EncuestaAtendido]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [EncuestaAtendido] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [EncuestaHoraAtencion]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [EncuestaHoraAtencion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [EncuestaComentarios]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [EncuestaComentarios] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [EncuestaRecomendacion]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [EncuestaRecomendacion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [EncuestaEstado]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [EncuestaEstado] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [EncuestaId]" ;
      }
   ...
   protected Object[] conditional_H003E3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          short A37EncuestaId ,
                                          ...
                                          int A19CitaId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [Encuesta]" ;
      addWhere(sWhereString, "([CitaId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([EncuestaId] AS decimal(4,0))) like '%' + ?) or ( 'buena' like '%' + LOWER(?) and [EncuestaAtencion] = 'B') or ( 'regular' like '%' + LOWER(?) and [EncuestaAtencion] = 'R') or ( 'mala' like '%' + LOWER(?) and [EncuestaAtencion] = 'M') or ( 'si' like '%' + LOWER(?) and [EncuestaAtendido] = 'S') or ( 'no' like '%' + LOWER(?) and [EncuestaAtendido] = 'N') or ( [EncuestaComentarios] like '%' + ?) or ( CONVERT( char(2), CAST([EncuestaRecomendacion] AS decimal(2,0))) like '%' + ?) or ( 'pendiente' like '%' + LOWER(?) and [EncuestaEstado] = 'P') or ( 'realizada' like '%' + LOWER(?) and [EncuestaEstado] = 'R'))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H003E2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).byteValue() , (String)dynConstraints[6] , ((Number) dynConstraints[7]).shortValue() , ((Boolean) dynConstraints[8]).booleanValue() , ((Number) dynConstraints[9]).intValue() , ((Number) dynConstraints[10]).intValue() );
            case 1 :
                  return conditional_H003E3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).byteValue() , (String)dynConstraints[6] , ((Number) dynConstraints[7]).shortValue() , ((Boolean) dynConstraints[8]).booleanValue() , ((Number) dynConstraints[9]).intValue() , ((Number) dynConstraints[10]).intValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H003E2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H003E3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
