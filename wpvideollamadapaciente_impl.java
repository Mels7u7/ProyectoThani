...
public final  class wpvideollamadapaciente_impl extends GXDataArea
{
   public wpvideollamadapaciente_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wpvideollamadapaciente_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wpvideollamadapaciente_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511033491", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vFECHACITA", getSecureSignedToken( "", AV19FechaCita));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vFECHACITA", localUtil.dtoc( AV19FechaCita, 0, "/"));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vFECHACITA", getSecureSignedToken( "", AV19FechaCita));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vTODAY", localUtil.dtoc( Gx_date, 0, "/"));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTODAY", getSecureSignedToken( "", Gx_date));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, "vISOPENVIDEOCALL", AV8isOpenVideoCall);
   ...
   {
      return formatLink("com.projectthani.wpvideollamadapaciente", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV6CitaId,8,0))}, new String[] {"CitaId"})  ;
   }

   public String getPgmname( )
   {
      return "WPVideoLlamadaPaciente" ;
   }
   ...
   public void wb330( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.projectthani.GxWebStd.gx_bitmap( httpContext, imgLogologin_Internalname, sImgUrl, "", "", "", context.getHttpContext().getTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.getHttpContext().getImageSrcSet( sImgUrl), "HLP_WPVideoLlamadaPaciente.htm");
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblTextblockicon_Internalname, lblTextblockicon_Caption, "", "", lblTextblockicon_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(1), "HLP_WPVideoLlamadaPaciente.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "Center", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblTbxvideollamada_Internalname, "¿Ingresar a la videollamada?", "", "", lblTbxvideollamada_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "DataDescriptionVideollamada", 0, "", 1, 1, 0, (short)(1), "HLP_WPVideoLlamadaPaciente.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "Center", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.projectthani.GxWebStd.gx_button_ctrl( httpContext, bttBtnvideollamada_Internalname, "", "Iniciar videollamada", bttBtnvideollamada_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'BTNVIDEOLLAMADA\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WPVideoLlamadaPaciente.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "Center", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.projectthani.GxWebStd.gx_button_ctrl( httpContext, bttBtnregresarcitas_Internalname, "", "Ir a mis citas médicas", bttBtnregresarcitas_Jsonclick, 7, "Confirmar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11331_client"+"'", TempTags, "", 2, "HLP_WPVideoLlamadaPaciente.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "Center", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "Center", "top", "div");
   ...
   public void start332( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Videollamada Paciente", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void e12332( )
   {
      ...
      {
         A89CitaEstadoCita = H00332_A89CitaEstadoCita[0] ;
         n89CitaEstadoCita = H00332_n89CitaEstadoCita[0] ;
         A95CitaEstado = H00332_A95CitaEstado[0] ;
         n95CitaEstado = H00332_n95CitaEstado[0] ;
         A19CitaId = H00332_A19CitaId[0] ;
         A20PacienteId = H00332_A20PacienteId[0] ;
         A64CitaCode = H00332_A64CitaCode[0] ;
         A21SGCitaDisponibilidadId = H00332_A21SGCitaDisponibilidadId[0] ;
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV19FechaCita", localUtil.format(AV19FechaCita, "99/99/99"));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vFECHACITA", getSecureSignedToken( "", AV19FechaCita));
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV8isOpenVideoCall", AV8isOpenVideoCall);
   ...
   public void e13332( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.dateCompare(GXutil.resetTime(AV19FechaCita), GXutil.resetTime(Gx_date)) && ! AV8isOpenVideoCall )
      {
      ...
      {
         if ( AV8isOpenVideoCall )
         {
            httpContext.GX_msglist.addItem("Ya tiene abierto la video llamada. O recargue la página.");
         }
         else
         {
            httpContext.GX_msglist.addItem("La fecha de la Cita no corresponde a la de hoy.");
         }
      }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110334988", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wpvideollamadapaciente.js", "?20225110334989", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Videollamada Paciente" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV19FechaCita',fld:'vFECHACITA',pic:'',hsh:true},{av:'Gx_date',fld:'vTODAY',pic:'',hsh:true},{av:'AV20NombresApellidosPac',fld:'vNOMBRESAPELLIDOSPAC',pic:'',hsh:true},{av:'AV6CitaId',fld:'vCITAID',pic:'ZZZZZZZ9',hsh:true}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("'BTNVIDEOLLAMADA'","{handler:'e13332',iparms:[{av:'AV19FechaCita',fld:'vFECHACITA',pic:'',hsh:true},{av:'Gx_date',fld:'vTODAY',pic:'',hsh:true},{av:'AV8isOpenVideoCall',fld:'vISOPENVIDEOCALL',pic:''},{av:'AV20NombresApellidosPac',fld:'vNOMBRESAPELLIDOSPAC',pic:'',hsh:true},{av:'AV9MeetConfig',fld:'vMEETCONFIG',pic:''}]");
      setEventMetadata("'BTNVIDEOLLAMADA'",",oparms:[{av:'AV8isOpenVideoCall',fld:'vISOPENVIDEOCALL',pic:''},{av:'AV9MeetConfig',fld:'vMEETCONFIG',pic:''},{av:'new com.hugao.hugaojitsiclient.web.SdtProperties(remoteHandle, context).getgxTv_SdtProperties_Containername()',ctrl:'GX.HUGAO.JITSICLIENT',prop:'Containername'},{av:'new com.hugao.hugaojitsiclient.web.SdtProperties(remoteHandle, context).getgxTv_SdtProperties_Useallwindow()',ctrl:'GX.HUGAO.JITSICLIENT',prop:'Useallwindow'},{av:'new com.hugao.hugaojitsiclient.web.SdtProperties(remoteHandle, context).getgxTv_SdtProperties_Disposeonunload()',ctrl:'GX.HUGAO.JITSICLIENT',prop:'Disposeonunload'},{av:'new com.hugao.hugaojitsiclient.web.SdtProperties(remoteHandle, context).getgxTv_SdtProperties_Piplocation()',ctrl:'GX.HUGAO.JITSICLIENT',prop:'Piplocation'}]}");
      setEventMetadata("'IRCITASMEDICAS'","{handler:'e11331',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      sEvtType = "" ;
      scmdbuf = "" ;
      H00332_A89CitaEstadoCita = new String[] {""} ;
      H00332_n89CitaEstadoCita = new boolean[] {false} ;
      H00332_A95CitaEstado = new String[] {""} ;
      H00332_n95CitaEstado = new boolean[] {false} ;
      H00332_A19CitaId = new int[1] ;
      H00332_A20PacienteId = new int[1] ;
      H00332_A64CitaCode = new String[] {""} ;
      H00332_A21SGCitaDisponibilidadId = new int[1] ;
      A89CitaEstadoCita = "" ;
      A95CitaEstado = "" ;
      A64CitaCode = "" ;
      AV15CodigoCita = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.wpvideollamadapaciente__default(),
         new Object[] {
             new Object[] {
            H00332_A89CitaEstadoCita, H00332_n89CitaEstadoCita, H00332_A95CitaEstado, H00332_n95CitaEstado, H00332_A19CitaId, H00332_A20PacienteId, H00332_A64CitaCode, H00332_A21SGCitaDisponibilidadId
            }
         }
      );
      Gx_date = GXutil.today( ) ;
   ...
   private String[] H00332_A89CitaEstadoCita ;
   private boolean[] H00332_n89CitaEstadoCita ;
   private String[] H00332_A95CitaEstado ;
   private boolean[] H00332_n95CitaEstado ;
   private int[] H00332_A19CitaId ;
   private int[] H00332_A20PacienteId ;
   private String[] H00332_A64CitaCode ;
   private int[] H00332_A21SGCitaDisponibilidadId ;
...
final  class wpvideollamadapaciente__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00332", "SELECT TOP 1 [CitaEstadoCita], [CitaEstado], [CitaId], [PacienteId], [CitaCode], [SGCitaDisponibilidadId] FROM [Cita] WHERE ([CitaId] = ?) AND ([CitaEstado] = 'A') AND ([CitaEstadoCita] = 'R') ORDER BY [CitaId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
