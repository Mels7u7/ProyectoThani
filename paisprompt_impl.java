...
public final  class paisprompt_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV8InOutPaisId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutPaisId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutPaisId), 4, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutPaisDescripcion = httpContext.GetPar( "InOutPaisDescripcion") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutPaisDescripcion", AV9InOutPaisDescripcion);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110335841", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.paisprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutPaisId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutPaisDescripcion))}, new String[] {"InOutPaisId","InOutPaisDescripcion"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTPAISID", GXutil.ltrim( localUtil.ntoc( AV8InOutPaisId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTPAISDESCRIPCION", AV9InOutPaisDescripcion);
   ...
   {
      return formatLink("com.projectthani.paisprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutPaisId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutPaisDescripcion))}, new String[] {"InOutPaisId","InOutPaisDescripcion"})  ;
   }
   ...
   public void wb620( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_622( true) ;
      }
      else
      {
         wb_table1_12_622( false) ;
      }
      return  ;
   }

   public void wb_table1_12_622e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start622( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Pais", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_PAISDESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A184PaisDescripcion, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "PAISDESCRIPCION", A184PaisDescripcion);
   }
   ...
   public void rf622( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A259PaisEstado = H00622_A259PaisEstado[0] ;
            A184PaisDescripcion = H00622_A184PaisDescripcion[0] ;
            A43PaisId = H00622_A43PaisId[0] ;
            e17622 ();
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_PAISID"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, localUtil.format( DecimalUtil.doubleToDec(A43PaisId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_PAISDESCRIPCION"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, GXutil.rtrim( localUtil.format( A184PaisDescripcion, ""))));
   }
   ...
   public void e15622( )
   {
      ...
      Form.setCaption( "Selecciona Pais" );
   ...
   public void e18622( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutPaisId = A43PaisId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutPaisId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutPaisId), 4, 0));
      AV9InOutPaisDescripcion = A184PaisDescripcion ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutPaisDescripcion", AV9InOutPaisDescripcion);
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV8InOutPaisId),AV9InOutPaisDescripcion});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutPaisId","AV9InOutPaisDescripcion"});
   ...
   public void wb_table1_12_622( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_PaisPrompt.htm");
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_12_622e( true) ;
      }
      else
      {
         wb_table1_12_622e( false) ;
      }
   }
   ...
   {
      AV8InOutPaisId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutPaisId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutPaisId), 4, 0));
      AV9InOutPaisDescripcion = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutPaisDescripcion", AV9InOutPaisDescripcion);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110335913", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("paisprompt.js", "?20225110335913", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_242( )
   {
      ...
      cmbPaisEstado.setInternalname( "PAISESTADO_"+sGXsfl_24_idx );
   }
   ...
   public void subsflControlProps_fel_242( )
   {
      ...
      cmbPaisEstado.setInternalname( "PAISESTADO_"+sGXsfl_24_fel_idx );
   }
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         {
            GXCCtl = "PAISESTADO_" + sGXsfl_24_idx ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbPaisEstado.getInternalname(), "Values", cmbPaisEstado.ToJavascriptSource(), !bGXsfl_24_Refreshing);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:PaisId|2:PaisDescripcion|3:PaisEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11622',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12622',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e13622',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e17622',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e18622',iparms:[{av:'A43PaisId',fld:'PAISID',pic:'ZZZ9',hsh:true},{av:'A184PaisDescripcion',fld:'PAISDESCRIPCION',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutPaisId',fld:'vINOUTPAISID',pic:'ZZZ9'},{av:'AV9InOutPaisDescripcion',fld:'vINOUTPAISDESCRIPCION',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e14622',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H00622_A259PaisEstado = new String[] {""} ;
      H00622_A184PaisDescripcion = new String[] {""} ;
      H00622_A43PaisId = new short[1] ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.paisprompt__default(),
         new Object[] {
             new Object[] {
            H00622_A259PaisEstado, H00622_A184PaisDescripcion, H00622_A43PaisId
            }
            , new Object[] {
   ...
   private short wcpOAV8InOutPaisId ;
   private short AV8InOutPaisId ;
   ...
   private String wcpOAV9InOutPaisDescripcion ;
   private String AV13FilterFullText ;
   private String AV9InOutPaisDescripcion ;
   ...
   private String[] H00622_A259PaisEstado ;
   private String[] H00622_A184PaisDescripcion ;
   private short[] H00622_A43PaisId ;
...
{
   protected Object[] conditional_H00622( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H00623( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          short A43PaisId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00622(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
            case 1 :
                  return conditional_H00623(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00622", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00623", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
