...
public final  class serviciocategserviciowc_impl extends GXWebComponent
{
   public serviciocategserviciowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public serviciocategserviciowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( serviciocategserviciowc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8ServicioCategId = (short)(GXutil.lval( httpContext.GetPar( "ServicioCategId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ServicioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ServicioCategId), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(AV8ServicioCategId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8ServicioCategId, AV20ManageFiltersExecutionStep, AV34Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Servicio Categ Servicio WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511033559", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.serviciocategserviciowc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8ServicioCategId,4,0))}, new String[] {"ServicioCategId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8ServicioCategId", GXutil.ltrim( localUtil.ntoc( wcpOAV8ServicioCategId, (byte)(4), (byte)(0), ",", "")));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSERVICIOCATEGID", GXutil.ltrim( localUtil.ntoc( AV8ServicioCategId, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return "ServicioCategServicioWC" ;
   }

   public String getPgmdesc( )
   {
      return "Servicio Categ Servicio WC" ;
   }
   ...
   public void wb4F0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.serviciocategserviciowc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_4F2( true) ;
      }
      else
      {
         wb_table1_22_4F2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_4F2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtServicioCategId_Internalname, GXutil.ltrim( localUtil.ntoc( A52ServicioCategId, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A52ServicioCategId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtServicioCategId_Jsonclick, 0, "Attribute", "", "", "", "", edtServicioCategId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id4", "right", false, "", "HLP_ServicioCategServicioWC.htm");
         /* User Defined Control */
   ...
   public void start4F2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Servicio Categ Servicio WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_SERVICIOID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A27ServicioId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"SERVICIOID", GXutil.ltrim( localUtil.ntoc( A27ServicioId, (byte)(4), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV34Pgmname = "ServicioCategServicioWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf4F2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Short.valueOf(AV8ServicioCategId) ,
                                              Short.valueOf(A52ServicioCategId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.DECIMAL, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN,
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H004F2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8ServicioCategId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A52ServicioCategId = H004F2_A52ServicioCategId[0] ;
            ...
            A286ServicioEstado = H004F2_A286ServicioEstado[0] ;
            A285ServicioObservacion = H004F2_A285ServicioObservacion[0] ;
            A284ServicioComision = H004F2_A284ServicioComision[0] ;
            A283ServicioCosto = H004F2_A283ServicioCosto[0] ;
            A282ServicioDescripcion = H004F2_A282ServicioDescripcion[0] ;
            A281ServicioNombre = H004F2_A281ServicioNombre[0] ;
            A27ServicioId = H004F2_A27ServicioId[0] ;
            e184F2 ();
   ...
   public void send_integrity_lvl_hashes4F2( )
   {
      ...
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_DELETE", AV29IsAuthorized_Delete);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( sPrefix, AV29IsAuthorized_Delete));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_SERVICIOID"+"_"+sGXsfl_37_idx, getSecureSignedToken( sPrefix+sGXsfl_37_idx, localUtil.format( DecimalUtil.doubleToDec(A27ServicioId), "ZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H004F3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8ServicioCategId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void strup4F0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8ServicioCategId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8ServicioCategId"), ",", ".")) ;
   ...
   public void e164F2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtServicioCategId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtServicioCategId_Visible), 5, 0), true);
   ...
   public void e114F2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("ServicioCategServicioWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV34Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("ServicioCategServicioWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "ServicioCategServicioWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         serviciocategserviciowc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      serviciocategserviciowc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "ServicioCategServicioWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Servicio" );
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "ServicioCategId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8ServicioCategId, 4, 0) );
   ...
   public void wb_table1_22_4F2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_4F2( true) ;
      }
      else
      {
         wb_table2_27_4F2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_4F2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_4F2e( true) ;
      }
      else
      {
         wb_table1_22_4F2e( false) ;
      }
   }

   public void wb_table2_27_4F2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8ServicioCategId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ServicioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ServicioCategId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8ServicioCategId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "serviciocategserviciowc", GetJustCreated( ));
      ...
      {
         AV8ServicioCategId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ServicioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ServicioCategId), 4, 0));
      }
      wcpOAV8ServicioCategId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8ServicioCategId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV8ServicioCategId != wcpOAV8ServicioCategId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8ServicioCategId = AV8ServicioCategId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8ServicioCategId = httpContext.cgiGet( sPrefix+"AV8ServicioCategId_CTRL") ;
      if ( GXutil.len( sCtrlAV8ServicioCategId) > 0 )
      {
         AV8ServicioCategId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV8ServicioCategId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ServicioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ServicioCategId), 4, 0));
      }
      else
      {
         AV8ServicioCategId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8ServicioCategId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8ServicioCategId_PARM", GXutil.ltrim( localUtil.ntoc( AV8ServicioCategId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8ServicioCategId)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8ServicioCategId_CTRL", GXutil.rtrim( sCtrlAV8ServicioCategId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511033760", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("serviciocategserviciowc.js", "?2022511033760", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtServicioId_Internalname = sPrefix+"SERVICIOID_"+sGXsfl_37_idx ;
      edtServicioNombre_Internalname = sPrefix+"SERVICIONOMBRE_"+sGXsfl_37_idx ;
      edtServicioDescripcion_Internalname = sPrefix+"SERVICIODESCRIPCION_"+sGXsfl_37_idx ;
      edtServicioCosto_Internalname = sPrefix+"SERVICIOCOSTO_"+sGXsfl_37_idx ;
      edtServicioComision_Internalname = sPrefix+"SERVICIOCOMISION_"+sGXsfl_37_idx ;
      edtServicioObservacion_Internalname = sPrefix+"SERVICIOOBSERVACION_"+sGXsfl_37_idx ;
      cmbServicioEstado.setInternalname( sPrefix+"SERVICIOESTADO_"+sGXsfl_37_idx );
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtServicioId_Internalname = sPrefix+"SERVICIOID_"+sGXsfl_37_fel_idx ;
      edtServicioNombre_Internalname = sPrefix+"SERVICIONOMBRE_"+sGXsfl_37_fel_idx ;
      edtServicioDescripcion_Internalname = sPrefix+"SERVICIODESCRIPCION_"+sGXsfl_37_fel_idx ;
      edtServicioCosto_Internalname = sPrefix+"SERVICIOCOSTO_"+sGXsfl_37_fel_idx ;
      edtServicioComision_Internalname = sPrefix+"SERVICIOCOMISION_"+sGXsfl_37_fel_idx ;
      edtServicioObservacion_Internalname = sPrefix+"SERVICIOOBSERVACION_"+sGXsfl_37_fel_idx ;
      cmbServicioEstado.setInternalname( sPrefix+"SERVICIOESTADO_"+sGXsfl_37_fel_idx );
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtServicioNombre_Internalname,A281ServicioNombre,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtServicioNombre_Link,"","","",edtServicioNombre_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtServicioDescripcion_Internalname,A282ServicioDescripcion,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtServicioDescripcion_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtServicioComision_Internalname,GXutil.ltrim( localUtil.ntoc( A284ServicioComision, (byte)(4), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A284ServicioComision), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtServicioComision_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtServicioObservacion_Internalname,A285ServicioObservacion,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtServicioObservacion_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         {
            GXCCtl = "SERVICIOESTADO_" + sGXsfl_37_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbServicioEstado.getInternalname(), "Values", cmbServicioEstado.ToJavascriptSource(), !bGXsfl_37_Refreshing);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:ServicioId|3:ServicioNombre|4:ServicioDescripcion|5:ServicioCosto|6:ServicioComision|7:ServicioObservacion|8:ServicioEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e184F2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A27ServicioId',fld:'SERVICIOID',pic:'ZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV26Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV28Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtServicioNombre_Link',ctrl:'SERVICIONOMBRE',prop:'Link'}]}");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e154F2',iparms:[{av:'A27ServicioId',fld:'SERVICIOID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H004F2_A52ServicioCategId = new short[1] ;
      H004F2_A286ServicioEstado = new String[] {""} ;
      H004F2_A285ServicioObservacion = new String[] {""} ;
      H004F2_A284ServicioComision = new short[1] ;
      H004F2_A283ServicioCosto = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H004F2_A282ServicioDescripcion = new String[] {""} ;
      H004F2_A281ServicioNombre = new String[] {""} ;
      H004F2_A27ServicioId = new short[1] ;
      ...
      sCtrlAV8ServicioCategId = "" ;
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.serviciocategserviciowc__default(),
         new Object[] {
             new Object[] {
            H004F2_A52ServicioCategId, H004F2_A286ServicioEstado, H004F2_A285ServicioObservacion, H004F2_A284ServicioComision, H004F2_A283ServicioCosto, H004F2_A282ServicioDescripcion, H004F2_A281ServicioNombre, H004F2_A27ServicioId
            }
            , new Object[] {
   ...
   private short wcpOAV8ServicioCategId ;
   private short AV8ServicioCategId ;
   ...
   private String sCtrlAV8ServicioCategId ;
   ...
   private short[] H004F2_A52ServicioCategId ;
   private String[] H004F2_A286ServicioEstado ;
   private String[] H004F2_A285ServicioObservacion ;
   private short[] H004F2_A284ServicioComision ;
   private java.math.BigDecimal[] H004F2_A283ServicioCosto ;
   private String[] H004F2_A282ServicioDescripcion ;
   private String[] H004F2_A281ServicioNombre ;
   private short[] H004F2_A27ServicioId ;
...
final  class serviciocategserviciowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H004F2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          short A52ServicioCategId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [ServicioCategId], [ServicioEstado], [ServicioObservacion], [ServicioComision], [ServicioCosto], [ServicioDescripcion], [ServicioNombre], [ServicioId]" ;
      sFromString = " FROM [Servicio]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([ServicioCategId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([ServicioId] AS decimal(4,0))) like '%' + ?) or ( [ServicioNombre] like '%' + ?) or ( [ServicioDescripcion] like '%' + ?) or ( CONVERT( char(6), CAST([ServicioCosto] AS decimal(6,2))) like '%' + ?) or ( CONVERT( char(4), CAST([ServicioComision] AS decimal(4,0))) like '%' + ?) or ( [ServicioObservacion] like '%' + ?) or ( 'activo' like '%' + LOWER(?) and [ServicioEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and [ServicioEstado] = 'I'))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [ServicioCategId], [ServicioNombre]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [ServicioCategId] DESC, [ServicioNombre] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [ServicioCategId], [ServicioId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [ServicioCategId] DESC, [ServicioId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [ServicioCategId], [ServicioDescripcion]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [ServicioCategId] DESC, [ServicioDescripcion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [ServicioCategId], [ServicioCosto]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [ServicioCategId] DESC, [ServicioCosto] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [ServicioCategId], [ServicioComision]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [ServicioCategId] DESC, [ServicioComision] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [ServicioCategId], [ServicioObservacion]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [ServicioCategId] DESC, [ServicioObservacion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [ServicioCategId], [ServicioEstado]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [ServicioCategId] DESC, [ServicioEstado] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [ServicioId]" ;
      }
   ...
   protected Object[] conditional_H004F3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          short A27ServicioId ,
                                          ...
                                          short A52ServicioCategId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [Servicio]" ;
      addWhere(sWhereString, "([ServicioCategId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([ServicioId] AS decimal(4,0))) like '%' + ?) or ( [ServicioNombre] like '%' + ?) or ( [ServicioDescripcion] like '%' + ?) or ( CONVERT( char(6), CAST([ServicioCosto] AS decimal(6,2))) like '%' + ?) or ( CONVERT( char(4), CAST([ServicioComision] AS decimal(4,0))) like '%' + ?) or ( [ServicioObservacion] like '%' + ?) or ( 'activo' like '%' + LOWER(?) and [ServicioEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and [ServicioEstado] = 'I'))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H004F2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (java.math.BigDecimal)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , (String)dynConstraints[6] , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , ((Boolean) dynConstraints[9]).booleanValue() , ((Number) dynConstraints[10]).shortValue() , ((Number) dynConstraints[11]).shortValue() );
            case 1 :
                  return conditional_H004F3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (java.math.BigDecimal)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , (String)dynConstraints[6] , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , ((Boolean) dynConstraints[9]).booleanValue() , ((Number) dynConstraints[10]).shortValue() , ((Number) dynConstraints[11]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H004F2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H004F3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
