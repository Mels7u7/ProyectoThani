...
public final  class petitoriosubcategpetitoriowc_impl extends GXWebComponent
{
   public petitoriosubcategpetitoriowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public petitoriosubcategpetitoriowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( petitoriosubcategpetitoriowc_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = httpContext.GetFirstPar( "PetitorioSubCategId") ;
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8PetitorioSubCategId = (short)(GXutil.lval( httpContext.GetPar( "PetitorioSubCategId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PetitorioSubCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PetitorioSubCategId), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(AV8PetitorioSubCategId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8PetitorioSubCategId, AV20ManageFiltersExecutionStep, AV34Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Petitorio Sub Categ Petitorio WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110325671", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.petitoriosubcategpetitoriowc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8PetitorioSubCategId,4,0))}, new String[] {"PetitorioSubCategId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8PetitorioSubCategId", GXutil.ltrim( localUtil.ntoc( wcpOAV8PetitorioSubCategId, (byte)(4), (byte)(0), ",", "")));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPETITORIOSUBCATEGID", GXutil.ltrim( localUtil.ntoc( AV8PetitorioSubCategId, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return "PetitorioSubCategPetitorioWC" ;
   }
   ...
   public void wb480( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.petitoriosubcategpetitoriowc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_482( true) ;
      }
      else
      {
         wb_table1_22_482( false) ;
      }
      return  ;
   }

   public void wb_table1_22_482e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtPetitorioSubCategId_Internalname, GXutil.ltrim( localUtil.ntoc( A48PetitorioSubCategId, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A48PetitorioSubCategId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPetitorioSubCategId_Jsonclick, 0, "Attribute", "", "", "", "", edtPetitorioSubCategId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id4", "right", false, "", "HLP_PetitorioSubCategPetitorioWC.htm");
         /* User Defined Control */
   ...
   public void start482( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Petitorio Sub Categ Petitorio WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV34Pgmname = "PetitorioSubCategPetitorioWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf482( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Short.valueOf(AV8PetitorioSubCategId) ,
                                              Short.valueOf(A48PetitorioSubCategId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.DECIMAL, TypeConstants.SHORT,
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H00482 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8PetitorioSubCategId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A48PetitorioSubCategId = H00482_A48PetitorioSubCategId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A48PetitorioSubCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A48PetitorioSubCategId), 4, 0));
            A264PetitorioPrecio = H00482_A264PetitorioPrecio[0] ;
            A261PetitorioPresentacion = H00482_A261PetitorioPresentacion[0] ;
            A39FormaFarmaceuticaId = H00482_A39FormaFarmaceuticaId[0] ;
            A260PetitorioConcentracion = H00482_A260PetitorioConcentracion[0] ;
            A263PetitorioProducto = H00482_A263PetitorioProducto[0] ;
            A262PetitorioPrincipioActivo = H00482_A262PetitorioPrincipioActivo[0] ;
            A36DrogueriaId = H00482_A36DrogueriaId[0] ;
            A25PetitorioId = H00482_A25PetitorioId[0] ;
            e18482 ();
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H00483 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8PetitorioSubCategId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void strup480( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8PetitorioSubCategId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8PetitorioSubCategId"), ",", ".")) ;
   ...
   public void e16482( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtPetitorioSubCategId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtPetitorioSubCategId_Visible), 5, 0), true);
   ...
   public void e11482( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("PetitorioSubCategPetitorioWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV34Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("PetitorioSubCategPetitorioWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "PetitorioSubCategPetitorioWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         petitoriosubcategpetitoriowc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      petitoriosubcategpetitoriowc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "PetitorioSubCategPetitorioWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "PetitorioSubCategId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8PetitorioSubCategId, 4, 0) );
   ...
   public void wb_table1_22_482( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_482( true) ;
      }
      else
      {
         wb_table2_27_482( false) ;
      }
      return  ;
   }

   public void wb_table2_27_482e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_482e( true) ;
      }
      else
      {
         wb_table1_22_482e( false) ;
      }
   }

   public void wb_table2_27_482( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8PetitorioSubCategId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PetitorioSubCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PetitorioSubCategId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8PetitorioSubCategId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "petitoriosubcategpetitoriowc", GetJustCreated( ));
      ...
      {
         AV8PetitorioSubCategId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PetitorioSubCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PetitorioSubCategId), 4, 0));
      }
      wcpOAV8PetitorioSubCategId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8PetitorioSubCategId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV8PetitorioSubCategId != wcpOAV8PetitorioSubCategId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8PetitorioSubCategId = AV8PetitorioSubCategId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8PetitorioSubCategId = httpContext.cgiGet( sPrefix+"AV8PetitorioSubCategId_CTRL") ;
      if ( GXutil.len( sCtrlAV8PetitorioSubCategId) > 0 )
      {
         AV8PetitorioSubCategId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV8PetitorioSubCategId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PetitorioSubCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PetitorioSubCategId), 4, 0));
      }
      else
      {
         AV8PetitorioSubCategId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8PetitorioSubCategId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8PetitorioSubCategId_PARM", GXutil.ltrim( localUtil.ntoc( AV8PetitorioSubCategId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8PetitorioSubCategId)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8PetitorioSubCategId_CTRL", GXutil.rtrim( sCtrlAV8PetitorioSubCategId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110325852", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("petitoriosubcategpetitoriowc.js", "?20225110325852", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:PetitorioId|3:DrogueriaId|4:PetitorioPrincipioActivo|5:PetitorioProducto|6:PetitorioConcentracion|7:FormaFarmaceuticaId|8:PetitorioPresentacion|9:PetitorioPrecio" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e18482',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A25PetitorioId',fld:'PETITORIOID',pic:'ZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e15482',iparms:[{av:'A25PetitorioId',fld:'PETITORIOID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H00482_A48PetitorioSubCategId = new short[1] ;
      H00482_A264PetitorioPrecio = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00482_A261PetitorioPresentacion = new String[] {""} ;
      H00482_A39FormaFarmaceuticaId = new short[1] ;
      H00482_A260PetitorioConcentracion = new String[] {""} ;
      H00482_A263PetitorioProducto = new String[] {""} ;
      H00482_A262PetitorioPrincipioActivo = new String[] {""} ;
      H00482_A36DrogueriaId = new short[1] ;
      H00482_A25PetitorioId = new short[1] ;
      ...
      sCtrlAV8PetitorioSubCategId = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.petitoriosubcategpetitoriowc__default(),
         new Object[] {
             new Object[] {
            H00482_A48PetitorioSubCategId, H00482_A264PetitorioPrecio, H00482_A261PetitorioPresentacion, H00482_A39FormaFarmaceuticaId, H00482_A260PetitorioConcentracion, H00482_A263PetitorioProducto, H00482_A262PetitorioPrincipioActivo, H00482_A36DrogueriaId, H00482_A25PetitorioId
            }
            , new Object[] {
   ...
   private short wcpOAV8PetitorioSubCategId ;
   private short AV8PetitorioSubCategId ;
   ...
   private String sCtrlAV8PetitorioSubCategId ;
   ...
   private short[] H00482_A48PetitorioSubCategId ;
   private java.math.BigDecimal[] H00482_A264PetitorioPrecio ;
   private String[] H00482_A261PetitorioPresentacion ;
   private short[] H00482_A39FormaFarmaceuticaId ;
   private String[] H00482_A260PetitorioConcentracion ;
   private String[] H00482_A263PetitorioProducto ;
   private String[] H00482_A262PetitorioPrincipioActivo ;
   private short[] H00482_A36DrogueriaId ;
   private short[] H00482_A25PetitorioId ;
...
final  class petitoriosubcategpetitoriowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00482( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          short A48PetitorioSubCategId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [PetitorioSubCategId], [PetitorioPrecio], [PetitorioPresentacion], [FormaFarmaceuticaId], [PetitorioConcentracion], [PetitorioProducto], [PetitorioPrincipioActivo]," ;
      sSelectString += " [DrogueriaId], [PetitorioId]" ;
      sFromString = " FROM [Petitorio]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([PetitorioSubCategId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([PetitorioId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(4), CAST([DrogueriaId] AS decimal(4,0))) like '%' + ?) or ( [PetitorioPrincipioActivo] like '%' + ?) or ( [PetitorioProducto] like '%' + ?) or ( [PetitorioConcentracion] like '%' + ?) or ( CONVERT( char(4), CAST([FormaFarmaceuticaId] AS decimal(4,0))) like '%' + ?) or ( [PetitorioPresentacion] like '%' + ?) or ( CONVERT( char(7), CAST([PetitorioPrecio] AS decimal(7,2))) like '%' + ?))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [PetitorioSubCategId], [PetitorioPrincipioActivo]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId] DESC, [PetitorioPrincipioActivo] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId], [PetitorioId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId] DESC, [PetitorioId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId], [DrogueriaId]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId] DESC, [DrogueriaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId], [PetitorioProducto]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId] DESC, [PetitorioProducto] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId], [PetitorioConcentracion]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId] DESC, [PetitorioConcentracion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId], [FormaFarmaceuticaId]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId] DESC, [FormaFarmaceuticaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId], [PetitorioPresentacion]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId] DESC, [PetitorioPresentacion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId], [PetitorioPrecio]" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId] DESC, [PetitorioPrecio] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [PetitorioId]" ;
      }
   ...
   protected Object[] conditional_H00483( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          short A25PetitorioId ,
                                          ...
                                          short A48PetitorioSubCategId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [Petitorio]" ;
      addWhere(sWhereString, "([PetitorioSubCategId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([PetitorioId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(4), CAST([DrogueriaId] AS decimal(4,0))) like '%' + ?) or ( [PetitorioPrincipioActivo] like '%' + ?) or ( [PetitorioProducto] like '%' + ?) or ( [PetitorioConcentracion] like '%' + ?) or ( CONVERT( char(4), CAST([FormaFarmaceuticaId] AS decimal(4,0))) like '%' + ?) or ( [PetitorioPresentacion] like '%' + ?) or ( CONVERT( char(7), CAST([PetitorioPrecio] AS decimal(7,2))) like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00482(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , (String)dynConstraints[7] , (java.math.BigDecimal)dynConstraints[8] , ((Number) dynConstraints[9]).shortValue() , ((Boolean) dynConstraints[10]).booleanValue() , ((Number) dynConstraints[11]).shortValue() , ((Number) dynConstraints[12]).shortValue() );
            case 1 :
                  return conditional_H00483(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , (String)dynConstraints[7] , (java.math.BigDecimal)dynConstraints[8] , ((Number) dynConstraints[9]).shortValue() , ((Boolean) dynConstraints[10]).booleanValue() , ((Number) dynConstraints[11]).shortValue() , ((Number) dynConstraints[12]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00482", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00483", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
