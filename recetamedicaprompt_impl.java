...
public final  class recetamedicaprompt_impl extends GXDataArea
{
   public recetamedicaprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public recetamedicaprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( recetamedicaprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutRecetaMedicaId") ;
         ...
         {
            AV8InOutRecetaMedicaId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutRecetaMedicaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutRecetaMedicaId), 4, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutRecetaMedicaConcentracion = httpContext.GetPar( "InOutRecetaMedicaConcentracion") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutRecetaMedicaConcentracion", AV9InOutRecetaMedicaConcentracion);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511034114", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.recetamedicaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutRecetaMedicaId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutRecetaMedicaConcentracion))}, new String[] {"InOutRecetaMedicaId","InOutRecetaMedicaConcentracion"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTRECETAMEDICAID", GXutil.ltrim( localUtil.ntoc( AV8InOutRecetaMedicaId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTRECETAMEDICACONCENTRACION", AV9InOutRecetaMedicaConcentracion);
   ...
   {
      return formatLink("com.projectthani.recetamedicaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutRecetaMedicaId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutRecetaMedicaConcentracion))}, new String[] {"InOutRecetaMedicaId","InOutRecetaMedicaConcentracion"})  ;
   }

   public String getPgmname( )
   {
      return "RecetaMedicaPrompt" ;
   }

   public String getPgmdesc( )
   {
      return "Selecciona Receta Medica" ;
   }
   ...
   public void wb650( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_652( true) ;
      }
      else
      {
         wb_table1_12_652( false) ;
      }
      return  ;
   }

   public void wb_table1_12_652e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start652( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Receta Medica", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtRecetaMedicaArchivo_Internalname, "URL", httpContext.getResourceRelative(A270RecetaMedicaArchivo), !bGXsfl_24_Refreshing);
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_RECETAMEDICACONCENTRACION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A268RecetaMedicaConcentracion, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "RECETAMEDICACONCENTRACION", A268RecetaMedicaConcentracion);
   }
   ...
   public void rf652( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING,
                                              TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.BYTE, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                              }
         });
         ...
         {
            A267RecetaMedicaNombreArchivo = H00652_A267RecetaMedicaNombreArchivo[0] ;
            n267RecetaMedicaNombreArchivo = H00652_n267RecetaMedicaNombreArchivo[0] ;
            edtRecetaMedicaArchivo_Filename = A267RecetaMedicaNombreArchivo ;
            A271RecetaArchivoTipo = H00652_A271RecetaArchivoTipo[0] ;
            edtRecetaMedicaArchivo_Filetype = A271RecetaArchivoTipo ;
            httpContext.ajax_rsp_assign_prop("", false, edtRecetaMedicaArchivo_Internalname, "Filetype", edtRecetaMedicaArchivo_Filetype, !bGXsfl_24_Refreshing);
            A332RecetaIndicaciones = H00652_A332RecetaIndicaciones[0] ;
            A272RecetaMedicaFlag = H00652_A272RecetaMedicaFlag[0] ;
            n272RecetaMedicaFlag = H00652_n272RecetaMedicaFlag[0] ;
            A270RecetaMedicaArchivo = H00652_A270RecetaMedicaArchivo[0] ;
            n270RecetaMedicaArchivo = H00652_n270RecetaMedicaArchivo[0] ;
            httpContext.ajax_rsp_assign_prop("", false, edtRecetaMedicaArchivo_Internalname, "URL", httpContext.getResourceRelative(A270RecetaMedicaArchivo), !bGXsfl_24_Refreshing);
            A273RecetaMedicaAtencion = H00652_A273RecetaMedicaAtencion[0] ;
            n273RecetaMedicaAtencion = H00652_n273RecetaMedicaAtencion[0] ;
            A269RecetaMedicaCantidad = H00652_A269RecetaMedicaCantidad[0] ;
            n269RecetaMedicaCantidad = H00652_n269RecetaMedicaCantidad[0] ;
            A268RecetaMedicaConcentracion = H00652_A268RecetaMedicaConcentracion[0] ;
            n268RecetaMedicaConcentracion = H00652_n268RecetaMedicaConcentracion[0] ;
            A231MedicamentoFormaFarm = H00652_A231MedicamentoFormaFarm[0] ;
            n231MedicamentoFormaFarm = H00652_n231MedicamentoFormaFarm[0] ;
            A230MedicamentoNombre = H00652_A230MedicamentoNombre[0] ;
            A229MedicamentoCodigo = H00652_A229MedicamentoCodigo[0] ;
            A42MedicamentoId = H00652_A42MedicamentoId[0] ;
            n42MedicamentoId = H00652_n42MedicamentoId[0] ;
            A19CitaId = H00652_A19CitaId[0] ;
            A50RecetaMedicaId = H00652_A50RecetaMedicaId[0] ;
            A231MedicamentoFormaFarm = H00652_A231MedicamentoFormaFarm[0] ;
            n231MedicamentoFormaFarm = H00652_n231MedicamentoFormaFarm[0] ;
            A230MedicamentoNombre = H00652_A230MedicamentoNombre[0] ;
            A229MedicamentoCodigo = H00652_A229MedicamentoCodigo[0] ;
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_RECETAMEDICAID"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, localUtil.format( DecimalUtil.doubleToDec(A50RecetaMedicaId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_RECETAMEDICACONCENTRACION"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, GXutil.rtrim( localUtil.format( A268RecetaMedicaConcentracion, ""))));
   }
   ...
   public void e15652( )
   {
      ...
      Form.setCaption( "Selecciona Receta Medica" );
   ...
   public void e18652( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutRecetaMedicaId = A50RecetaMedicaId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutRecetaMedicaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutRecetaMedicaId), 4, 0));
      AV9InOutRecetaMedicaConcentracion = A268RecetaMedicaConcentracion ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutRecetaMedicaConcentracion", AV9InOutRecetaMedicaConcentracion);
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV8InOutRecetaMedicaId),AV9InOutRecetaMedicaConcentracion});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutRecetaMedicaId","AV9InOutRecetaMedicaConcentracion"});
   ...
   public void wb_table1_12_652( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_RecetaMedicaPrompt.htm");
   ...
   {
      AV8InOutRecetaMedicaId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutRecetaMedicaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutRecetaMedicaId), 4, 0));
      AV9InOutRecetaMedicaConcentracion = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutRecetaMedicaConcentracion", AV9InOutRecetaMedicaConcentracion);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202251103425", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("recetamedicaprompt.js", "?202251103425", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_242( )
   {
      ...
      edtRecetaMedicaId_Internalname = "RECETAMEDICAID_"+sGXsfl_24_idx ;
      edtCitaId_Internalname = "CITAID_"+sGXsfl_24_idx ;
      edtMedicamentoId_Internalname = "MEDICAMENTOID_"+sGXsfl_24_idx ;
      edtMedicamentoCodigo_Internalname = "MEDICAMENTOCODIGO_"+sGXsfl_24_idx ;
      edtMedicamentoNombre_Internalname = "MEDICAMENTONOMBRE_"+sGXsfl_24_idx ;
      edtMedicamentoFormaFarm_Internalname = "MEDICAMENTOFORMAFARM_"+sGXsfl_24_idx ;
      edtRecetaMedicaConcentracion_Internalname = "RECETAMEDICACONCENTRACION_"+sGXsfl_24_idx ;
      edtRecetaMedicaCantidad_Internalname = "RECETAMEDICACANTIDAD_"+sGXsfl_24_idx ;
      edtRecetaMedicaAtencion_Internalname = "RECETAMEDICAATENCION_"+sGXsfl_24_idx ;
      edtRecetaMedicaArchivo_Internalname = "RECETAMEDICAARCHIVO_"+sGXsfl_24_idx ;
      edtRecetaMedicaNombreArchivo_Internalname = "RECETAMEDICANOMBREARCHIVO_"+sGXsfl_24_idx ;
      edtRecetaMedicaFlag_Internalname = "RECETAMEDICAFLAG_"+sGXsfl_24_idx ;
      edtRecetaIndicaciones_Internalname = "RECETAINDICACIONES_"+sGXsfl_24_idx ;
      edtRecetaArchivoTipo_Internalname = "RECETAARCHIVOTIPO_"+sGXsfl_24_idx ;
   }

   public void subsflControlProps_fel_242( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_24_fel_idx ;
      edtRecetaMedicaId_Internalname = "RECETAMEDICAID_"+sGXsfl_24_fel_idx ;
      edtCitaId_Internalname = "CITAID_"+sGXsfl_24_fel_idx ;
      edtMedicamentoId_Internalname = "MEDICAMENTOID_"+sGXsfl_24_fel_idx ;
      edtMedicamentoCodigo_Internalname = "MEDICAMENTOCODIGO_"+sGXsfl_24_fel_idx ;
      edtMedicamentoNombre_Internalname = "MEDICAMENTONOMBRE_"+sGXsfl_24_fel_idx ;
      edtMedicamentoFormaFarm_Internalname = "MEDICAMENTOFORMAFARM_"+sGXsfl_24_fel_idx ;
      edtRecetaMedicaConcentracion_Internalname = "RECETAMEDICACONCENTRACION_"+sGXsfl_24_fel_idx ;
      edtRecetaMedicaCantidad_Internalname = "RECETAMEDICACANTIDAD_"+sGXsfl_24_fel_idx ;
      edtRecetaMedicaAtencion_Internalname = "RECETAMEDICAATENCION_"+sGXsfl_24_fel_idx ;
      edtRecetaMedicaArchivo_Internalname = "RECETAMEDICAARCHIVO_"+sGXsfl_24_fel_idx ;
      edtRecetaMedicaNombreArchivo_Internalname = "RECETAMEDICANOMBREARCHIVO_"+sGXsfl_24_fel_idx ;
      edtRecetaMedicaFlag_Internalname = "RECETAMEDICAFLAG_"+sGXsfl_24_fel_idx ;
      edtRecetaIndicaciones_Internalname = "RECETAINDICACIONES_"+sGXsfl_24_fel_idx ;
      edtRecetaArchivoTipo_Internalname = "RECETAARCHIVOTIPO_"+sGXsfl_24_fel_idx ;
   }
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtMedicamentoCodigo_Internalname,A229MedicamentoCodigo,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtMedicamentoCodigo_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(15),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(24),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:RecetaMedicaId|2:CitaId|3:MedicamentoId|4:MedicamentoCodigo|5:MedicamentoNombre|6:MedicamentoFormaFarm|7:RecetaMedicaConcentracion|8:RecetaMedicaCantidad|9:RecetaMedicaAtencion|12:RecetaMedicaFlag|13:RecetaIndicaciones" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11652',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12652',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      ...
      setEventMetadata("ENTER","{handler:'e18652',iparms:[{av:'A50RecetaMedicaId',fld:'RECETAMEDICAID',pic:'ZZZ9',hsh:true},{av:'A268RecetaMedicaConcentracion',fld:'RECETAMEDICACONCENTRACION',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutRecetaMedicaId',fld:'vINOUTRECETAMEDICAID',pic:'ZZZ9'},{av:'AV9InOutRecetaMedicaConcentracion',fld:'vINOUTRECETAMEDICACONCENTRACION',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e14652',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
   ...
   {
      wcpOAV9InOutRecetaMedicaConcentracion = "" ;
      ...
      AV9InOutRecetaMedicaConcentracion = "" ;
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H00652_A267RecetaMedicaNombreArchivo = new String[] {""} ;
      H00652_n267RecetaMedicaNombreArchivo = new boolean[] {false} ;
      H00652_A271RecetaArchivoTipo = new String[] {""} ;
      H00652_A332RecetaIndicaciones = new String[] {""} ;
      H00652_A272RecetaMedicaFlag = new byte[1] ;
      H00652_n272RecetaMedicaFlag = new boolean[] {false} ;
      H00652_A270RecetaMedicaArchivo = new String[] {""} ;
      H00652_n270RecetaMedicaArchivo = new boolean[] {false} ;
      H00652_A273RecetaMedicaAtencion = new String[] {""} ;
      H00652_n273RecetaMedicaAtencion = new boolean[] {false} ;
      H00652_A269RecetaMedicaCantidad = new short[1] ;
      H00652_n269RecetaMedicaCantidad = new boolean[] {false} ;
      H00652_A268RecetaMedicaConcentracion = new String[] {""} ;
      H00652_n268RecetaMedicaConcentracion = new boolean[] {false} ;
      H00652_A231MedicamentoFormaFarm = new String[] {""} ;
      H00652_n231MedicamentoFormaFarm = new boolean[] {false} ;
      H00652_A230MedicamentoNombre = new String[] {""} ;
      H00652_A229MedicamentoCodigo = new String[] {""} ;
      H00652_A42MedicamentoId = new short[1] ;
      H00652_n42MedicamentoId = new boolean[] {false} ;
      H00652_A19CitaId = new int[1] ;
      H00652_A50RecetaMedicaId = new short[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.recetamedicaprompt__default(),
         new Object[] {
             new Object[] {
            H00652_A267RecetaMedicaNombreArchivo, H00652_n267RecetaMedicaNombreArchivo, H00652_A271RecetaArchivoTipo, H00652_A332RecetaIndicaciones, H00652_A272RecetaMedicaFlag, H00652_n272RecetaMedicaFlag, H00652_A270RecetaMedicaArchivo, H00652_n270RecetaMedicaArchivo, H00652_A273RecetaMedicaAtencion, H00652_n273RecetaMedicaAtencion,
            H00652_A269RecetaMedicaCantidad, H00652_n269RecetaMedicaCantidad, H00652_A268RecetaMedicaConcentracion, H00652_n268RecetaMedicaConcentracion, H00652_A231MedicamentoFormaFarm, H00652_n231MedicamentoFormaFarm, H00652_A230MedicamentoNombre, H00652_A229MedicamentoCodigo, H00652_A42MedicamentoId, H00652_n42MedicamentoId,
            H00652_A19CitaId, H00652_A50RecetaMedicaId
            }
            , new Object[] {
   ...
   private short wcpOAV8InOutRecetaMedicaId ;
   private short AV8InOutRecetaMedicaId ;
   ...
   private String wcpOAV9InOutRecetaMedicaConcentracion ;
   private String AV13FilterFullText ;
   private String AV9InOutRecetaMedicaConcentracion ;
   ...
   private String[] H00652_A267RecetaMedicaNombreArchivo ;
   private boolean[] H00652_n267RecetaMedicaNombreArchivo ;
   private String[] H00652_A271RecetaArchivoTipo ;
   private String[] H00652_A332RecetaIndicaciones ;
   private byte[] H00652_A272RecetaMedicaFlag ;
   private boolean[] H00652_n272RecetaMedicaFlag ;
   private String[] H00652_A270RecetaMedicaArchivo ;
   private boolean[] H00652_n270RecetaMedicaArchivo ;
   private String[] H00652_A273RecetaMedicaAtencion ;
   private boolean[] H00652_n273RecetaMedicaAtencion ;
   private short[] H00652_A269RecetaMedicaCantidad ;
   private boolean[] H00652_n269RecetaMedicaCantidad ;
   private String[] H00652_A268RecetaMedicaConcentracion ;
   private boolean[] H00652_n268RecetaMedicaConcentracion ;
   private String[] H00652_A231MedicamentoFormaFarm ;
   private boolean[] H00652_n231MedicamentoFormaFarm ;
   private String[] H00652_A230MedicamentoNombre ;
   private String[] H00652_A229MedicamentoCodigo ;
   private short[] H00652_A42MedicamentoId ;
   private boolean[] H00652_n42MedicamentoId ;
   private int[] H00652_A19CitaId ;
   private short[] H00652_A50RecetaMedicaId ;
...
final  class recetamedicaprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00652(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , (String)dynConstraints[9] , ((Number) dynConstraints[10]).byteValue() , (String)dynConstraints[11] , ((Number) dynConstraints[12]).shortValue() , ((Boolean) dynConstraints[13]).booleanValue() );
            case 1 :
                  return conditional_H00653(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , (String)dynConstraints[9] , ((Number) dynConstraints[10]).byteValue() , (String)dynConstraints[11] , ((Number) dynConstraints[12]).shortValue() , ((Boolean) dynConstraints[13]).booleanValue() );
      }
