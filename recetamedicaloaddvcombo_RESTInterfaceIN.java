...
@javax.xml.bind.annotation.XmlType(name = "recetamedicaloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class recetamedicaloaddvcombo_RESTInterfaceIN
{
   ...
   {
      return AV26RecetaMedicaId ;
   }

   @JsonProperty("RecetaMedicaId")
   public void setRecetaMedicaId(  short Value )
   {
      AV26RecetaMedicaId= Value;
   }
