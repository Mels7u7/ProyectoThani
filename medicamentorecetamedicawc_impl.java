...
public final  class medicamentorecetamedicawc_impl extends GXWebComponent
{
   public medicamentorecetamedicawc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public medicamentorecetamedicawc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( medicamentorecetamedicawc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8MedicamentoId = (short)(GXutil.lval( httpContext.GetPar( "MedicamentoId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8MedicamentoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8MedicamentoId), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(AV8MedicamentoId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8MedicamentoId, AV20ManageFiltersExecutionStep, AV33Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Medicamento Receta Medica WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202251103368", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.medicamentorecetamedicawc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8MedicamentoId,4,0))}, new String[] {"MedicamentoId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8MedicamentoId", GXutil.ltrim( localUtil.ntoc( wcpOAV8MedicamentoId, (byte)(4), (byte)(0), ",", "")));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vMEDICAMENTOID", GXutil.ltrim( localUtil.ntoc( AV8MedicamentoId, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return "MedicamentoRecetaMedicaWC" ;
   }

   public String getPgmdesc( )
   {
      return "Medicamento Receta Medica WC" ;
   }
   ...
   public void wb5A0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.medicamentorecetamedicawc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_5A2( true) ;
      }
      else
      {
         wb_table1_22_5A2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_5A2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeValue( "Nombre Archivo") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            ...
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
            httpContext.writeValue( "Archivo Tipo") ;
            httpContext.writeTextNL( "</th>") ;
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtMedicamentoId_Internalname, GXutil.ltrim( localUtil.ntoc( A42MedicamentoId, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A42MedicamentoId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMedicamentoId_Jsonclick, 0, "Attribute", "", "", "", "", edtMedicamentoId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id4", "right", false, "", "HLP_MedicamentoRecetaMedicaWC.htm");
         /* User Defined Control */
   ...
   public void start5A2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Medicamento Receta Medica WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop(sPrefix, false, edtRecetaMedicaArchivo_Internalname, "URL", httpContext.getResourceRelative(A270RecetaMedicaArchivo), !bGXsfl_37_Refreshing);
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_RECETAMEDICAID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A50RecetaMedicaId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"RECETAMEDICAID", GXutil.ltrim( localUtil.ntoc( A50RecetaMedicaId, (byte)(4), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV33Pgmname = "MedicamentoRecetaMedicaWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf5A2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Short.valueOf(AV8MedicamentoId) ,
                                              Short.valueOf(A42MedicamentoId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.INT, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.BYTE,
                                              TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                              }
         });
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H005A2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8MedicamentoId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A267RecetaMedicaNombreArchivo = H005A2_A267RecetaMedicaNombreArchivo[0] ;
            n267RecetaMedicaNombreArchivo = H005A2_n267RecetaMedicaNombreArchivo[0] ;
            edtRecetaMedicaArchivo_Filename = A267RecetaMedicaNombreArchivo ;
            A271RecetaArchivoTipo = H005A2_A271RecetaArchivoTipo[0] ;
            edtRecetaMedicaArchivo_Filetype = A271RecetaArchivoTipo ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtRecetaMedicaArchivo_Internalname, "Filetype", edtRecetaMedicaArchivo_Filetype, !bGXsfl_37_Refreshing);
            A42MedicamentoId = H005A2_A42MedicamentoId[0] ;
            n42MedicamentoId = H005A2_n42MedicamentoId[0] ;
            ...
            A332RecetaIndicaciones = H005A2_A332RecetaIndicaciones[0] ;
            A272RecetaMedicaFlag = H005A2_A272RecetaMedicaFlag[0] ;
            n272RecetaMedicaFlag = H005A2_n272RecetaMedicaFlag[0] ;
            A270RecetaMedicaArchivo = H005A2_A270RecetaMedicaArchivo[0] ;
            n270RecetaMedicaArchivo = H005A2_n270RecetaMedicaArchivo[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtRecetaMedicaArchivo_Internalname, "URL", httpContext.getResourceRelative(A270RecetaMedicaArchivo), !bGXsfl_37_Refreshing);
            A273RecetaMedicaAtencion = H005A2_A273RecetaMedicaAtencion[0] ;
            n273RecetaMedicaAtencion = H005A2_n273RecetaMedicaAtencion[0] ;
            A269RecetaMedicaCantidad = H005A2_A269RecetaMedicaCantidad[0] ;
            n269RecetaMedicaCantidad = H005A2_n269RecetaMedicaCantidad[0] ;
            A268RecetaMedicaConcentracion = H005A2_A268RecetaMedicaConcentracion[0] ;
            n268RecetaMedicaConcentracion = H005A2_n268RecetaMedicaConcentracion[0] ;
            A19CitaId = H005A2_A19CitaId[0] ;
            A50RecetaMedicaId = H005A2_A50RecetaMedicaId[0] ;
            e185A2 ();
   ...
   public void send_integrity_lvl_hashes5A2( )
   {
      ...
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_DELETE", AV29IsAuthorized_Delete);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( sPrefix, AV29IsAuthorized_Delete));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_RECETAMEDICAID"+"_"+sGXsfl_37_idx, getSecureSignedToken( sPrefix+sGXsfl_37_idx, localUtil.format( DecimalUtil.doubleToDec(A50RecetaMedicaId), "ZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H005A3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8MedicamentoId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void strup5A0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8MedicamentoId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8MedicamentoId"), ",", ".")) ;
   ...
   public void e165A2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtMedicamentoId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtMedicamentoId_Visible), 5, 0), true);
   ...
   public void e115A2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("MedicamentoRecetaMedicaWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV33Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("MedicamentoRecetaMedicaWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "MedicamentoRecetaMedicaWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         medicamentorecetamedicawc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWRecetaMedica_Update", GXv_boolean7) ;
      medicamentorecetamedicawc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWRecetaMedica_Delete", GXv_boolean7) ;
      medicamentorecetamedicawc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWRecetaMedica_Insert", GXv_boolean7) ;
      medicamentorecetamedicawc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "MedicamentoRecetaMedicaWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "RecetaMedica" );
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "MedicamentoId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8MedicamentoId, 4, 0) );
   ...
   public void wb_table1_22_5A2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_5A2( true) ;
      }
      else
      {
         wb_table2_27_5A2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_5A2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_5A2e( true) ;
      }
      else
      {
         wb_table1_22_5A2e( false) ;
      }
   }

   public void wb_table2_27_5A2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8MedicamentoId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8MedicamentoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8MedicamentoId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8MedicamentoId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "medicamentorecetamedicawc", GetJustCreated( ));
      ...
      {
         AV8MedicamentoId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8MedicamentoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8MedicamentoId), 4, 0));
      }
      wcpOAV8MedicamentoId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8MedicamentoId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV8MedicamentoId != wcpOAV8MedicamentoId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8MedicamentoId = AV8MedicamentoId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8MedicamentoId = httpContext.cgiGet( sPrefix+"AV8MedicamentoId_CTRL") ;
      if ( GXutil.len( sCtrlAV8MedicamentoId) > 0 )
      {
         AV8MedicamentoId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV8MedicamentoId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8MedicamentoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8MedicamentoId), 4, 0));
      }
      else
      {
         AV8MedicamentoId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8MedicamentoId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8MedicamentoId_PARM", GXutil.ltrim( localUtil.ntoc( AV8MedicamentoId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8MedicamentoId)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8MedicamentoId_CTRL", GXutil.rtrim( sCtrlAV8MedicamentoId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511033823", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("medicamentorecetamedicawc.js", "?2022511033823", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtRecetaMedicaId_Internalname = sPrefix+"RECETAMEDICAID_"+sGXsfl_37_idx ;
      edtCitaId_Internalname = sPrefix+"CITAID_"+sGXsfl_37_idx ;
      edtRecetaMedicaConcentracion_Internalname = sPrefix+"RECETAMEDICACONCENTRACION_"+sGXsfl_37_idx ;
      edtRecetaMedicaCantidad_Internalname = sPrefix+"RECETAMEDICACANTIDAD_"+sGXsfl_37_idx ;
      edtRecetaMedicaAtencion_Internalname = sPrefix+"RECETAMEDICAATENCION_"+sGXsfl_37_idx ;
      edtRecetaMedicaArchivo_Internalname = sPrefix+"RECETAMEDICAARCHIVO_"+sGXsfl_37_idx ;
      edtRecetaMedicaNombreArchivo_Internalname = sPrefix+"RECETAMEDICANOMBREARCHIVO_"+sGXsfl_37_idx ;
      edtRecetaMedicaFlag_Internalname = sPrefix+"RECETAMEDICAFLAG_"+sGXsfl_37_idx ;
      edtRecetaIndicaciones_Internalname = sPrefix+"RECETAINDICACIONES_"+sGXsfl_37_idx ;
      edtRecetaArchivoTipo_Internalname = sPrefix+"RECETAARCHIVOTIPO_"+sGXsfl_37_idx ;
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtRecetaMedicaId_Internalname = sPrefix+"RECETAMEDICAID_"+sGXsfl_37_fel_idx ;
      edtCitaId_Internalname = sPrefix+"CITAID_"+sGXsfl_37_fel_idx ;
      edtRecetaMedicaConcentracion_Internalname = sPrefix+"RECETAMEDICACONCENTRACION_"+sGXsfl_37_fel_idx ;
      edtRecetaMedicaCantidad_Internalname = sPrefix+"RECETAMEDICACANTIDAD_"+sGXsfl_37_fel_idx ;
      edtRecetaMedicaAtencion_Internalname = sPrefix+"RECETAMEDICAATENCION_"+sGXsfl_37_fel_idx ;
      edtRecetaMedicaArchivo_Internalname = sPrefix+"RECETAMEDICAARCHIVO_"+sGXsfl_37_fel_idx ;
      edtRecetaMedicaNombreArchivo_Internalname = sPrefix+"RECETAMEDICANOMBREARCHIVO_"+sGXsfl_37_fel_idx ;
      edtRecetaMedicaFlag_Internalname = sPrefix+"RECETAMEDICAFLAG_"+sGXsfl_37_fel_idx ;
      edtRecetaIndicaciones_Internalname = sPrefix+"RECETAINDICACIONES_"+sGXsfl_37_fel_idx ;
      edtRecetaArchivoTipo_Internalname = sPrefix+"RECETAARCHIVOTIPO_"+sGXsfl_37_fel_idx ;
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRecetaMedicaId_Internalname,GXutil.ltrim( localUtil.ntoc( A50RecetaMedicaId, (byte)(4), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A50RecetaMedicaId), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRecetaMedicaId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id4","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRecetaMedicaAtencion_Internalname,A273RecetaMedicaAtencion,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRecetaMedicaAtencion_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRecetaMedicaNombreArchivo_Internalname,A267RecetaMedicaNombreArchivo,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRecetaMedicaNombreArchivo_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRecetaMedicaFlag_Internalname,GXutil.ltrim( localUtil.ntoc( A272RecetaMedicaFlag, (byte)(1), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A272RecetaMedicaFlag), "9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRecetaMedicaFlag_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRecetaIndicaciones_Internalname,A332RecetaIndicaciones,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRecetaIndicaciones_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(300),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRecetaArchivoTipo_Internalname,A271RecetaArchivoTipo,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRecetaArchivoTipo_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(30),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:RecetaMedicaId|3:CitaId|4:RecetaMedicaConcentracion|5:RecetaMedicaCantidad|6:RecetaMedicaAtencion|9:RecetaMedicaFlag|10:RecetaIndicaciones" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e185A2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A50RecetaMedicaId',fld:'RECETAMEDICAID',pic:'ZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV26Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV28Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtRecetaMedicaConcentracion_Link',ctrl:'RECETAMEDICACONCENTRACION',prop:'Link'}]}");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e155A2',iparms:[{av:'A50RecetaMedicaId',fld:'RECETAMEDICAID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H005A2_A267RecetaMedicaNombreArchivo = new String[] {""} ;
      H005A2_n267RecetaMedicaNombreArchivo = new boolean[] {false} ;
      H005A2_A271RecetaArchivoTipo = new String[] {""} ;
      H005A2_A42MedicamentoId = new short[1] ;
      H005A2_n42MedicamentoId = new boolean[] {false} ;
      H005A2_A332RecetaIndicaciones = new String[] {""} ;
      H005A2_A272RecetaMedicaFlag = new byte[1] ;
      H005A2_n272RecetaMedicaFlag = new boolean[] {false} ;
      H005A2_A270RecetaMedicaArchivo = new String[] {""} ;
      H005A2_n270RecetaMedicaArchivo = new boolean[] {false} ;
      H005A2_A273RecetaMedicaAtencion = new String[] {""} ;
      H005A2_n273RecetaMedicaAtencion = new boolean[] {false} ;
      H005A2_A269RecetaMedicaCantidad = new short[1] ;
      H005A2_n269RecetaMedicaCantidad = new boolean[] {false} ;
      H005A2_A268RecetaMedicaConcentracion = new String[] {""} ;
      H005A2_n268RecetaMedicaConcentracion = new boolean[] {false} ;
      H005A2_A19CitaId = new int[1] ;
      H005A2_A50RecetaMedicaId = new short[1] ;
      ...
      sCtrlAV8MedicamentoId = "" ;
      ROClassString = "" ;
      gxblobfileaux = new com.genexus.util.GXFile();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.medicamentorecetamedicawc__default(),
         new Object[] {
             new Object[] {
            H005A2_A267RecetaMedicaNombreArchivo, H005A2_n267RecetaMedicaNombreArchivo, H005A2_A271RecetaArchivoTipo, H005A2_A42MedicamentoId, H005A2_n42MedicamentoId, H005A2_A332RecetaIndicaciones, H005A2_A272RecetaMedicaFlag, H005A2_n272RecetaMedicaFlag, H005A2_A270RecetaMedicaArchivo, H005A2_n270RecetaMedicaArchivo,
            H005A2_A273RecetaMedicaAtencion, H005A2_n273RecetaMedicaAtencion, H005A2_A269RecetaMedicaCantidad, H005A2_n269RecetaMedicaCantidad, H005A2_A268RecetaMedicaConcentracion, H005A2_n268RecetaMedicaConcentracion, H005A2_A19CitaId, H005A2_A50RecetaMedicaId
            }
            , new Object[] {
   ...
   private short wcpOAV8MedicamentoId ;
   private short AV8MedicamentoId ;
   ...
   private String sCtrlAV8MedicamentoId ;
   ...
   private String[] H005A2_A267RecetaMedicaNombreArchivo ;
   private boolean[] H005A2_n267RecetaMedicaNombreArchivo ;
   private String[] H005A2_A271RecetaArchivoTipo ;
   private short[] H005A2_A42MedicamentoId ;
   private boolean[] H005A2_n42MedicamentoId ;
   private String[] H005A2_A332RecetaIndicaciones ;
   private byte[] H005A2_A272RecetaMedicaFlag ;
   private boolean[] H005A2_n272RecetaMedicaFlag ;
   private String[] H005A2_A270RecetaMedicaArchivo ;
   private boolean[] H005A2_n270RecetaMedicaArchivo ;
   private String[] H005A2_A273RecetaMedicaAtencion ;
   private boolean[] H005A2_n273RecetaMedicaAtencion ;
   private short[] H005A2_A269RecetaMedicaCantidad ;
   private boolean[] H005A2_n269RecetaMedicaCantidad ;
   private String[] H005A2_A268RecetaMedicaConcentracion ;
   private boolean[] H005A2_n268RecetaMedicaConcentracion ;
   private int[] H005A2_A19CitaId ;
   private short[] H005A2_A50RecetaMedicaId ;
...
final  class medicamentorecetamedicawc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H005A2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          short A42MedicamentoId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [RecetaMedicaNombreArchivo], [RecetaArchivoTipo], [MedicamentoId], [RecetaIndicaciones], [RecetaMedicaFlag], [RecetaMedicaArchivo], [RecetaMedicaAtencion], [RecetaMedicaCantidad]," ;
      sSelectString += " [RecetaMedicaConcentracion], [CitaId], [RecetaMedicaId]" ;
      sFromString = " FROM [RecetaMedica]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([MedicamentoId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([RecetaMedicaId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(8), CAST([CitaId] AS decimal(8,0))) like '%' + ?) or ( [RecetaMedicaConcentracion] like '%' + ?) or ( CONVERT( char(4), CAST([RecetaMedicaCantidad] AS decimal(4,0))) like '%' + ?) or ( [RecetaMedicaAtencion] like '%' + ?) or ( CONVERT( char(1), CAST([RecetaMedicaFlag] AS decimal(1,0))) like '%' + ?) or ( [RecetaIndicaciones] like '%' + ?))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [MedicamentoId], [RecetaMedicaConcentracion]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [MedicamentoId] DESC, [RecetaMedicaConcentracion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [MedicamentoId], [RecetaMedicaId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [MedicamentoId] DESC, [RecetaMedicaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [MedicamentoId], [CitaId]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [MedicamentoId] DESC, [CitaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [MedicamentoId], [RecetaMedicaCantidad]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [MedicamentoId] DESC, [RecetaMedicaCantidad] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [MedicamentoId], [RecetaMedicaAtencion]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [MedicamentoId] DESC, [RecetaMedicaAtencion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [MedicamentoId], [RecetaMedicaFlag]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [MedicamentoId] DESC, [RecetaMedicaFlag] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [MedicamentoId], [RecetaIndicaciones]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [MedicamentoId] DESC, [RecetaIndicaciones] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [RecetaMedicaId]" ;
      }
   ...
   protected Object[] conditional_H005A3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          short A50RecetaMedicaId ,
                                          ...
                                          short A42MedicamentoId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [RecetaMedica]" ;
      addWhere(sWhereString, "([MedicamentoId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([RecetaMedicaId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(8), CAST([CitaId] AS decimal(8,0))) like '%' + ?) or ( [RecetaMedicaConcentracion] like '%' + ?) or ( CONVERT( char(4), CAST([RecetaMedicaCantidad] AS decimal(4,0))) like '%' + ?) or ( [RecetaMedicaAtencion] like '%' + ?) or ( CONVERT( char(1), CAST([RecetaMedicaFlag] AS decimal(1,0))) like '%' + ?) or ( [RecetaIndicaciones] like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005A2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , ((Number) dynConstraints[2]).intValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , (String)dynConstraints[5] , ((Number) dynConstraints[6]).byteValue() , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , ((Boolean) dynConstraints[9]).booleanValue() , ((Number) dynConstraints[10]).shortValue() , ((Number) dynConstraints[11]).shortValue() );
            case 1 :
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H005A2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H005A3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
                           ...
                           Object[] buf ) throws SQLException
   {
      switch ( cursor )
      {
            case 0 :
               ...
               ((String[]) buf[8])[0] = rslt.getBLOBFile(6, rslt.getVarchar(2), rslt.getVarchar(1));
