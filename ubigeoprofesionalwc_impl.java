...
public final  class ubigeoprofesionalwc_impl extends GXWebComponent
{
   public ubigeoprofesionalwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public ubigeoprofesionalwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( ubigeoprofesionalwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8UbigeoCode = httpContext.GetPar( "UbigeoCode") ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8UbigeoCode", AV8UbigeoCode);
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,AV8UbigeoCode});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8UbigeoCode, AV20ManageFiltersExecutionStep, AV34Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, AV30IsAuthorized_PaisDescripcion, A44UbigeoCode, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Ubigeo Profesional WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511033487", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.ubigeoprofesionalwc", new String[] {GXutil.URLEncode(GXutil.rtrim(AV8UbigeoCode))}, new String[] {"UbigeoCode"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      forbiddenHiddens.add("hshsalt", sPrefix+"hsh"+"UbigeoProfesionalWC");
      forbiddenHiddens.add("UbigeoCode", GXutil.rtrim( localUtil.format( A44UbigeoCode, "")));
      ...
      GXutil.writeLogInfo("ubigeoprofesionalwc:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8UbigeoCode", GXutil.rtrim( wcpOAV8UbigeoCode));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vUBIGEOCODE", GXutil.rtrim( AV8UbigeoCode));
   ...
   public void renderHtmlCloseForm7M2( )
   {
   ...
   public void wb7M0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.ubigeoprofesionalwc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         StyleString = "" ;
         com.projectthani.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 37, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 7, "Agregar", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e117m1_client"+"'", TempTags, "", 2, "HLP_UbigeoProfesionalWC.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_7M2( true) ;
      }
      else
      {
         wb_table1_22_7M2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_7M2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtUbigeoCode_Internalname, GXutil.rtrim( A44UbigeoCode), GXutil.rtrim( localUtil.format( A44UbigeoCode, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtUbigeoCode_Jsonclick, 0, "Attribute", "", "", "", "", edtUbigeoCode_Visible, 0, 0, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_UbigeoProfesionalWC.htm");
         /* User Defined Control */
   ...
   public void start7M2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Ubigeo Profesional WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV34Pgmname = "UbigeoProfesionalWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf7M2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.STRING
                                              }
         });
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H007M2 */
         pr_default.execute(0, new Object[] {AV8UbigeoCode, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A44UbigeoCode = H007M2_A44UbigeoCode[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A44UbigeoCode", A44UbigeoCode);
            A6SecUserId = H007M2_A6SecUserId[0] ;
            A194ProfesionalTelefono = H007M2_A194ProfesionalTelefono[0] ;
            A193ProfesionalLinkedin = H007M2_A193ProfesionalLinkedin[0] ;
            A192ProfesionalInstagram = H007M2_A192ProfesionalInstagram[0] ;
            A191ProfesionalFacebook = H007M2_A191ProfesionalFacebook[0] ;
            A190ProfesionalTwitter = H007M2_A190ProfesionalTwitter[0] ;
            A189ProfesionalFoto = H007M2_A189ProfesionalFoto[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtProfesionalFoto_Internalname, "Bitmap", ((GXutil.strcmp("", A189ProfesionalFoto)==0) ? A40000ProfesionalFoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A189ProfesionalFoto))), !bGXsfl_37_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtProfesionalFoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A189ProfesionalFoto), true);
            A40000ProfesionalFoto_GXI = H007M2_A40000ProfesionalFoto_GXI[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtProfesionalFoto_Internalname, "Bitmap", ((GXutil.strcmp("", A189ProfesionalFoto)==0) ? A40000ProfesionalFoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A189ProfesionalFoto))), !bGXsfl_37_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtProfesionalFoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A189ProfesionalFoto), true);
            A184PaisDescripcion = H007M2_A184PaisDescripcion[0] ;
            A43PaisId = H007M2_A43PaisId[0] ;
            A183ProfesionalDireccion = H007M2_A183ProfesionalDireccion[0] ;
            A182ProfesionalTiempoCita = H007M2_A182ProfesionalTiempoCita[0] ;
            A181ProfesionalColorCita = H007M2_A181ProfesionalColorCita[0] ;
            A180ProfesionalColorDisponible = H007M2_A180ProfesionalColorDisponible[0] ;
            A88ProfesionalCOP = H007M2_A88ProfesionalCOP[0] ;
            A179ProfesionalCorreo = H007M2_A179ProfesionalCorreo[0] ;
            A178ProfesionalDescripcion = H007M2_A178ProfesionalDescripcion[0] ;
            A177ProfesionalSexo = H007M2_A177ProfesionalSexo[0] ;
            A176ProfesionalFechaNacimiento = H007M2_A176ProfesionalFechaNacimiento[0] ;
            A174ProfesionalNroDocumento = H007M2_A174ProfesionalNroDocumento[0] ;
            A173ProfesionalTipoDocumento = H007M2_A173ProfesionalTipoDocumento[0] ;
            A31ProfesionalId = H007M2_A31ProfesionalId[0] ;
            A84ProfesionalNombres = H007M2_A84ProfesionalNombres[0] ;
            A86ProfesionalApellidoMaterno = H007M2_A86ProfesionalApellidoMaterno[0] ;
            A85ProfesionalApellidoPaterno = H007M2_A85ProfesionalApellidoPaterno[0] ;
            A184PaisDescripcion = H007M2_A184PaisDescripcion[0] ;
   ...
   public void send_integrity_lvl_hashes7M2( )
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV34Pgmname));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV34Pgmname, ""))));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_UPDATE", AV27IsAuthorized_Update);
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H007M3 */
      pr_default.execute(1, new Object[] {AV8UbigeoCode, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void strup7M0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8UbigeoCode = httpContext.cgiGet( sPrefix+"wcpOAV8UbigeoCode") ;
         AV8UbigeoCode = httpContext.cgiGet( sPrefix+"vUBIGEOCODE") ;
         ...
         {
            GXutil.writeLogError("ubigeoprofesionalwc:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e167M2( )
   {
      ...
      ubigeoprofesionalwc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtUbigeoCode_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtUbigeoCode_Visible), 5, 0), true);
   ...
   public void e127M2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("UbigeoProfesionalWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV34Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("UbigeoProfesionalWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "UbigeoProfesionalWCFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         ubigeoprofesionalwc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S152( )
   {
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWUbigeo_Update", GXv_boolean2) ;
      ubigeoprofesionalwc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWUbigeo_Delete", GXv_boolean2) ;
      ubigeoprofesionalwc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWUbigeo_Insert", GXv_boolean2) ;
      ubigeoprofesionalwc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "UbigeoProfesionalWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Ubigeo" );
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "UbigeoCode" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( AV8UbigeoCode );
   ...
   public void wb_table1_22_7M2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_7M2( true) ;
      }
      else
      {
         wb_table2_27_7M2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_7M2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_7M2e( true) ;
      }
      else
      {
         wb_table1_22_7M2e( false) ;
      }
   }

   public void wb_table2_27_7M2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8UbigeoCode = (String)getParm(obj,0,TypeConstants.STRING) ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8UbigeoCode", AV8UbigeoCode);
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8UbigeoCode = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "ubigeoprofesionalwc", GetJustCreated( ));
      ...
      {
         AV8UbigeoCode = (String)getParm(obj,2,TypeConstants.STRING) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8UbigeoCode", AV8UbigeoCode);
      }
      wcpOAV8UbigeoCode = httpContext.cgiGet( sPrefix+"wcpOAV8UbigeoCode") ;
      if ( ! GetJustCreated( ) && ( ( GXutil.strcmp(AV8UbigeoCode, wcpOAV8UbigeoCode) != 0 ) ) )
      {
         setjustcreated();
      }
      wcpOAV8UbigeoCode = AV8UbigeoCode ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8UbigeoCode = httpContext.cgiGet( sPrefix+"AV8UbigeoCode_CTRL") ;
      if ( GXutil.len( sCtrlAV8UbigeoCode) > 0 )
      {
         AV8UbigeoCode = httpContext.cgiGet( sCtrlAV8UbigeoCode) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8UbigeoCode", AV8UbigeoCode);
      }
      else
      {
         AV8UbigeoCode = httpContext.cgiGet( sPrefix+"AV8UbigeoCode_PARM") ;
      }
   }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8UbigeoCode_PARM", GXutil.rtrim( AV8UbigeoCode));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8UbigeoCode)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8UbigeoCode_CTRL", GXutil.rtrim( sCtrlAV8UbigeoCode));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511033796", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("ubigeoprofesionalwc.js", "?2022511033797", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8UbigeoCode',fld:'vUBIGEOCODE',pic:''},{av:'sPrefix'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV34Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_PaisDescripcion',fld:'vISAUTHORIZED_PAISDESCRIPCION',pic:'',hsh:true},{av:'A44UbigeoCode',fld:'UBIGEOCODE',pic:''}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e137M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8UbigeoCode',fld:'vUBIGEOCODE',pic:''},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV34Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_PaisDescripcion',fld:'vISAUTHORIZED_PAISDESCRIPCION',pic:'',hsh:true},{av:'A44UbigeoCode',fld:'UBIGEOCODE',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e147M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8UbigeoCode',fld:'vUBIGEOCODE',pic:''},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV34Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_PaisDescripcion',fld:'vISAUTHORIZED_PAISDESCRIPCION',pic:'',hsh:true},{av:'A44UbigeoCode',fld:'UBIGEOCODE',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e157M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8UbigeoCode',fld:'vUBIGEOCODE',pic:''},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV34Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_PaisDescripcion',fld:'vISAUTHORIZED_PAISDESCRIPCION',pic:'',hsh:true},{av:'A44UbigeoCode',fld:'UBIGEOCODE',pic:''},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e187M2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A44UbigeoCode',fld:'UBIGEOCODE',pic:''},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_PaisDescripcion',fld:'vISAUTHORIZED_PAISDESCRIPCION',pic:'',hsh:true},{av:'A43PaisId',fld:'PAISID',pic:'ZZZ9'},{av:'A190ProfesionalTwitter',fld:'PROFESIONALTWITTER',pic:''},{av:'A191ProfesionalFacebook',fld:'PROFESIONALFACEBOOK',pic:''},{av:'A192ProfesionalInstagram',fld:'PROFESIONALINSTAGRAM',pic:''},{av:'A193ProfesionalLinkedin',fld:'PROFESIONALLINKEDIN',pic:''}]");
      ...
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e127M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8UbigeoCode',fld:'vUBIGEOCODE',pic:''},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV34Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_PaisDescripcion',fld:'vISAUTHORIZED_PAISDESCRIPCION',pic:'',hsh:true},{av:'A44UbigeoCode',fld:'UBIGEOCODE',pic:''},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e117M1',iparms:[{av:'AV8UbigeoCode',fld:'vUBIGEOCODE',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H007M2_A44UbigeoCode = new String[] {""} ;
      H007M2_A6SecUserId = new short[1] ;
      H007M2_A194ProfesionalTelefono = new String[] {""} ;
      H007M2_A193ProfesionalLinkedin = new String[] {""} ;
      H007M2_A192ProfesionalInstagram = new String[] {""} ;
      H007M2_A191ProfesionalFacebook = new String[] {""} ;
      H007M2_A190ProfesionalTwitter = new String[] {""} ;
      H007M2_A189ProfesionalFoto = new String[] {""} ;
      H007M2_A40000ProfesionalFoto_GXI = new String[] {""} ;
      H007M2_A184PaisDescripcion = new String[] {""} ;
      H007M2_A43PaisId = new short[1] ;
      H007M2_A183ProfesionalDireccion = new String[] {""} ;
      H007M2_A182ProfesionalTiempoCita = new byte[1] ;
      H007M2_A181ProfesionalColorCita = new String[] {""} ;
      H007M2_A180ProfesionalColorDisponible = new String[] {""} ;
      H007M2_A88ProfesionalCOP = new String[] {""} ;
      H007M2_A179ProfesionalCorreo = new String[] {""} ;
      H007M2_A178ProfesionalDescripcion = new String[] {""} ;
      H007M2_A177ProfesionalSexo = new String[] {""} ;
      H007M2_A176ProfesionalFechaNacimiento = new java.util.Date[] {GXutil.nullDate()} ;
      H007M2_A174ProfesionalNroDocumento = new String[] {""} ;
      H007M2_A173ProfesionalTipoDocumento = new String[] {""} ;
      H007M2_A31ProfesionalId = new int[1] ;
      H007M2_A84ProfesionalNombres = new String[] {""} ;
      H007M2_A86ProfesionalApellidoMaterno = new String[] {""} ;
      H007M2_A85ProfesionalApellidoPaterno = new String[] {""} ;
      ...
      sImgUrl = "" ;
      gxphoneLink = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.ubigeoprofesionalwc__default(),
         new Object[] {
             new Object[] {
            H007M2_A44UbigeoCode, H007M2_A6SecUserId, H007M2_A194ProfesionalTelefono, H007M2_A193ProfesionalLinkedin, H007M2_A192ProfesionalInstagram, H007M2_A191ProfesionalFacebook, H007M2_A190ProfesionalTwitter, H007M2_A189ProfesionalFoto, H007M2_A40000ProfesionalFoto_GXI, H007M2_A184PaisDescripcion,
            H007M2_A43PaisId, H007M2_A183ProfesionalDireccion, H007M2_A182ProfesionalTiempoCita, H007M2_A181ProfesionalColorCita, H007M2_A180ProfesionalColorDisponible, H007M2_A88ProfesionalCOP, H007M2_A179ProfesionalCorreo, H007M2_A178ProfesionalDescripcion, H007M2_A177ProfesionalSexo, H007M2_A176ProfesionalFechaNacimiento,
            H007M2_A174ProfesionalNroDocumento, H007M2_A173ProfesionalTipoDocumento, H007M2_A31ProfesionalId, H007M2_A84ProfesionalNombres, H007M2_A86ProfesionalApellidoMaterno, H007M2_A85ProfesionalApellidoPaterno
            }
            , new Object[] {
   ...
   private String wcpOAV8UbigeoCode ;
   ...
   private String sCtrlAV8UbigeoCode ;
   ...
   private String[] H007M2_A44UbigeoCode ;
   private short[] H007M2_A6SecUserId ;
   private String[] H007M2_A194ProfesionalTelefono ;
   private String[] H007M2_A193ProfesionalLinkedin ;
   private String[] H007M2_A192ProfesionalInstagram ;
   private String[] H007M2_A191ProfesionalFacebook ;
   private String[] H007M2_A190ProfesionalTwitter ;
   private String[] H007M2_A189ProfesionalFoto ;
   private String[] H007M2_A40000ProfesionalFoto_GXI ;
   private String[] H007M2_A184PaisDescripcion ;
   private short[] H007M2_A43PaisId ;
   private String[] H007M2_A183ProfesionalDireccion ;
   private byte[] H007M2_A182ProfesionalTiempoCita ;
   private String[] H007M2_A181ProfesionalColorCita ;
   private String[] H007M2_A180ProfesionalColorDisponible ;
   private String[] H007M2_A88ProfesionalCOP ;
   private String[] H007M2_A179ProfesionalCorreo ;
   private String[] H007M2_A178ProfesionalDescripcion ;
   private String[] H007M2_A177ProfesionalSexo ;
   private java.util.Date[] H007M2_A176ProfesionalFechaNacimiento ;
   private String[] H007M2_A174ProfesionalNroDocumento ;
   private String[] H007M2_A173ProfesionalTipoDocumento ;
   private int[] H007M2_A31ProfesionalId ;
   private String[] H007M2_A84ProfesionalNombres ;
   private String[] H007M2_A86ProfesionalApellidoMaterno ;
   private String[] H007M2_A85ProfesionalApellidoPaterno ;
...
final  class ubigeoprofesionalwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          String A44UbigeoCode )
   {
      ...
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalTipoDocumento]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalTipoDocumento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalNroDocumento]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalNroDocumento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalApellidoPaterno]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalApellidoPaterno] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalApellidoMaterno]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalApellidoMaterno] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalNombres]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalNombres] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalFechaNacimiento]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalFechaNacimiento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalSexo]" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalSexo] DESC" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalDescripcion]" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalDescripcion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalCorreo]" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalCorreo] DESC" ;
      }
      else if ( ( AV14OrderedBy == 11 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalCOP]" ;
      }
      else if ( ( AV14OrderedBy == 11 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalCOP] DESC" ;
      }
      else if ( ( AV14OrderedBy == 12 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalColorDisponible]" ;
      }
      else if ( ( AV14OrderedBy == 12 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalColorDisponible] DESC" ;
      }
      else if ( ( AV14OrderedBy == 13 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalColorCita]" ;
      }
      else if ( ( AV14OrderedBy == 13 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalColorCita] DESC" ;
      }
      else if ( ( AV14OrderedBy == 14 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalTiempoCita]" ;
      }
      else if ( ( AV14OrderedBy == 14 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalTiempoCita] DESC" ;
      }
      else if ( ( AV14OrderedBy == 15 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalDireccion]" ;
      }
      else if ( ( AV14OrderedBy == 15 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalDireccion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 16 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[PaisId]" ;
      }
      else if ( ( AV14OrderedBy == 16 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[PaisId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 17 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T2.[PaisDescripcion]" ;
      }
      else if ( ( AV14OrderedBy == 17 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T2.[PaisDescripcion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 18 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalTwitter]" ;
      }
      else if ( ( AV14OrderedBy == 18 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalTwitter] DESC" ;
      }
      else if ( ( AV14OrderedBy == 19 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalFacebook]" ;
      }
      else if ( ( AV14OrderedBy == 19 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalFacebook] DESC" ;
      }
      else if ( ( AV14OrderedBy == 20 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalInstagram]" ;
      }
      else if ( ( AV14OrderedBy == 20 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalInstagram] DESC" ;
      }
      else if ( ( AV14OrderedBy == 21 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalLinkedin]" ;
      }
      else if ( ( AV14OrderedBy == 21 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalLinkedin] DESC" ;
      }
      else if ( ( AV14OrderedBy == 22 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ProfesionalTelefono]" ;
      }
      else if ( ( AV14OrderedBy == 22 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ProfesionalTelefono] DESC" ;
      }
      else if ( ( AV14OrderedBy == 23 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[SecUserId]" ;
      }
      else if ( ( AV14OrderedBy == 23 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[SecUserId] DESC" ;
      }
      else if ( true )
      {
                                          ...
                                          String A44UbigeoCode )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([Profesional] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisId])" ;
      addWhere(sWhereString, "(T1.[UbigeoCode] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST(T1.[ProfesionalId] AS decimal(8,0))) like '%' + ?) or ( 'dni' like '%' + LOWER(?) and T1.[ProfesionalTipoDocumento] = '1') or ( 'ruc' like '%' + LOWER(?) and T1.[ProfesionalTipoDocumento] = '6') or ( 'libreta electoral' like '%' + LOWER(?) and T1.[ProfesionalTipoDocumento] = '2') or ( 'carnet de extranjeria' like '%' + LOWER(?) and T1.[ProfesionalTipoDocumento] = '4') or ( 'pasaporte' like '%' + LOWER(?) and T1.[ProfesionalTipoDocumento] = '7') or ( 'sin documento' like '%' + LOWER(?) and T1.[ProfesionalTipoDocumento] = '0') or ( T1.[ProfesionalNroDocumento] like '%' + ?) or ( T1.[ProfesionalApellidoPaterno] like '%' + ?) or ( T1.[ProfesionalApellidoMaterno] like '%' + ?) or ( T1.[ProfesionalNombres] like '%' + ?) or ( T1.[ProfesionalApellidoPaterno] + ' ' + T1.[ProfesionalApellidoMaterno] + ', ' + T1.[ProfesionalNombres] like '%' + ?) or ( 'masculino' like '%' + LOWER(?) and T1.[ProfesionalSexo] = 'M') or ( 'femenino' like '%' + LOWER(?) and T1.[ProfesionalSexo] = 'F') or ( T1.[ProfesionalDescripcion] like '%' + ?) or ( T1.[ProfesionalCorreo] like '%' + ?) or ( T1.[ProfesionalCOP] like '%' + ?) or ( T1.[ProfesionalColorDisponible] like '%' + ?) or ( T1.[ProfesionalColorCita] like '%' + ?) or ( '30 minutos' like '%' + LOWER(?) and T1.[ProfesionalTiempoCita] = 30) or ( '1 hora' like '%' + LOWER(?) and T1.[ProfesionalTiempoCita] = 60) or ( T1.[ProfesionalDireccion] like '%' + ?) or ( CONVERT( char(4), CAST(T1.[PaisId] AS decimal(4,0))) like '%' + ?) or ( T2.[PaisDescripcion] like '%' + ?) or ( T1.[ProfesionalTwitter] like '%' + ?) or ( T1.[ProfesionalFacebook] like '%' + ?) or ( T1.[ProfesionalInstagram] like '%' + ?) or ( T1.[ProfesionalLinkedin] like '%' + ?) or ( T1.[ProfesionalTelefono] like '%' + ?) or ( CONVERT( char(4), CAST(T1.[SecUserId] AS decimal(4,0))) like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H007M2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (String)dynConstraints[8] , (String)dynConstraints[9] , (String)dynConstraints[10] , (String)dynConstraints[11] , (String)dynConstraints[12] , ((Number) dynConstraints[13]).byteValue() , (String)dynConstraints[14] , ((Number) dynConstraints[15]).shortValue() , (String)dynConstraints[16] , (String)dynConstraints[17] , (String)dynConstraints[18] , (String)dynConstraints[19] , (String)dynConstraints[20] , (String)dynConstraints[21] , ((Number) dynConstraints[22]).shortValue() , ((Number) dynConstraints[23]).shortValue() , ((Boolean) dynConstraints[24]).booleanValue() , (String)dynConstraints[25] , (String)dynConstraints[26] );
            case 1 :
                  return conditional_H007M3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (String)dynConstraints[8] , (String)dynConstraints[9] , (String)dynConstraints[10] , (String)dynConstraints[11] , (String)dynConstraints[12] , ((Number) dynConstraints[13]).byteValue() , (String)dynConstraints[14] , ((Number) dynConstraints[15]).shortValue() , (String)dynConstraints[16] , (String)dynConstraints[17] , (String)dynConstraints[18] , (String)dynConstraints[19] , (String)dynConstraints[20] , (String)dynConstraints[21] , ((Number) dynConstraints[22]).shortValue() , ((Number) dynConstraints[23]).shortValue() , ((Boolean) dynConstraints[24]).booleanValue() , (String)dynConstraints[25] , (String)dynConstraints[26] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H007M2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H007M3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
