...
public final  class paiswwgetfilterdata_services_rest extends GxRestService
{
   ...
   public javax.ws.rs.core.Response execute( com.projectthani.paiswwgetfilterdata_RESTInterfaceIN entity ) throws Exception
   {
      super.init( "POST" );
      String AV19DDOName;
      ...
      try
      {
         com.projectthani.paiswwgetfilterdata worker = new com.projectthani.paiswwgetfilterdata(remoteHandle, context);
         worker.execute(AV19DDOName,AV17SearchTxt,AV18SearchTxtTo,AV23OptionsJson,AV26OptionsDescJson,AV28OptionIndexesJson );
         com.projectthani.paiswwgetfilterdata_RESTInterfaceOUT data = new com.projectthani.paiswwgetfilterdata_RESTInterfaceOUT();
