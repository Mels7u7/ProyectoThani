...
public final  class pacientepacientefamiliar1wc_impl extends GXWebComponent
{
   public pacientepacientefamiliar1wc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public pacientepacientefamiliar1wc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( pacientepacientefamiliar1wc_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = httpContext.GetFirstPar( "SGPacienteHijoPacienteId") ;
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8SGPacienteHijoPacienteId = (int)(GXutil.lval( httpContext.GetPar( "SGPacienteHijoPacienteId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8SGPacienteHijoPacienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8SGPacienteHijoPacienteId), 8, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Integer.valueOf(AV8SGPacienteHijoPacienteId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8SGPacienteHijoPacienteId, AV20ManageFiltersExecutionStep, AV33Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Paciente Paciente Familiar1 WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110325422", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.pacientepacientefamiliar1wc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8SGPacienteHijoPacienteId,8,0))}, new String[] {"SGPacienteHijoPacienteId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8SGPacienteHijoPacienteId", GXutil.ltrim( localUtil.ntoc( wcpOAV8SGPacienteHijoPacienteId, (byte)(8), (byte)(0), ",", "")));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSGPACIENTEHIJOPACIENTEID", GXutil.ltrim( localUtil.ntoc( AV8SGPacienteHijoPacienteId, (byte)(8), (byte)(0), ",", "")));
   ...
   {
      return "PacientePacienteFamiliar1WC" ;
   }
   ...
   public void wb550( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.pacientepacientefamiliar1wc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_552( true) ;
      }
      else
      {
         wb_table1_22_552( false) ;
      }
      return  ;
   }

   public void wb_table1_22_552e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start552( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Paciente Paciente Familiar1 WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 int AV8SGPacienteHijoPacienteId ,
   ...
   {
      /* GeneXus formulas. */
      AV33Pgmname = "PacientePacienteFamiliar1WC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf552( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Integer.valueOf(AV8SGPacienteHijoPacienteId) ,
                                              Integer.valueOf(A46SGPacienteHijoPacienteId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.INT, TypeConstants.INT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.INT
                                              }
         });
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H00552 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV8SGPacienteHijoPacienteId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A46SGPacienteHijoPacienteId = H00552_A46SGPacienteHijoPacienteId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A46SGPacienteHijoPacienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A46SGPacienteHijoPacienteId), 8, 0));
            A236PacienteFamiliarEstado = H00552_A236PacienteFamiliarEstado[0] ;
            A235PacienteFamiliarParentesco = H00552_A235PacienteFamiliarParentesco[0] ;
            A20PacienteId = H00552_A20PacienteId[0] ;
            A45PacienteFamiliarId = H00552_A45PacienteFamiliarId[0] ;
            e18552 ();
   ...
   public void send_integrity_lvl_hashes552( )
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV33Pgmname));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV33Pgmname, ""))));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_UPDATE", AV27IsAuthorized_Update);
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H00553 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV8SGPacienteHijoPacienteId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void strup550( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8SGPacienteHijoPacienteId = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8SGPacienteHijoPacienteId"), ",", ".")) ;
   ...
   public void e16552( )
   {
      ...
      edtSGPacienteHijoPacienteId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtSGPacienteHijoPacienteId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtSGPacienteHijoPacienteId_Visible), 5, 0), true);
   ...
   public void e11552( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("PacientePacienteFamiliar1WCFilters")),GXutil.URLEncode(GXutil.rtrim(AV33Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("PacientePacienteFamiliar1WCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "PacientePacienteFamiliar1WCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         pacientepacientefamiliar1wc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      pacientepacientefamiliar1wc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "PacientePacienteFamiliar1WCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "SGPacienteHijoPacienteId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8SGPacienteHijoPacienteId, 8, 0) );
   ...
   public void wb_table1_22_552( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_552( true) ;
      }
      else
      {
         wb_table2_27_552( false) ;
      }
      return  ;
   }

   public void wb_table2_27_552e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_552e( true) ;
      }
      else
      {
         wb_table1_22_552e( false) ;
      }
   }

   public void wb_table2_27_552( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8SGPacienteHijoPacienteId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.INT), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8SGPacienteHijoPacienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8SGPacienteHijoPacienteId), 8, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8SGPacienteHijoPacienteId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "pacientepacientefamiliar1wc", GetJustCreated( ));
      ...
      {
         AV8SGPacienteHijoPacienteId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.INT), TypeConstants.INT)).intValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8SGPacienteHijoPacienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8SGPacienteHijoPacienteId), 8, 0));
      }
      wcpOAV8SGPacienteHijoPacienteId = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8SGPacienteHijoPacienteId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV8SGPacienteHijoPacienteId != wcpOAV8SGPacienteHijoPacienteId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8SGPacienteHijoPacienteId = AV8SGPacienteHijoPacienteId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8SGPacienteHijoPacienteId = httpContext.cgiGet( sPrefix+"AV8SGPacienteHijoPacienteId_CTRL") ;
      if ( GXutil.len( sCtrlAV8SGPacienteHijoPacienteId) > 0 )
      {
         AV8SGPacienteHijoPacienteId = (int)(localUtil.ctol( httpContext.cgiGet( sCtrlAV8SGPacienteHijoPacienteId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8SGPacienteHijoPacienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8SGPacienteHijoPacienteId), 8, 0));
      }
      else
      {
         AV8SGPacienteHijoPacienteId = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8SGPacienteHijoPacienteId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8SGPacienteHijoPacienteId_PARM", GXutil.ltrim( localUtil.ntoc( AV8SGPacienteHijoPacienteId, (byte)(8), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8SGPacienteHijoPacienteId)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8SGPacienteHijoPacienteId_CTRL", GXutil.rtrim( sCtrlAV8SGPacienteHijoPacienteId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110325595", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("pacientepacientefamiliar1wc.js", "?20225110325595", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      edtSGPacienteHijoPacienteId_Visible = 1 ;
      ...
      Ddo_grid_Columnids = "2:PacienteFamiliarId|3:PacienteId|4:PacienteFamiliarParentesco|5:PacienteFamiliarEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e18552',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A45PacienteFamiliarId',fld:'PACIENTEFAMILIARID',pic:'ZZZZZZZ9'},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e15552',iparms:[{av:'A45PacienteFamiliarId',fld:'PACIENTEFAMILIARID',pic:'ZZZZZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H00552_A46SGPacienteHijoPacienteId = new int[1] ;
      H00552_A236PacienteFamiliarEstado = new String[] {""} ;
      H00552_A235PacienteFamiliarParentesco = new String[] {""} ;
      H00552_A20PacienteId = new int[1] ;
      H00552_A45PacienteFamiliarId = new int[1] ;
      ...
      sCtrlAV8SGPacienteHijoPacienteId = "" ;
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.pacientepacientefamiliar1wc__default(),
         new Object[] {
             new Object[] {
            H00552_A46SGPacienteHijoPacienteId, H00552_A236PacienteFamiliarEstado, H00552_A235PacienteFamiliarParentesco, H00552_A20PacienteId, H00552_A45PacienteFamiliarId
            }
            , new Object[] {
   ...
   private int wcpOAV8SGPacienteHijoPacienteId ;
   private int subGrid_Rows ;
   private int Gridpaginationbar_Rowsperpageselectedvalue ;
   private int nRC_GXsfl_37 ;
   private int AV8SGPacienteHijoPacienteId ;
   ...
   private int edtSGPacienteHijoPacienteId_Visible ;
   ...
   private String sCtrlAV8SGPacienteHijoPacienteId ;
   ...
   private int[] H00552_A46SGPacienteHijoPacienteId ;
   private String[] H00552_A236PacienteFamiliarEstado ;
   private String[] H00552_A235PacienteFamiliarParentesco ;
   private int[] H00552_A20PacienteId ;
   private int[] H00552_A45PacienteFamiliarId ;
...
final  class pacientepacientefamiliar1wc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00552( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          int A46SGPacienteHijoPacienteId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [SGPacienteHijoPacienteId], [PacienteFamiliarEstado], [PacienteFamiliarParentesco], [PacienteId], [PacienteFamiliarId]" ;
      sFromString = " FROM [PacienteFamiliar]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([SGPacienteHijoPacienteId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([PacienteFamiliarId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(8), CAST([PacienteId] AS decimal(8,0))) like '%' + ?) or ( 'hijo(a)' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'H') or ( 'padre' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'P') or ( 'madre' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'M') or ( 'hermano(a)' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'HM') or ( 'sobrino(a)' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'S') or ( 'tio(a)' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'T') or ( 'abuelo(a)' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'A') or ( 'nieto(a)' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'N') or ( 'otro' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'O') or ( 'activo' like '%' + LOWER(?) and [PacienteFamiliarEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and [PacienteFamiliarEstado] = 'I'))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [SGPacienteHijoPacienteId], [PacienteFamiliarId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacienteHijoPacienteId] DESC, [PacienteFamiliarId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacienteHijoPacienteId], [PacienteId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacienteHijoPacienteId] DESC, [PacienteId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacienteHijoPacienteId], [PacienteFamiliarParentesco]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacienteHijoPacienteId] DESC, [PacienteFamiliarParentesco] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacienteHijoPacienteId], [PacienteFamiliarEstado]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacienteHijoPacienteId] DESC, [PacienteFamiliarEstado] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [PacienteFamiliarId]" ;
      }
   ...
   protected Object[] conditional_H00553( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A45PacienteFamiliarId ,
                                          ...
                                          int A46SGPacienteHijoPacienteId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [PacienteFamiliar]" ;
      addWhere(sWhereString, "([SGPacienteHijoPacienteId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([PacienteFamiliarId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(8), CAST([PacienteId] AS decimal(8,0))) like '%' + ?) or ( 'hijo(a)' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'H') or ( 'padre' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'P') or ( 'madre' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'M') or ( 'hermano(a)' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'HM') or ( 'sobrino(a)' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'S') or ( 'tio(a)' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'T') or ( 'abuelo(a)' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'A') or ( 'nieto(a)' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'N') or ( 'otro' like '%' + LOWER(?) and [PacienteFamiliarParentesco] = 'O') or ( 'activo' like '%' + LOWER(?) and [PacienteFamiliarEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and [PacienteFamiliarEstado] = 'I'))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00552(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() , ((Number) dynConstraints[7]).intValue() , ((Number) dynConstraints[8]).intValue() );
            case 1 :
                  return conditional_H00553(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() , ((Number) dynConstraints[7]).intValue() , ((Number) dynConstraints[8]).intValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00552", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00553", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
