...
public final  class sedeconfcomisionwc_impl extends GXWebComponent
{
   public sedeconfcomisionwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public sedeconfcomisionwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( sedeconfcomisionwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8SedeId, AV20ManageFiltersExecutionStep, AV33Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Sede Conf Comision WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110323745", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.sedeconfcomisionwc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8SedeId,4,0))}, new String[] {"SedeId"}) +"\">") ;
   ...
   public void wb5G0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.sedeconfcomisionwc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void wb_table1_22_5G2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeValue( "Comision Id") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            ...
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Porcentaje") ;
            httpContext.writeTextNL( "</th>") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A29ConfComisionId, (byte)(4), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.format(A123FechaDesde, "99/99/99"));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.format(A124FechaHasta, "99/99/99"));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A125Porcentaje, (byte)(4), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.rtrim( A126Estado));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtSedeId_Internalname, GXutil.ltrim( localUtil.ntoc( A30SedeId, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A30SedeId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSedeId_Jsonclick, 0, "Attribute", "", "", "", "", edtSedeId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id4", "right", false, "", "HLP_SedeConfComisionWC.htm");
         /* User Defined Control */
   ...
   public void start5G2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Sede Conf Comision WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           A123FechaDesde = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtFechaDesde_Internalname), 0)) ;
                           A124FechaHasta = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtFechaHasta_Internalname), 0)) ;
                           A125Porcentaje = (short)(localUtil.ctol( httpContext.cgiGet( edtPorcentaje_Internalname), ",", ".")) ;
                           cmbEstado.setName( cmbEstado.getInternalname() );
   ...
   {
      /* GeneXus formulas. */
      AV33Pgmname = "SedeConfComisionWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf5G2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT
                                              }
         });
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H005G2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8SedeId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A30SedeId = H005G2_A30SedeId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A30SedeId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A30SedeId), 4, 0));
            A126Estado = H005G2_A126Estado[0] ;
            A125Porcentaje = H005G2_A125Porcentaje[0] ;
            A124FechaHasta = H005G2_A124FechaHasta[0] ;
            A123FechaDesde = H005G2_A123FechaDesde[0] ;
            A32EspecialidadId = H005G2_A32EspecialidadId[0] ;
            A31ProfesionalId = H005G2_A31ProfesionalId[0] ;
            A29ConfComisionId = H005G2_A29ConfComisionId[0] ;
            e185G2 ();
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H005G3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8SedeId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   private void e185G2( )
   {
      ...
      {
         edtavUpdate_Link = formatLink("com.projectthani.confcomision", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A29ConfComisionId,4,0))}, new String[] {})  ;
      }
      AV28Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDelete_Internalname, AV28Delete);
      if ( AV29IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.projectthani.confcomision", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A29ConfComisionId,4,0))}, new String[] {})  ;
      }
      /* Load Method */
      if ( wbStart != -1 )
      {
   ...
   public void e115G2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("SedeConfComisionWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV33Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("SedeConfComisionWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "SedeConfComisionWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         sedeconfcomisionwc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e155G2( )
   {
      /* 'DoInsert' Routine */
      returnInSub = false ;
      callWebObject(formatLink("com.projectthani.confcomision", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {}) );
   ...
   public void S152( )
   {
      ...
      new com.projectthani.wwpbaseobjects.secisauthbyobjectname(remoteHandle, context).execute( "ConfComision", GXv_boolean7) ;
      sedeconfcomisionwc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "SedeConfComisionWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "ConfComision" );
   ...
   public void wb_table1_22_5G2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void wb_table2_27_5G2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table2_27_5G2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "sedeconfcomisionwc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110323930", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("sedeconfcomisionwc.js", "?20225110323930", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtConfComisionId_Internalname = sPrefix+"CONFCOMISIONID_"+sGXsfl_37_idx ;
      ...
      edtFechaDesde_Internalname = sPrefix+"FECHADESDE_"+sGXsfl_37_idx ;
      edtFechaHasta_Internalname = sPrefix+"FECHAHASTA_"+sGXsfl_37_idx ;
      edtPorcentaje_Internalname = sPrefix+"PORCENTAJE_"+sGXsfl_37_idx ;
      cmbEstado.setInternalname( sPrefix+"ESTADO_"+sGXsfl_37_idx );
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtConfComisionId_Internalname = sPrefix+"CONFCOMISIONID_"+sGXsfl_37_fel_idx ;
      ...
      edtFechaDesde_Internalname = sPrefix+"FECHADESDE_"+sGXsfl_37_fel_idx ;
      edtFechaHasta_Internalname = sPrefix+"FECHAHASTA_"+sGXsfl_37_fel_idx ;
      edtPorcentaje_Internalname = sPrefix+"PORCENTAJE_"+sGXsfl_37_fel_idx ;
      cmbEstado.setInternalname( sPrefix+"ESTADO_"+sGXsfl_37_fel_idx );
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtConfComisionId_Internalname,GXutil.ltrim( localUtil.ntoc( A29ConfComisionId, (byte)(4), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A29ConfComisionId), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtConfComisionId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id4","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtFechaDesde_Internalname,localUtil.format(A123FechaDesde, "99/99/99"),localUtil.format( A123FechaDesde, "99/99/99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtFechaDesde_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtFechaHasta_Internalname,localUtil.format(A124FechaHasta, "99/99/99"),localUtil.format( A124FechaHasta, "99/99/99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtFechaHasta_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPorcentaje_Internalname,GXutil.ltrim( localUtil.ntoc( A125Porcentaje, (byte)(4), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A125Porcentaje), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtPorcentaje_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         }
         if ( ( cmbEstado.getItemCount() == 0 ) && isAjaxCallMode( ) )
         {
            GXCCtl = "ESTADO_" + sGXsfl_37_idx ;
            cmbEstado.setName( GXCCtl );
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbEstado,cmbEstado.getInternalname(),GXutil.rtrim( A126Estado),Integer.valueOf(1),cmbEstado.getJsonclick(),Integer.valueOf(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","char","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","Attribute","WWColumn hidden-xs","","","",Boolean.valueOf(true),Integer.valueOf(1)});
         cmbEstado.setValue( GXutil.rtrim( A126Estado) );
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbEstado.getInternalname(), "Values", cmbEstado.ToJavascriptSource(), !bGXsfl_37_Refreshing);
   ...
   public void init_default_properties( )
   {
      ...
      edtConfComisionId_Internalname = sPrefix+"CONFCOMISIONID" ;
      edtProfesionalId_Internalname = sPrefix+"PROFESIONALID" ;
      edtEspecialidadId_Internalname = sPrefix+"ESPECIALIDADID" ;
      edtFechaDesde_Internalname = sPrefix+"FECHADESDE" ;
      edtFechaHasta_Internalname = sPrefix+"FECHAHASTA" ;
      edtPorcentaje_Internalname = sPrefix+"PORCENTAJE" ;
      cmbEstado.setInternalname( sPrefix+"ESTADO" );
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:ConfComisionId|3:ProfesionalId|4:EspecialidadId|5:FechaDesde|6:FechaHasta|7:Porcentaje|8:Estado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e185G2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A29ConfComisionId',fld:'CONFCOMISIONID',pic:'ZZZ9'},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e155G2',iparms:[{av:'A29ConfComisionId',fld:'CONFCOMISIONID',pic:'ZZZ9'}]");
      setEventMetadata("'DOINSERT'",",oparms:[{av:'A29ConfComisionId',fld:'CONFCOMISIONID',pic:'ZZZ9'}]}");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H005G2_A30SedeId = new short[1] ;
      H005G2_A126Estado = new String[] {""} ;
      H005G2_A125Porcentaje = new short[1] ;
      H005G2_A124FechaHasta = new java.util.Date[] {GXutil.nullDate()} ;
      H005G2_A123FechaDesde = new java.util.Date[] {GXutil.nullDate()} ;
      H005G2_A32EspecialidadId = new short[1] ;
      H005G2_A31ProfesionalId = new int[1] ;
      H005G2_A29ConfComisionId = new short[1] ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.sedeconfcomisionwc__default(),
         new Object[] {
             new Object[] {
            H005G2_A30SedeId, H005G2_A126Estado, H005G2_A125Porcentaje, H005G2_A124FechaHasta, H005G2_A123FechaDesde, H005G2_A32EspecialidadId, H005G2_A31ProfesionalId, H005G2_A29ConfComisionId
            }
            , new Object[] {
   ...
   private short[] H005G2_A30SedeId ;
   private String[] H005G2_A126Estado ;
   private short[] H005G2_A125Porcentaje ;
   private java.util.Date[] H005G2_A124FechaHasta ;
   private java.util.Date[] H005G2_A123FechaDesde ;
   private short[] H005G2_A32EspecialidadId ;
   private int[] H005G2_A31ProfesionalId ;
   private short[] H005G2_A29ConfComisionId ;
...
final  class sedeconfcomisionwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H005G2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          short A29ConfComisionId ,
                                          int A31ProfesionalId ,
                                          short A32EspecialidadId ,
                                          short A125Porcentaje ,
                                          String A126Estado ,
                                          short AV14OrderedBy ,
                                          boolean AV15OrderedDsc ,
                                          short AV8SedeId ,
                                          short A30SedeId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [SedeId], [Estado], [Porcentaje], [FechaHasta], [FechaDesde], [EspecialidadId], [ProfesionalId], [ConfComisionId]" ;
      sFromString = " FROM [ConfComision]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([SedeId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([ConfComisionId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(8), CAST([ProfesionalId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(4), CAST([EspecialidadId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(4), CAST([Porcentaje] AS decimal(4,0))) like '%' + ?) or ( 'activo' like '%' + LOWER(?) and [Estado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and [Estado] = 'I'))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [SedeId], [ConfComisionId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SedeId] DESC, [ConfComisionId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SedeId], [ProfesionalId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SedeId] DESC, [ProfesionalId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SedeId], [EspecialidadId]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SedeId] DESC, [EspecialidadId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SedeId], [FechaDesde]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SedeId] DESC, [FechaDesde] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SedeId], [FechaHasta]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SedeId] DESC, [FechaHasta] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SedeId], [Porcentaje]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SedeId] DESC, [Porcentaje] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SedeId], [Estado]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SedeId] DESC, [Estado] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [ConfComisionId]" ;
      }
                                          ...
                                          short A30SedeId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [ConfComision]" ;
      addWhere(sWhereString, "([SedeId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([ConfComisionId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(8), CAST([ProfesionalId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(4), CAST([EspecialidadId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(4), CAST([Porcentaje] AS decimal(4,0))) like '%' + ?) or ( 'activo' like '%' + LOWER(?) and [Estado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and [Estado] = 'I'))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005G2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).shortValue() , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() , ((Number) dynConstraints[8]).shortValue() , ((Number) dynConstraints[9]).shortValue() );
            case 1 :
                  return conditional_H005G3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).shortValue() , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() , ((Number) dynConstraints[8]).shortValue() , ((Number) dynConstraints[9]).shortValue() );
      }
