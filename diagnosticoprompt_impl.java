...
public final  class diagnosticoprompt_impl extends GXDataArea
{
   public diagnosticoprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public diagnosticoprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( diagnosticoprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutDiagnosticoId") ;
         ...
         {
            AV8InOutDiagnosticoId = (int)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutDiagnosticoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutDiagnosticoId), 8, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutDiagnosticoCodigo = httpContext.GetPar( "InOutDiagnosticoCodigo") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutDiagnosticoCodigo", AV9InOutDiagnosticoCodigo);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110335280", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.diagnosticoprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutDiagnosticoId,8,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutDiagnosticoCodigo))}, new String[] {"InOutDiagnosticoId","InOutDiagnosticoCodigo"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTDIAGNOSTICOID", GXutil.ltrim( localUtil.ntoc( AV8InOutDiagnosticoId, (byte)(8), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTDIAGNOSTICOCODIGO", AV9InOutDiagnosticoCodigo);
   ...
   {
      return formatLink("com.projectthani.diagnosticoprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutDiagnosticoId,8,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutDiagnosticoCodigo))}, new String[] {"InOutDiagnosticoId","InOutDiagnosticoCodigo"})  ;
   }

   public String getPgmname( )
   {
      return "DiagnosticoPrompt" ;
   }
   ...
   public void wb5S0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_5S2( true) ;
      }
      else
      {
         wb_table1_12_5S2( false) ;
      }
      return  ;
   }

   public void wb_table1_12_5S2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start5S2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Diagnostico", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_DIAGNOSTICOCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A107DiagnosticoCodigo, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "DIAGNOSTICOCODIGO", A107DiagnosticoCodigo);
   }
   ...
   public void rf5S2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.INT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                              }
         });
         ...
         {
            A131DiagnosticoEstado = H005S2_A131DiagnosticoEstado[0] ;
            A130DiagnosticoTipoSexo = H005S2_A130DiagnosticoTipoSexo[0] ;
            A23DiagnosticoId = H005S2_A23DiagnosticoId[0] ;
            A108DiagnosticoDescripcion = H005S2_A108DiagnosticoDescripcion[0] ;
            A107DiagnosticoCodigo = H005S2_A107DiagnosticoCodigo[0] ;
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_DIAGNOSTICOID"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, localUtil.format( DecimalUtil.doubleToDec(A23DiagnosticoId), "ZZZZZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_DIAGNOSTICOCODIGO"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, GXutil.rtrim( localUtil.format( A107DiagnosticoCodigo, ""))));
   }
   ...
   public void e155S2( )
   {
      ...
      Form.setCaption( "Selecciona Diagnostico" );
   ...
   public void e185S2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutDiagnosticoId = A23DiagnosticoId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutDiagnosticoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutDiagnosticoId), 8, 0));
      AV9InOutDiagnosticoCodigo = A107DiagnosticoCodigo ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutDiagnosticoCodigo", AV9InOutDiagnosticoCodigo);
      httpContext.setWebReturnParms(new Object[] {Integer.valueOf(AV8InOutDiagnosticoId),AV9InOutDiagnosticoCodigo});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutDiagnosticoId","AV9InOutDiagnosticoCodigo"});
   ...
   public void wb_table1_12_5S2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_DiagnosticoPrompt.htm");
   ...
   {
      AV8InOutDiagnosticoId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutDiagnosticoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutDiagnosticoId), 8, 0));
      AV9InOutDiagnosticoCodigo = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutDiagnosticoCodigo", AV9InOutDiagnosticoCodigo);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110335360", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("diagnosticoprompt.js", "?20225110335360", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_242( )
   {
      ...
      edtDiagnosticoId_Internalname = "DIAGNOSTICOID_"+sGXsfl_24_idx ;
      edtDiagnosticoCodigo_Internalname = "DIAGNOSTICOCODIGO_"+sGXsfl_24_idx ;
      edtDiagnosticoDescripcion_Internalname = "DIAGNOSTICODESCRIPCION_"+sGXsfl_24_idx ;
      cmbDiagnosticoTipoSexo.setInternalname( "DIAGNOSTICOTIPOSEXO_"+sGXsfl_24_idx );
      cmbDiagnosticoEstado.setInternalname( "DIAGNOSTICOESTADO_"+sGXsfl_24_idx );
      edtDiagnosticoLongDesc_Internalname = "DIAGNOSTICOLONGDESC_"+sGXsfl_24_idx ;
   }

   public void subsflControlProps_fel_242( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_24_fel_idx ;
      edtDiagnosticoId_Internalname = "DIAGNOSTICOID_"+sGXsfl_24_fel_idx ;
      edtDiagnosticoCodigo_Internalname = "DIAGNOSTICOCODIGO_"+sGXsfl_24_fel_idx ;
      edtDiagnosticoDescripcion_Internalname = "DIAGNOSTICODESCRIPCION_"+sGXsfl_24_fel_idx ;
      cmbDiagnosticoTipoSexo.setInternalname( "DIAGNOSTICOTIPOSEXO_"+sGXsfl_24_fel_idx );
      cmbDiagnosticoEstado.setInternalname( "DIAGNOSTICOESTADO_"+sGXsfl_24_fel_idx );
      edtDiagnosticoLongDesc_Internalname = "DIAGNOSTICOLONGDESC_"+sGXsfl_24_fel_idx ;
   }
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         {
            GXCCtl = "DIAGNOSTICOTIPOSEXO_" + sGXsfl_24_idx ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbDiagnosticoTipoSexo.getInternalname(), "Values", cmbDiagnosticoTipoSexo.ToJavascriptSource(), !bGXsfl_24_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         {
            GXCCtl = "DIAGNOSTICOESTADO_" + sGXsfl_24_idx ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbDiagnosticoEstado.getInternalname(), "Values", cmbDiagnosticoEstado.ToJavascriptSource(), !bGXsfl_24_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:DiagnosticoId|2:DiagnosticoCodigo|3:DiagnosticoDescripcion|4:DiagnosticoTipoSexo|5:DiagnosticoEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e115S2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e125S2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e135S2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e175S2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e185S2',iparms:[{av:'A23DiagnosticoId',fld:'DIAGNOSTICOID',pic:'ZZZZZZZ9',hsh:true},{av:'A107DiagnosticoCodigo',fld:'DIAGNOSTICOCODIGO',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutDiagnosticoId',fld:'vINOUTDIAGNOSTICOID',pic:'ZZZZZZZ9'},{av:'AV9InOutDiagnosticoCodigo',fld:'vINOUTDIAGNOSTICOCODIGO',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e145S2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H005S2_A131DiagnosticoEstado = new String[] {""} ;
      H005S2_A130DiagnosticoTipoSexo = new String[] {""} ;
      H005S2_A23DiagnosticoId = new int[1] ;
      H005S2_A108DiagnosticoDescripcion = new String[] {""} ;
      H005S2_A107DiagnosticoCodigo = new String[] {""} ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.diagnosticoprompt__default(),
         new Object[] {
             new Object[] {
            H005S2_A131DiagnosticoEstado, H005S2_A130DiagnosticoTipoSexo, H005S2_A23DiagnosticoId, H005S2_A108DiagnosticoDescripcion, H005S2_A107DiagnosticoCodigo
            }
            , new Object[] {
   ...
   private String wcpOAV9InOutDiagnosticoCodigo ;
   private String AV13FilterFullText ;
   private String AV9InOutDiagnosticoCodigo ;
   ...
   private String[] H005S2_A131DiagnosticoEstado ;
   private String[] H005S2_A130DiagnosticoTipoSexo ;
   private int[] H005S2_A23DiagnosticoId ;
   private String[] H005S2_A108DiagnosticoDescripcion ;
   private String[] H005S2_A107DiagnosticoCodigo ;
...
final  class diagnosticoprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005S2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
            case 1 :
                  return conditional_H005S3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H005S2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H005S3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
