...
public final  class petitoriocategview_impl extends GXDataArea
{
   public petitoriocategview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public petitoriocategview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( petitoriocategview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10PetitorioCategId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10PetitorioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10PetitorioCategId), 4, 0));
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPETITORIOCATEGID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PetitorioCategId), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110334915", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.petitoriocategview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PetitorioCategId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PetitorioCategId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vPETITORIOCATEGID", GXutil.ltrim( localUtil.ntoc( AV10PetitorioCategId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPETITORIOCATEGID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PetitorioCategId), "ZZZ9")));
   ...
   public void renderHtmlCloseForm( )
   {
      ...
      if ( ! ( WebComp_Petitoriosubcategwc == null ) )
      {
         WebComp_Petitoriosubcategwc.componentjscripts();
      }
   }
   ...
   {
      return formatLink("com.projectthani.petitoriocategview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PetitorioCategId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PetitorioCategId","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "PetitorioCategView" ;
   }
   ...
   public void wb470( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, "Ir a Petitorio Categ", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_PetitorioCategView.htm");
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divPetitoriocateggeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblPetitoriosubcateg_title_Internalname, "Petitorio Sub Categ", "", "", lblPetitoriosubcateg_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_PetitorioCategView.htm");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         httpContext.writeText( "PetitorioSubCateg") ;
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         httpContext.writeText( "</div>") ;
         httpContext.writeText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel1"+"\" style=\"display:none;\">") ;
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divUnnamedtablepetitoriosubcateg_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         {
            /* WebComponent */
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "W0033"+"", GXutil.rtrim( WebComp_Petitoriosubcategwc_Component));
            httpContext.writeText( "<div") ;
            com.projectthani.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
            httpContext.writeText( " id=\""+"gxHTMLWrpW0033"+""+"\""+"") ;
            httpContext.writeText( ">") ;
            if ( GXutil.len( WebComp_Petitoriosubcategwc_Component) != 0 )
            {
               if ( GXutil.strcmp(GXutil.lower( OldPetitoriosubcategwc), GXutil.lower( WebComp_Petitoriosubcategwc_Component)) != 0 )
               {
                  httpContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
               }
               WebComp_Petitoriosubcategwc.componentdraw();
               if ( GXutil.strcmp(GXutil.lower( OldPetitoriosubcategwc), GXutil.lower( WebComp_Petitoriosubcategwc_Component)) != 0 )
               {
                  httpContext.ajax_rspEndCmp();
               }
   ...
   public void start472( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Petitorio Categ View", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldPetitoriosubcategwc = httpContext.cgiGet( "W0033") ;
                        if ( ( GXutil.len( OldPetitoriosubcategwc) == 0 ) || ( GXutil.strcmp(OldPetitoriosubcategwc, WebComp_Petitoriosubcategwc_Component) != 0 ) )
                        {
                           WebComp_Petitoriosubcategwc = WebUtils.getWebComponent(getClass(), "com.projectthani." + OldPetitoriosubcategwc + "_impl", remoteHandle, context);
                           WebComp_Petitoriosubcategwc_Component = OldPetitoriosubcategwc ;
                        }
                        if ( GXutil.len( WebComp_Petitoriosubcategwc_Component) != 0 )
                        {
                           WebComp_Petitoriosubcategwc.componentprocess("W0033", "", sEvt);
                        }
                        WebComp_Petitoriosubcategwc_Component = OldPetitoriosubcategwc ;
                     }
                  }
   ...
   public void rf472( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         if ( 1 != 0 )
         {
            if ( GXutil.len( WebComp_Petitoriosubcategwc_Component) != 0 )
            {
               WebComp_Petitoriosubcategwc.componentstart();
            }
         }
      }
   ...
   public void e12472( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.projectthani.petitoriocategww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV18GXLvl9 = (byte)(0) ;
      /* Using cursor H00472 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10PetitorioCategId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A49PetitorioCategId = H00472_A49PetitorioCategId[0] ;
         A266PetitorioCategNombre = H00472_A266PetitorioCategNombre[0] ;
         AV18GXLvl9 = (byte)(1) ;
         Form.setCaption( A266PetitorioCategNombre );
   ...
   public void S112( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( WebComp_Webcomponent_general_Component), GXutil.lower( "PetitorioCategGeneral")) != 0 )
      {
         WebComp_Webcomponent_general = WebUtils.getWebComponent(getClass(), "com.projectthani.petitoriocateggeneral_impl", remoteHandle, context);
         WebComp_Webcomponent_general_Component = "PetitorioCategGeneral" ;
      }
      if ( GXutil.len( WebComp_Webcomponent_general_Component) != 0 )
      {
         WebComp_Webcomponent_general.setjustcreated();
         WebComp_Webcomponent_general.componentprepare(new Object[] {"W0019","",Short.valueOf(AV10PetitorioCategId)});
   ...
   public void S122( )
   {
      ...
      returnInSub = false ;
      /* Using cursor H00473 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV10PetitorioCategId)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A49PetitorioCategId = H00473_A49PetitorioCategId[0] ;
         ...
         petitoriocategview_impl.this.GXt_boolean2 = GXv_boolean3[0] ;
         AV15TempBoolean = GXt_boolean2 ;
         if ( AV15TempBoolean )
         {
            if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "PetitorioSubCateg") == 0 ) )
            {
               /* Object Property */
               if ( true )
               {
                  bDynCreated_Petitoriosubcategwc = true ;
               }
               if ( GXutil.strcmp(GXutil.lower( WebComp_Petitoriosubcategwc_Component), GXutil.lower( "PetitorioCategPetitorioSubCategWC")) != 0 )
               {
                  WebComp_Petitoriosubcategwc = WebUtils.getWebComponent(getClass(), "com.projectthani.petitoriocategpetitoriosubcategwc_impl", remoteHandle, context);
                  WebComp_Petitoriosubcategwc_Component = "PetitorioCategPetitorioSubCategWC" ;
               }
               if ( GXutil.len( WebComp_Petitoriosubcategwc_Component) != 0 )
               {
                  WebComp_Petitoriosubcategwc.setjustcreated();
                  WebComp_Petitoriosubcategwc.componentprepare(new Object[] {"W0033","",Short.valueOf(AV10PetitorioCategId)});
                  WebComp_Petitoriosubcategwc.componentbind(new Object[] {""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Petitoriosubcategwc )
               {
                  httpContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
                  WebComp_Petitoriosubcategwc.componentdraw();
                  httpContext.ajax_rspEndCmp();
   ...
   {
      AV10PetitorioCategId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10PetitorioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10PetitorioCategId), 4, 0));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPETITORIOCATEGID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PetitorioCategId), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      if ( ! ( WebComp_Petitoriosubcategwc == null ) )
      {
         if ( GXutil.len( WebComp_Petitoriosubcategwc_Component) != 0 )
         {
            WebComp_Petitoriosubcategwc.componentthemes();
         }
      }
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110334945", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("petitoriocategview.js", "?20225110334945", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void init_default_properties( )
   {
      ...
      divPetitoriocateggeneral_cell_Internalname = "PETITORIOCATEGGENERAL_CELL" ;
      lblPetitoriosubcateg_title_Internalname = "PETITORIOSUBCATEG_TITLE" ;
      divUnnamedtablepetitoriosubcateg_Internalname = "UNNAMEDTABLEPETITORIOSUBCATEG" ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Petitorio Categ View" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10PetitorioCategId',fld:'vPETITORIOCATEGID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("TABS.TABCHANGED","{handler:'e11472',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'A49PetitorioCategId',fld:'PETITORIOCATEGID',pic:'ZZZ9'},{av:'AV10PetitorioCategId',fld:'vPETITORIOCATEGID',pic:'ZZZ9',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
      setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'PETITORIOSUBCATEGWC'}]}");
   }
   ...
   public void initialize( )
   {
      ...
      lblPetitoriosubcateg_title_Jsonclick = "" ;
      WebComp_Petitoriosubcategwc_Component = "" ;
      OldPetitoriosubcategwc = "" ;
      sEvt = "" ;
      EvtGridId = "" ;
      EvtRowId = "" ;
      sEvtType = "" ;
      ...
      scmdbuf = "" ;
      H00472_A49PetitorioCategId = new short[1] ;
      H00472_A266PetitorioCategNombre = new String[] {""} ;
      A266PetitorioCategNombre = "" ;
      H00473_A49PetitorioCategId = new short[1] ;
      GXv_boolean3 = new boolean[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.petitoriocategview__default(),
         new Object[] {
             new Object[] {
            H00472_A49PetitorioCategId, H00472_A266PetitorioCategNombre
            }
            , new Object[] {
            H00473_A49PetitorioCategId
            }
         }
      );
      /* GeneXus formulas. */
      ...
      WebComp_Petitoriosubcategwc = new com.genexus.webpanels.GXWebComponentNull(remoteHandle, context);
   }
   ...
   private short wcpOAV10PetitorioCategId ;
   private short nRcdExists_4 ;
   private short nIsMod_4 ;
   private short nRcdExists_3 ;
   private short nIsMod_3 ;
   private short AV10PetitorioCategId ;
   ...
   private String divPetitoriocateggeneral_cell_Internalname ;
   ...
   private String lblPetitoriosubcateg_title_Internalname ;
   private String lblPetitoriosubcateg_title_Jsonclick ;
   private String divUnnamedtablepetitoriosubcateg_Internalname ;
   private String WebComp_Petitoriosubcategwc_Component ;
   private String OldPetitoriosubcategwc ;
   private String sEvt ;
   ...
   private boolean bDynCreated_Petitoriosubcategwc ;
   private String A266PetitorioCategNombre ;
   private com.genexus.internet.MsgList BackMsgLst ;
   private com.genexus.internet.MsgList LclMsgLst ;
   private GXWebComponent WebComp_Webcomponent_general ;
   private GXWebComponent WebComp_Petitoriosubcategwc ;
   private com.genexus.webpanels.GXUserControl ucPanel_general ;
   private com.genexus.webpanels.GXUserControl ucTabs ;
   private IDataStoreProvider pr_default ;
   private short[] H00472_A49PetitorioCategId ;
   private String[] H00472_A266PetitorioCategNombre ;
   private short[] H00473_A49PetitorioCategId ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class petitoriocategview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00472", "SELECT [PetitorioCategId], [PetitorioCategNombre] FROM [PetitorioCateg] WHERE [PetitorioCategId] = ? ORDER BY [PetitorioCategId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H00473", "SELECT [PetitorioCategId] FROM [PetitorioCateg] WHERE [PetitorioCategId] = ? ORDER BY [PetitorioCategId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
