...
public final  class serviciocitaserviciowc_impl extends GXWebComponent
{
   public serviciocitaserviciowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public serviciocitaserviciowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( serviciocitaserviciowc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8ServicioId = (short)(GXutil.lval( httpContext.GetPar( "ServicioId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ServicioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ServicioId), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(AV8ServicioId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8ServicioId, AV20ManageFiltersExecutionStep, AV34Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Servicio Cita Servicio WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110323629", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.serviciocitaserviciowc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8ServicioId,4,0))}, new String[] {"ServicioId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8ServicioId", GXutil.ltrim( localUtil.ntoc( wcpOAV8ServicioId, (byte)(4), (byte)(0), ",", "")));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSERVICIOID", GXutil.ltrim( localUtil.ntoc( AV8ServicioId, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return "ServicioCitaServicioWC" ;
   }

   public String getPgmdesc( )
   {
      return "Servicio Cita Servicio WC" ;
   }
   ...
   public void wb4M0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.serviciocitaserviciowc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_4M2( true) ;
      }
      else
      {
         wb_table1_22_4M2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_4M2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeValue( "Servicio Id") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Cita Id") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Servicio Flag") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Servicio Estado") ;
            httpContext.writeTextNL( "</th>") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A26CitaServicioId, (byte)(8), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A19CitaId, (byte)(8), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A115CitaServicioFlag, (byte)(1), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.rtrim( A114CitaServicioEstado));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtServicioId_Internalname, GXutil.ltrim( localUtil.ntoc( A27ServicioId, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A27ServicioId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtServicioId_Jsonclick, 0, "Attribute", "", "", "", "", edtServicioId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id4", "right", false, "", "HLP_ServicioCitaServicioWC.htm");
         /* User Defined Control */
   ...
   public void start4M2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Servicio Cita Servicio WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           cmbCitaServicioEstado.setName( cmbCitaServicioEstado.getInternalname() );
   ...
   {
      /* GeneXus formulas. */
      AV34Pgmname = "ServicioCitaServicioWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf4M2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV16FilterFullText ,
                                              Integer.valueOf(A26CitaServicioId) ,
                                              Integer.valueOf(A19CitaId) ,
                                              Byte.valueOf(A115CitaServicioFlag) ,
                                              A114CitaServicioEstado ,
                                              Short.valueOf(AV14OrderedBy) ,
                                              Boolean.valueOf(AV15OrderedDsc) ,
                                              Short.valueOf(AV8ServicioId) ,
                                              Short.valueOf(A27ServicioId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.INT, TypeConstants.INT, TypeConstants.BYTE, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT
                                              }
         });
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H004M2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8ServicioId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A27ServicioId = H004M2_A27ServicioId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A27ServicioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A27ServicioId), 4, 0));
            A114CitaServicioEstado = H004M2_A114CitaServicioEstado[0] ;
            A115CitaServicioFlag = H004M2_A115CitaServicioFlag[0] ;
            A19CitaId = H004M2_A19CitaId[0] ;
            A26CitaServicioId = H004M2_A26CitaServicioId[0] ;
            e184M2 ();
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H004M3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8ServicioId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void strup4M0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8ServicioId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8ServicioId"), ",", ".")) ;
   ...
   public void e164M2( )
   {
      ...
      edtServicioId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtServicioId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtServicioId_Visible), 5, 0), true);
   ...
   private void e184M2( )
   {
      ...
      {
         edtavUpdate_Link = formatLink("com.projectthani.citaservicio", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A26CitaServicioId,8,0))}, new String[] {})  ;
      }
      AV28Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDelete_Internalname, AV28Delete);
      if ( AV29IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.projectthani.citaservicio", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A26CitaServicioId,8,0))}, new String[] {})  ;
      }
      /* Load Method */
      if ( wbStart != -1 )
      {
   ...
   public void e114M2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("ServicioCitaServicioWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV34Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("ServicioCitaServicioWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "ServicioCitaServicioWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         serviciocitaserviciowc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e154M2( )
   {
      /* 'DoInsert' Routine */
      returnInSub = false ;
      callWebObject(formatLink("com.projectthani.citaservicio", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {}) );
   ...
   public void S152( )
   {
      ...
      new com.projectthani.wwpbaseobjects.secisauthbyobjectname(remoteHandle, context).execute( "CitaServicio", GXv_boolean7) ;
      serviciocitaserviciowc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "ServicioCitaServicioWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "CitaServicio" );
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "ServicioId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8ServicioId, 4, 0) );
   ...
   public void wb_table1_22_4M2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_4M2( true) ;
      }
      else
      {
         wb_table2_27_4M2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_4M2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_4M2e( true) ;
      }
      else
      {
         wb_table1_22_4M2e( false) ;
      }
   }

   public void wb_table2_27_4M2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8ServicioId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ServicioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ServicioId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8ServicioId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "serviciocitaserviciowc", GetJustCreated( ));
      ...
      {
         AV8ServicioId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ServicioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ServicioId), 4, 0));
      }
      wcpOAV8ServicioId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8ServicioId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV8ServicioId != wcpOAV8ServicioId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8ServicioId = AV8ServicioId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8ServicioId = httpContext.cgiGet( sPrefix+"AV8ServicioId_CTRL") ;
      if ( GXutil.len( sCtrlAV8ServicioId) > 0 )
      {
         AV8ServicioId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV8ServicioId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ServicioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ServicioId), 4, 0));
      }
      else
      {
         AV8ServicioId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8ServicioId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8ServicioId_PARM", GXutil.ltrim( localUtil.ntoc( AV8ServicioId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8ServicioId)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8ServicioId_CTRL", GXutil.rtrim( sCtrlAV8ServicioId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511032386", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("serviciocitaserviciowc.js", "?2022511032387", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtCitaServicioId_Internalname = sPrefix+"CITASERVICIOID_"+sGXsfl_37_idx ;
      edtCitaId_Internalname = sPrefix+"CITAID_"+sGXsfl_37_idx ;
      edtCitaServicioFlag_Internalname = sPrefix+"CITASERVICIOFLAG_"+sGXsfl_37_idx ;
      cmbCitaServicioEstado.setInternalname( sPrefix+"CITASERVICIOESTADO_"+sGXsfl_37_idx );
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtCitaServicioId_Internalname = sPrefix+"CITASERVICIOID_"+sGXsfl_37_fel_idx ;
      edtCitaId_Internalname = sPrefix+"CITAID_"+sGXsfl_37_fel_idx ;
      edtCitaServicioFlag_Internalname = sPrefix+"CITASERVICIOFLAG_"+sGXsfl_37_fel_idx ;
      cmbCitaServicioEstado.setInternalname( sPrefix+"CITASERVICIOESTADO_"+sGXsfl_37_fel_idx );
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCitaServicioId_Internalname,GXutil.ltrim( localUtil.ntoc( A26CitaServicioId, (byte)(8), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A26CitaServicioId), "ZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtCitaServicioId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCitaServicioFlag_Internalname,GXutil.ltrim( localUtil.ntoc( A115CitaServicioFlag, (byte)(1), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A115CitaServicioFlag), "9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtCitaServicioFlag_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         }
         if ( ( cmbCitaServicioEstado.getItemCount() == 0 ) && isAjaxCallMode( ) )
         {
            GXCCtl = "CITASERVICIOESTADO_" + sGXsfl_37_idx ;
            cmbCitaServicioEstado.setName( GXCCtl );
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbCitaServicioEstado,cmbCitaServicioEstado.getInternalname(),GXutil.rtrim( A114CitaServicioEstado),Integer.valueOf(1),cmbCitaServicioEstado.getJsonclick(),Integer.valueOf(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","char","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","Attribute","WWColumn hidden-xs","","","",Boolean.valueOf(true),Integer.valueOf(1)});
         cmbCitaServicioEstado.setValue( GXutil.rtrim( A114CitaServicioEstado) );
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbCitaServicioEstado.getInternalname(), "Values", cmbCitaServicioEstado.ToJavascriptSource(), !bGXsfl_37_Refreshing);
   ...
   public void init_default_properties( )
   {
      ...
      edtCitaServicioId_Internalname = sPrefix+"CITASERVICIOID" ;
      edtCitaId_Internalname = sPrefix+"CITAID" ;
      edtCitaServicioFlag_Internalname = sPrefix+"CITASERVICIOFLAG" ;
      cmbCitaServicioEstado.setInternalname( sPrefix+"CITASERVICIOESTADO" );
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:CitaServicioId|3:CitaId|4:CitaServicioFlag|5:CitaServicioEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e184M2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A26CitaServicioId',fld:'CITASERVICIOID',pic:'ZZZZZZZ9'},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e154M2',iparms:[{av:'A26CitaServicioId',fld:'CITASERVICIOID',pic:'ZZZZZZZ9'}]");
      setEventMetadata("'DOINSERT'",",oparms:[{av:'A26CitaServicioId',fld:'CITASERVICIOID',pic:'ZZZZZZZ9'}]}");
      setEventMetadata("NULL","{handler:'valid_Citaservicioestado',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H004M2_A27ServicioId = new short[1] ;
      H004M2_A114CitaServicioEstado = new String[] {""} ;
      H004M2_A115CitaServicioFlag = new byte[1] ;
      H004M2_A19CitaId = new int[1] ;
      H004M2_A26CitaServicioId = new int[1] ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.serviciocitaserviciowc__default(),
         new Object[] {
             new Object[] {
            H004M2_A27ServicioId, H004M2_A114CitaServicioEstado, H004M2_A115CitaServicioFlag, H004M2_A19CitaId, H004M2_A26CitaServicioId
            }
            , new Object[] {
   ...
   private short wcpOAV8ServicioId ;
   private short AV8ServicioId ;
   ...
   private String sCtrlAV8ServicioId ;
   ...
   private short[] H004M2_A27ServicioId ;
   private String[] H004M2_A114CitaServicioEstado ;
   private byte[] H004M2_A115CitaServicioFlag ;
   private int[] H004M2_A19CitaId ;
   private int[] H004M2_A26CitaServicioId ;
...
final  class serviciocitaserviciowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H004M2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A26CitaServicioId ,
                                          int A19CitaId ,
                                          byte A115CitaServicioFlag ,
                                          String A114CitaServicioEstado ,
                                          short AV14OrderedBy ,
                                          boolean AV15OrderedDsc ,
                                          short AV8ServicioId ,
                                          short A27ServicioId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [ServicioId], [CitaServicioEstado], [CitaServicioFlag], [CitaId], [CitaServicioId]" ;
      sFromString = " FROM [CitaServicio]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([ServicioId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([CitaServicioId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(8), CAST([CitaId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(1), CAST([CitaServicioFlag] AS decimal(1,0))) like '%' + ?) or ( 'pendiente' like '%' + LOWER(?) and [CitaServicioEstado] = 'P') or ( 'pagado' like '%' + LOWER(?) and [CitaServicioEstado] = 'G') or ( 'rechazado' like '%' + LOWER(?) and [CitaServicioEstado] = 'R') or ( 'finalizado' like '%' + LOWER(?) and [CitaServicioEstado] = 'F'))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [ServicioId], [CitaServicioId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [ServicioId] DESC, [CitaServicioId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [ServicioId], [CitaId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [ServicioId] DESC, [CitaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [ServicioId], [CitaServicioFlag]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [ServicioId] DESC, [CitaServicioFlag] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [ServicioId], [CitaServicioEstado]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [ServicioId] DESC, [CitaServicioEstado] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [CitaServicioId]" ;
      }
   ...
   protected Object[] conditional_H004M3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A26CitaServicioId ,
                                          ...
                                          short A27ServicioId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [CitaServicio]" ;
      addWhere(sWhereString, "([ServicioId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([CitaServicioId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(8), CAST([CitaId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(1), CAST([CitaServicioFlag] AS decimal(1,0))) like '%' + ?) or ( 'pendiente' like '%' + LOWER(?) and [CitaServicioEstado] = 'P') or ( 'pagado' like '%' + LOWER(?) and [CitaServicioEstado] = 'G') or ( 'rechazado' like '%' + LOWER(?) and [CitaServicioEstado] = 'R') or ( 'finalizado' like '%' + LOWER(?) and [CitaServicioEstado] = 'F'))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H004M2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).byteValue() , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() , ((Number) dynConstraints[7]).shortValue() , ((Number) dynConstraints[8]).shortValue() );
            case 1 :
                  return conditional_H004M3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).byteValue() , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() , ((Number) dynConstraints[7]).shortValue() , ((Number) dynConstraints[8]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H004M2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H004M3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
