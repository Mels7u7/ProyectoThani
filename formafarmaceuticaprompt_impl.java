...
public final  class formafarmaceuticaprompt_impl extends GXDataArea
{
   public formafarmaceuticaprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public formafarmaceuticaprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( formafarmaceuticaprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutFormaFarmaceuticaId") ;
         ...
         {
            AV8InOutFormaFarmaceuticaId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutFormaFarmaceuticaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutFormaFarmaceuticaId), 4, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511034427", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.formafarmaceuticaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutFormaFarmaceuticaId,4,0))}, new String[] {"InOutFormaFarmaceuticaId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTFORMAFARMACEUTICAID", GXutil.ltrim( localUtil.ntoc( AV8InOutFormaFarmaceuticaId, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return formatLink("com.projectthani.formafarmaceuticaprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutFormaFarmaceuticaId,4,0))}, new String[] {"InOutFormaFarmaceuticaId"})  ;
   }

   public String getPgmname( )
   {
      return "FormaFarmaceuticaPrompt" ;
   }
   ...
   public void wb6L0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_6L2( true) ;
      }
      else
      {
         wb_table1_12_6L2( false) ;
      }
      return  ;
   }

   public void wb_table1_12_6L2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start6L2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Forma Farmaceutica", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf6L2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A163FormaFarmaceuticaEstado = H006L2_A163FormaFarmaceuticaEstado[0] ;
            A39FormaFarmaceuticaId = H006L2_A39FormaFarmaceuticaId[0] ;
            A162FormaFarmaceuticaDescripcion = H006L2_A162FormaFarmaceuticaDescripcion[0] ;
            A161FormaFarmaceuticaCodigo = H006L2_A161FormaFarmaceuticaCodigo[0] ;
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_FORMAFARMACEUTICAID"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, localUtil.format( DecimalUtil.doubleToDec(A39FormaFarmaceuticaId), "ZZZ9")));
   }
   ...
   public void e156L2( )
   {
      ...
      Form.setCaption( "Selecciona Forma Farmaceutica" );
   ...
   public void e186L2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutFormaFarmaceuticaId = A39FormaFarmaceuticaId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutFormaFarmaceuticaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutFormaFarmaceuticaId), 4, 0));
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV8InOutFormaFarmaceuticaId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutFormaFarmaceuticaId"});
   ...
   public void wb_table1_12_6L2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_FormaFarmaceuticaPrompt.htm");
   ...
   {
      AV8InOutFormaFarmaceuticaId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutFormaFarmaceuticaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutFormaFarmaceuticaId), 4, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202251103450", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("formafarmaceuticaprompt.js", "?202251103450", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_242( )
   {
      ...
      edtFormaFarmaceuticaCodigo_Internalname = "FORMAFARMACEUTICACODIGO_"+sGXsfl_24_idx ;
      edtFormaFarmaceuticaDescripcion_Internalname = "FORMAFARMACEUTICADESCRIPCION_"+sGXsfl_24_idx ;
      cmbFormaFarmaceuticaEstado.setInternalname( "FORMAFARMACEUTICAESTADO_"+sGXsfl_24_idx );
      edtFormaFarmaceuticaDescripcion2_Internalname = "FORMAFARMACEUTICADESCRIPCION2_"+sGXsfl_24_idx ;
   }
   ...
   public void subsflControlProps_fel_242( )
   {
      ...
      edtFormaFarmaceuticaCodigo_Internalname = "FORMAFARMACEUTICACODIGO_"+sGXsfl_24_fel_idx ;
      edtFormaFarmaceuticaDescripcion_Internalname = "FORMAFARMACEUTICADESCRIPCION_"+sGXsfl_24_fel_idx ;
      cmbFormaFarmaceuticaEstado.setInternalname( "FORMAFARMACEUTICAESTADO_"+sGXsfl_24_fel_idx );
      edtFormaFarmaceuticaDescripcion2_Internalname = "FORMAFARMACEUTICADESCRIPCION2_"+sGXsfl_24_fel_idx ;
   }
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         {
            GXCCtl = "FORMAFARMACEUTICAESTADO_" + sGXsfl_24_idx ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbFormaFarmaceuticaEstado.getInternalname(), "Values", cmbFormaFarmaceuticaEstado.ToJavascriptSource(), !bGXsfl_24_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:FormaFarmaceuticaId|2:FormaFarmaceuticaCodigo|3:FormaFarmaceuticaDescripcion|4:FormaFarmaceuticaEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e116L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e126L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      ...
      setEventMetadata("ENTER","{handler:'e186L2',iparms:[{av:'A39FormaFarmaceuticaId',fld:'FORMAFARMACEUTICAID',pic:'ZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutFormaFarmaceuticaId',fld:'vINOUTFORMAFARMACEUTICAID',pic:'ZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e146L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV12FilterFullText = "" ;
      H006L2_A163FormaFarmaceuticaEstado = new String[] {""} ;
      H006L2_A39FormaFarmaceuticaId = new short[1] ;
      H006L2_A162FormaFarmaceuticaDescripcion = new String[] {""} ;
      H006L2_A161FormaFarmaceuticaCodigo = new String[] {""} ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.formafarmaceuticaprompt__default(),
         new Object[] {
             new Object[] {
            H006L2_A163FormaFarmaceuticaEstado, H006L2_A39FormaFarmaceuticaId, H006L2_A162FormaFarmaceuticaDescripcion, H006L2_A161FormaFarmaceuticaCodigo
            }
            , new Object[] {
   ...
   private short wcpOAV8InOutFormaFarmaceuticaId ;
   private short AV8InOutFormaFarmaceuticaId ;
   ...
   private String[] H006L2_A163FormaFarmaceuticaEstado ;
   private short[] H006L2_A39FormaFarmaceuticaId ;
   private String[] H006L2_A162FormaFarmaceuticaDescripcion ;
   private String[] H006L2_A161FormaFarmaceuticaCodigo ;
...
final  class formafarmaceuticaprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H006L2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
            case 1 :
                  return conditional_H006L3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
      }
