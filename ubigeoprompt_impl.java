...
public final  class ubigeoprompt_impl extends GXDataArea
{
   public ubigeoprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public ubigeoprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( ubigeoprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutUbigeoCode") ;
         ...
         {
            AV8InOutUbigeoCode = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutUbigeoCode", AV8InOutUbigeoCode);
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutUbigeoNombre = httpContext.GetPar( "InOutUbigeoNombre") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutUbigeoNombre", AV9InOutUbigeoNombre);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511033357", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.ubigeoprompt", new String[] {GXutil.URLEncode(GXutil.rtrim(AV8InOutUbigeoCode)),GXutil.URLEncode(GXutil.rtrim(AV9InOutUbigeoNombre))}, new String[] {"InOutUbigeoCode","InOutUbigeoNombre"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTUBIGEOCODE", GXutil.rtrim( AV8InOutUbigeoCode));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTUBIGEONOMBRE", AV9InOutUbigeoNombre);
   ...
   {
      return formatLink("com.projectthani.ubigeoprompt", new String[] {GXutil.URLEncode(GXutil.rtrim(AV8InOutUbigeoCode)),GXutil.URLEncode(GXutil.rtrim(AV9InOutUbigeoNombre))}, new String[] {"InOutUbigeoCode","InOutUbigeoNombre"})  ;
   }
   ...
   public void wb2G0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_2G2( true) ;
      }
      else
      {
         wb_table1_12_2G2( false) ;
      }
      return  ;
   }

   public void wb_table1_12_2G2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start2G2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Ubigeo", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_UBIGEONOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A185UbigeoNombre, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "UBIGEONOMBRE", A185UbigeoNombre);
   }
   ...
   public void rf2G2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A294UbigeoEstado = H002G2_A294UbigeoEstado[0] ;
            A44UbigeoCode = H002G2_A44UbigeoCode[0] ;
            A188UbigeoDistrito = H002G2_A188UbigeoDistrito[0] ;
            A187UbigeoProvincia = H002G2_A187UbigeoProvincia[0] ;
            A186UbigeoDepartamento = H002G2_A186UbigeoDepartamento[0] ;
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_UBIGEOCODE"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, GXutil.rtrim( localUtil.format( A44UbigeoCode, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_UBIGEONOMBRE"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, GXutil.rtrim( localUtil.format( A185UbigeoNombre, ""))));
   }
   ...
   public void e152G2( )
   {
      ...
      Form.setCaption( "Selecciona Ubigeo" );
   ...
   public void e182G2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutUbigeoCode = A44UbigeoCode ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutUbigeoCode", AV8InOutUbigeoCode);
      AV9InOutUbigeoNombre = A185UbigeoNombre ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutUbigeoNombre", AV9InOutUbigeoNombre);
      httpContext.setWebReturnParms(new Object[] {AV8InOutUbigeoCode,AV9InOutUbigeoNombre});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutUbigeoCode","AV9InOutUbigeoNombre"});
   ...
   public void wb_table1_12_2G2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_UbigeoPrompt.htm");
   ...
   {
      AV8InOutUbigeoCode = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutUbigeoCode", AV8InOutUbigeoCode);
      AV9InOutUbigeoNombre = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutUbigeoNombre", AV9InOutUbigeoNombre);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110333619", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("ubigeoprompt.js", "?20225110333619", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_242( )
   {
      ...
      edtUbigeoDepartamento_Internalname = "UBIGEODEPARTAMENTO_"+sGXsfl_24_idx ;
      edtUbigeoDepartamentoCode_Internalname = "UBIGEODEPARTAMENTOCODE_"+sGXsfl_24_idx ;
      edtUbigeoProvincia_Internalname = "UBIGEOPROVINCIA_"+sGXsfl_24_idx ;
      edtUbigeoProvinciaCode_Internalname = "UBIGEOPROVINCIACODE_"+sGXsfl_24_idx ;
      edtUbigeoDistrito_Internalname = "UBIGEODISTRITO_"+sGXsfl_24_idx ;
      edtUbigeoDistritoCode_Internalname = "UBIGEODISTRITOCODE_"+sGXsfl_24_idx ;
      edtUbigeoNombre_Internalname = "UBIGEONOMBRE_"+sGXsfl_24_idx ;
      cmbUbigeoEstado.setInternalname( "UBIGEOESTADO_"+sGXsfl_24_idx );
   }
   ...
   public void subsflControlProps_fel_242( )
   {
      ...
      edtUbigeoDepartamento_Internalname = "UBIGEODEPARTAMENTO_"+sGXsfl_24_fel_idx ;
      edtUbigeoDepartamentoCode_Internalname = "UBIGEODEPARTAMENTOCODE_"+sGXsfl_24_fel_idx ;
      edtUbigeoProvincia_Internalname = "UBIGEOPROVINCIA_"+sGXsfl_24_fel_idx ;
      edtUbigeoProvinciaCode_Internalname = "UBIGEOPROVINCIACODE_"+sGXsfl_24_fel_idx ;
      edtUbigeoDistrito_Internalname = "UBIGEODISTRITO_"+sGXsfl_24_fel_idx ;
      edtUbigeoDistritoCode_Internalname = "UBIGEODISTRITOCODE_"+sGXsfl_24_fel_idx ;
      edtUbigeoNombre_Internalname = "UBIGEONOMBRE_"+sGXsfl_24_fel_idx ;
      cmbUbigeoEstado.setInternalname( "UBIGEOESTADO_"+sGXsfl_24_fel_idx );
   }
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         {
            GXCCtl = "UBIGEOESTADO_" + sGXsfl_24_idx ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbUbigeoEstado.getInternalname(), "Values", cmbUbigeoEstado.ToJavascriptSource(), !bGXsfl_24_Refreshing);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:UbigeoCode|2:UbigeoDepartamento|4:UbigeoProvincia|6:UbigeoDistrito|9:UbigeoEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e112G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e122G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      ...
      setEventMetadata("ENTER","{handler:'e182G2',iparms:[{av:'A44UbigeoCode',fld:'UBIGEOCODE',pic:'',hsh:true},{av:'A185UbigeoNombre',fld:'UBIGEONOMBRE',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutUbigeoCode',fld:'vINOUTUBIGEOCODE',pic:''},{av:'AV9InOutUbigeoNombre',fld:'vINOUTUBIGEONOMBRE',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e142G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
   ...
   {
      wcpOAV8InOutUbigeoCode = "" ;
      wcpOAV9InOutUbigeoNombre = "" ;
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H002G2_A294UbigeoEstado = new String[] {""} ;
      H002G2_A44UbigeoCode = new String[] {""} ;
      H002G2_A188UbigeoDistrito = new String[] {""} ;
      H002G2_A187UbigeoProvincia = new String[] {""} ;
      H002G2_A186UbigeoDepartamento = new String[] {""} ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.ubigeoprompt__default(),
         new Object[] {
             new Object[] {
            H002G2_A294UbigeoEstado, H002G2_A44UbigeoCode, H002G2_A188UbigeoDistrito, H002G2_A187UbigeoProvincia, H002G2_A186UbigeoDepartamento
            }
            , new Object[] {
   ...
   private String wcpOAV8InOutUbigeoCode ;
   ...
   private String AV8InOutUbigeoCode ;
   ...
   private String wcpOAV9InOutUbigeoNombre ;
   private String AV13FilterFullText ;
   private String AV9InOutUbigeoNombre ;
   ...
   private String[] H002G2_A294UbigeoEstado ;
   private String[] H002G2_A44UbigeoCode ;
   private String[] H002G2_A188UbigeoDistrito ;
   private String[] H002G2_A187UbigeoProvincia ;
   private String[] H002G2_A186UbigeoDepartamento ;
...
final  class ubigeoprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H002G2( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H002G3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          String A44UbigeoCode ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H002G2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
            case 1 :
                  return conditional_H002G3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H002G2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H002G3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
