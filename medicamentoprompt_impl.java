...
public final  class medicamentoprompt_impl extends GXDataArea
{
   public medicamentoprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public medicamentoprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( medicamentoprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutMedicamentoId") ;
         ...
         {
            AV8InOutMedicamentoId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutMedicamentoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutMedicamentoId), 4, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutMedicamentoCodigo = httpContext.GetPar( "InOutMedicamentoCodigo") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutMedicamentoCodigo", AV9InOutMedicamentoCodigo);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511034493", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.medicamentoprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutMedicamentoId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutMedicamentoCodigo))}, new String[] {"InOutMedicamentoId","InOutMedicamentoCodigo"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTMEDICAMENTOID", GXutil.ltrim( localUtil.ntoc( AV8InOutMedicamentoId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTMEDICAMENTOCODIGO", AV9InOutMedicamentoCodigo);
   ...
   {
      return formatLink("com.projectthani.medicamentoprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutMedicamentoId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutMedicamentoCodigo))}, new String[] {"InOutMedicamentoId","InOutMedicamentoCodigo"})  ;
   }

   public String getPgmname( )
   {
      return "MedicamentoPrompt" ;
   }
   ...
   public void wb6N0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_6N2( true) ;
      }
      else
      {
         wb_table1_12_6N2( false) ;
      }
      return  ;
   }

   public void wb_table1_12_6N2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start6N2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Medicamento", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_MEDICAMENTOCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A229MedicamentoCodigo, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "MEDICAMENTOCODIGO", A229MedicamentoCodigo);
   }
   ...
   public void rf6N2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                              }
         });
         ...
         {
            A231MedicamentoFormaFarm = H006N2_A231MedicamentoFormaFarm[0] ;
            n231MedicamentoFormaFarm = H006N2_n231MedicamentoFormaFarm[0] ;
            A230MedicamentoNombre = H006N2_A230MedicamentoNombre[0] ;
            A229MedicamentoCodigo = H006N2_A229MedicamentoCodigo[0] ;
            A42MedicamentoId = H006N2_A42MedicamentoId[0] ;
            e176N2 ();
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_MEDICAMENTOID"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, localUtil.format( DecimalUtil.doubleToDec(A42MedicamentoId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_MEDICAMENTOCODIGO"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, GXutil.rtrim( localUtil.format( A229MedicamentoCodigo, ""))));
   }
   ...
   public void e156N2( )
   {
      ...
      Form.setCaption( "Selecciona Medicamento" );
   ...
   public void e186N2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutMedicamentoId = A42MedicamentoId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutMedicamentoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutMedicamentoId), 4, 0));
      AV9InOutMedicamentoCodigo = A229MedicamentoCodigo ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutMedicamentoCodigo", AV9InOutMedicamentoCodigo);
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV8InOutMedicamentoId),AV9InOutMedicamentoCodigo});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutMedicamentoId","AV9InOutMedicamentoCodigo"});
   ...
   public void wb_table1_12_6N2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_MedicamentoPrompt.htm");
   ...
   {
      AV8InOutMedicamentoId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutMedicamentoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutMedicamentoId), 4, 0));
      AV9InOutMedicamentoCodigo = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutMedicamentoCodigo", AV9InOutMedicamentoCodigo);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511034566", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("medicamentoprompt.js", "?2022511034566", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:MedicamentoId|2:MedicamentoCodigo|3:MedicamentoNombre|4:MedicamentoFormaFarm" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e116N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e126N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      ...
      setEventMetadata("ENTER","{handler:'e186N2',iparms:[{av:'A42MedicamentoId',fld:'MEDICAMENTOID',pic:'ZZZ9',hsh:true},{av:'A229MedicamentoCodigo',fld:'MEDICAMENTOCODIGO',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutMedicamentoId',fld:'vINOUTMEDICAMENTOID',pic:'ZZZ9'},{av:'AV9InOutMedicamentoCodigo',fld:'vINOUTMEDICAMENTOCODIGO',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e146N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H006N2_A231MedicamentoFormaFarm = new String[] {""} ;
      H006N2_n231MedicamentoFormaFarm = new boolean[] {false} ;
      H006N2_A230MedicamentoNombre = new String[] {""} ;
      H006N2_A229MedicamentoCodigo = new String[] {""} ;
      H006N2_A42MedicamentoId = new short[1] ;
      ...
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.medicamentoprompt__default(),
         new Object[] {
             new Object[] {
            H006N2_A231MedicamentoFormaFarm, H006N2_n231MedicamentoFormaFarm, H006N2_A230MedicamentoNombre, H006N2_A229MedicamentoCodigo, H006N2_A42MedicamentoId
            }
            , new Object[] {
   ...
   private short wcpOAV8InOutMedicamentoId ;
   private short AV8InOutMedicamentoId ;
   ...
   private String wcpOAV9InOutMedicamentoCodigo ;
   private String AV13FilterFullText ;
   private String AV9InOutMedicamentoCodigo ;
   ...
   private String[] H006N2_A231MedicamentoFormaFarm ;
   private boolean[] H006N2_n231MedicamentoFormaFarm ;
   private String[] H006N2_A230MedicamentoNombre ;
   private String[] H006N2_A229MedicamentoCodigo ;
   private short[] H006N2_A42MedicamentoId ;
...
final  class medicamentoprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H006N2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
            case 1 :
                  return conditional_H006N3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
      }
