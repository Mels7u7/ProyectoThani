...
public final  class disponibilidadpagowc_impl extends GXWebComponent
{
   public disponibilidadpagowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public disponibilidadpagowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( disponibilidadpagowc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8DisponibilidadId = (int)(GXutil.lval( httpContext.GetPar( "DisponibilidadId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8DisponibilidadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8DisponibilidadId), 8, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Integer.valueOf(AV8DisponibilidadId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV30IsAuthorized_CitaCode = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_CitaCode")) ;
               AV31IsAuthorized_PagoMonto = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_PagoMonto")) ;
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8DisponibilidadId, AV20ManageFiltersExecutionStep, AV35Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, AV30IsAuthorized_CitaCode, AV31IsAuthorized_PagoMonto, A34DisponibilidadId, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Disponibilidad Pago WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110324339", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.disponibilidadpagowc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8DisponibilidadId,8,0))}, new String[] {"DisponibilidadId"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_CITACODE", getSecureSignedToken( sPrefix, AV30IsAuthorized_CitaCode));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_PAGOMONTO", getSecureSignedToken( sPrefix, AV31IsAuthorized_PagoMonto));
      GXKey = httpContext.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
      forbiddenHiddens = new com.genexus.util.GXProperties() ;
      forbiddenHiddens.add("hshsalt", sPrefix+"hsh"+"DisponibilidadPagoWC");
      ...
      GXutil.writeLogInfo("disponibilidadpagowc:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8DisponibilidadId", GXutil.ltrim( localUtil.ntoc( wcpOAV8DisponibilidadId, (byte)(8), (byte)(0), ",", "")));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( sPrefix, AV29IsAuthorized_Delete));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_CITACODE", AV30IsAuthorized_CitaCode);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_CITACODE", getSecureSignedToken( sPrefix, AV30IsAuthorized_CitaCode));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_PAGOMONTO", AV31IsAuthorized_PagoMonto);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_PAGOMONTO", getSecureSignedToken( sPrefix, AV31IsAuthorized_PagoMonto));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vDISPONIBILIDADID", GXutil.ltrim( localUtil.ntoc( AV8DisponibilidadId, (byte)(8), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm7K2( )
   {
   ...
   public void wb7K0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.disponibilidadpagowc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         StyleString = "" ;
         com.projectthani.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 37, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 7, "Agregar", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e117k1_client"+"'", TempTags, "", 2, "HLP_DisponibilidadPagoWC.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_7K2( true) ;
      }
      else
      {
         wb_table1_22_7K2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_7K2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtDisponibilidadId_Internalname, GXutil.ltrim( localUtil.ntoc( A34DisponibilidadId, (byte)(8), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A34DisponibilidadId), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDisponibilidadId_Jsonclick, 0, "Attribute", "", "", "", "", edtDisponibilidadId_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id", "right", false, "", "HLP_DisponibilidadPagoWC.htm");
         /* User Defined Control */
   ...
   public void start7K2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Disponibilidad Pago WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 boolean AV30IsAuthorized_CitaCode ,
                                 boolean AV31IsAuthorized_PagoMonto ,
   ...
   {
      /* GeneXus formulas. */
      AV35Pgmname = "DisponibilidadPagoWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf7K2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Integer.valueOf(AV8DisponibilidadId) ,
                                              ...
                                              TypeConstants.INT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.INT, TypeConstants.BOOLEAN
                                              }
         });
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H007K2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV8DisponibilidadId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A21SGCitaDisponibilidadId = H007K2_A21SGCitaDisponibilidadId[0] ;
            A34DisponibilidadId = H007K2_A34DisponibilidadId[0] ;
            n34DisponibilidadId = H007K2_n34DisponibilidadId[0] ;
            ...
            A246PagoEstadoR = H007K2_A246PagoEstadoR[0] ;
            A339PagoEnlaceXML = H007K2_A339PagoEnlaceXML[0] ;
            A338PagoEnlacePDF = H007K2_A338PagoEnlacePDF[0] ;
            A311PagoStatusCode = H007K2_A311PagoStatusCode[0] ;
            A310PagoPasarelaId = H007K2_A310PagoPasarelaId[0] ;
            A309PagoResponse = H007K2_A309PagoResponse[0] ;
            A308PagoRequest = H007K2_A308PagoRequest[0] ;
            A257PagoNubefactResponse = H007K2_A257PagoNubefactResponse[0] ;
            A256PagoNubefactRequest = H007K2_A256PagoNubefactRequest[0] ;
            A253PagoMoneda = H007K2_A253PagoMoneda[0] ;
            A252PagoFechaEmision = H007K2_A252PagoFechaEmision[0] ;
            A245PagoNumero = H007K2_A245PagoNumero[0] ;
            A244PagoTipoDocumento = H007K2_A244PagoTipoDocumento[0] ;
            A251PagoClienteEmail = H007K2_A251PagoClienteEmail[0] ;
            A250PagoClienteDireccion = H007K2_A250PagoClienteDireccion[0] ;
            A249PagoClienteDenominacion = H007K2_A249PagoClienteDenominacion[0] ;
            A248PagoClienteNroDocumento = H007K2_A248PagoClienteNroDocumento[0] ;
            A247PagoTipoDocumentoCliente = H007K2_A247PagoTipoDocumentoCliente[0] ;
            A243PagoToken = H007K2_A243PagoToken[0] ;
            A242PagoMonto = H007K2_A242PagoMonto[0] ;
            A66SGCitaDisponibilidadFecha = H007K2_A66SGCitaDisponibilidadFecha[0] ;
            n66SGCitaDisponibilidadFecha = H007K2_n66SGCitaDisponibilidadFecha[0] ;
            A64CitaCode = H007K2_A64CitaCode[0] ;
            A19CitaId = H007K2_A19CitaId[0] ;
            n19CitaId = H007K2_n19CitaId[0] ;
            A47PagoId = H007K2_A47PagoId[0] ;
            A21SGCitaDisponibilidadId = H007K2_A21SGCitaDisponibilidadId[0] ;
            A64CitaCode = H007K2_A64CitaCode[0] ;
            A66SGCitaDisponibilidadFecha = H007K2_A66SGCitaDisponibilidadFecha[0] ;
            n66SGCitaDisponibilidadFecha = H007K2_n66SGCitaDisponibilidadFecha[0] ;
   ...
   public void send_integrity_lvl_hashes7K2( )
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV35Pgmname));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV35Pgmname, ""))));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_UPDATE", AV27IsAuthorized_Update);
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H007K3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV8DisponibilidadId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void strup7K0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8DisponibilidadId = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8DisponibilidadId"), ",", ".")) ;
         AV8DisponibilidadId = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"vDISPONIBILIDADID"), ",", ".")) ;
         ...
         {
            GXutil.writeLogError("disponibilidadpagowc:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e167K2( )
   {
      ...
      S112 ();
      if (returnInSub) return;
      GXt_boolean1 = AV30IsAuthorized_CitaCode ;
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWCita", GXv_boolean2) ;
      disponibilidadpagowc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV30IsAuthorized_CitaCode = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV30IsAuthorized_CitaCode", AV30IsAuthorized_CitaCode);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_CITACODE", getSecureSignedToken( sPrefix, AV30IsAuthorized_CitaCode));
      GXt_boolean1 = AV31IsAuthorized_PagoMonto ;
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPago", GXv_boolean2) ;
      disponibilidadpagowc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV31IsAuthorized_PagoMonto = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV31IsAuthorized_PagoMonto", AV31IsAuthorized_PagoMonto);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_PAGOMONTO", getSecureSignedToken( sPrefix, AV31IsAuthorized_PagoMonto));
      Ddo_grid_Gridinternalname = subGrid_Internalname ;
      ucDdo_grid.sendProperty(context, sPrefix, false, Ddo_grid_Internalname, "GridInternalName", Ddo_grid_Gridinternalname);
      edtDisponibilidadId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtDisponibilidadId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtDisponibilidadId_Visible), 5, 0), true);
   ...
   public void e127K2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("DisponibilidadPagoWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV35Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("DisponibilidadPagoWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "DisponibilidadPagoWCFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         disponibilidadpagowc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "DisponibilidadPagoWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "DisponibilidadId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8DisponibilidadId, 8, 0) );
   ...
   public void wb_table1_22_7K2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_7K2( true) ;
      }
      else
      {
         wb_table2_27_7K2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_7K2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_7K2e( true) ;
      }
      else
      {
         wb_table1_22_7K2e( false) ;
      }
   }

   public void wb_table2_27_7K2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8DisponibilidadId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.INT), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8DisponibilidadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8DisponibilidadId), 8, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8DisponibilidadId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "disponibilidadpagowc", GetJustCreated( ));
      ...
      {
         AV8DisponibilidadId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.INT), TypeConstants.INT)).intValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8DisponibilidadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8DisponibilidadId), 8, 0));
      }
      wcpOAV8DisponibilidadId = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8DisponibilidadId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV8DisponibilidadId != wcpOAV8DisponibilidadId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8DisponibilidadId = AV8DisponibilidadId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8DisponibilidadId = httpContext.cgiGet( sPrefix+"AV8DisponibilidadId_CTRL") ;
      if ( GXutil.len( sCtrlAV8DisponibilidadId) > 0 )
      {
         AV8DisponibilidadId = (int)(localUtil.ctol( httpContext.cgiGet( sCtrlAV8DisponibilidadId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8DisponibilidadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8DisponibilidadId), 8, 0));
      }
      else
      {
         AV8DisponibilidadId = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8DisponibilidadId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8DisponibilidadId_PARM", GXutil.ltrim( localUtil.ntoc( AV8DisponibilidadId, (byte)(8), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8DisponibilidadId)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8DisponibilidadId_CTRL", GXutil.rtrim( sCtrlAV8DisponibilidadId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110324655", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("disponibilidadpagowc.js", "?20225110324656", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtPagoId_Internalname = sPrefix+"PAGOID_"+sGXsfl_37_idx ;
      ...
      edtPagoMonto_Internalname = sPrefix+"PAGOMONTO_"+sGXsfl_37_idx ;
      edtPagoToken_Internalname = sPrefix+"PAGOTOKEN_"+sGXsfl_37_idx ;
      cmbPagoTipoDocumentoCliente.setInternalname( sPrefix+"PAGOTIPODOCUMENTOCLIENTE_"+sGXsfl_37_idx );
      edtPagoClienteNroDocumento_Internalname = sPrefix+"PAGOCLIENTENRODOCUMENTO_"+sGXsfl_37_idx ;
      edtPagoClienteDenominacion_Internalname = sPrefix+"PAGOCLIENTEDENOMINACION_"+sGXsfl_37_idx ;
      edtPagoClienteDireccion_Internalname = sPrefix+"PAGOCLIENTEDIRECCION_"+sGXsfl_37_idx ;
      edtPagoClienteEmail_Internalname = sPrefix+"PAGOCLIENTEEMAIL_"+sGXsfl_37_idx ;
      cmbPagoTipoDocumento.setInternalname( sPrefix+"PAGOTIPODOCUMENTO_"+sGXsfl_37_idx );
      edtPagoNumero_Internalname = sPrefix+"PAGONUMERO_"+sGXsfl_37_idx ;
      edtPagoFechaEmision_Internalname = sPrefix+"PAGOFECHAEMISION_"+sGXsfl_37_idx ;
      cmbPagoMoneda.setInternalname( sPrefix+"PAGOMONEDA_"+sGXsfl_37_idx );
      edtPagoNubefactRequest_Internalname = sPrefix+"PAGONUBEFACTREQUEST_"+sGXsfl_37_idx ;
      edtPagoNubefactResponse_Internalname = sPrefix+"PAGONUBEFACTRESPONSE_"+sGXsfl_37_idx ;
      edtPagoRequest_Internalname = sPrefix+"PAGOREQUEST_"+sGXsfl_37_idx ;
      edtPagoResponse_Internalname = sPrefix+"PAGORESPONSE_"+sGXsfl_37_idx ;
      edtPagoPasarelaId_Internalname = sPrefix+"PAGOPASARELAID_"+sGXsfl_37_idx ;
      edtPagoStatusCode_Internalname = sPrefix+"PAGOSTATUSCODE_"+sGXsfl_37_idx ;
      edtPagoEnlacePDF_Internalname = sPrefix+"PAGOENLACEPDF_"+sGXsfl_37_idx ;
      edtPagoEnlaceXML_Internalname = sPrefix+"PAGOENLACEXML_"+sGXsfl_37_idx ;
      cmbPagoEstadoR.setInternalname( sPrefix+"PAGOESTADOR_"+sGXsfl_37_idx );
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtPagoId_Internalname = sPrefix+"PAGOID_"+sGXsfl_37_fel_idx ;
      ...
      edtPagoMonto_Internalname = sPrefix+"PAGOMONTO_"+sGXsfl_37_fel_idx ;
      edtPagoToken_Internalname = sPrefix+"PAGOTOKEN_"+sGXsfl_37_fel_idx ;
      cmbPagoTipoDocumentoCliente.setInternalname( sPrefix+"PAGOTIPODOCUMENTOCLIENTE_"+sGXsfl_37_fel_idx );
      edtPagoClienteNroDocumento_Internalname = sPrefix+"PAGOCLIENTENRODOCUMENTO_"+sGXsfl_37_fel_idx ;
      edtPagoClienteDenominacion_Internalname = sPrefix+"PAGOCLIENTEDENOMINACION_"+sGXsfl_37_fel_idx ;
      edtPagoClienteDireccion_Internalname = sPrefix+"PAGOCLIENTEDIRECCION_"+sGXsfl_37_fel_idx ;
      edtPagoClienteEmail_Internalname = sPrefix+"PAGOCLIENTEEMAIL_"+sGXsfl_37_fel_idx ;
      cmbPagoTipoDocumento.setInternalname( sPrefix+"PAGOTIPODOCUMENTO_"+sGXsfl_37_fel_idx );
      edtPagoNumero_Internalname = sPrefix+"PAGONUMERO_"+sGXsfl_37_fel_idx ;
      edtPagoFechaEmision_Internalname = sPrefix+"PAGOFECHAEMISION_"+sGXsfl_37_fel_idx ;
      cmbPagoMoneda.setInternalname( sPrefix+"PAGOMONEDA_"+sGXsfl_37_fel_idx );
      edtPagoNubefactRequest_Internalname = sPrefix+"PAGONUBEFACTREQUEST_"+sGXsfl_37_fel_idx ;
      edtPagoNubefactResponse_Internalname = sPrefix+"PAGONUBEFACTRESPONSE_"+sGXsfl_37_fel_idx ;
      edtPagoRequest_Internalname = sPrefix+"PAGOREQUEST_"+sGXsfl_37_fel_idx ;
      edtPagoResponse_Internalname = sPrefix+"PAGORESPONSE_"+sGXsfl_37_fel_idx ;
      edtPagoPasarelaId_Internalname = sPrefix+"PAGOPASARELAID_"+sGXsfl_37_fel_idx ;
      edtPagoStatusCode_Internalname = sPrefix+"PAGOSTATUSCODE_"+sGXsfl_37_fel_idx ;
      edtPagoEnlacePDF_Internalname = sPrefix+"PAGOENLACEPDF_"+sGXsfl_37_fel_idx ;
      edtPagoEnlaceXML_Internalname = sPrefix+"PAGOENLACEXML_"+sGXsfl_37_fel_idx ;
      cmbPagoEstadoR.setInternalname( sPrefix+"PAGOESTADOR_"+sGXsfl_37_fel_idx );
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPagoId_Internalname,GXutil.ltrim( localUtil.ntoc( A47PagoId, (byte)(8), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A47PagoId), "ZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtPagoId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPagoMonto_Internalname,GXutil.ltrim( localUtil.ntoc( A242PagoMonto, (byte)(6), (byte)(2), ",", "")),GXutil.ltrim( localUtil.format( A242PagoMonto, "ZZ9.99")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtPagoMonto_Link,"","","",edtPagoMonto_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(6),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         {
            GXCCtl = "PAGOTIPODOCUMENTOCLIENTE_" + sGXsfl_37_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbPagoTipoDocumentoCliente.getInternalname(), "Values", cmbPagoTipoDocumentoCliente.ToJavascriptSource(), !bGXsfl_37_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPagoClienteNroDocumento_Internalname,A248PagoClienteNroDocumento,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtPagoClienteNroDocumento_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPagoClienteDireccion_Internalname,A250PagoClienteDireccion,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtPagoClienteDireccion_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPagoClienteEmail_Internalname,A251PagoClienteEmail,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","mailto:"+A251PagoClienteEmail,"","","",edtPagoClienteEmail_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"email","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"GeneXus\\Email","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         {
            GXCCtl = "PAGOTIPODOCUMENTO_" + sGXsfl_37_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbPagoTipoDocumento.getInternalname(), "Values", cmbPagoTipoDocumento.ToJavascriptSource(), !bGXsfl_37_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPagoNumero_Internalname,GXutil.ltrim( localUtil.ntoc( A245PagoNumero, (byte)(8), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A245PagoNumero), "ZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtPagoNumero_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         {
            GXCCtl = "PAGOMONEDA_" + sGXsfl_37_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbPagoMoneda.getInternalname(), "Values", cmbPagoMoneda.ToJavascriptSource(), !bGXsfl_37_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPagoNubefactRequest_Internalname,A256PagoNubefactRequest,A256PagoNubefactRequest,"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtPagoNubefactRequest_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(2097152),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPagoNubefactResponse_Internalname,A257PagoNubefactResponse,A257PagoNubefactResponse,"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtPagoNubefactResponse_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(2097152),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPagoRequest_Internalname,A308PagoRequest,A308PagoRequest,"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtPagoRequest_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(2097152),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPagoStatusCode_Internalname,GXutil.ltrim( localUtil.ntoc( A311PagoStatusCode, (byte)(8), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A311PagoStatusCode), "ZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtPagoStatusCode_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPagoEnlaceXML_Internalname,A339PagoEnlaceXML,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtPagoEnlaceXML_Link,edtPagoEnlaceXML_Linktarget,"","",edtPagoEnlaceXML_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"url","",Integer.valueOf(410),"px",Integer.valueOf(17),"px",Integer.valueOf(1000),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"GeneXus\\Url","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         {
            GXCCtl = "PAGOESTADOR_" + sGXsfl_37_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbPagoEstadoR.getInternalname(), "Values", cmbPagoEstadoR.ToJavascriptSource(), !bGXsfl_37_Refreshing);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8DisponibilidadId',fld:'vDISPONIBILIDADID',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_CitaCode',fld:'vISAUTHORIZED_CITACODE',pic:'',hsh:true},{av:'AV31IsAuthorized_PagoMonto',fld:'vISAUTHORIZED_PAGOMONTO',pic:'',hsh:true},{av:'A34DisponibilidadId',fld:'DISPONIBILIDADID',pic:'ZZZZZZZ9'}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e137K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8DisponibilidadId',fld:'vDISPONIBILIDADID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_CitaCode',fld:'vISAUTHORIZED_CITACODE',pic:'',hsh:true},{av:'AV31IsAuthorized_PagoMonto',fld:'vISAUTHORIZED_PAGOMONTO',pic:'',hsh:true},{av:'A34DisponibilidadId',fld:'DISPONIBILIDADID',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e147K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8DisponibilidadId',fld:'vDISPONIBILIDADID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_CitaCode',fld:'vISAUTHORIZED_CITACODE',pic:'',hsh:true},{av:'AV31IsAuthorized_PagoMonto',fld:'vISAUTHORIZED_PAGOMONTO',pic:'',hsh:true},{av:'A34DisponibilidadId',fld:'DISPONIBILIDADID',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e157K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8DisponibilidadId',fld:'vDISPONIBILIDADID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_CitaCode',fld:'vISAUTHORIZED_CITACODE',pic:'',hsh:true},{av:'AV31IsAuthorized_PagoMonto',fld:'vISAUTHORIZED_PAGOMONTO',pic:'',hsh:true},{av:'A34DisponibilidadId',fld:'DISPONIBILIDADID',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e187K2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A34DisponibilidadId',fld:'DISPONIBILIDADID',pic:'ZZZZZZZ9'},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_CitaCode',fld:'vISAUTHORIZED_CITACODE',pic:'',hsh:true},{av:'A19CitaId',fld:'CITAID',pic:'ZZZZZZZ9'},{av:'AV31IsAuthorized_PagoMonto',fld:'vISAUTHORIZED_PAGOMONTO',pic:'',hsh:true},{av:'A47PagoId',fld:'PAGOID',pic:'ZZZZZZZ9'},{av:'A338PagoEnlacePDF',fld:'PAGOENLACEPDF',pic:''},{av:'A339PagoEnlaceXML',fld:'PAGOENLACEXML',pic:''}]");
      ...
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e127K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8DisponibilidadId',fld:'vDISPONIBILIDADID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_CitaCode',fld:'vISAUTHORIZED_CITACODE',pic:'',hsh:true},{av:'AV31IsAuthorized_PagoMonto',fld:'vISAUTHORIZED_PAGOMONTO',pic:'',hsh:true},{av:'A34DisponibilidadId',fld:'DISPONIBILIDADID',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e117K1',iparms:[{av:'AV8DisponibilidadId',fld:'vDISPONIBILIDADID',pic:'ZZZZZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H007K2_A21SGCitaDisponibilidadId = new int[1] ;
      H007K2_A34DisponibilidadId = new int[1] ;
      H007K2_n34DisponibilidadId = new boolean[] {false} ;
      H007K2_A246PagoEstadoR = new String[] {""} ;
      H007K2_A339PagoEnlaceXML = new String[] {""} ;
      H007K2_A338PagoEnlacePDF = new String[] {""} ;
      H007K2_A311PagoStatusCode = new int[1] ;
      H007K2_A310PagoPasarelaId = new String[] {""} ;
      H007K2_A309PagoResponse = new String[] {""} ;
      H007K2_A308PagoRequest = new String[] {""} ;
      H007K2_A257PagoNubefactResponse = new String[] {""} ;
      H007K2_A256PagoNubefactRequest = new String[] {""} ;
      H007K2_A253PagoMoneda = new short[1] ;
      H007K2_A252PagoFechaEmision = new java.util.Date[] {GXutil.nullDate()} ;
      H007K2_A245PagoNumero = new int[1] ;
      H007K2_A244PagoTipoDocumento = new short[1] ;
      H007K2_A251PagoClienteEmail = new String[] {""} ;
      H007K2_A250PagoClienteDireccion = new String[] {""} ;
      H007K2_A249PagoClienteDenominacion = new String[] {""} ;
      H007K2_A248PagoClienteNroDocumento = new String[] {""} ;
      H007K2_A247PagoTipoDocumentoCliente = new String[] {""} ;
      H007K2_A243PagoToken = new String[] {""} ;
      H007K2_A242PagoMonto = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H007K2_A66SGCitaDisponibilidadFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H007K2_n66SGCitaDisponibilidadFecha = new boolean[] {false} ;
      H007K2_A64CitaCode = new String[] {""} ;
      H007K2_A19CitaId = new int[1] ;
      H007K2_n19CitaId = new boolean[] {false} ;
      H007K2_A47PagoId = new int[1] ;
      ...
      sCtrlAV8DisponibilidadId = "" ;
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.disponibilidadpagowc__default(),
         new Object[] {
             new Object[] {
            H007K2_A21SGCitaDisponibilidadId, H007K2_A34DisponibilidadId, H007K2_n34DisponibilidadId, H007K2_A246PagoEstadoR, H007K2_A339PagoEnlaceXML, H007K2_A338PagoEnlacePDF, H007K2_A311PagoStatusCode, H007K2_A310PagoPasarelaId, H007K2_A309PagoResponse, H007K2_A308PagoRequest,
            H007K2_A257PagoNubefactResponse, H007K2_A256PagoNubefactRequest, H007K2_A253PagoMoneda, H007K2_A252PagoFechaEmision, H007K2_A245PagoNumero, H007K2_A244PagoTipoDocumento, H007K2_A251PagoClienteEmail, H007K2_A250PagoClienteDireccion, H007K2_A249PagoClienteDenominacion, H007K2_A248PagoClienteNroDocumento,
            H007K2_A247PagoTipoDocumentoCliente, H007K2_A243PagoToken, H007K2_A242PagoMonto, H007K2_A66SGCitaDisponibilidadFecha, H007K2_n66SGCitaDisponibilidadFecha, H007K2_A64CitaCode, H007K2_A19CitaId, H007K2_n19CitaId, H007K2_A47PagoId
            }
            , new Object[] {
   ...
   private int wcpOAV8DisponibilidadId ;
   ...
   private String sCtrlAV8DisponibilidadId ;
   ...
   private boolean AV30IsAuthorized_CitaCode ;
   private boolean AV31IsAuthorized_PagoMonto ;
   ...
   private int[] H007K2_A21SGCitaDisponibilidadId ;
   private int[] H007K2_A34DisponibilidadId ;
   private boolean[] H007K2_n34DisponibilidadId ;
   private String[] H007K2_A246PagoEstadoR ;
   private String[] H007K2_A339PagoEnlaceXML ;
   private String[] H007K2_A338PagoEnlacePDF ;
   private int[] H007K2_A311PagoStatusCode ;
   private String[] H007K2_A310PagoPasarelaId ;
   private String[] H007K2_A309PagoResponse ;
   private String[] H007K2_A308PagoRequest ;
   private String[] H007K2_A257PagoNubefactResponse ;
   private String[] H007K2_A256PagoNubefactRequest ;
   private short[] H007K2_A253PagoMoneda ;
   private java.util.Date[] H007K2_A252PagoFechaEmision ;
   private int[] H007K2_A245PagoNumero ;
   private short[] H007K2_A244PagoTipoDocumento ;
   private String[] H007K2_A251PagoClienteEmail ;
   private String[] H007K2_A250PagoClienteDireccion ;
   private String[] H007K2_A249PagoClienteDenominacion ;
   private String[] H007K2_A248PagoClienteNroDocumento ;
   private String[] H007K2_A247PagoTipoDocumentoCliente ;
   private String[] H007K2_A243PagoToken ;
   private java.math.BigDecimal[] H007K2_A242PagoMonto ;
   private java.util.Date[] H007K2_A66SGCitaDisponibilidadFecha ;
   private boolean[] H007K2_n66SGCitaDisponibilidadFecha ;
   private String[] H007K2_A64CitaCode ;
   private int[] H007K2_A19CitaId ;
   private boolean[] H007K2_n19CitaId ;
   private int[] H007K2_A47PagoId ;
...
final  class disponibilidadpagowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H007K2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          int A34DisponibilidadId )
   {
      ...
      String scmdbuf;
      byte[] GXv_int11 = new byte[37];
      Object[] GXv_Object12 = new Object[2];
      String sSelectString;
      String sFromString;
      String sOrderString;
      sSelectString = " T2.[SGCitaDisponibilidadId] AS SGCitaDisponibilidadId, T1.[DisponibilidadId], T1.[PagoEstadoR], T1.[PagoEnlaceXML], T1.[PagoEnlacePDF], T1.[PagoStatusCode], T1.[PagoPasarelaId]," ;
      ...
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoMonto]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoMonto] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[CitaId]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[CitaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T2.[CitaCode]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T2.[CitaCode] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T3.[DisponibilidadFecha]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T3.[DisponibilidadFecha] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoToken]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoToken] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoTipoDocumentoCliente]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoTipoDocumentoCliente] DESC" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoClienteNroDocumento]" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoClienteNroDocumento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoClienteDenominacion]" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoClienteDenominacion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoClienteDireccion]" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoClienteDireccion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 11 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoClienteEmail]" ;
      }
      else if ( ( AV14OrderedBy == 11 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoClienteEmail] DESC" ;
      }
      else if ( ( AV14OrderedBy == 12 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoTipoDocumento]" ;
      }
      else if ( ( AV14OrderedBy == 12 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoTipoDocumento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 13 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoNumero]" ;
      }
      else if ( ( AV14OrderedBy == 13 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoNumero] DESC" ;
      }
      else if ( ( AV14OrderedBy == 14 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoFechaEmision]" ;
      }
      else if ( ( AV14OrderedBy == 14 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoFechaEmision] DESC" ;
      }
      else if ( ( AV14OrderedBy == 15 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoMoneda]" ;
      }
      else if ( ( AV14OrderedBy == 15 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoMoneda] DESC" ;
      }
      else if ( ( AV14OrderedBy == 16 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoNubefactRequest]" ;
      }
      else if ( ( AV14OrderedBy == 16 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoNubefactRequest] DESC" ;
      }
      else if ( ( AV14OrderedBy == 17 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoNubefactResponse]" ;
      }
      else if ( ( AV14OrderedBy == 17 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoNubefactResponse] DESC" ;
      }
      else if ( ( AV14OrderedBy == 18 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoRequest]" ;
      }
      else if ( ( AV14OrderedBy == 18 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoRequest] DESC" ;
      }
      else if ( ( AV14OrderedBy == 19 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoResponse]" ;
      }
      else if ( ( AV14OrderedBy == 19 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoResponse] DESC" ;
      }
      else if ( ( AV14OrderedBy == 20 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoPasarelaId]" ;
      }
      else if ( ( AV14OrderedBy == 20 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoPasarelaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 21 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoStatusCode]" ;
      }
      else if ( ( AV14OrderedBy == 21 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoStatusCode] DESC" ;
      }
      else if ( ( AV14OrderedBy == 22 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoEnlacePDF]" ;
      }
      else if ( ( AV14OrderedBy == 22 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoEnlacePDF] DESC" ;
      }
      else if ( ( AV14OrderedBy == 23 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoEnlaceXML]" ;
      }
      else if ( ( AV14OrderedBy == 23 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoEnlaceXML] DESC" ;
      }
      else if ( ( AV14OrderedBy == 24 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId], T1.[PagoEstadoR]" ;
      }
      else if ( ( AV14OrderedBy == 24 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DisponibilidadId] DESC, T1.[PagoEstadoR] DESC" ;
      }
      else if ( true )
      {
   ...
   protected Object[] conditional_H007K3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A47PagoId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H007K2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , (String)dynConstraints[3] , (java.math.BigDecimal)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (String)dynConstraints[8] , (String)dynConstraints[9] , (String)dynConstraints[10] , ((Number) dynConstraints[11]).shortValue() , ((Number) dynConstraints[12]).intValue() , ((Number) dynConstraints[13]).shortValue() , (String)dynConstraints[14] , (String)dynConstraints[15] , (String)dynConstraints[16] , (String)dynConstraints[17] , (String)dynConstraints[18] , ((Number) dynConstraints[19]).intValue() , (String)dynConstraints[20] , (String)dynConstraints[21] , (String)dynConstraints[22] , ((Number) dynConstraints[23]).shortValue() , ((Boolean) dynConstraints[24]).booleanValue() , ((Number) dynConstraints[25]).intValue() , ((Number) dynConstraints[26]).intValue() );
            case 1 :
                  return conditional_H007K3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , (String)dynConstraints[3] , (java.math.BigDecimal)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (String)dynConstraints[8] , (String)dynConstraints[9] , (String)dynConstraints[10] , ((Number) dynConstraints[11]).shortValue() , ((Number) dynConstraints[12]).intValue() , ((Number) dynConstraints[13]).shortValue() , (String)dynConstraints[14] , (String)dynConstraints[15] , (String)dynConstraints[16] , (String)dynConstraints[17] , (String)dynConstraints[18] , ((Number) dynConstraints[19]).intValue() , (String)dynConstraints[20] , (String)dynConstraints[21] , (String)dynConstraints[22] , ((Number) dynConstraints[23]).shortValue() , ((Boolean) dynConstraints[24]).booleanValue() , ((Number) dynConstraints[25]).intValue() , ((Number) dynConstraints[26]).intValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H007K2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H007K3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
