...
public final  class formafarmaceuticaview_impl extends GXDataArea
{
   public formafarmaceuticaview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public formafarmaceuticaview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( formafarmaceuticaview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10FormaFarmaceuticaId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10FormaFarmaceuticaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10FormaFarmaceuticaId), 4, 0));
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vFORMAFARMACEUTICAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10FormaFarmaceuticaId), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511034432", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.formafarmaceuticaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10FormaFarmaceuticaId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"FormaFarmaceuticaId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vFORMAFARMACEUTICAID", GXutil.ltrim( localUtil.ntoc( AV10FormaFarmaceuticaId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vFORMAFARMACEUTICAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10FormaFarmaceuticaId), "ZZZ9")));
   ...
   {
      return formatLink("com.projectthani.formafarmaceuticaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10FormaFarmaceuticaId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"FormaFarmaceuticaId","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "FormaFarmaceuticaView" ;
   }
   ...
   public void wb6M0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, "Ir a Forma Farmaceutica", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_FormaFarmaceuticaView.htm");
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divFormafarmaceuticageneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblPetitorio_title_Internalname, "Petitorio", "", "", lblPetitorio_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_FormaFarmaceuticaView.htm");
         /* Div Control */
         ...
         {
            /* WebComponent */
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "W0033"+"", GXutil.rtrim( WebComp_Petitoriowc_Component));
            httpContext.writeText( "<div") ;
            com.projectthani.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
   ...
   public void start6M2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Forma Farmaceutica View", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldPetitoriowc = httpContext.cgiGet( "W0033") ;
                        ...
                        if ( GXutil.len( WebComp_Petitoriowc_Component) != 0 )
                        {
                           WebComp_Petitoriowc.componentprocess("W0033", "", sEvt);
                        }
                        WebComp_Petitoriowc_Component = OldPetitoriowc ;
                     }
                  }
   ...
   public void e126M2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.projectthani.formafarmaceuticaww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV18GXLvl9 = (byte)(0) ;
      /* Using cursor H006M2 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10FormaFarmaceuticaId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A39FormaFarmaceuticaId = H006M2_A39FormaFarmaceuticaId[0] ;
         AV18GXLvl9 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( WebComp_Webcomponent_general_Component), GXutil.lower( "FormaFarmaceuticaGeneral")) != 0 )
      {
         WebComp_Webcomponent_general = WebUtils.getWebComponent(getClass(), "com.projectthani.formafarmaceuticageneral_impl", remoteHandle, context);
         WebComp_Webcomponent_general_Component = "FormaFarmaceuticaGeneral" ;
      }
      if ( GXutil.len( WebComp_Webcomponent_general_Component) != 0 )
      {
         WebComp_Webcomponent_general.setjustcreated();
         WebComp_Webcomponent_general.componentprepare(new Object[] {"W0019","",Short.valueOf(AV10FormaFarmaceuticaId)});
   ...
   public void S122( )
   {
      ...
      returnInSub = false ;
      /* Using cursor H006M3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV10FormaFarmaceuticaId)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A39FormaFarmaceuticaId = H006M3_A39FormaFarmaceuticaId[0] ;
         ...
         formafarmaceuticaview_impl.this.GXt_boolean2 = GXv_boolean3[0] ;
         AV15TempBoolean = GXt_boolean2 ;
         if ( AV15TempBoolean )
         {
            if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "Petitorio") == 0 ) )
            {
               /* Object Property */
               if ( true )
               {
               ...
               if ( GXutil.strcmp(GXutil.lower( WebComp_Petitoriowc_Component), GXutil.lower( "FormaFarmaceuticaPetitorioWC")) != 0 )
               {
                  WebComp_Petitoriowc = WebUtils.getWebComponent(getClass(), "com.projectthani.formafarmaceuticapetitoriowc_impl", remoteHandle, context);
                  WebComp_Petitoriowc_Component = "FormaFarmaceuticaPetitorioWC" ;
               }
               if ( GXutil.len( WebComp_Petitoriowc_Component) != 0 )
               {
                  WebComp_Petitoriowc.setjustcreated();
                  WebComp_Petitoriowc.componentprepare(new Object[] {"W0033","",Short.valueOf(AV10FormaFarmaceuticaId)});
   ...
   {
      AV10FormaFarmaceuticaId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10FormaFarmaceuticaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10FormaFarmaceuticaId), 4, 0));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vFORMAFARMACEUTICAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10FormaFarmaceuticaId), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511034458", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("formafarmaceuticaview.js", "?2022511034458", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void init_default_properties( )
   {
      ...
      divFormafarmaceuticageneral_cell_Internalname = "FORMAFARMACEUTICAGENERAL_CELL" ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Forma Farmaceutica View" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10FormaFarmaceuticaId',fld:'vFORMAFARMACEUTICAID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("TABS.TABCHANGED","{handler:'e116M2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'A39FormaFarmaceuticaId',fld:'FORMAFARMACEUTICAID',pic:'ZZZ9'},{av:'AV10FormaFarmaceuticaId',fld:'vFORMAFARMACEUTICAID',pic:'ZZZ9',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
      setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'PETITORIOWC'}]}");
   }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H006M2_A39FormaFarmaceuticaId = new short[1] ;
      H006M3_A39FormaFarmaceuticaId = new short[1] ;
      GXv_boolean3 = new boolean[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.formafarmaceuticaview__default(),
         new Object[] {
             new Object[] {
            H006M2_A39FormaFarmaceuticaId
            }
            , new Object[] {
            H006M3_A39FormaFarmaceuticaId
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV10FormaFarmaceuticaId ;
   private short nRcdExists_4 ;
   private short nIsMod_4 ;
   private short nRcdExists_3 ;
   private short nIsMod_3 ;
   private short AV10FormaFarmaceuticaId ;
   ...
   private String divFormafarmaceuticageneral_cell_Internalname ;
   ...
   private short[] H006M2_A39FormaFarmaceuticaId ;
   private short[] H006M3_A39FormaFarmaceuticaId ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class formafarmaceuticaview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H006M2", "SELECT [FormaFarmaceuticaId] FROM [FormaFarmaceutica] WHERE [FormaFarmaceuticaId] = ? ORDER BY [FormaFarmaceuticaId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H006M3", "SELECT [FormaFarmaceuticaId] FROM [FormaFarmaceutica] WHERE [FormaFarmaceuticaId] = ? ORDER BY [FormaFarmaceuticaId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
