...
@javax.ws.rs.Path("/TemplateWWGetFilterData")
public final  class templatewwgetfilterdata_services_rest extends GxRestService
{
   @javax.ws.rs.POST
   ...
   public javax.ws.rs.core.Response execute( com.projectthani.templatewwgetfilterdata_RESTInterfaceIN entity ) throws Exception
   {
      ...
      if ( ! processHeaders("templatewwgetfilterdata",myServletRequestWrapper,myServletResponseWrapper) )
      {
      ...
      try
      {
         com.projectthani.templatewwgetfilterdata worker = new com.projectthani.templatewwgetfilterdata(remoteHandle, context);
         worker.execute(AV21DDOName,AV19SearchTxt,AV20SearchTxtTo,AV25OptionsJson,AV28OptionsDescJson,AV30OptionIndexesJson );
         com.projectthani.templatewwgetfilterdata_RESTInterfaceOUT data = new com.projectthani.templatewwgetfilterdata_RESTInterfaceOUT();
