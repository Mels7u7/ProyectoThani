...
public final  class petitoriosubcategprompt_impl extends GXDataArea
{
   public petitoriosubcategprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public petitoriosubcategprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( petitoriosubcategprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutPetitorioSubCategId") ;
         ...
         {
            AV8InOutPetitorioSubCategId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutPetitorioSubCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutPetitorioSubCategId), 4, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutPetitorioSubCategNombre = httpContext.GetPar( "InOutPetitorioSubCategNombre") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutPetitorioSubCategNombre", AV9InOutPetitorioSubCategNombre);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110335974", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.petitoriosubcategprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutPetitorioSubCategId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutPetitorioSubCategNombre))}, new String[] {"InOutPetitorioSubCategId","InOutPetitorioSubCategNombre"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTPETITORIOSUBCATEGID", GXutil.ltrim( localUtil.ntoc( AV8InOutPetitorioSubCategId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTPETITORIOSUBCATEGNOMBRE", AV9InOutPetitorioSubCategNombre);
   ...
   {
      return formatLink("com.projectthani.petitoriosubcategprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutPetitorioSubCategId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutPetitorioSubCategNombre))}, new String[] {"InOutPetitorioSubCategId","InOutPetitorioSubCategNombre"})  ;
   }

   public String getPgmname( )
   {
      return "PetitorioSubCategPrompt" ;
   }
   ...
   public void wb630( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_632( true) ;
      }
      else
      {
         wb_table1_12_632( false) ;
      }
      return  ;
   }

   public void wb_table1_12_632e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start632( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Petitorio Sub Categ", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_PETITORIOSUBCATEGNOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A265PetitorioSubCategNombre, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "PETITORIOSUBCATEGNOMBRE", A265PetitorioSubCategNombre);
   }
   ...
   public void rf632( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                              }
         });
         ...
         {
            A265PetitorioSubCategNombre = H00632_A265PetitorioSubCategNombre[0] ;
            A266PetitorioCategNombre = H00632_A266PetitorioCategNombre[0] ;
            A49PetitorioCategId = H00632_A49PetitorioCategId[0] ;
            A48PetitorioSubCategId = H00632_A48PetitorioSubCategId[0] ;
            A266PetitorioCategNombre = H00632_A266PetitorioCategNombre[0] ;
            e17632 ();
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_PETITORIOSUBCATEGID"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, localUtil.format( DecimalUtil.doubleToDec(A48PetitorioSubCategId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_PETITORIOSUBCATEGNOMBRE"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, GXutil.rtrim( localUtil.format( A265PetitorioSubCategNombre, ""))));
   }
   ...
   public void e15632( )
   {
      ...
      Form.setCaption( "Selecciona Petitorio Sub Categ" );
   ...
   public void e18632( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutPetitorioSubCategId = A48PetitorioSubCategId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutPetitorioSubCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutPetitorioSubCategId), 4, 0));
      AV9InOutPetitorioSubCategNombre = A265PetitorioSubCategNombre ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutPetitorioSubCategNombre", AV9InOutPetitorioSubCategNombre);
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV8InOutPetitorioSubCategId),AV9InOutPetitorioSubCategNombre});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutPetitorioSubCategId","AV9InOutPetitorioSubCategNombre"});
   ...
   public void wb_table1_12_632( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_PetitorioSubCategPrompt.htm");
   ...
   {
      AV8InOutPetitorioSubCategId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutPetitorioSubCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutPetitorioSubCategId), 4, 0));
      AV9InOutPetitorioSubCategNombre = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutPetitorioSubCategNombre", AV9InOutPetitorioSubCategNombre);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511034043", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("petitoriosubcategprompt.js", "?2022511034043", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_242( )
   {
      ...
      edtPetitorioCategNombre_Internalname = "PETITORIOCATEGNOMBRE_"+sGXsfl_24_idx ;
      edtPetitorioSubCategNombre_Internalname = "PETITORIOSUBCATEGNOMBRE_"+sGXsfl_24_idx ;
   }
   ...
   public void subsflControlProps_fel_242( )
   {
      ...
      edtPetitorioCategNombre_Internalname = "PETITORIOCATEGNOMBRE_"+sGXsfl_24_fel_idx ;
      edtPetitorioSubCategNombre_Internalname = "PETITORIOSUBCATEGNOMBRE_"+sGXsfl_24_fel_idx ;
   }
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPetitorioCategNombre_Internalname,A266PetitorioCategNombre,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtPetitorioCategNombre_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(200),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(24),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPetitorioSubCategNombre_Internalname,A265PetitorioSubCategNombre,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtPetitorioSubCategNombre_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(200),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(24),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:PetitorioSubCategId|2:PetitorioCategId|3:PetitorioCategNombre|4:PetitorioSubCategNombre" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11632',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12632',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e13632',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e17632',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e18632',iparms:[{av:'A48PetitorioSubCategId',fld:'PETITORIOSUBCATEGID',pic:'ZZZ9',hsh:true},{av:'A265PetitorioSubCategNombre',fld:'PETITORIOSUBCATEGNOMBRE',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutPetitorioSubCategId',fld:'vINOUTPETITORIOSUBCATEGID',pic:'ZZZ9'},{av:'AV9InOutPetitorioSubCategNombre',fld:'vINOUTPETITORIOSUBCATEGNOMBRE',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e14632',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
   ...
   {
      wcpOAV9InOutPetitorioSubCategNombre = "" ;
      ...
      AV9InOutPetitorioSubCategNombre = "" ;
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H00632_A265PetitorioSubCategNombre = new String[] {""} ;
      H00632_A266PetitorioCategNombre = new String[] {""} ;
      H00632_A49PetitorioCategId = new short[1] ;
      H00632_A48PetitorioSubCategId = new short[1] ;
      ...
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.petitoriosubcategprompt__default(),
         new Object[] {
             new Object[] {
            H00632_A265PetitorioSubCategNombre, H00632_A266PetitorioCategNombre, H00632_A49PetitorioCategId, H00632_A48PetitorioSubCategId
            }
            , new Object[] {
   ...
   private short wcpOAV8InOutPetitorioSubCategId ;
   private short AV8InOutPetitorioSubCategId ;
   ...
   private String wcpOAV9InOutPetitorioSubCategNombre ;
   private String AV13FilterFullText ;
   private String AV9InOutPetitorioSubCategNombre ;
   ...
   private String[] H00632_A265PetitorioSubCategNombre ;
   private String[] H00632_A266PetitorioCategNombre ;
   private short[] H00632_A49PetitorioCategId ;
   private short[] H00632_A48PetitorioSubCategId ;
...
final  class petitoriosubcategprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00632( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H00633( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          short A48PetitorioSubCategId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00632(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
            case 1 :
                  return conditional_H00633(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00632", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00633", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
