...
public final  class disponibilidadview_impl extends GXDataArea
{
   public disponibilidadview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public disponibilidadview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( disponibilidadview_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110331549", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.disponibilidadview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10DisponibilidadId,8,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"DisponibilidadId","TabCode"}) +"\">") ;
   ...
   {
      return formatLink("com.projectthani.disponibilidadview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10DisponibilidadId,8,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"DisponibilidadId","TabCode"})  ;
   }
   ...
   public void wb1R0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, "Ir a Disponibilidad", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_DisponibilidadView.htm");
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divDisponibilidadgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCita_title_Internalname, "SGCita Disponibilidad", "", "", lblCita_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_DisponibilidadView.htm");
         /* Div Control */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblPago_title_Internalname, "Pago", "", "", lblPago_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_DisponibilidadView.htm");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         {
            /* WebComponent */
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "W0041"+"", GXutil.rtrim( WebComp_Pagowc_Component));
            httpContext.writeText( "<div") ;
            com.projectthani.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
   ...
   public void start1R2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Disponibilidad View", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldPagowc = httpContext.cgiGet( "W0041") ;
                        ...
                        if ( GXutil.len( WebComp_Pagowc_Component) != 0 )
                        {
                           WebComp_Pagowc.componentprocess("W0041", "", sEvt);
                        }
                        WebComp_Pagowc_Component = OldPagowc ;
                     }
                  }
   ...
   public void e121R2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.projectthani.disponibilidadww", new String[] {}, new String[] {})  ;
      ...
      {
         A34DisponibilidadId = H001R2_A34DisponibilidadId[0] ;
         AV18GXLvl9 = (byte)(1) ;
   ...
   public void S112( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( WebComp_Webcomponent_general_Component), GXutil.lower( "DisponibilidadGeneral")) != 0 )
      {
         WebComp_Webcomponent_general = WebUtils.getWebComponent(getClass(), "com.projectthani.disponibilidadgeneral_impl", remoteHandle, context);
         WebComp_Webcomponent_general_Component = "DisponibilidadGeneral" ;
      }
      if ( GXutil.len( WebComp_Webcomponent_general_Component) != 0 )
      {
         WebComp_Webcomponent_general.setjustcreated();
         WebComp_Webcomponent_general.componentprepare(new Object[] {"W0019","",Integer.valueOf(AV10DisponibilidadId)});
   ...
   public void S122( )
   {
      ...
      {
         A34DisponibilidadId = H001R3_A34DisponibilidadId[0] ;
         ...
         disponibilidadview_impl.this.GXt_boolean2 = GXv_boolean3[0] ;
         ...
         if ( AV15TempBoolean )
         {
            if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "Cita") == 0 ) )
            {
               ...
               if ( GXutil.strcmp(GXutil.lower( WebComp_Citawc_Component), GXutil.lower( "DisponibilidadCitaWC")) != 0 )
               {
                  WebComp_Citawc = WebUtils.getWebComponent(getClass(), "com.projectthani.disponibilidadcitawc_impl", remoteHandle, context);
                  WebComp_Citawc_Component = "DisponibilidadCitaWC" ;
               }
               if ( GXutil.len( WebComp_Citawc_Component) != 0 )
               {
                  WebComp_Citawc.setjustcreated();
                  WebComp_Citawc.componentprepare(new Object[] {"W0033","",Integer.valueOf(AV10DisponibilidadId)});
         ...
         if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "Pago") == 0 ) )
         {
            ...
            if ( GXutil.strcmp(GXutil.lower( WebComp_Pagowc_Component), GXutil.lower( "DisponibilidadPagoWC")) != 0 )
            {
               WebComp_Pagowc = WebUtils.getWebComponent(getClass(), "com.projectthani.disponibilidadpagowc_impl", remoteHandle, context);
               WebComp_Pagowc_Component = "DisponibilidadPagoWC" ;
            }
            if ( GXutil.len( WebComp_Pagowc_Component) != 0 )
            {
               WebComp_Pagowc.setjustcreated();
               WebComp_Pagowc.componentprepare(new Object[] {"W0041","",Integer.valueOf(AV10DisponibilidadId)});
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110331587", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("disponibilidadview.js", "?20225110331587", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void init_default_properties( )
   {
      ...
      divDisponibilidadgeneral_cell_Internalname = "DISPONIBILIDADGENERAL_CELL" ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Disponibilidad View" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10DisponibilidadId',fld:'vDISPONIBILIDADID',pic:'ZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("TABS.TABCHANGED","{handler:'e111R2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'A34DisponibilidadId',fld:'DISPONIBILIDADID',pic:'ZZZZZZZ9'},{av:'AV10DisponibilidadId',fld:'vDISPONIBILIDADID',pic:'ZZZZZZZ9',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
      setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'CITAWC'},{ctrl:'PAGOWC'}]}");
   }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H001R2_A34DisponibilidadId = new int[1] ;
      H001R3_A34DisponibilidadId = new int[1] ;
      GXv_boolean3 = new boolean[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.disponibilidadview__default(),
         new Object[] {
             new Object[] {
            H001R2_A34DisponibilidadId
            }
            , new Object[] {
            H001R3_A34DisponibilidadId
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String divDisponibilidadgeneral_cell_Internalname ;
   ...
   private int[] H001R2_A34DisponibilidadId ;
   private int[] H001R3_A34DisponibilidadId ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class disponibilidadview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001R2", "SELECT [DisponibilidadId] FROM [Disponibilidad] WHERE [DisponibilidadId] = ? ORDER BY [DisponibilidadId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H001R3", "SELECT [DisponibilidadId] FROM [Disponibilidad] WHERE [DisponibilidadId] = ? ORDER BY [DisponibilidadId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
