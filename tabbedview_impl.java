...
public final  class tabbedview_impl extends GXWebComponent
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110312575", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("com.projectthani.tabbedview", new String[] {GXutil.URLEncode(GXutil.rtrim(AV15TabCode))}, new String[] {"Tabs","TabCode"}) +"\">") ;
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vTABTEMPLATE", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV20TabTemplate, ""))));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV15TabCode", GXutil.rtrim( wcpOAV15TabCode));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vFIRSTTAB", GXutil.ltrim( localUtil.ntoc( AV5FirstTab, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vLASTTAB", GXutil.ltrim( localUtil.ntoc( AV11LastTab, (byte)(4), (byte)(0), ",", "")));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTABCODE", GXutil.rtrim( AV15TabCode));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vINDEX", GXutil.ltrim( localUtil.ntoc( AV8Index, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSELECTEDTAB", GXutil.ltrim( localUtil.ntoc( AV13SelectedTab, (byte)(4), (byte)(0), ",", "")));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTABSMARKUP", GXutil.rtrim( AV19TabsMarkup));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTABTEMPLATE", GXutil.rtrim( AV20TabTemplate));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vTABTEMPLATE", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV20TabTemplate, ""))));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vURLCHANGEDEVENT", AV23URLChangedEvent);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"HISTORYMANAGER_Hash", GXutil.rtrim( Historymanager_Hash));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"HISTORYMANAGER_Hash", GXutil.rtrim( Historymanager_Hash));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"HISTORYMANAGER_Hash", GXutil.rtrim( Historymanager_Hash));
   }
   ...
   public void wb1D0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.tabbedview");
            httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
            httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
            httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
            httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void S122( )
   {
      ...
      {
         AV14Tab = (com.projectthani.SdtTabOptions_TabOptionsItem)((com.projectthani.SdtTabOptions_TabOptionsItem)AV18Tabs.elementAt(-1+AV8Index));
   ...
   public void S132( )
   {
      ...
      {
         if ( ( ( GXutil.strcmp(Historymanager_Hash, "") == 0 ) && ( ( GXutil.strcmp(((com.projectthani.SdtTabOptions_TabOptionsItem)AV18Tabs.elementAt(-1+AV8Index)).getgxTv_SdtTabOptions_TabOptionsItem_Code(), AV15TabCode) == 0 ) ) ) || ( ( GXutil.strcmp(((com.projectthani.SdtTabOptions_TabOptionsItem)AV18Tabs.elementAt(-1+AV8Index)).getgxTv_SdtTabOptions_TabOptionsItem_Code(), Historymanager_Hash) == 0 ) ) )
         {
   ...
   public void wb_table1_2_1D2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.projectthani.GxWebStd.gx_table_start( httpContext, tblTable1_Internalname, tblTable1_Internalname, "", "ViewTable", 0, "", "", 0, 0, sStyleString, "none", "", 0);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divTabcontainer_Internalname, 1, 0, "px", 0, "px", "TabContainer", "left", "top", "", "", "div");
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblTabs_Internalname, lblTabs_Caption, "", "", lblTabs_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", 0, "", 1, 1, 0, (short)(1), "HLP_TabbedView.htm");
         /* Static images/pictures */
         ClassString = "TabPagingPrevious" ;
         StyleString = "" ;
         sImgUrl = "(none)" ;
         com.projectthani.GxWebStd.gx_bitmap( httpContext, imgTabprevious_Internalname, sImgUrl, "", "", "", context.getHttpContext().getTheme( ), imgTabprevious_Visible, 1, "", "Previous Tab", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, false, false, context.getHttpContext().getImageSrcSet( sImgUrl), "HLP_TabbedView.htm");
         /* Static images/pictures */
         ClassString = "TabPagingNext" ;
         StyleString = "" ;
         sImgUrl = "(none)" ;
         com.projectthani.GxWebStd.gx_bitmap( httpContext, imgTabnext_Internalname, sImgUrl, "", "", "", context.getHttpContext().getTheme( ), imgTabnext_Visible, 1, "", "Next Tab", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, false, false, context.getHttpContext().getImageSrcSet( sImgUrl), "HLP_TabbedView.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td style=\""+GXutil.CssPrettify( "vertical-align:top;height:39px")+"\">") ;
         wb_table2_11_1D2( true) ;
      }
      else
      {
         wb_table2_11_1D2( false) ;
      }
      return  ;
   }

   public void wb_table2_11_1D2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table2_11_1D2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.projectthani.GxWebStd.gx_table_start( httpContext, tblTable2_Internalname, tblTable2_Internalname, "", "TableBorder", 0, "", "", 0, 0, sStyleString, "none", "", 0);
         httpContext.writeText( "<tbody>") ;
         httpContext.writeText( "<tr>") ;
         ...
         {
            /* WebComponent */
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"W0014"+"", GXutil.rtrim( WebComp_Component_Component));
            httpContext.writeText( "<div") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_11_1D2e( true) ;
      }
      else
      {
         wb_table2_11_1D2e( false) ;
      }
   }
   ...
   {
      AV18Tabs = (GXBaseCollection<com.projectthani.SdtTabOptions_TabOptionsItem>)getParm(obj,0) ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      {
         AV18Tabs = (GXBaseCollection<com.projectthani.SdtTabOptions_TabOptionsItem>)getParm(obj,2) ;
   ...
   public void wcparametersget( )
   {
      ...
      {
         AV18Tabs = new GXBaseCollection<com.projectthani.SdtTabOptions_TabOptionsItem>() ;
      }
      else
      {
   ...
   public void wcparametersset( )
   {
      ...
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV18Tabs_CTRL", GXutil.rtrim( sCtrlAV18Tabs));
      }
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV15TabCode_PARM", GXutil.rtrim( AV15TabCode));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV15TabCode)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV15TabCode_CTRL", GXutil.rtrim( sCtrlAV15TabCode));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110312599", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("tabbedview.js", "?20225110312599", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("HISTORYMANAGER.URLCHANGED","{handler:'e111D2',iparms:[{av:'AV5FirstTab',fld:'vFIRSTTAB',pic:'ZZZ9'},{av:'AV11LastTab',fld:'vLASTTAB',pic:'ZZZ9'},{av:'AV18Tabs',fld:'vTABS',pic:''},{av:'AV15TabCode',fld:'vTABCODE',pic:''},{av:'Historymanager_Hash',ctrl:'HISTORYMANAGER',prop:'Hash'},{av:'AV8Index',fld:'vINDEX',pic:'ZZZ9'},{av:'AV13SelectedTab',fld:'vSELECTEDTAB',pic:'ZZZ9'},{av:'AV14Tab',fld:'vTAB',pic:''},{av:'AV19TabsMarkup',fld:'vTABSMARKUP',pic:''},{av:'AV20TabTemplate',fld:'vTABTEMPLATE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      gxfirstwebparm_bkp = "" ;
      sPrefix = "" ;
      AV18Tabs = new GXBaseCollection<com.projectthani.SdtTabOptions_TabOptionsItem>(com.projectthani.SdtTabOptions_TabOptionsItem.class, "TabOptionsItem", "ProjectThani", remoteHandle);
      AV15TabCode = "" ;
      ...
      AV20TabTemplate = "" ;
      GXKey = "" ;
      AV14Tab = new com.projectthani.SdtTabOptions_TabOptionsItem(remoteHandle, context);
      AV19TabsMarkup = "" ;
      GX_FocusControl = "" ;
   ...
   private GXBaseCollection<com.projectthani.SdtTabOptions_TabOptionsItem> AV18Tabs ;
   private com.projectthani.SdtTabOptions_TabOptionsItem AV14Tab ;
}
