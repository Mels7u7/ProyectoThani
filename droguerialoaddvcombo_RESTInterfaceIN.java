...
@javax.xml.bind.annotation.XmlType(name = "droguerialoaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class droguerialoaddvcombo_RESTInterfaceIN
{
   ...
   @JsonProperty("DrogueriaId")
   public short getDrogueriaId( )
   {
      return AV24DrogueriaId ;
   }

   @JsonProperty("DrogueriaId")
   public void setDrogueriaId(  short Value )
   {
      AV24DrogueriaId= Value;
   }
