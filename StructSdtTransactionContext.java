...
public final  class StructSdtTransactionContext implements Cloneable, java.io.Serializable
{
   ...
   public java.util.Vector<com.projectthani.StructSdtTransactionContext_Attribute> getAttributes( )
   {
      return gxTv_SdtTransactionContext_Attributes ;
   }

   public void setAttributes( java.util.Vector<com.projectthani.StructSdtTransactionContext_Attribute> value )
   {
   ...
   protected java.util.Vector<com.projectthani.StructSdtTransactionContext_Attribute> gxTv_SdtTransactionContext_Attributes=null ;
}
