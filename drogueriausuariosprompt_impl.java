...
public final  class drogueriausuariosprompt_impl extends GXDataArea
{
   public drogueriausuariosprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public drogueriausuariosprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( drogueriausuariosprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InDrogueriaId") ;
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            AV8InDrogueriaId = (short)(GXutil.lval( httpContext.GetPar( "InDrogueriaId"))) ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            {
               GxWebError = (byte)(1) ;
            ...
            gxgrgrid_refresh( subGrid_Rows, AV13FilterFullText, AV8InDrogueriaId) ;
         ...
         {
            AV8InDrogueriaId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InDrogueriaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InDrogueriaId), 4, 0));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110335653", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.drogueriausuariosprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InDrogueriaId,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutSecUserId,4,0))}, new String[] {"InDrogueriaId","InOutSecUserId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINDROGUERIAID", GXutil.ltrim( localUtil.ntoc( AV8InDrogueriaId, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return formatLink("com.projectthani.drogueriausuariosprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InDrogueriaId,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV9InOutSecUserId,4,0))}, new String[] {"InDrogueriaId","InOutSecUserId"})  ;
   }

   public String getPgmname( )
   {
      return "DrogueriaUsuariosPrompt" ;
   }
   ...
   public void wb5V0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_5V2( true) ;
      }
      else
      {
         wb_table1_12_5V2( false) ;
      }
      return  ;
   }

   public void wb_table1_12_5V2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start5V2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Usuarios", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf5V2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Short.valueOf(AV8InDrogueriaId) ,
         ...
         lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
         /* Using cursor H005V2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8InDrogueriaId), lV13FilterFullText, lV13FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_24_idx = 1 ;
         sGXsfl_24_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_24_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_242( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A36DrogueriaId = H005V2_A36DrogueriaId[0] ;
            A141DrogueriaNombre = H005V2_A141DrogueriaNombre[0] ;
            A14SecUserName = H005V2_A14SecUserName[0] ;
            A6SecUserId = H005V2_A6SecUserId[0] ;
            A141DrogueriaNombre = H005V2_A141DrogueriaNombre[0] ;
            A14SecUserName = H005V2_A14SecUserName[0] ;
            e175V2 ();
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
      /* Using cursor H005V3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8InDrogueriaId), lV13FilterFullText, lV13FilterFullText});
   ...
   public void e155V2( )
   {
      ...
      Form.setCaption( "Selecciona Usuarios" );
   ...
   public void wb_table1_12_5V2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_DrogueriaUsuariosPrompt.htm");
   ...
   {
      AV8InDrogueriaId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InDrogueriaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InDrogueriaId), 4, 0));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110335719", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("drogueriausuariosprompt.js", "?20225110335719", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InDrogueriaId',fld:'vINDROGUERIAID',pic:'ZZZ9'}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e115V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InDrogueriaId',fld:'vINDROGUERIAID',pic:'ZZZ9'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e125V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InDrogueriaId',fld:'vINDROGUERIAID',pic:'ZZZ9'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e135V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InDrogueriaId',fld:'vINDROGUERIAID',pic:'ZZZ9'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("ENTER","{handler:'e185V2',iparms:[{av:'A6SecUserId',fld:'SECUSERID',pic:'ZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV9InOutSecUserId',fld:'vINOUTSECUSERID',pic:'ZZZ9'}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e145V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InDrogueriaId',fld:'vINDROGUERIAID',pic:'ZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H005V2_A36DrogueriaId = new short[1] ;
      H005V2_A141DrogueriaNombre = new String[] {""} ;
      H005V2_A14SecUserName = new String[] {""} ;
      H005V2_A6SecUserId = new short[1] ;
      A141DrogueriaNombre = "" ;
      ...
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.drogueriausuariosprompt__default(),
         new Object[] {
             new Object[] {
            H005V2_A36DrogueriaId, H005V2_A141DrogueriaNombre, H005V2_A14SecUserName, H005V2_A6SecUserId
            }
            , new Object[] {
   ...
   private short wcpOAV8InDrogueriaId ;
   private short wcpOAV9InOutSecUserId ;
   private short AV8InDrogueriaId ;
   ...
   private short[] H005V2_A36DrogueriaId ;
   private String[] H005V2_A141DrogueriaNombre ;
   private String[] H005V2_A14SecUserName ;
   private short[] H005V2_A6SecUserId ;
...
final  class drogueriausuariosprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          short A36DrogueriaId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[DrogueriaId], T2.[DrogueriaNombre], T3.[SecUserName], T1.[SecUserId]" ;
      sFromString = " FROM (([DrogueriaUsuarios] T1 INNER JOIN [Drogueria] T2 ON T2.[DrogueriaId] = T1.[DrogueriaId]) INNER JOIN [SecUser] T3 ON T3.[SecUserId] = T1.[SecUserId])" ;
      sOrderString = "" ;
      ...
      if ( AV11OrderedBy == 1 )
      {
         sOrderString += " ORDER BY T2.[DrogueriaNombre]" ;
      }
                                          ...
                                          short A36DrogueriaId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM (([DrogueriaUsuarios] T1 INNER JOIN [Drogueria] T2 ON T2.[DrogueriaId] = T1.[DrogueriaId]) INNER JOIN [SecUser] T3 ON T3.[SecUserId] = T1.[SecUserId])" ;
      addWhere(sWhereString, "(T1.[DrogueriaId] = ?)");
      if ( ! (GXutil.strcmp("", AV13FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST(T1.[SecUserId] AS decimal(4,0))) like '%' + ?) or ( T3.[SecUserName] like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005V2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).shortValue() );
            case 1 :
                  return conditional_H005V3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).shortValue() );
      }
