...
public final  class drogueriausuarioswc_impl extends GXWebComponent
{
   public drogueriausuarioswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public drogueriausuarioswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( drogueriausuarioswc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV22IsAuthorized_SecUserName = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_SecUserName")) ;
               sPrefix = httpContext.GetPar( "sPrefix") ;
               ...
               gxgrgrid_refresh( subGrid_Rows, AV8DrogueriaId, AV25Pgmname, AV14OrderedBy, AV15OrderedDsc, AV22IsAuthorized_SecUserName, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Drogueria Usuarios WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511031265", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.drogueriausuarioswc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8DrogueriaId,4,0))}, new String[] {"DrogueriaId"}) +"\">") ;
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV25Pgmname, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_SECUSERNAME", getSecureSignedToken( sPrefix, AV22IsAuthorized_SecUserName));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"nRC_GXsfl_15", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_15, (byte)(8), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vGRIDCURRENTPAGE", GXutil.ltrim( localUtil.ntoc( AV20GridCurrentPage, (byte)(10), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vGRIDPAGECOUNT", GXutil.ltrim( localUtil.ntoc( AV21GridPageCount, (byte)(10), (byte)(0), ",", "")));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV25Pgmname));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV25Pgmname, ""))));
      ...
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_SECUSERNAME", AV22IsAuthorized_SecUserName);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_SECUSERNAME", getSecureSignedToken( sPrefix, AV22IsAuthorized_SecUserName));
   ...
   public void wb3V0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.drogueriausuarioswc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void start3V2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Drogueria Usuarios WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 boolean AV22IsAuthorized_SecUserName ,
                                 String sPrefix )
   {
      initialize_formulas( ) ;
      com.projectthani.GxWebStd.set_html_headers( httpContext, 0, "", "");
   ...
   {
      /* GeneXus formulas. */
      AV25Pgmname = "DrogueriaUsuariosWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf3V2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H003V2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8DrogueriaId), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_15_idx = 1 ;
         sGXsfl_15_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_15_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_152( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A36DrogueriaId = H003V2_A36DrogueriaId[0] ;
            ...
            A14SecUserName = H003V2_A14SecUserName[0] ;
            A6SecUserId = H003V2_A6SecUserId[0] ;
            A14SecUserName = H003V2_A14SecUserName[0] ;
            e163V2 ();
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      /* Using cursor H003V3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8DrogueriaId)});
   ...
   public void strup3V0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         AV20GridCurrentPage = localUtil.ctol( httpContext.cgiGet( sPrefix+"vGRIDCURRENTPAGE"), ",", ".") ;
         AV21GridPageCount = localUtil.ctol( httpContext.cgiGet( sPrefix+"vGRIDPAGECOUNT"), ",", ".") ;
   ...
   public void e143V2( )
   {
      ...
      GXt_boolean1 = AV22IsAuthorized_SecUserName ;
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWSecUser", GXv_boolean2) ;
      drogueriausuarioswc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV22IsAuthorized_SecUserName = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV22IsAuthorized_SecUserName", AV22IsAuthorized_SecUserName);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_SECUSERNAME", getSecureSignedToken( sPrefix, AV22IsAuthorized_SecUserName));
   ...
   private void e163V2( )
   {
      /* Grid_Load Routine */
      returnInSub = false ;
      if ( AV22IsAuthorized_SecUserName )
      {
   ...
   public void S122( )
   {
      ...
      {
         AV12GridState.fromxml(new com.projectthani.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( AV25Pgmname+"GridState"), null, null);
      }
      else
      {
   ...
   public void S142( )
   {
      ...
      new com.projectthani.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV25Pgmname+"GridState", AV12GridState.toxml(false, true, "WWPGridState", "ProjectThani")) ;
   }
   ...
   public void S112( )
   {
      ...
      AV16Session.setValue("TrnContext", AV10TrnContext.toxml(false, true, "WWPTransactionContext", "ProjectThani"));
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "drogueriausuarioswc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110312717", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("drogueriausuarioswc.js", "?20225110312717", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   {
      edtSecUserId_Internalname = sPrefix+"SECUSERID_"+sGXsfl_15_idx ;
      edtSecUserName_Internalname = sPrefix+"SECUSERNAME_"+sGXsfl_15_idx ;
   }

   public void subsflControlProps_fel_152( )
   {
      edtSecUserId_Internalname = sPrefix+"SECUSERID_"+sGXsfl_15_fel_idx ;
      edtSecUserName_Internalname = sPrefix+"SECUSERNAME_"+sGXsfl_15_fel_idx ;
   }
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "0:SecUserId|1:SecUserName" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8DrogueriaId',fld:'vDROGUERIAID',pic:'ZZZ9'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV25Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV22IsAuthorized_SecUserName',fld:'vISAUTHORIZED_SECUSERNAME',pic:'',hsh:true}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e113V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8DrogueriaId',fld:'vDROGUERIAID',pic:'ZZZ9'},{av:'AV25Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV22IsAuthorized_SecUserName',fld:'vISAUTHORIZED_SECUSERNAME',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e163V2',iparms:[{av:'AV22IsAuthorized_SecUserName',fld:'vISAUTHORIZED_SECUSERNAME',pic:'',hsh:true},{av:'A6SecUserId',fld:'SECUSERID',pic:'ZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      sEvtType = "" ;
      scmdbuf = "" ;
      H003V2_A36DrogueriaId = new short[1] ;
      H003V2_A14SecUserName = new String[] {""} ;
      H003V2_A6SecUserId = new short[1] ;
      ...
      sCtrlAV8DrogueriaId = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.drogueriausuarioswc__default(),
         new Object[] {
             new Object[] {
            H003V2_A36DrogueriaId, H003V2_A14SecUserName, H003V2_A6SecUserId
            }
            , new Object[] {
   ...
   private boolean AV22IsAuthorized_SecUserName ;
   ...
   private short[] H003V2_A36DrogueriaId ;
   private String[] H003V2_A14SecUserName ;
   private short[] H003V2_A6SecUserId ;
...
final  class drogueriausuarioswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          short A36DrogueriaId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[DrogueriaId], T2.[SecUserName], T1.[SecUserId]" ;
      sFromString = " FROM ([DrogueriaUsuarios] T1 INNER JOIN [SecUser] T2 ON T2.[SecUserId] = T1.[SecUserId])" ;
      sOrderString = "" ;
      ...
      {
         sOrderString += " ORDER BY T1.[DrogueriaId] DESC, T1.[SecUserId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[DrogueriaId], T2.[SecUserName]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[DrogueriaId] DESC, T2.[SecUserName] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[DrogueriaId], T1.[SecUserId]" ;
                                          ...
                                          short A36DrogueriaId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([DrogueriaUsuarios] T1 INNER JOIN [SecUser] T2 ON T2.[SecUserId] = T1.[SecUserId])" ;
      addWhere(sWhereString, "(T1.[DrogueriaId] = ?)");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H003V2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).shortValue() , ((Number) dynConstraints[3]).shortValue() );
            case 1 :
                  return conditional_H003V3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).shortValue() , ((Number) dynConstraints[3]).shortValue() );
      }
