...
public final  class pacienteratingprofesionalwc_impl extends GXWebComponent
{
   public pacienteratingprofesionalwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public pacienteratingprofesionalwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( pacienteratingprofesionalwc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Paciente Rating Profesional WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110321991", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   public void renderHtmlCloseForm7F2( )
   {
   ...
   {
      return "PacienteRatingProfesionalWC" ;
   }
   ...
   public void wb7F0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.pacienteratingprofesionalwc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_7F2( true) ;
      }
      else
      {
         wb_table1_22_7F2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_7F2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A60RatingProfesionalId, (byte)(8), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A62SGProfesionalProfesionalId, (byte)(8), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A366RatingProfesionalCitaId, (byte)(4), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.format(A353RatingProfesionalFechaRegistro, "99/99/99"));
            GridContainer.AddColumnProperties(GridColumn);
   ...
   public void start7F2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Paciente Rating Profesional WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           GXCCtl = "RATINGPROFESIONALRATING_Enabled_" + sGXsfl_37_idx ;
                           Ratingprofesionalrating_Enabled = GXutil.strtobool( httpContext.cgiGet( sPrefix+GXCCtl)) ;
                           httpContext.ajax_rsp_assign_prop(sPrefix, false, Ratingprofesionalrating_Internalname, "Enabled", GXutil.booltostr( Ratingprofesionalrating_Enabled), true);
                           ...
                           A353RatingProfesionalFechaRegistro = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtRatingProfesionalFechaRegistro_Internalname), 0)) ;
                           GXCCtl = "RATINGPROFESIONALRATING_" + sGXsfl_37_idx ;
                           A352RatingProfesionalRating = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+GXCCtl), ",", ".")) ;
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
   ...
   {
      /* GeneXus formulas. */
      AV33Pgmname = "PacienteRatingProfesionalWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf7F2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV16FilterFullText ,
                                              Integer.valueOf(A60RatingProfesionalId) ,
                                              Integer.valueOf(A62SGProfesionalProfesionalId) ,
                                              Short.valueOf(A366RatingProfesionalCitaId) ,
                                              Short.valueOf(A352RatingProfesionalRating) ,
                                              Short.valueOf(AV14OrderedBy) ,
                                              Boolean.valueOf(AV15OrderedDsc) ,
                                              Integer.valueOf(AV8SGPacientePacienteId) ,
                                              Integer.valueOf(A61SGPacientePacienteId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.INT, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.INT
                                              }
         });
         ...
         {
            A61SGPacientePacienteId = H007F2_A61SGPacientePacienteId[0] ;
            ...
            A352RatingProfesionalRating = H007F2_A352RatingProfesionalRating[0] ;
            A353RatingProfesionalFechaRegistro = H007F2_A353RatingProfesionalFechaRegistro[0] ;
            A366RatingProfesionalCitaId = H007F2_A366RatingProfesionalCitaId[0] ;
            A62SGProfesionalProfesionalId = H007F2_A62SGProfesionalProfesionalId[0] ;
            A60RatingProfesionalId = H007F2_A60RatingProfesionalId[0] ;
            e187F2 ();
   ...
   public void send_integrity_lvl_hashes7F2( )
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV33Pgmname));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV33Pgmname, ""))));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_UPDATE", AV27IsAuthorized_Update);
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      GRID_nRecordCount = H007F3_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void e117F2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("PacienteRatingProfesionalWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV33Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("PacienteRatingProfesionalWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "PacienteRatingProfesionalWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         pacienteratingprofesionalwc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      pacienteratingprofesionalwc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "PacienteRatingProfesionalWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void wb_table1_22_7F2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_7F2( true) ;
      }
      else
      {
         wb_table2_27_7F2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_7F2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_7F2e( true) ;
      }
      else
      {
         wb_table1_22_7F2e( false) ;
      }
   }

   public void wb_table2_27_7F2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "pacienteratingprofesionalwc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110322171", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("pacienteratingprofesionalwc.js", "?20225110322171", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtRatingProfesionalId_Internalname = sPrefix+"RATINGPROFESIONALID_"+sGXsfl_37_idx ;
      edtSGProfesionalProfesionalId_Internalname = sPrefix+"SGPROFESIONALPROFESIONALID_"+sGXsfl_37_idx ;
      edtRatingProfesionalCitaId_Internalname = sPrefix+"RATINGPROFESIONALCITAID_"+sGXsfl_37_idx ;
      Ratingprofesionalrating_Internalname = sPrefix+"RATINGPROFESIONALRATING_"+sGXsfl_37_idx ;
      edtRatingProfesionalFechaRegistro_Internalname = sPrefix+"RATINGPROFESIONALFECHAREGISTRO_"+sGXsfl_37_idx ;
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtRatingProfesionalId_Internalname = sPrefix+"RATINGPROFESIONALID_"+sGXsfl_37_fel_idx ;
      edtSGProfesionalProfesionalId_Internalname = sPrefix+"SGPROFESIONALPROFESIONALID_"+sGXsfl_37_fel_idx ;
      edtRatingProfesionalCitaId_Internalname = sPrefix+"RATINGPROFESIONALCITAID_"+sGXsfl_37_fel_idx ;
      Ratingprofesionalrating_Internalname = sPrefix+"RATINGPROFESIONALRATING_"+sGXsfl_37_fel_idx ;
      edtRatingProfesionalFechaRegistro_Internalname = sPrefix+"RATINGPROFESIONALFECHAREGISTRO_"+sGXsfl_37_fel_idx ;
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRatingProfesionalId_Internalname,GXutil.ltrim( localUtil.ntoc( A60RatingProfesionalId, (byte)(8), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A60RatingProfesionalId), "ZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRatingProfesionalId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRatingProfesionalCitaId_Internalname,GXutil.ltrim( localUtil.ntoc( A366RatingProfesionalCitaId, (byte)(4), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A366RatingProfesionalCitaId), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRatingProfesionalCitaId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td>") ;
         ...
         /* User Defined Control */
         GridRow.AddColumnProperties("usercontrol", -1, isAjaxCallMode( ), new Object[] {sPrefix+"RATINGPROFESIONALRATINGContainer"+"_"+sGXsfl_37_idx,Integer.valueOf(1)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRatingProfesionalFechaRegistro_Internalname,localUtil.format(A353RatingProfesionalFechaRegistro, "99/99/99"),localUtil.format( A353RatingProfesionalFechaRegistro, "99/99/99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRatingProfesionalFechaRegistro_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         send_integrity_lvl_hashes7F2( ) ;
         GXCCtl = "RATINGPROFESIONALRATING_" + sGXsfl_37_idx ;
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+GXCCtl, GXutil.ltrim( localUtil.ntoc( A352RatingProfesionalRating, (byte)(4), (byte)(0), ",", "")));
         GXCCtl = "RATINGPROFESIONALRATING_Enabled_" + sGXsfl_37_idx ;
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+GXCCtl, GXutil.booltostr( Ratingprofesionalrating_Enabled));
   ...
   public void init_default_properties( )
   {
      ...
      edtRatingProfesionalId_Internalname = sPrefix+"RATINGPROFESIONALID" ;
      edtSGProfesionalProfesionalId_Internalname = sPrefix+"SGPROFESIONALPROFESIONALID" ;
      edtRatingProfesionalCitaId_Internalname = sPrefix+"RATINGPROFESIONALCITAID" ;
      Ratingprofesionalrating_Internalname = sPrefix+"RATINGPROFESIONALRATING" ;
      edtRatingProfesionalFechaRegistro_Internalname = sPrefix+"RATINGPROFESIONALFECHAREGISTRO" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:RatingProfesionalId|3:SGProfesionalProfesionalId|4:RatingProfesionalCitaId|5:RatingProfesionalRating|6:RatingProfesionalFechaRegistro" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e187F2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A20PacienteId',fld:'PACIENTEID',pic:'ZZZZZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e157F2',iparms:[{av:'A20PacienteId',fld:'PACIENTEID',pic:'ZZZZZZZ9',hsh:true}]");
      setEventMetadata("'DOINSERT'",",oparms:[]}");
      setEventMetadata("NULL","{handler:'valid_Ratingprofesionalfecharegistro',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H007F2_A61SGPacientePacienteId = new int[1] ;
      H007F2_A352RatingProfesionalRating = new short[1] ;
      H007F2_A353RatingProfesionalFechaRegistro = new java.util.Date[] {GXutil.nullDate()} ;
      H007F2_A366RatingProfesionalCitaId = new short[1] ;
      H007F2_A62SGProfesionalProfesionalId = new int[1] ;
      H007F2_A60RatingProfesionalId = new int[1] ;
      H007F3_AGRID_nRecordCount = new long[1] ;
      ...
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.pacienteratingprofesionalwc__default(),
         new Object[] {
             new Object[] {
            H007F2_A61SGPacientePacienteId, H007F2_A352RatingProfesionalRating, H007F2_A353RatingProfesionalFechaRegistro, H007F2_A366RatingProfesionalCitaId, H007F2_A62SGProfesionalProfesionalId, H007F2_A60RatingProfesionalId
            }
            , new Object[] {
            H007F3_AGRID_nRecordCount
            }
         }
      );
      AV33Pgmname = "PacienteRatingProfesionalWC" ;
   ...
   private int[] H007F2_A61SGPacientePacienteId ;
   private short[] H007F2_A352RatingProfesionalRating ;
   private java.util.Date[] H007F2_A353RatingProfesionalFechaRegistro ;
   private short[] H007F2_A366RatingProfesionalCitaId ;
   private int[] H007F2_A62SGProfesionalProfesionalId ;
   private int[] H007F2_A60RatingProfesionalId ;
   private long[] H007F3_AGRID_nRecordCount ;
...
final  class pacienteratingprofesionalwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H007F2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A60RatingProfesionalId ,
                                          int A62SGProfesionalProfesionalId ,
                                          short A366RatingProfesionalCitaId ,
                                          short A352RatingProfesionalRating ,
                                          short AV14OrderedBy ,
                                          boolean AV15OrderedDsc ,
                                          int AV8SGPacientePacienteId ,
                                          int A61SGPacientePacienteId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [SGPacientePacienteId], [RatingProfesionalRating], [RatingProfesionalFechaRegistro], [RatingProfesionalCitaId], [SGProfesionalProfesionalId], [RatingProfesionalId]" ;
      sFromString = " FROM [RatingProfesional]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([SGPacientePacienteId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([RatingProfesionalId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(8), CAST([SGProfesionalProfesionalId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(4), CAST([RatingProfesionalCitaId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(4), CAST([RatingProfesionalRating] AS decimal(4,0))) like '%' + ?))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [RatingProfesionalCitaId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [RatingProfesionalCitaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [RatingProfesionalId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [RatingProfesionalId] DESC" ;
      }
      ...
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [RatingProfesionalRating]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [RatingProfesionalRating] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [RatingProfesionalFechaRegistro]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [RatingProfesionalFechaRegistro] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [RatingProfesionalId]" ;
      }
   ...
   protected Object[] conditional_H007F3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A60RatingProfesionalId ,
                                          ...
                                          int A61SGPacientePacienteId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [RatingProfesional]" ;
      addWhere(sWhereString, "([SGPacientePacienteId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([RatingProfesionalId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(8), CAST([SGProfesionalProfesionalId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(4), CAST([RatingProfesionalCitaId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(4), CAST([RatingProfesionalRating] AS decimal(4,0))) like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H007F2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).shortValue() , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() , ((Number) dynConstraints[7]).intValue() , ((Number) dynConstraints[8]).intValue() );
            case 1 :
                  return conditional_H007F3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).shortValue() , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() , ((Number) dynConstraints[7]).intValue() , ((Number) dynConstraints[8]).intValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H007F2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H007F3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
