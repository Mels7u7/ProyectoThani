...
public final  class templateprompt_impl extends GXDataArea
{
   public templateprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public templateprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( templateprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutTemplateId") ;
         ...
         {
            AV8InOutTemplateId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTemplateId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTemplateId), 4, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutTemplateCode = httpContext.GetPar( "InOutTemplateCode") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutTemplateCode", AV9InOutTemplateCode);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202251103426", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.templateprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutTemplateId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutTemplateCode))}, new String[] {"InOutTemplateId","InOutTemplateCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTTEMPLATEID", GXutil.ltrim( localUtil.ntoc( AV8InOutTemplateId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTTEMPLATECODE", AV9InOutTemplateCode);
   ...
   {
      return formatLink("com.projectthani.templateprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutTemplateId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutTemplateCode))}, new String[] {"InOutTemplateId","InOutTemplateCode"})  ;
   }
   ...
   public void wb670( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_672( true) ;
      }
      else
      {
         wb_table1_12_672( false) ;
      }
      return  ;
   }

   public void wb_table1_12_672e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Content") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         ...
         else
         {
            ...
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A53TemplateId, (byte)(4), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A291TemplateCode);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A292TemplateContent);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.rtrim( A293TemplateStatus));
            GridContainer.AddColumnProperties(GridColumn);
   ...
   public void start672( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Template", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           cmbTemplateStatus.setName( cmbTemplateStatus.getInternalname() );
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_TEMPLATEID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A53TemplateId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "TEMPLATEID", GXutil.ltrim( localUtil.ntoc( A53TemplateId, (byte)(4), (byte)(0), ".", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_TEMPLATECODE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A291TemplateCode, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "TEMPLATECODE", A291TemplateCode);
   }
   ...
   public void rf672( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                              }
         });
         ...
         {
            A293TemplateStatus = H00672_A293TemplateStatus[0] ;
            A292TemplateContent = H00672_A292TemplateContent[0] ;
            A291TemplateCode = H00672_A291TemplateCode[0] ;
            A53TemplateId = H00672_A53TemplateId[0] ;
            e17672 ();
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_TEMPLATEID"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, localUtil.format( DecimalUtil.doubleToDec(A53TemplateId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_TEMPLATECODE"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, GXutil.rtrim( localUtil.format( A291TemplateCode, ""))));
   }
   ...
   public void e15672( )
   {
      ...
      Form.setCaption( "Selecciona Template" );
   ...
   public void e18672( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutTemplateId = A53TemplateId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTemplateId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTemplateId), 4, 0));
      AV9InOutTemplateCode = A291TemplateCode ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutTemplateCode", AV9InOutTemplateCode);
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV8InOutTemplateId),AV9InOutTemplateCode});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutTemplateId","AV9InOutTemplateCode"});
   ...
   public void wb_table1_12_672( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_TemplatePrompt.htm");
   ...
   {
      AV8InOutTemplateId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutTemplateId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutTemplateId), 4, 0));
      AV9InOutTemplateCode = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutTemplateCode", AV9InOutTemplateCode);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511034272", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("templateprompt.js", "?2022511034272", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_242( )
   {
      ...
      edtTemplateId_Internalname = "TEMPLATEID_"+sGXsfl_24_idx ;
      edtTemplateCode_Internalname = "TEMPLATECODE_"+sGXsfl_24_idx ;
      edtTemplateContent_Internalname = "TEMPLATECONTENT_"+sGXsfl_24_idx ;
      cmbTemplateStatus.setInternalname( "TEMPLATESTATUS_"+sGXsfl_24_idx );
   }

   public void subsflControlProps_fel_242( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_24_fel_idx ;
      edtTemplateId_Internalname = "TEMPLATEID_"+sGXsfl_24_fel_idx ;
      edtTemplateCode_Internalname = "TEMPLATECODE_"+sGXsfl_24_fel_idx ;
      edtTemplateContent_Internalname = "TEMPLATECONTENT_"+sGXsfl_24_fel_idx ;
      cmbTemplateStatus.setInternalname( "TEMPLATESTATUS_"+sGXsfl_24_fel_idx );
   }
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTemplateId_Internalname,GXutil.ltrim( localUtil.ntoc( A53TemplateId, (byte)(4), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A53TemplateId), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTemplateId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(24),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id4","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTemplateCode_Internalname,A291TemplateCode,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTemplateCode_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(24),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTemplateContent_Internalname,A292TemplateContent,A292TemplateContent,"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTemplateContent_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(2097152),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(24),Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         }
         if ( ( cmbTemplateStatus.getItemCount() == 0 ) && isAjaxCallMode( ) )
         {
            GXCCtl = "TEMPLATESTATUS_" + sGXsfl_24_idx ;
            cmbTemplateStatus.setName( GXCCtl );
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbTemplateStatus,cmbTemplateStatus.getInternalname(),GXutil.rtrim( A293TemplateStatus),Integer.valueOf(1),cmbTemplateStatus.getJsonclick(),Integer.valueOf(0),"'"+""+"'"+",false,"+"'"+""+"'","char","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","Attribute","WWColumn hidden-xs","","","",Boolean.valueOf(true),Integer.valueOf(1)});
         cmbTemplateStatus.setValue( GXutil.rtrim( A293TemplateStatus) );
         httpContext.ajax_rsp_assign_prop("", false, cmbTemplateStatus.getInternalname(), "Values", cmbTemplateStatus.ToJavascriptSource(), !bGXsfl_24_Refreshing);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:TemplateId|2:TemplateCode|3:TemplateContent|4:TemplateStatus" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11672',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12672',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e13672',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e17672',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e18672',iparms:[{av:'A53TemplateId',fld:'TEMPLATEID',pic:'ZZZ9',hsh:true},{av:'A291TemplateCode',fld:'TEMPLATECODE',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutTemplateId',fld:'vINOUTTEMPLATEID',pic:'ZZZ9'},{av:'AV9InOutTemplateCode',fld:'vINOUTTEMPLATECODE',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e14672',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
      ...
      setEventMetadata("NULL","{handler:'valid_Templatestatus',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H00672_A293TemplateStatus = new String[] {""} ;
      H00672_A292TemplateContent = new String[] {""} ;
      H00672_A291TemplateCode = new String[] {""} ;
      H00672_A53TemplateId = new short[1] ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.templateprompt__default(),
         new Object[] {
             new Object[] {
            H00672_A293TemplateStatus, H00672_A292TemplateContent, H00672_A291TemplateCode, H00672_A53TemplateId
            }
            , new Object[] {
   ...
   private short wcpOAV8InOutTemplateId ;
   private short AV8InOutTemplateId ;
   ...
   private String edtTemplateContent_Jsonclick ;
   ...
   private String wcpOAV9InOutTemplateCode ;
   private String AV13FilterFullText ;
   private String AV9InOutTemplateCode ;
   ...
   private String[] H00672_A293TemplateStatus ;
   private String[] H00672_A292TemplateContent ;
   private String[] H00672_A291TemplateCode ;
   private short[] H00672_A53TemplateId ;
...
final  class templateprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [TemplateStatus], [TemplateContent], [TemplateCode], [TemplateId]" ;
      sFromString = " FROM [Template]" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV13FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([TemplateId] AS decimal(4,0))) like '%' + ?) or ( [TemplateCode] like '%' + ?) or ( [TemplateContent] like '%' + ?) or ( 'activo' like '%' + LOWER(?) and [TemplateStatus] = 'A') or ( 'inactivo' like '%' + LOWER(?) and [TemplateStatus] = 'I'))");
      }
      else
      {
         GXv_int4[0] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [TemplateCode]" ;
      }
      else if ( ( AV11OrderedBy == 1 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY [TemplateCode] DESC" ;
      }
      else if ( ( AV11OrderedBy == 2 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY [TemplateId]" ;
      }
      else if ( ( AV11OrderedBy == 2 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY [TemplateId] DESC" ;
      }
      else if ( ( AV11OrderedBy == 3 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY [TemplateContent]" ;
      }
      else if ( ( AV11OrderedBy == 3 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY [TemplateContent] DESC" ;
      }
      else if ( ( AV11OrderedBy == 4 ) && ! AV12OrderedDsc )
      {
         sOrderString += " ORDER BY [TemplateStatus]" ;
      }
      else if ( ( AV11OrderedBy == 4 ) && ( AV12OrderedDsc ) )
      {
         sOrderString += " ORDER BY [TemplateStatus] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [TemplateId]" ;
                                          ...
                                          boolean AV12OrderedDsc )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [Template]" ;
      if ( ! (GXutil.strcmp("", AV13FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([TemplateId] AS decimal(4,0))) like '%' + ?) or ( [TemplateCode] like '%' + ?) or ( [TemplateContent] like '%' + ?) or ( 'activo' like '%' + LOWER(?) and [TemplateStatus] = 'A') or ( 'inactivo' like '%' + LOWER(?) and [TemplateStatus] = 'I'))");
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00672(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
            case 1 :
                  return conditional_H00673(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() );
      }
