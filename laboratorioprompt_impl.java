...
public final  class laboratorioprompt_impl extends GXDataArea
{
   public laboratorioprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public laboratorioprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( laboratorioprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutLaboratorioId") ;
         ...
         {
            AV8InOutLaboratorioId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutLaboratorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutLaboratorioId), 4, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutLaboratorioNombre = httpContext.GetPar( "InOutLaboratorioNombre") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutLaboratorioNombre", AV9InOutLaboratorioNombre);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110333386", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.laboratorioprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutLaboratorioId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutLaboratorioNombre))}, new String[] {"InOutLaboratorioId","InOutLaboratorioNombre"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTLABORATORIOID", GXutil.ltrim( localUtil.ntoc( AV8InOutLaboratorioId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTLABORATORIONOMBRE", AV9InOutLaboratorioNombre);
   ...
   {
      return formatLink("com.projectthani.laboratorioprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutLaboratorioId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutLaboratorioNombre))}, new String[] {"InOutLaboratorioId","InOutLaboratorioNombre"})  ;
   }

   public String getPgmname( )
   {
      return "LaboratorioPrompt" ;
   }
   ...
   public void wb2I0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_2I2( true) ;
      }
      else
      {
         wb_table1_12_2I2( false) ;
      }
      return  ;
   }

   public void wb_table1_12_2I2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start2I2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Laboratorio", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtLaboratorioPhoto_Internalname, "Bitmap", ((GXutil.strcmp("", A169LaboratorioPhoto)==0) ? A40000LaboratorioPhoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A169LaboratorioPhoto))), !bGXsfl_24_Refreshing);
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_LABORATORIONOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A165LaboratorioNombre, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "LABORATORIONOMBRE", A165LaboratorioNombre);
   }
   ...
   public void rf2I2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
         /* Using cursor H002I2 */
         pr_default.execute(0, new Object[] {lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_24_idx = 1 ;
         sGXsfl_24_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_24_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_242( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A171LaboratorioEstado = H002I2_A171LaboratorioEstado[0] ;
            A170LaboratorioComision = H002I2_A170LaboratorioComision[0] ;
            A169LaboratorioPhoto = H002I2_A169LaboratorioPhoto[0] ;
            httpContext.ajax_rsp_assign_prop("", false, edtLaboratorioPhoto_Internalname, "Bitmap", ((GXutil.strcmp("", A169LaboratorioPhoto)==0) ? A40000LaboratorioPhoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A169LaboratorioPhoto))), !bGXsfl_24_Refreshing);
            httpContext.ajax_rsp_assign_prop("", false, edtLaboratorioPhoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A169LaboratorioPhoto), true);
            A40000LaboratorioPhoto_GXI = H002I2_A40000LaboratorioPhoto_GXI[0] ;
            httpContext.ajax_rsp_assign_prop("", false, edtLaboratorioPhoto_Internalname, "Bitmap", ((GXutil.strcmp("", A169LaboratorioPhoto)==0) ? A40000LaboratorioPhoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A169LaboratorioPhoto))), !bGXsfl_24_Refreshing);
            httpContext.ajax_rsp_assign_prop("", false, edtLaboratorioPhoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A169LaboratorioPhoto), true);
            A168LaboratorioNroDocumento = H002I2_A168LaboratorioNroDocumento[0] ;
            A167LaboratorioTipoDocumento = H002I2_A167LaboratorioTipoDocumento[0] ;
            A166LaboratorioDescripcion = H002I2_A166LaboratorioDescripcion[0] ;
            A165LaboratorioNombre = H002I2_A165LaboratorioNombre[0] ;
            A40LaboratorioId = H002I2_A40LaboratorioId[0] ;
            e172I2 ();
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_LABORATORIOID"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, localUtil.format( DecimalUtil.doubleToDec(A40LaboratorioId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_LABORATORIONOMBRE"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, GXutil.rtrim( localUtil.format( A165LaboratorioNombre, ""))));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
      /* Using cursor H002I3 */
      pr_default.execute(1, new Object[] {lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText});
   ...
   public void e152I2( )
   {
      ...
      Form.setCaption( "Selecciona Laboratorio" );
   ...
   public void e182I2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutLaboratorioId = A40LaboratorioId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutLaboratorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutLaboratorioId), 4, 0));
      AV9InOutLaboratorioNombre = A165LaboratorioNombre ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutLaboratorioNombre", AV9InOutLaboratorioNombre);
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV8InOutLaboratorioId),AV9InOutLaboratorioNombre});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutLaboratorioId","AV9InOutLaboratorioNombre"});
   ...
   public void wb_table1_12_2I2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_LaboratorioPrompt.htm");
   ...
   {
      AV8InOutLaboratorioId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutLaboratorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutLaboratorioId), 4, 0));
      AV9InOutLaboratorioNombre = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutLaboratorioNombre", AV9InOutLaboratorioNombre);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511033356", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("laboratorioprompt.js", "?2022511033357", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_242( )
   {
      ...
      edtLaboratorioId_Internalname = "LABORATORIOID_"+sGXsfl_24_idx ;
      edtLaboratorioNombre_Internalname = "LABORATORIONOMBRE_"+sGXsfl_24_idx ;
      edtLaboratorioDescripcion_Internalname = "LABORATORIODESCRIPCION_"+sGXsfl_24_idx ;
      cmbLaboratorioTipoDocumento.setInternalname( "LABORATORIOTIPODOCUMENTO_"+sGXsfl_24_idx );
      edtLaboratorioNroDocumento_Internalname = "LABORATORIONRODOCUMENTO_"+sGXsfl_24_idx ;
      edtLaboratorioPhoto_Internalname = "LABORATORIOPHOTO_"+sGXsfl_24_idx ;
      edtLaboratorioComision_Internalname = "LABORATORIOCOMISION_"+sGXsfl_24_idx ;
      cmbLaboratorioEstado.setInternalname( "LABORATORIOESTADO_"+sGXsfl_24_idx );
   }

   public void subsflControlProps_fel_242( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_24_fel_idx ;
      edtLaboratorioId_Internalname = "LABORATORIOID_"+sGXsfl_24_fel_idx ;
      edtLaboratorioNombre_Internalname = "LABORATORIONOMBRE_"+sGXsfl_24_fel_idx ;
      edtLaboratorioDescripcion_Internalname = "LABORATORIODESCRIPCION_"+sGXsfl_24_fel_idx ;
      cmbLaboratorioTipoDocumento.setInternalname( "LABORATORIOTIPODOCUMENTO_"+sGXsfl_24_fel_idx );
      edtLaboratorioNroDocumento_Internalname = "LABORATORIONRODOCUMENTO_"+sGXsfl_24_fel_idx ;
      edtLaboratorioPhoto_Internalname = "LABORATORIOPHOTO_"+sGXsfl_24_fel_idx ;
      edtLaboratorioComision_Internalname = "LABORATORIOCOMISION_"+sGXsfl_24_fel_idx ;
      cmbLaboratorioEstado.setInternalname( "LABORATORIOESTADO_"+sGXsfl_24_fel_idx );
   }
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         {
            GXCCtl = "LABORATORIOTIPODOCUMENTO_" + sGXsfl_24_idx ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbLaboratorioTipoDocumento.getInternalname(), "Values", cmbLaboratorioTipoDocumento.ToJavascriptSource(), !bGXsfl_24_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         {
            GXCCtl = "LABORATORIOESTADO_" + sGXsfl_24_idx ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbLaboratorioEstado.getInternalname(), "Values", cmbLaboratorioEstado.ToJavascriptSource(), !bGXsfl_24_Refreshing);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:LaboratorioId|2:LaboratorioNombre|3:LaboratorioDescripcion|4:LaboratorioTipoDocumento|5:LaboratorioNroDocumento|7:LaboratorioComision|8:LaboratorioEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e112I2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e122I2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e172I2',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e182I2',iparms:[{av:'A40LaboratorioId',fld:'LABORATORIOID',pic:'ZZZ9',hsh:true},{av:'A165LaboratorioNombre',fld:'LABORATORIONOMBRE',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutLaboratorioId',fld:'vINOUTLABORATORIOID',pic:'ZZZ9'},{av:'AV9InOutLaboratorioNombre',fld:'vINOUTLABORATORIONOMBRE',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e142I2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H002I2_A171LaboratorioEstado = new String[] {""} ;
      H002I2_A170LaboratorioComision = new short[1] ;
      H002I2_A169LaboratorioPhoto = new String[] {""} ;
      H002I2_A40000LaboratorioPhoto_GXI = new String[] {""} ;
      H002I2_A168LaboratorioNroDocumento = new String[] {""} ;
      H002I2_A167LaboratorioTipoDocumento = new String[] {""} ;
      H002I2_A166LaboratorioDescripcion = new String[] {""} ;
      H002I2_A165LaboratorioNombre = new String[] {""} ;
      H002I2_A40LaboratorioId = new short[1] ;
      ...
      StyleString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.laboratorioprompt__default(),
         new Object[] {
             new Object[] {
            H002I2_A171LaboratorioEstado, H002I2_A170LaboratorioComision, H002I2_A169LaboratorioPhoto, H002I2_A40000LaboratorioPhoto_GXI, H002I2_A168LaboratorioNroDocumento, H002I2_A167LaboratorioTipoDocumento, H002I2_A166LaboratorioDescripcion, H002I2_A165LaboratorioNombre, H002I2_A40LaboratorioId
            }
            , new Object[] {
   ...
   private short wcpOAV8InOutLaboratorioId ;
   private short AV8InOutLaboratorioId ;
   ...
   private String wcpOAV9InOutLaboratorioNombre ;
   private String AV13FilterFullText ;
   private String AV9InOutLaboratorioNombre ;
   ...
   private String[] H002I2_A171LaboratorioEstado ;
   private short[] H002I2_A170LaboratorioComision ;
   private String[] H002I2_A169LaboratorioPhoto ;
   private String[] H002I2_A40000LaboratorioPhoto_GXI ;
   private String[] H002I2_A168LaboratorioNroDocumento ;
   private String[] H002I2_A167LaboratorioTipoDocumento ;
   private String[] H002I2_A166LaboratorioDescripcion ;
   private String[] H002I2_A165LaboratorioNombre ;
   private short[] H002I2_A40LaboratorioId ;
...
final  class laboratorioprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H002I2( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H002I3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          short A40LaboratorioId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H002I2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , ((Boolean) dynConstraints[9]).booleanValue() );
            case 1 :
                  return conditional_H002I3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , ((Boolean) dynConstraints[9]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H002I2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H002I3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
