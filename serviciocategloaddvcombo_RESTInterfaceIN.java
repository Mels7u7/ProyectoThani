...
@javax.xml.bind.annotation.XmlType(name = "serviciocategloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class serviciocategloaddvcombo_RESTInterfaceIN
{
   ...
   @JsonProperty("ServicioCategId")
   public short getServicioCategId( )
   {
      return AV25ServicioCategId ;
   }

   @JsonProperty("ServicioCategId")
   public void setServicioCategId(  short Value )
   {
      AV25ServicioCategId= Value;
   }
