...
public final  class pacientecomentarioprofesionalwc_impl extends GXWebComponent
{
   public pacientecomentarioprofesionalwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public pacientecomentarioprofesionalwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( pacientecomentarioprofesionalwc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Paciente Comentario Profesional WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110322391", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   public void renderHtmlCloseForm7G2( )
   {
   ...
   {
      return "PacienteComentarioProfesionalWC" ;
   }
   ...
   public void wb7G0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.pacientecomentarioprofesionalwc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_7G2( true) ;
      }
      else
      {
         wb_table1_22_7G2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_7G2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeValue( "Profesional Comentario") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A63ComentarioProfesionalId, (byte)(8), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A62SGProfesionalProfesionalId, (byte)(8), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A384ComentarioProfesionalCitaId, (byte)(4), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A385ComentarioProfesionalComentario);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.format(A386ComentarioProfesionalFechaRegistro, "99/99/99"));
            GridContainer.AddColumnProperties(GridColumn);
   ...
   public void start7G2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Paciente Comentario Profesional WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           A386ComentarioProfesionalFechaRegistro = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtComentarioProfesionalFechaRegistro_Internalname), 0)) ;
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
   ...
   {
      /* GeneXus formulas. */
      AV33Pgmname = "PacienteComentarioProfesionalWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf7G2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV16FilterFullText ,
                                              Integer.valueOf(A63ComentarioProfesionalId) ,
                                              Integer.valueOf(A62SGProfesionalProfesionalId) ,
                                              Short.valueOf(A384ComentarioProfesionalCitaId) ,
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.INT, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.INT
                                              }
         });
         ...
         {
            A61SGPacientePacienteId = H007G2_A61SGPacientePacienteId[0] ;
            ...
            A386ComentarioProfesionalFechaRegistro = H007G2_A386ComentarioProfesionalFechaRegistro[0] ;
            A385ComentarioProfesionalComentario = H007G2_A385ComentarioProfesionalComentario[0] ;
            A384ComentarioProfesionalCitaId = H007G2_A384ComentarioProfesionalCitaId[0] ;
            A62SGProfesionalProfesionalId = H007G2_A62SGProfesionalProfesionalId[0] ;
            A63ComentarioProfesionalId = H007G2_A63ComentarioProfesionalId[0] ;
            e187G2 ();
   ...
   public void send_integrity_lvl_hashes7G2( )
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV33Pgmname));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV33Pgmname, ""))));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_UPDATE", AV27IsAuthorized_Update);
   ...
   public void e117G2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("PacienteComentarioProfesionalWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV33Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("PacienteComentarioProfesionalWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "PacienteComentarioProfesionalWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         pacientecomentarioprofesionalwc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      pacientecomentarioprofesionalwc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "PacienteComentarioProfesionalWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void wb_table1_22_7G2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_7G2( true) ;
      }
      else
      {
         wb_table2_27_7G2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_7G2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_7G2e( true) ;
      }
      else
      {
         wb_table1_22_7G2e( false) ;
      }
   }

   public void wb_table2_27_7G2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "pacientecomentarioprofesionalwc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110322582", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("pacientecomentarioprofesionalwc.js", "?20225110322582", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtComentarioProfesionalId_Internalname = sPrefix+"COMENTARIOPROFESIONALID_"+sGXsfl_37_idx ;
      edtSGProfesionalProfesionalId_Internalname = sPrefix+"SGPROFESIONALPROFESIONALID_"+sGXsfl_37_idx ;
      edtComentarioProfesionalCitaId_Internalname = sPrefix+"COMENTARIOPROFESIONALCITAID_"+sGXsfl_37_idx ;
      edtComentarioProfesionalComentario_Internalname = sPrefix+"COMENTARIOPROFESIONALCOMENTARIO_"+sGXsfl_37_idx ;
      edtComentarioProfesionalFechaRegistro_Internalname = sPrefix+"COMENTARIOPROFESIONALFECHAREGISTRO_"+sGXsfl_37_idx ;
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtComentarioProfesionalId_Internalname = sPrefix+"COMENTARIOPROFESIONALID_"+sGXsfl_37_fel_idx ;
      edtSGProfesionalProfesionalId_Internalname = sPrefix+"SGPROFESIONALPROFESIONALID_"+sGXsfl_37_fel_idx ;
      edtComentarioProfesionalCitaId_Internalname = sPrefix+"COMENTARIOPROFESIONALCITAID_"+sGXsfl_37_fel_idx ;
      edtComentarioProfesionalComentario_Internalname = sPrefix+"COMENTARIOPROFESIONALCOMENTARIO_"+sGXsfl_37_fel_idx ;
      edtComentarioProfesionalFechaRegistro_Internalname = sPrefix+"COMENTARIOPROFESIONALFECHAREGISTRO_"+sGXsfl_37_fel_idx ;
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComentarioProfesionalId_Internalname,GXutil.ltrim( localUtil.ntoc( A63ComentarioProfesionalId, (byte)(8), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A63ComentarioProfesionalId), "ZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtComentarioProfesionalId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSGProfesionalProfesionalId_Internalname,GXutil.ltrim( localUtil.ntoc( A62SGProfesionalProfesionalId, (byte)(8), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A62SGProfesionalProfesionalId), "ZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSGProfesionalProfesionalId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComentarioProfesionalCitaId_Internalname,GXutil.ltrim( localUtil.ntoc( A384ComentarioProfesionalCitaId, (byte)(4), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A384ComentarioProfesionalCitaId), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtComentarioProfesionalCitaId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComentarioProfesionalComentario_Internalname,A385ComentarioProfesionalComentario,A385ComentarioProfesionalComentario,"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtComentarioProfesionalComentario_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(2097152),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtComentarioProfesionalFechaRegistro_Internalname,localUtil.format(A386ComentarioProfesionalFechaRegistro, "99/99/99"),localUtil.format( A386ComentarioProfesionalFechaRegistro, "99/99/99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtComentarioProfesionalFechaRegistro_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
   ...
   public void init_default_properties( )
   {
      ...
      edtComentarioProfesionalId_Internalname = sPrefix+"COMENTARIOPROFESIONALID" ;
      edtSGProfesionalProfesionalId_Internalname = sPrefix+"SGPROFESIONALPROFESIONALID" ;
      edtComentarioProfesionalCitaId_Internalname = sPrefix+"COMENTARIOPROFESIONALCITAID" ;
      edtComentarioProfesionalComentario_Internalname = sPrefix+"COMENTARIOPROFESIONALCOMENTARIO" ;
      edtComentarioProfesionalFechaRegistro_Internalname = sPrefix+"COMENTARIOPROFESIONALFECHAREGISTRO" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtComentarioProfesionalComentario_Jsonclick = "" ;
      ...
      Ddo_grid_Columnids = "2:ComentarioProfesionalId|3:SGProfesionalProfesionalId|4:ComentarioProfesionalCitaId|5:ComentarioProfesionalComentario|6:ComentarioProfesionalFechaRegistro" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e187G2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A20PacienteId',fld:'PACIENTEID',pic:'ZZZZZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e157G2',iparms:[{av:'A20PacienteId',fld:'PACIENTEID',pic:'ZZZZZZZ9',hsh:true}]");
      setEventMetadata("'DOINSERT'",",oparms:[]}");
      setEventMetadata("NULL","{handler:'valid_Comentarioprofesionalfecharegistro',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H007G2_A61SGPacientePacienteId = new int[1] ;
      H007G2_A386ComentarioProfesionalFechaRegistro = new java.util.Date[] {GXutil.nullDate()} ;
      H007G2_A385ComentarioProfesionalComentario = new String[] {""} ;
      H007G2_A384ComentarioProfesionalCitaId = new short[1] ;
      H007G2_A62SGProfesionalProfesionalId = new int[1] ;
      H007G2_A63ComentarioProfesionalId = new int[1] ;
      ...
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.pacientecomentarioprofesionalwc__default(),
         new Object[] {
             new Object[] {
            H007G2_A61SGPacientePacienteId, H007G2_A386ComentarioProfesionalFechaRegistro, H007G2_A385ComentarioProfesionalComentario, H007G2_A384ComentarioProfesionalCitaId, H007G2_A62SGProfesionalProfesionalId, H007G2_A63ComentarioProfesionalId
            }
            , new Object[] {
   ...
   private String edtComentarioProfesionalComentario_Jsonclick ;
   ...
   private int[] H007G2_A61SGPacientePacienteId ;
   private java.util.Date[] H007G2_A386ComentarioProfesionalFechaRegistro ;
   private String[] H007G2_A385ComentarioProfesionalComentario ;
   private short[] H007G2_A384ComentarioProfesionalCitaId ;
   private int[] H007G2_A62SGProfesionalProfesionalId ;
   private int[] H007G2_A63ComentarioProfesionalId ;
...
final  class pacientecomentarioprofesionalwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H007G2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A63ComentarioProfesionalId ,
                                          int A62SGProfesionalProfesionalId ,
                                          short A384ComentarioProfesionalCitaId ,
                                          String A385ComentarioProfesionalComentario ,
                                          short AV14OrderedBy ,
                                          boolean AV15OrderedDsc ,
                                          int AV8SGPacientePacienteId ,
                                          int A61SGPacientePacienteId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [SGPacientePacienteId], [ComentarioProfesionalFechaRegistro], [ComentarioProfesionalComentario], [ComentarioProfesionalCitaId], [SGProfesionalProfesionalId], [ComentarioProfesionalId]" ;
      sFromString = " FROM [ComentarioProfesional]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([SGPacientePacienteId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([ComentarioProfesionalId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(8), CAST([SGProfesionalProfesionalId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(4), CAST([ComentarioProfesionalCitaId] AS decimal(4,0))) like '%' + ?) or ( [ComentarioProfesionalComentario] like '%' + ?))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [ComentarioProfesionalCitaId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [ComentarioProfesionalCitaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [ComentarioProfesionalId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [ComentarioProfesionalId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [SGProfesionalProfesionalId]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [SGProfesionalProfesionalId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [ComentarioProfesionalComentario]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [ComentarioProfesionalComentario] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [ComentarioProfesionalFechaRegistro]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [ComentarioProfesionalFechaRegistro] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [ComentarioProfesionalId]" ;
      }
   ...
   protected Object[] conditional_H007G3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A63ComentarioProfesionalId ,
                                          ...
                                          int A61SGPacientePacienteId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [ComentarioProfesional]" ;
      addWhere(sWhereString, "([SGPacientePacienteId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([ComentarioProfesionalId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(8), CAST([SGProfesionalProfesionalId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(4), CAST([ComentarioProfesionalCitaId] AS decimal(4,0))) like '%' + ?) or ( [ComentarioProfesionalComentario] like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H007G2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() , ((Number) dynConstraints[7]).intValue() , ((Number) dynConstraints[8]).intValue() );
            case 1 :
                  return conditional_H007G3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() , ((Number) dynConstraints[7]).intValue() , ((Number) dynConstraints[8]).intValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H007G2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H007G3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
