...
public final  class laboratorioview_impl extends GXDataArea
{
   public laboratorioview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public laboratorioview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( laboratorioview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10LaboratorioId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10LaboratorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10LaboratorioId), 4, 0));
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLABORATORIOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10LaboratorioId), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110335017", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.laboratorioview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10LaboratorioId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"LaboratorioId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vLABORATORIOID", GXutil.ltrim( localUtil.ntoc( AV10LaboratorioId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLABORATORIOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10LaboratorioId), "ZZZ9")));
   ...
   public void renderHtmlCloseForm( )
   {
      ...
      if ( ! ( WebComp_Laboratoriousuarioswc == null ) )
      {
         WebComp_Laboratoriousuarioswc.componentjscripts();
      }
      if ( ! ( WebComp_Serviciocategwc == null ) )
      {
         WebComp_Serviciocategwc.componentjscripts();
      }
   }
   ...
   {
      return formatLink("com.projectthani.laboratorioview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10LaboratorioId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"LaboratorioId","TabCode"})  ;
   }
   ...
   public void wb4E0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, "Ir a Laboratorio", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_LaboratorioView.htm");
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divLaboratoriogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblLaboratoriousuarios_title_Internalname, "Laboratorio Usuarios", "", "", lblLaboratoriousuarios_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_LaboratorioView.htm");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         httpContext.writeText( "LaboratorioUsuarios") ;
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         httpContext.writeText( "</div>") ;
         httpContext.writeText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel1"+"\" style=\"display:none;\">") ;
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divUnnamedtablelaboratoriousuarios_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         {
            /* WebComponent */
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "W0033"+"", GXutil.rtrim( WebComp_Laboratoriousuarioswc_Component));
            httpContext.writeText( "<div") ;
            com.projectthani.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
            httpContext.writeText( " id=\""+"gxHTMLWrpW0033"+""+"\""+"") ;
            httpContext.writeText( ">") ;
            if ( GXutil.len( WebComp_Laboratoriousuarioswc_Component) != 0 )
            {
               if ( GXutil.strcmp(GXutil.lower( OldLaboratoriousuarioswc), GXutil.lower( WebComp_Laboratoriousuarioswc_Component)) != 0 )
               {
                  httpContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
               }
               WebComp_Laboratoriousuarioswc.componentdraw();
               if ( GXutil.strcmp(GXutil.lower( OldLaboratoriousuarioswc), GXutil.lower( WebComp_Laboratoriousuarioswc_Component)) != 0 )
               {
                  httpContext.ajax_rspEndCmp();
               }
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblServiciocateg_title_Internalname, "Servicio Categ", "", "", lblServiciocateg_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_LaboratorioView.htm");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         httpContext.writeText( "ServicioCateg") ;
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         httpContext.writeText( "</div>") ;
         httpContext.writeText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel2"+"\" style=\"display:none;\">") ;
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divUnnamedtableserviciocateg_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         {
            /* WebComponent */
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "W0041"+"", GXutil.rtrim( WebComp_Serviciocategwc_Component));
            httpContext.writeText( "<div") ;
            com.projectthani.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
            httpContext.writeText( " id=\""+"gxHTMLWrpW0041"+""+"\""+"") ;
            httpContext.writeText( ">") ;
            if ( GXutil.len( WebComp_Serviciocategwc_Component) != 0 )
            {
               if ( GXutil.strcmp(GXutil.lower( OldServiciocategwc), GXutil.lower( WebComp_Serviciocategwc_Component)) != 0 )
               {
                  httpContext.ajax_rspStartCmp("gxHTMLWrpW0041"+"");
               }
               WebComp_Serviciocategwc.componentdraw();
               if ( GXutil.strcmp(GXutil.lower( OldServiciocategwc), GXutil.lower( WebComp_Serviciocategwc_Component)) != 0 )
               {
                  httpContext.ajax_rspEndCmp();
               }
   ...
   public void start4E2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Laboratorio View", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldLaboratoriousuarioswc = httpContext.cgiGet( "W0033") ;
                        if ( ( GXutil.len( OldLaboratoriousuarioswc) == 0 ) || ( GXutil.strcmp(OldLaboratoriousuarioswc, WebComp_Laboratoriousuarioswc_Component) != 0 ) )
                        {
                           WebComp_Laboratoriousuarioswc = WebUtils.getWebComponent(getClass(), "com.projectthani." + OldLaboratoriousuarioswc + "_impl", remoteHandle, context);
                           WebComp_Laboratoriousuarioswc_Component = OldLaboratoriousuarioswc ;
                        }
                        if ( GXutil.len( WebComp_Laboratoriousuarioswc_Component) != 0 )
                        {
                           WebComp_Laboratoriousuarioswc.componentprocess("W0033", "", sEvt);
                        }
                        WebComp_Laboratoriousuarioswc_Component = OldLaboratoriousuarioswc ;
                     }
                     else if ( nCmpId == 41 )
                     {
                        OldServiciocategwc = httpContext.cgiGet( "W0041") ;
                        if ( ( GXutil.len( OldServiciocategwc) == 0 ) || ( GXutil.strcmp(OldServiciocategwc, WebComp_Serviciocategwc_Component) != 0 ) )
                        {
                           WebComp_Serviciocategwc = WebUtils.getWebComponent(getClass(), "com.projectthani." + OldServiciocategwc + "_impl", remoteHandle, context);
                           WebComp_Serviciocategwc_Component = OldServiciocategwc ;
                        }
                        if ( GXutil.len( WebComp_Serviciocategwc_Component) != 0 )
                        {
                           WebComp_Serviciocategwc.componentprocess("W0041", "", sEvt);
                        }
                        WebComp_Serviciocategwc_Component = OldServiciocategwc ;
                     }
                  }
   ...
   public void rf4E2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         if ( 1 != 0 )
         {
            if ( GXutil.len( WebComp_Laboratoriousuarioswc_Component) != 0 )
            {
               WebComp_Laboratoriousuarioswc.componentstart();
            }
         }
      }
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         if ( 1 != 0 )
         {
            if ( GXutil.len( WebComp_Serviciocategwc_Component) != 0 )
            {
               WebComp_Serviciocategwc.componentstart();
            }
         }
      }
   ...
   public void e124E2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.projectthani.laboratorioww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV18GXLvl9 = (byte)(0) ;
      /* Using cursor H004E2 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10LaboratorioId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A40LaboratorioId = H004E2_A40LaboratorioId[0] ;
         A165LaboratorioNombre = H004E2_A165LaboratorioNombre[0] ;
         AV18GXLvl9 = (byte)(1) ;
         Form.setCaption( A165LaboratorioNombre );
   ...
   public void S112( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( WebComp_Webcomponent_general_Component), GXutil.lower( "LaboratorioGeneral")) != 0 )
      {
         WebComp_Webcomponent_general = WebUtils.getWebComponent(getClass(), "com.projectthani.laboratoriogeneral_impl", remoteHandle, context);
         WebComp_Webcomponent_general_Component = "LaboratorioGeneral" ;
      }
      if ( GXutil.len( WebComp_Webcomponent_general_Component) != 0 )
      {
         WebComp_Webcomponent_general.setjustcreated();
         WebComp_Webcomponent_general.componentprepare(new Object[] {"W0019","",Short.valueOf(AV10LaboratorioId)});
   ...
   public void S122( )
   {
      ...
      returnInSub = false ;
      /* Using cursor H004E3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV10LaboratorioId)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A40LaboratorioId = H004E3_A40LaboratorioId[0] ;
         if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "LaboratorioUsuarios") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Laboratoriousuarioswc = true ;
            }
            if ( GXutil.strcmp(GXutil.lower( WebComp_Laboratoriousuarioswc_Component), GXutil.lower( "LaboratorioLaboratorioUsuariosWC")) != 0 )
            {
               WebComp_Laboratoriousuarioswc = WebUtils.getWebComponent(getClass(), "com.projectthani.laboratoriolaboratoriousuarioswc_impl", remoteHandle, context);
               WebComp_Laboratoriousuarioswc_Component = "LaboratorioLaboratorioUsuariosWC" ;
            }
            if ( GXutil.len( WebComp_Laboratoriousuarioswc_Component) != 0 )
            {
               WebComp_Laboratoriousuarioswc.setjustcreated();
               WebComp_Laboratoriousuarioswc.componentprepare(new Object[] {"W0033","",Short.valueOf(AV10LaboratorioId)});
               WebComp_Laboratoriousuarioswc.componentbind(new Object[] {""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Laboratoriousuarioswc )
            {
               httpContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
               WebComp_Laboratoriousuarioswc.componentdraw();
               httpContext.ajax_rspEndCmp();
         ...
         laboratorioview_impl.this.GXt_boolean2 = GXv_boolean3[0] ;
         AV13TempBoolean = GXt_boolean2 ;
         if ( AV13TempBoolean )
         {
            if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "ServicioCateg") == 0 ) )
            {
               /* Object Property */
               if ( true )
               {
                  bDynCreated_Serviciocategwc = true ;
               }
               if ( GXutil.strcmp(GXutil.lower( WebComp_Serviciocategwc_Component), GXutil.lower( "LaboratorioServicioCategWC")) != 0 )
               {
                  WebComp_Serviciocategwc = WebUtils.getWebComponent(getClass(), "com.projectthani.laboratorioserviciocategwc_impl", remoteHandle, context);
                  WebComp_Serviciocategwc_Component = "LaboratorioServicioCategWC" ;
               }
               if ( GXutil.len( WebComp_Serviciocategwc_Component) != 0 )
               {
                  WebComp_Serviciocategwc.setjustcreated();
                  WebComp_Serviciocategwc.componentprepare(new Object[] {"W0041","",Short.valueOf(AV10LaboratorioId)});
                  WebComp_Serviciocategwc.componentbind(new Object[] {""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Serviciocategwc )
               {
                  httpContext.ajax_rspStartCmp("gxHTMLWrpW0041"+"");
                  WebComp_Serviciocategwc.componentdraw();
                  httpContext.ajax_rspEndCmp();
   ...
   {
      AV10LaboratorioId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10LaboratorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10LaboratorioId), 4, 0));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vLABORATORIOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10LaboratorioId), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      if ( ! ( WebComp_Laboratoriousuarioswc == null ) )
      {
         if ( GXutil.len( WebComp_Laboratoriousuarioswc_Component) != 0 )
         {
            WebComp_Laboratoriousuarioswc.componentthemes();
         }
      }
      if ( ! ( WebComp_Serviciocategwc == null ) )
      {
         if ( GXutil.len( WebComp_Serviciocategwc_Component) != 0 )
         {
            WebComp_Serviciocategwc.componentthemes();
         }
      }
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110335047", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("laboratorioview.js", "?20225110335047", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void init_default_properties( )
   {
      ...
      divLaboratoriogeneral_cell_Internalname = "LABORATORIOGENERAL_CELL" ;
      lblLaboratoriousuarios_title_Internalname = "LABORATORIOUSUARIOS_TITLE" ;
      divUnnamedtablelaboratoriousuarios_Internalname = "UNNAMEDTABLELABORATORIOUSUARIOS" ;
      lblServiciocateg_title_Internalname = "SERVICIOCATEG_TITLE" ;
      divUnnamedtableserviciocateg_Internalname = "UNNAMEDTABLESERVICIOCATEG" ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Laboratorio View" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10LaboratorioId',fld:'vLABORATORIOID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("TABS.TABCHANGED","{handler:'e114E2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'A40LaboratorioId',fld:'LABORATORIOID',pic:'ZZZ9'},{av:'AV10LaboratorioId',fld:'vLABORATORIOID',pic:'ZZZ9',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
      setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'LABORATORIOUSUARIOSWC'},{ctrl:'SERVICIOCATEGWC'}]}");
   }
   ...
   public void initialize( )
   {
      ...
      lblLaboratoriousuarios_title_Jsonclick = "" ;
      WebComp_Laboratoriousuarioswc_Component = "" ;
      OldLaboratoriousuarioswc = "" ;
      lblServiciocateg_title_Jsonclick = "" ;
      WebComp_Serviciocategwc_Component = "" ;
      OldServiciocategwc = "" ;
      sEvt = "" ;
      EvtGridId = "" ;
      EvtRowId = "" ;
      ...
      scmdbuf = "" ;
      H004E2_A40LaboratorioId = new short[1] ;
      H004E2_A165LaboratorioNombre = new String[] {""} ;
      A165LaboratorioNombre = "" ;
      H004E3_A40LaboratorioId = new short[1] ;
      GXv_boolean3 = new boolean[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.laboratorioview__default(),
         new Object[] {
             new Object[] {
            H004E2_A40LaboratorioId, H004E2_A165LaboratorioNombre
            }
            , new Object[] {
            H004E3_A40LaboratorioId
            }
         }
      );
      /* GeneXus formulas. */
      ...
      WebComp_Laboratoriousuarioswc = new com.genexus.webpanels.GXWebComponentNull(remoteHandle, context);
      WebComp_Serviciocategwc = new com.genexus.webpanels.GXWebComponentNull(remoteHandle, context);
   }
   ...
   private short wcpOAV10LaboratorioId ;
   private short nRcdExists_4 ;
   private short nIsMod_4 ;
   private short nRcdExists_3 ;
   private short nIsMod_3 ;
   private short AV10LaboratorioId ;
   ...
   private String divLaboratoriogeneral_cell_Internalname ;
   ...
   private String lblLaboratoriousuarios_title_Internalname ;
   private String lblLaboratoriousuarios_title_Jsonclick ;
   private String divUnnamedtablelaboratoriousuarios_Internalname ;
   private String WebComp_Laboratoriousuarioswc_Component ;
   private String OldLaboratoriousuarioswc ;
   private String lblServiciocateg_title_Internalname ;
   private String lblServiciocateg_title_Jsonclick ;
   private String divUnnamedtableserviciocateg_Internalname ;
   private String WebComp_Serviciocategwc_Component ;
   private String OldServiciocategwc ;
   private String sEvt ;
   ...
   private boolean bDynCreated_Laboratoriousuarioswc ;
   private boolean AV13TempBoolean ;
   private boolean GXt_boolean2 ;
   private boolean GXv_boolean3[] ;
   private boolean bDynCreated_Serviciocategwc ;
   private String A165LaboratorioNombre ;
   private com.genexus.internet.MsgList BackMsgLst ;
   private com.genexus.internet.MsgList LclMsgLst ;
   private GXWebComponent WebComp_Webcomponent_general ;
   private GXWebComponent WebComp_Laboratoriousuarioswc ;
   private GXWebComponent WebComp_Serviciocategwc ;
   private com.genexus.webpanels.GXUserControl ucPanel_general ;
   private com.genexus.webpanels.GXUserControl ucTabs ;
   private IDataStoreProvider pr_default ;
   private short[] H004E2_A40LaboratorioId ;
   private String[] H004E2_A165LaboratorioNombre ;
   private short[] H004E3_A40LaboratorioId ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class laboratorioview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H004E2", "SELECT [LaboratorioId], [LaboratorioNombre] FROM [Laboratorio] WHERE [LaboratorioId] = ? ORDER BY [LaboratorioId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H004E3", "SELECT [LaboratorioId] FROM [Laboratorio] WHERE [LaboratorioId] = ? ORDER BY [LaboratorioId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
