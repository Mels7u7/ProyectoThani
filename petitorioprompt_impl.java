...
public final  class petitorioprompt_impl extends GXDataArea
{
   public petitorioprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public petitorioprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( petitorioprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutPetitorioId") ;
         ...
         {
            AV8InOutPetitorioId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutPetitorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutPetitorioId), 4, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutPetitorioPrincipioActivo = httpContext.GetPar( "InOutPetitorioPrincipioActivo") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutPetitorioPrincipioActivo", AV9InOutPetitorioPrincipioActivo);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110335780", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.petitorioprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutPetitorioId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutPetitorioPrincipioActivo))}, new String[] {"InOutPetitorioId","InOutPetitorioPrincipioActivo"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTPETITORIOID", GXutil.ltrim( localUtil.ntoc( AV8InOutPetitorioId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTPETITORIOPRINCIPIOACTIVO", AV9InOutPetitorioPrincipioActivo);
   ...
   {
      return formatLink("com.projectthani.petitorioprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutPetitorioId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutPetitorioPrincipioActivo))}, new String[] {"InOutPetitorioId","InOutPetitorioPrincipioActivo"})  ;
   }

   public String getPgmname( )
   {
      return "PetitorioPrompt" ;
   }
   ...
   public void wb610( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_612( true) ;
      }
      else
      {
         wb_table1_12_612( false) ;
      }
      return  ;
   }

   public void wb_table1_12_612e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start612( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Petitorio", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_PETITORIOPRINCIPIOACTIVO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A262PetitorioPrincipioActivo, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "PETITORIOPRINCIPIOACTIVO", A262PetitorioPrincipioActivo);
   }
   ...
   public void rf612( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING,
         ...
         lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
         /* Using cursor H00612 */
         pr_default.execute(0, new Object[] {lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_24_idx = 1 ;
         sGXsfl_24_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_24_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_242( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A264PetitorioPrecio = H00612_A264PetitorioPrecio[0] ;
            A261PetitorioPresentacion = H00612_A261PetitorioPresentacion[0] ;
            A39FormaFarmaceuticaId = H00612_A39FormaFarmaceuticaId[0] ;
            A260PetitorioConcentracion = H00612_A260PetitorioConcentracion[0] ;
            A48PetitorioSubCategId = H00612_A48PetitorioSubCategId[0] ;
            A49PetitorioCategId = H00612_A49PetitorioCategId[0] ;
            A263PetitorioProducto = H00612_A263PetitorioProducto[0] ;
            A262PetitorioPrincipioActivo = H00612_A262PetitorioPrincipioActivo[0] ;
            A36DrogueriaId = H00612_A36DrogueriaId[0] ;
            A25PetitorioId = H00612_A25PetitorioId[0] ;
            A49PetitorioCategId = H00612_A49PetitorioCategId[0] ;
            e17612 ();
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_PETITORIOID"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, localUtil.format( DecimalUtil.doubleToDec(A25PetitorioId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_PETITORIOPRINCIPIOACTIVO"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, GXutil.rtrim( localUtil.format( A262PetitorioPrincipioActivo, ""))));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV13FilterFullText = GXutil.concat( GXutil.rtrim( AV13FilterFullText), "%", "") ;
      /* Using cursor H00613 */
      pr_default.execute(1, new Object[] {lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, lV13FilterFullText});
   ...
   public void e15612( )
   {
      ...
      Form.setCaption( "Selecciona Petitorio" );
   ...
   public void e18612( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutPetitorioId = A25PetitorioId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutPetitorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutPetitorioId), 4, 0));
      AV9InOutPetitorioPrincipioActivo = A262PetitorioPrincipioActivo ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutPetitorioPrincipioActivo", AV9InOutPetitorioPrincipioActivo);
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV8InOutPetitorioId),AV9InOutPetitorioPrincipioActivo});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutPetitorioId","AV9InOutPetitorioPrincipioActivo"});
   ...
   public void wb_table1_12_612( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_PetitorioPrompt.htm");
   ...
   {
      AV8InOutPetitorioId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutPetitorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutPetitorioId), 4, 0));
      AV9InOutPetitorioPrincipioActivo = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutPetitorioPrincipioActivo", AV9InOutPetitorioPrincipioActivo);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110335865", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("petitorioprompt.js", "?20225110335865", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_242( )
   {
      ...
      edtPetitorioId_Internalname = "PETITORIOID_"+sGXsfl_24_idx ;
      edtDrogueriaId_Internalname = "DROGUERIAID_"+sGXsfl_24_idx ;
      edtPetitorioPrincipioActivo_Internalname = "PETITORIOPRINCIPIOACTIVO_"+sGXsfl_24_idx ;
      edtPetitorioProducto_Internalname = "PETITORIOPRODUCTO_"+sGXsfl_24_idx ;
      edtPetitorioCategId_Internalname = "PETITORIOCATEGID_"+sGXsfl_24_idx ;
      edtPetitorioSubCategId_Internalname = "PETITORIOSUBCATEGID_"+sGXsfl_24_idx ;
      edtPetitorioConcentracion_Internalname = "PETITORIOCONCENTRACION_"+sGXsfl_24_idx ;
      edtFormaFarmaceuticaId_Internalname = "FORMAFARMACEUTICAID_"+sGXsfl_24_idx ;
      edtPetitorioPresentacion_Internalname = "PETITORIOPRESENTACION_"+sGXsfl_24_idx ;
      edtPetitorioPrecio_Internalname = "PETITORIOPRECIO_"+sGXsfl_24_idx ;
   }

   public void subsflControlProps_fel_242( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_24_fel_idx ;
      edtPetitorioId_Internalname = "PETITORIOID_"+sGXsfl_24_fel_idx ;
      edtDrogueriaId_Internalname = "DROGUERIAID_"+sGXsfl_24_fel_idx ;
      edtPetitorioPrincipioActivo_Internalname = "PETITORIOPRINCIPIOACTIVO_"+sGXsfl_24_fel_idx ;
      edtPetitorioProducto_Internalname = "PETITORIOPRODUCTO_"+sGXsfl_24_fel_idx ;
      edtPetitorioCategId_Internalname = "PETITORIOCATEGID_"+sGXsfl_24_fel_idx ;
      edtPetitorioSubCategId_Internalname = "PETITORIOSUBCATEGID_"+sGXsfl_24_fel_idx ;
      edtPetitorioConcentracion_Internalname = "PETITORIOCONCENTRACION_"+sGXsfl_24_fel_idx ;
      edtFormaFarmaceuticaId_Internalname = "FORMAFARMACEUTICAID_"+sGXsfl_24_fel_idx ;
      edtPetitorioPresentacion_Internalname = "PETITORIOPRESENTACION_"+sGXsfl_24_fel_idx ;
      edtPetitorioPrecio_Internalname = "PETITORIOPRECIO_"+sGXsfl_24_fel_idx ;
   }
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPetitorioPrincipioActivo_Internalname,A262PetitorioPrincipioActivo,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtPetitorioPrincipioActivo_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(200),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(24),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:PetitorioId|2:DrogueriaId|3:PetitorioPrincipioActivo|4:PetitorioProducto|5:PetitorioCategId|6:PetitorioSubCategId|7:PetitorioConcentracion|8:FormaFarmaceuticaId|9:PetitorioPresentacion|10:PetitorioPrecio" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11612',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12612',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e13612',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e17612',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e18612',iparms:[{av:'A25PetitorioId',fld:'PETITORIOID',pic:'ZZZ9',hsh:true},{av:'A262PetitorioPrincipioActivo',fld:'PETITORIOPRINCIPIOACTIVO',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutPetitorioId',fld:'vINOUTPETITORIOID',pic:'ZZZ9'},{av:'AV9InOutPetitorioPrincipioActivo',fld:'vINOUTPETITORIOPRINCIPIOACTIVO',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e14612',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
   ...
   {
      wcpOAV9InOutPetitorioPrincipioActivo = "" ;
      ...
      AV9InOutPetitorioPrincipioActivo = "" ;
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H00612_A264PetitorioPrecio = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00612_A261PetitorioPresentacion = new String[] {""} ;
      H00612_A39FormaFarmaceuticaId = new short[1] ;
      H00612_A260PetitorioConcentracion = new String[] {""} ;
      H00612_A48PetitorioSubCategId = new short[1] ;
      H00612_A49PetitorioCategId = new short[1] ;
      H00612_A263PetitorioProducto = new String[] {""} ;
      H00612_A262PetitorioPrincipioActivo = new String[] {""} ;
      H00612_A36DrogueriaId = new short[1] ;
      H00612_A25PetitorioId = new short[1] ;
      ...
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.petitorioprompt__default(),
         new Object[] {
             new Object[] {
            H00612_A264PetitorioPrecio, H00612_A261PetitorioPresentacion, H00612_A39FormaFarmaceuticaId, H00612_A260PetitorioConcentracion, H00612_A48PetitorioSubCategId, H00612_A49PetitorioCategId, H00612_A263PetitorioProducto, H00612_A262PetitorioPrincipioActivo, H00612_A36DrogueriaId, H00612_A25PetitorioId
            }
            , new Object[] {
   ...
   private short wcpOAV8InOutPetitorioId ;
   private short AV8InOutPetitorioId ;
   ...
   private String wcpOAV9InOutPetitorioPrincipioActivo ;
   private String AV13FilterFullText ;
   private String AV9InOutPetitorioPrincipioActivo ;
   ...
   private java.math.BigDecimal[] H00612_A264PetitorioPrecio ;
   private String[] H00612_A261PetitorioPresentacion ;
   private short[] H00612_A39FormaFarmaceuticaId ;
   private String[] H00612_A260PetitorioConcentracion ;
   private short[] H00612_A48PetitorioSubCategId ;
   private short[] H00612_A49PetitorioCategId ;
   private String[] H00612_A263PetitorioProducto ;
   private String[] H00612_A262PetitorioPrincipioActivo ;
   private short[] H00612_A36DrogueriaId ;
   private short[] H00612_A25PetitorioId ;
...
final  class petitorioprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00612( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H00613( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          short A25PetitorioId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00612(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).shortValue() , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , (String)dynConstraints[9] , (java.math.BigDecimal)dynConstraints[10] , ((Number) dynConstraints[11]).shortValue() , ((Boolean) dynConstraints[12]).booleanValue() );
            case 1 :
                  return conditional_H00613(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).shortValue() , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , (String)dynConstraints[9] , (java.math.BigDecimal)dynConstraints[10] , ((Number) dynConstraints[11]).shortValue() , ((Boolean) dynConstraints[12]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00612", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00613", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
