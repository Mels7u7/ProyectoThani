...
public final  class clinicasedewc_impl extends GXWebComponent
{
   public clinicasedewc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public clinicasedewc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( clinicasedewc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8ClinicaId = (short)(GXutil.lval( httpContext.GetPar( "ClinicaId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ClinicaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ClinicaId), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(AV8ClinicaId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8ClinicaId, AV20ManageFiltersExecutionStep, AV34Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, AV30IsAuthorized_UbigeoNombre, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Clinica Sede WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110324940", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.clinicasedewc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8ClinicaId,4,0))}, new String[] {"ClinicaId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8ClinicaId", GXutil.ltrim( localUtil.ntoc( wcpOAV8ClinicaId, (byte)(4), (byte)(0), ",", "")));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vCLINICAID", GXutil.ltrim( localUtil.ntoc( AV8ClinicaId, (byte)(4), (byte)(0), ",", "")));
   ...
   public void wb5D0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.clinicasedewc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_5D2( true) ;
      }
      else
      {
         wb_table1_22_5D2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_5D2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtClinicaId_Internalname, GXutil.ltrim( localUtil.ntoc( A28ClinicaId, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A28ClinicaId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtClinicaId_Jsonclick, 0, "Attribute", "", "", "", "", edtClinicaId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id4", "right", false, "", "HLP_ClinicaSedeWC.htm");
         /* User Defined Control */
   ...
   public void start5D2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Clinica Sede WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void rf5D2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              A279SedeTipo ,
                                              A280SedeSector ,
                                              Short.valueOf(AV8ClinicaId) ,
                                              Short.valueOf(A28ClinicaId) } ,
                                              new int[]{
                                              TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING,
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H005D2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8ClinicaId), AV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A28ClinicaId = H005D2_A28ClinicaId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A28ClinicaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A28ClinicaId), 4, 0));
            A280SedeSector = H005D2_A280SedeSector[0] ;
            A279SedeTipo = H005D2_A279SedeTipo[0] ;
            A278SedeEstado = H005D2_A278SedeEstado[0] ;
            A277SedeCorreo = H005D2_A277SedeCorreo[0] ;
            A276SedeDireccion = H005D2_A276SedeDireccion[0] ;
            A185UbigeoNombre = H005D2_A185UbigeoNombre[0] ;
            A44UbigeoCode = H005D2_A44UbigeoCode[0] ;
            A75SedeNombre = H005D2_A75SedeNombre[0] ;
            A30SedeId = H005D2_A30SedeId[0] ;
            A186UbigeoDepartamento = H005D2_A186UbigeoDepartamento[0] ;
            A187UbigeoProvincia = H005D2_A187UbigeoProvincia[0] ;
            A188UbigeoDistrito = H005D2_A188UbigeoDistrito[0] ;
            A185UbigeoNombre = H005D2_A185UbigeoNombre[0] ;
            A186UbigeoDepartamento = H005D2_A186UbigeoDepartamento[0] ;
            A187UbigeoProvincia = H005D2_A187UbigeoProvincia[0] ;
            A188UbigeoDistrito = H005D2_A188UbigeoDistrito[0] ;
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H005D3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8ClinicaId), AV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void strup5D0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8ClinicaId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8ClinicaId"), ",", ".")) ;
   ...
   public void e165D2( )
   {
      ...
      clinicasedewc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtClinicaId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtClinicaId_Visible), 5, 0), true);
   ...
   public void e115D2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("ClinicaSedeWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV34Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("ClinicaSedeWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "ClinicaSedeWCFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         clinicasedewc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "ClinicaSedeWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "ClinicaId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8ClinicaId, 4, 0) );
   ...
   public void wb_table1_22_5D2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_5D2( true) ;
      }
      else
      {
         wb_table2_27_5D2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_5D2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_5D2e( true) ;
      }
      else
      {
         wb_table1_22_5D2e( false) ;
      }
   }

   public void wb_table2_27_5D2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8ClinicaId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ClinicaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ClinicaId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8ClinicaId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "clinicasedewc", GetJustCreated( ));
      ...
      {
         AV8ClinicaId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ClinicaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ClinicaId), 4, 0));
      }
      wcpOAV8ClinicaId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8ClinicaId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV8ClinicaId != wcpOAV8ClinicaId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8ClinicaId = AV8ClinicaId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8ClinicaId = httpContext.cgiGet( sPrefix+"AV8ClinicaId_CTRL") ;
      if ( GXutil.len( sCtrlAV8ClinicaId) > 0 )
      {
         AV8ClinicaId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV8ClinicaId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8ClinicaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8ClinicaId), 4, 0));
      }
      else
      {
         AV8ClinicaId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8ClinicaId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8ClinicaId_PARM", GXutil.ltrim( localUtil.ntoc( AV8ClinicaId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8ClinicaId)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8ClinicaId_CTRL", GXutil.rtrim( sCtrlAV8ClinicaId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110325153", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("clinicasedewc.js", "?20225110325153", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:SedeId|3:SedeNombre|4:UbigeoCode|6:SedeDireccion|7:SedeCorreo|8:SedeEstado|9:SedeTipo|10:SedeSector" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e125D2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ClinicaId',fld:'vCLINICAID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV34Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_UbigeoNombre',fld:'vISAUTHORIZED_UBIGEONOMBRE',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e135D2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ClinicaId',fld:'vCLINICAID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV34Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_UbigeoNombre',fld:'vISAUTHORIZED_UBIGEONOMBRE',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e145D2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ClinicaId',fld:'vCLINICAID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV34Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_UbigeoNombre',fld:'vISAUTHORIZED_UBIGEONOMBRE',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e185D2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A30SedeId',fld:'SEDEID',pic:'ZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_UbigeoNombre',fld:'vISAUTHORIZED_UBIGEONOMBRE',pic:'',hsh:true},{av:'A44UbigeoCode',fld:'UBIGEOCODE',pic:''}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV26Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV28Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtSedeNombre_Link',ctrl:'SEDENOMBRE',prop:'Link'},{av:'edtUbigeoNombre_Link',ctrl:'UBIGEONOMBRE',prop:'Link'}]}");
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e115D2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ClinicaId',fld:'vCLINICAID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV34Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_UbigeoNombre',fld:'vISAUTHORIZED_UBIGEONOMBRE',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e155D2',iparms:[{av:'A30SedeId',fld:'SEDEID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H005D2_A28ClinicaId = new short[1] ;
      H005D2_A280SedeSector = new String[] {""} ;
      H005D2_A279SedeTipo = new String[] {""} ;
      H005D2_A278SedeEstado = new String[] {""} ;
      H005D2_A277SedeCorreo = new String[] {""} ;
      H005D2_A276SedeDireccion = new String[] {""} ;
      H005D2_A185UbigeoNombre = new String[] {""} ;
      H005D2_A44UbigeoCode = new String[] {""} ;
      H005D2_A75SedeNombre = new String[] {""} ;
      H005D2_A30SedeId = new short[1] ;
      H005D2_A186UbigeoDepartamento = new String[] {""} ;
      H005D2_A187UbigeoProvincia = new String[] {""} ;
      H005D2_A188UbigeoDistrito = new String[] {""} ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.clinicasedewc__default(),
         new Object[] {
             new Object[] {
            H005D2_A28ClinicaId, H005D2_A280SedeSector, H005D2_A279SedeTipo, H005D2_A278SedeEstado, H005D2_A277SedeCorreo, H005D2_A276SedeDireccion, H005D2_A185UbigeoNombre, H005D2_A44UbigeoCode, H005D2_A75SedeNombre, H005D2_A30SedeId,
            H005D2_A186UbigeoDepartamento, H005D2_A187UbigeoProvincia, H005D2_A188UbigeoDistrito
            }
            , new Object[] {
   ...
   private short wcpOAV8ClinicaId ;
   private short AV8ClinicaId ;
   ...
   private String sCtrlAV8ClinicaId ;
   ...
   private short[] H005D2_A28ClinicaId ;
   private String[] H005D2_A280SedeSector ;
   private String[] H005D2_A279SedeTipo ;
   private String[] H005D2_A278SedeEstado ;
   private String[] H005D2_A277SedeCorreo ;
   private String[] H005D2_A276SedeDireccion ;
   private String[] H005D2_A185UbigeoNombre ;
   private String[] H005D2_A44UbigeoCode ;
   private String[] H005D2_A75SedeNombre ;
   private short[] H005D2_A30SedeId ;
   private String[] H005D2_A186UbigeoDepartamento ;
   private String[] H005D2_A187UbigeoProvincia ;
   private String[] H005D2_A188UbigeoDistrito ;
...
final  class clinicasedewc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          short A28ClinicaId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[ClinicaId], T1.[SedeSector], T1.[SedeTipo], T1.[SedeEstado], T1.[SedeCorreo], T1.[SedeDireccion], T2.[UbigeoDepartamento] + ' / ' + T2.[UbigeoProvincia] + ' / '" ;
      sSelectString += " + T2.[UbigeoDistrito] AS UbigeoNombre, T1.[UbigeoCode], T1.[SedeNombre], T1.[SedeId], T2.[UbigeoDepartamento], T2.[UbigeoProvincia], T2.[UbigeoDistrito]" ;
      sFromString = " FROM ([Sede] T1 INNER JOIN [Ubigeo] T2 ON T2.[UbigeoCode] = T1.[UbigeoCode])" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.[ClinicaId] = ?)");
      addWhere(sWhereString, "((? = '') or ( ( CONVERT( char(4), CAST(T1.[SedeId] AS decimal(4,0))) like '%' + ?) or ( T1.[SedeNombre] like '%' + ?) or ( T1.[UbigeoCode] like '%' + ?) or ( T2.[UbigeoDepartamento] + ' / ' + T2.[UbigeoProvincia] + ' / ' + T2.[UbigeoDistrito] like '%' + ?) or ( T1.[SedeDireccion] like '%' + ?) or ( T1.[SedeCorreo] like '%' + ?) or ( 'activo' like '%' + LOWER(?) and T1.[SedeEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and T1.[SedeEstado] = 'I') or ( 'seleccione' like '%' + LOWER(?) and (T1.[SedeTipo] = '')) or ( 'hospital' like '%' + LOWER(?) and T1.[SedeTipo] = 'H') or ( 'clínica' like '%' + LOWER(?) and T1.[SedeTipo] = 'C') or ( 'policlínico' like '%' + LOWER(?) and T1.[SedeTipo] = 'P') or ( 'independiente' like '%' + LOWER(?) and T1.[SedeTipo] = 'I') or ( 'seleccione' like '%' + LOWER(?) and (T1.[SedeSector] = '')) or ( 'publico' like '%' + LOWER(?) and T1.[SedeSector] = 'P') or ( 'privado' like '%' + LOWER(?) and T1.[SedeSector] = 'V')))");
      if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ClinicaId], T1.[SedeNombre]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClinicaId] DESC, T1.[SedeNombre] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ClinicaId], T1.[SedeId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClinicaId] DESC, T1.[SedeId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ClinicaId], T1.[UbigeoCode]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClinicaId] DESC, T1.[UbigeoCode] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ClinicaId], T1.[SedeDireccion]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClinicaId] DESC, T1.[SedeDireccion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ClinicaId], T1.[SedeCorreo]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClinicaId] DESC, T1.[SedeCorreo] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ClinicaId], T1.[SedeEstado]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClinicaId] DESC, T1.[SedeEstado] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ClinicaId], T1.[SedeTipo]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClinicaId] DESC, T1.[SedeTipo] DESC" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[ClinicaId], T1.[SedeSector]" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[ClinicaId] DESC, T1.[SedeSector] DESC" ;
      }
      else if ( true )
      {
                                          ...
                                          short A28ClinicaId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([Sede] T1 INNER JOIN [Ubigeo] T2 ON T2.[UbigeoCode] = T1.[UbigeoCode])" ;
      addWhere(sWhereString, "(T1.[ClinicaId] = ?)");
      addWhere(sWhereString, "((? = '') or ( ( CONVERT( char(4), CAST(T1.[SedeId] AS decimal(4,0))) like '%' + ?) or ( T1.[SedeNombre] like '%' + ?) or ( T1.[UbigeoCode] like '%' + ?) or ( T2.[UbigeoDepartamento] + ' / ' + T2.[UbigeoProvincia] + ' / ' + T2.[UbigeoDistrito] like '%' + ?) or ( T1.[SedeDireccion] like '%' + ?) or ( T1.[SedeCorreo] like '%' + ?) or ( 'activo' like '%' + LOWER(?) and T1.[SedeEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and T1.[SedeEstado] = 'I') or ( 'seleccione' like '%' + LOWER(?) and (T1.[SedeTipo] = '')) or ( 'hospital' like '%' + LOWER(?) and T1.[SedeTipo] = 'H') or ( 'clínica' like '%' + LOWER(?) and T1.[SedeTipo] = 'C') or ( 'policlínico' like '%' + LOWER(?) and T1.[SedeTipo] = 'P') or ( 'independiente' like '%' + LOWER(?) and T1.[SedeTipo] = 'I') or ( 'seleccione' like '%' + LOWER(?) and (T1.[SedeSector] = '')) or ( 'publico' like '%' + LOWER(?) and T1.[SedeSector] = 'P') or ( 'privado' like '%' + LOWER(?) and T1.[SedeSector] = 'V')))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005D2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (String)dynConstraints[8] , (String)dynConstraints[9] , (String)dynConstraints[10] , (String)dynConstraints[11] , ((Number) dynConstraints[12]).shortValue() , ((Number) dynConstraints[13]).shortValue() );
            case 1 :
                  return conditional_H005D3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (String)dynConstraints[8] , (String)dynConstraints[9] , (String)dynConstraints[10] , (String)dynConstraints[11] , ((Number) dynConstraints[12]).shortValue() , ((Number) dynConstraints[13]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H005D2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H005D3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
