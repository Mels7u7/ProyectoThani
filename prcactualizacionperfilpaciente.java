...
public final  class prcactualizacionperfilpaciente extends GXProcedure
{
   public prcactualizacionperfilpaciente( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( prcactualizacionperfilpaciente.class ), "" );
   }
   ...
   {
      prcactualizacionperfilpaciente.this.AV16PacienteId = aP0;
      initialize();
      /* GeneXus formulas */
   ...
   private void privateExecute( )
   {
      ...
      prcactualizacionperfilpaciente.this.GXt_char1 = GXv_char2[0] ;
      ...
      if ( ! (GXutil.strcmp("", AV15PacienteCorreo)==0) && ( AV16PacienteId > 0 ) )
      {
         ...
         GXv_char2[0] = GXt_char1 ;
         new com.projectthani.prcgettemplatecontent(remoteHandle, context).execute( "CorreoActualizacionPerfil", GXv_char2) ;
         prcactualizacionperfilpaciente.this.GXt_char1 = GXv_char2[0] ;
   ...
   public void initialize( )
   {
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.prcactualizacionperfilpaciente__default(),
         new Object[] {
         }
      );
      /* GeneXus formulas. */
...
final  class prcactualizacionperfilpaciente__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
