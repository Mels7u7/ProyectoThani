...
public final  class templateview_impl extends GXDataArea
{
   public templateview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public templateview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( templateview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "TemplateId") ;
         ...
         {
            AV10TemplateId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10TemplateId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10TemplateId), 4, 0));
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTEMPLATEID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10TemplateId), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110335192", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.templateview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10TemplateId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"TemplateId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vTEMPLATEID", GXutil.ltrim( localUtil.ntoc( AV10TemplateId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTEMPLATEID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10TemplateId), "ZZZ9")));
   ...
   {
      return formatLink("com.projectthani.templateview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10TemplateId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"TemplateId","TabCode"})  ;
   }
   ...
   public void wb5R0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, "Ir a Template", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_TemplateView.htm");
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divTemplategeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
   ...
   public void start5R2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Template View", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void e115R2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.projectthani.templateww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H005R2 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10TemplateId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A53TemplateId = H005R2_A53TemplateId[0] ;
         A291TemplateCode = H005R2_A291TemplateCode[0] ;
         AV16GXLvl9 = (byte)(1) ;
         Form.setCaption( A291TemplateCode );
   ...
   public void S112( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( WebComp_Webcomponent_general_Component), GXutil.lower( "TemplateGeneral")) != 0 )
      {
         WebComp_Webcomponent_general = WebUtils.getWebComponent(getClass(), "com.projectthani.templategeneral_impl", remoteHandle, context);
         WebComp_Webcomponent_general_Component = "TemplateGeneral" ;
      }
      if ( GXutil.len( WebComp_Webcomponent_general_Component) != 0 )
      {
         WebComp_Webcomponent_general.setjustcreated();
         WebComp_Webcomponent_general.componentprepare(new Object[] {"W0019","",Short.valueOf(AV10TemplateId)});
   ...
   {
      AV10TemplateId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10TemplateId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10TemplateId), 4, 0));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTEMPLATEID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10TemplateId), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110335212", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("templateview.js", "?20225110335212", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
   ...
   public void init_default_properties( )
   {
      ...
      divTemplategeneral_cell_Internalname = "TEMPLATEGENERAL_CELL" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10TemplateId',fld:'vTEMPLATEID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H005R2_A53TemplateId = new short[1] ;
      H005R2_A291TemplateCode = new String[] {""} ;
      A291TemplateCode = "" ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.templateview__default(),
         new Object[] {
             new Object[] {
            H005R2_A53TemplateId, H005R2_A291TemplateCode
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV10TemplateId ;
   private short nRcdExists_3 ;
   private short nIsMod_3 ;
   private short AV10TemplateId ;
   private short wbEnd ;
   ...
   private String divTemplategeneral_cell_Internalname ;
   ...
   private short[] H005R2_A53TemplateId ;
   private String[] H005R2_A291TemplateCode ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class templateview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H005R2", "SELECT [TemplateId], [TemplateCode] FROM [Template] WHERE [TemplateId] = ? ORDER BY [TemplateId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
