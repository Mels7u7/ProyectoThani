...
@javax.xml.bind.annotation.XmlType(name = "servicioloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class servicioloaddvcombo_RESTInterfaceIN
{
   ...
   {
      return AV25ServicioId ;
   }

   @JsonProperty("ServicioId")
   public void setServicioId(  short Value )
   {
      AV25ServicioId= Value;
   }
