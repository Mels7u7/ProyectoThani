...
public final  class diagnosticoview_impl extends GXDataArea
{
   public diagnosticoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public diagnosticoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( diagnosticoview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10DiagnosticoId = (int)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10DiagnosticoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10DiagnosticoId), 8, 0));
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDIAGNOSTICOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10DiagnosticoId), "ZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.diagnosticoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10DiagnosticoId,8,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"DiagnosticoId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vDIAGNOSTICOID", GXutil.ltrim( localUtil.ntoc( AV10DiagnosticoId, (byte)(8), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDIAGNOSTICOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10DiagnosticoId), "ZZZZZZZ9")));
   ...
   {
      return formatLink("com.projectthani.diagnosticoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10DiagnosticoId,8,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"DiagnosticoId","TabCode"})  ;
   }
   ...
   public void wb1P0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, "Ir a Diagnostico", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_DiagnosticoView.htm");
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divDiagnosticogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCitadiagnostico_title_Internalname, "Cita Diagnostico", "", "", lblCitadiagnostico_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_DiagnosticoView.htm");
         /* Div Control */
   ...
   public void start1P2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Diagnostico View", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup1P0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10DiagnosticoId = (int)(localUtil.ctol( httpContext.cgiGet( "vDIAGNOSTICOID"), ",", ".")) ;
   ...
   public void e111P2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.projectthani.diagnosticoww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV18GXLvl9 = (byte)(0) ;
      /* Using cursor H001P2 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10DiagnosticoId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A23DiagnosticoId = H001P2_A23DiagnosticoId[0] ;
         A107DiagnosticoCodigo = H001P2_A107DiagnosticoCodigo[0] ;
         AV18GXLvl9 = (byte)(1) ;
         Form.setCaption( A107DiagnosticoCodigo );
   ...
   public void S112( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( WebComp_Webcomponent_general_Component), GXutil.lower( "DiagnosticoGeneral")) != 0 )
      {
         WebComp_Webcomponent_general = WebUtils.getWebComponent(getClass(), "com.projectthani.diagnosticogeneral_impl", remoteHandle, context);
         WebComp_Webcomponent_general_Component = "DiagnosticoGeneral" ;
      }
      if ( GXutil.len( WebComp_Webcomponent_general_Component) != 0 )
      {
         WebComp_Webcomponent_general.setjustcreated();
         WebComp_Webcomponent_general.componentprepare(new Object[] {"W0019","",Integer.valueOf(AV10DiagnosticoId)});
   ...
   public void S122( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "CitaDiagnostico") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Citadiagnosticowc_Component), GXutil.lower( "DiagnosticoCitaDiagnosticoWC")) != 0 )
         {
            WebComp_Citadiagnosticowc = WebUtils.getWebComponent(getClass(), "com.projectthani.diagnosticocitadiagnosticowc_impl", remoteHandle, context);
            WebComp_Citadiagnosticowc_Component = "DiagnosticoCitaDiagnosticoWC" ;
         }
         if ( GXutil.len( WebComp_Citadiagnosticowc_Component) != 0 )
         {
            WebComp_Citadiagnosticowc.setjustcreated();
            WebComp_Citadiagnosticowc.componentprepare(new Object[] {"W0033","",Integer.valueOf(AV10DiagnosticoId)});
   ...
   {
      AV10DiagnosticoId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10DiagnosticoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10DiagnosticoId), 8, 0));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vDIAGNOSTICOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10DiagnosticoId), "ZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110331571", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("diagnosticoview.js", "?20225110331571", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void init_default_properties( )
   {
      ...
      divDiagnosticogeneral_cell_Internalname = "DIAGNOSTICOGENERAL_CELL" ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Diagnostico View" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10DiagnosticoId',fld:'vDIAGNOSTICOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H001P2_A23DiagnosticoId = new int[1] ;
      H001P2_A107DiagnosticoCodigo = new String[] {""} ;
      A107DiagnosticoCodigo = "" ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.diagnosticoview__default(),
         new Object[] {
             new Object[] {
            H001P2_A23DiagnosticoId, H001P2_A107DiagnosticoCodigo
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int wcpOAV10DiagnosticoId ;
   private int AV10DiagnosticoId ;
   ...
   private String divDiagnosticogeneral_cell_Internalname ;
   ...
   private int[] H001P2_A23DiagnosticoId ;
   private String[] H001P2_A107DiagnosticoCodigo ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class diagnosticoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001P2", "SELECT [DiagnosticoId], [DiagnosticoCodigo] FROM [Diagnostico] WHERE [DiagnosticoId] = ? ORDER BY [DiagnosticoId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
