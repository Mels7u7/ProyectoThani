...
public final  class petitorioview_impl extends GXDataArea
{
   public petitorioview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public petitorioview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( petitorioview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10PetitorioId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10PetitorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10PetitorioId), 4, 0));
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPETITORIOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PetitorioId), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110334756", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.petitorioview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PetitorioId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PetitorioId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vPETITORIOID", GXutil.ltrim( localUtil.ntoc( AV10PetitorioId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPETITORIOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PetitorioId), "ZZZ9")));
   ...
   {
      return formatLink("com.projectthani.petitorioview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PetitorioId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PetitorioId","TabCode"})  ;
   }

   public String getPgmname( )
   {
      return "PetitorioView" ;
   }
   ...
   public void wb3X0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, "Ir a Petitorio", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_PetitorioView.htm");
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divPetitoriogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCitareceta_title_Internalname, "Cita Receta", "", "", lblCitareceta_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_PetitorioView.htm");
         /* Div Control */
         ...
         {
            /* WebComponent */
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "W0033"+"", GXutil.rtrim( WebComp_Citarecetawc_Component));
            httpContext.writeText( "<div") ;
            com.projectthani.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
   ...
   public void start3X2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Petitorio View", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldCitarecetawc = httpContext.cgiGet( "W0033") ;
                        ...
                        if ( GXutil.len( WebComp_Citarecetawc_Component) != 0 )
                        {
                           WebComp_Citarecetawc.componentprocess("W0033", "", sEvt);
                        }
                        WebComp_Citarecetawc_Component = OldCitarecetawc ;
                     }
                  }
   ...
   public void strup3X0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10PetitorioId = (short)(localUtil.ctol( httpContext.cgiGet( "vPETITORIOID"), ",", ".")) ;
   ...
   public void e113X2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.projectthani.petitorioww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H003X2 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10PetitorioId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A25PetitorioId = H003X2_A25PetitorioId[0] ;
         A262PetitorioPrincipioActivo = H003X2_A262PetitorioPrincipioActivo[0] ;
         AV16GXLvl9 = (byte)(1) ;
         Form.setCaption( A262PetitorioPrincipioActivo );
   ...
   public void S112( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( WebComp_Webcomponent_general_Component), GXutil.lower( "PetitorioGeneral")) != 0 )
      {
         WebComp_Webcomponent_general = WebUtils.getWebComponent(getClass(), "com.projectthani.petitoriogeneral_impl", remoteHandle, context);
         WebComp_Webcomponent_general_Component = "PetitorioGeneral" ;
      }
      if ( GXutil.len( WebComp_Webcomponent_general_Component) != 0 )
      {
         WebComp_Webcomponent_general.setjustcreated();
         WebComp_Webcomponent_general.componentprepare(new Object[] {"W0019","",Short.valueOf(AV10PetitorioId)});
   ...
   public void S122( )
   {
      /* 'LOADTABS' Routine */
      returnInSub = false ;
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "CitaReceta") == 0 ) )
      {
         /* Object Property */
         if ( true )
         {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Citarecetawc_Component), GXutil.lower( "PetitorioCitaRecetaWC")) != 0 )
         {
            WebComp_Citarecetawc = WebUtils.getWebComponent(getClass(), "com.projectthani.petitoriocitarecetawc_impl", remoteHandle, context);
            WebComp_Citarecetawc_Component = "PetitorioCitaRecetaWC" ;
         }
         if ( GXutil.len( WebComp_Citarecetawc_Component) != 0 )
         {
            WebComp_Citarecetawc.setjustcreated();
            WebComp_Citarecetawc.componentprepare(new Object[] {"W0033","",Short.valueOf(AV10PetitorioId)});
   ...
   {
      AV10PetitorioId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10PetitorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10PetitorioId), 4, 0));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPETITORIOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PetitorioId), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110334782", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("petitorioview.js", "?20225110334782", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void init_default_properties( )
   {
      ...
      divPetitoriogeneral_cell_Internalname = "PETITORIOGENERAL_CELL" ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Petitorio View" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10PetitorioId',fld:'vPETITORIOID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H003X2_A25PetitorioId = new short[1] ;
      H003X2_A262PetitorioPrincipioActivo = new String[] {""} ;
      A262PetitorioPrincipioActivo = "" ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.petitorioview__default(),
         new Object[] {
             new Object[] {
            H003X2_A25PetitorioId, H003X2_A262PetitorioPrincipioActivo
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV10PetitorioId ;
   private short nRcdExists_3 ;
   private short nIsMod_3 ;
   private short AV10PetitorioId ;
   private short wbEnd ;
   ...
   private String divPetitoriogeneral_cell_Internalname ;
   ...
   private short[] H003X2_A25PetitorioId ;
   private String[] H003X2_A262PetitorioPrincipioActivo ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class petitorioview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H003X2", "SELECT [PetitorioId], [PetitorioPrincipioActivo] FROM [Petitorio] WHERE [PetitorioId] = ? ORDER BY [PetitorioId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
