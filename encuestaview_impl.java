...
public final  class encuestaview_impl extends GXDataArea
{
   public encuestaview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public encuestaview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( encuestaview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10EncuestaId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10EncuestaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10EncuestaId), 4, 0));
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vENCUESTAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10EncuestaId), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110331594", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.encuestaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10EncuestaId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"EncuestaId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vENCUESTAID", GXutil.ltrim( localUtil.ntoc( AV10EncuestaId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vENCUESTAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10EncuestaId), "ZZZ9")));
   ...
   {
      return formatLink("com.projectthani.encuestaview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10EncuestaId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"EncuestaId","TabCode"})  ;
   }
   ...
   public void wb1U0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, "Ir a Encuesta", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_EncuestaView.htm");
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divEncuestageneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
   ...
   public void start1U2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Encuesta View", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void e111U2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.projectthani.encuestaww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H001U2 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10EncuestaId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A37EncuestaId = H001U2_A37EncuestaId[0] ;
         A148EncuestaAtencion = H001U2_A148EncuestaAtencion[0] ;
         n148EncuestaAtencion = H001U2_n148EncuestaAtencion[0] ;
         AV16GXLvl9 = (byte)(1) ;
         Form.setCaption( A148EncuestaAtencion );
   ...
   public void S112( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( WebComp_Webcomponent_general_Component), GXutil.lower( "EncuestaGeneral")) != 0 )
      {
         WebComp_Webcomponent_general = WebUtils.getWebComponent(getClass(), "com.projectthani.encuestageneral_impl", remoteHandle, context);
         WebComp_Webcomponent_general_Component = "EncuestaGeneral" ;
      }
      if ( GXutil.len( WebComp_Webcomponent_general_Component) != 0 )
      {
         WebComp_Webcomponent_general.setjustcreated();
         WebComp_Webcomponent_general.componentprepare(new Object[] {"W0019","",Short.valueOf(AV10EncuestaId)});
   ...
   {
      AV10EncuestaId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10EncuestaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10EncuestaId), 4, 0));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vENCUESTAID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10EncuestaId), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110331616", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("encuestaview.js", "?20225110331616", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
   ...
   public void init_default_properties( )
   {
      ...
      divEncuestageneral_cell_Internalname = "ENCUESTAGENERAL_CELL" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10EncuestaId',fld:'vENCUESTAID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H001U2_A37EncuestaId = new short[1] ;
      H001U2_A148EncuestaAtencion = new String[] {""} ;
      H001U2_n148EncuestaAtencion = new boolean[] {false} ;
      A148EncuestaAtencion = "" ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.encuestaview__default(),
         new Object[] {
             new Object[] {
            H001U2_A37EncuestaId, H001U2_A148EncuestaAtencion, H001U2_n148EncuestaAtencion
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV10EncuestaId ;
   private short nRcdExists_3 ;
   private short nIsMod_3 ;
   private short AV10EncuestaId ;
   private short wbEnd ;
   ...
   private String divEncuestageneral_cell_Internalname ;
   ...
   private short[] H001U2_A37EncuestaId ;
   private String[] H001U2_A148EncuestaAtencion ;
   private boolean[] H001U2_n148EncuestaAtencion ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class encuestaview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001U2", "SELECT [EncuestaId], [EncuestaAtencion] FROM [Encuesta] WHERE [EncuestaId] = ? ORDER BY [EncuestaId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
