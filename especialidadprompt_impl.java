...
public final  class especialidadprompt_impl extends GXDataArea
{
   public especialidadprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public especialidadprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( especialidadprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutEspecialidadId") ;
         ...
         {
            AV8InOutEspecialidadId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutEspecialidadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutEspecialidadId), 4, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutEspecialidadNombre = httpContext.GetPar( "InOutEspecialidadNombre") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutEspecialidadNombre", AV9InOutEspecialidadNombre);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110335683", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.especialidadprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutEspecialidadId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutEspecialidadNombre))}, new String[] {"InOutEspecialidadId","InOutEspecialidadNombre"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTESPECIALIDADID", GXutil.ltrim( localUtil.ntoc( AV8InOutEspecialidadId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTESPECIALIDADNOMBRE", AV9InOutEspecialidadNombre);
   ...
   {
      return formatLink("com.projectthani.especialidadprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutEspecialidadId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutEspecialidadNombre))}, new String[] {"InOutEspecialidadId","InOutEspecialidadNombre"})  ;
   }

   public String getPgmname( )
   {
      return "EspecialidadPrompt" ;
   }

   public String getPgmdesc( )
   {
      return "Selecciona Especialidad" ;
   }
   ...
   public void wb5X0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_5X2( true) ;
      }
      else
      {
         wb_table1_12_5X2( false) ;
      }
      return  ;
   }

   public void wb_table1_12_5X2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start5X2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Especialidad", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtEspecialidadFoto_Internalname, "Bitmap", ((GXutil.strcmp("", A155EspecialidadFoto)==0) ? A40000EspecialidadFoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A155EspecialidadFoto))), !bGXsfl_24_Refreshing);
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_ESPECIALIDADNOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A71EspecialidadNombre, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "ESPECIALIDADNOMBRE", A71EspecialidadNombre);
   }
   ...
   public void rf5X2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A156EspecialidadEstado = H005X2_A156EspecialidadEstado[0] ;
            A155EspecialidadFoto = H005X2_A155EspecialidadFoto[0] ;
            httpContext.ajax_rsp_assign_prop("", false, edtEspecialidadFoto_Internalname, "Bitmap", ((GXutil.strcmp("", A155EspecialidadFoto)==0) ? A40000EspecialidadFoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A155EspecialidadFoto))), !bGXsfl_24_Refreshing);
            httpContext.ajax_rsp_assign_prop("", false, edtEspecialidadFoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A155EspecialidadFoto), true);
            A40000EspecialidadFoto_GXI = H005X2_A40000EspecialidadFoto_GXI[0] ;
            httpContext.ajax_rsp_assign_prop("", false, edtEspecialidadFoto_Internalname, "Bitmap", ((GXutil.strcmp("", A155EspecialidadFoto)==0) ? A40000EspecialidadFoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A155EspecialidadFoto))), !bGXsfl_24_Refreshing);
            httpContext.ajax_rsp_assign_prop("", false, edtEspecialidadFoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A155EspecialidadFoto), true);
            A140EspecialidadCodigo = H005X2_A140EspecialidadCodigo[0] ;
            A154EspecialidadDescripcion = H005X2_A154EspecialidadDescripcion[0] ;
            A71EspecialidadNombre = H005X2_A71EspecialidadNombre[0] ;
            A32EspecialidadId = H005X2_A32EspecialidadId[0] ;
            e175X2 ();
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_ESPECIALIDADID"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, localUtil.format( DecimalUtil.doubleToDec(A32EspecialidadId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_ESPECIALIDADNOMBRE"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, GXutil.rtrim( localUtil.format( A71EspecialidadNombre, ""))));
   }
   ...
   public void e155X2( )
   {
      ...
      Form.setCaption( "Selecciona Especialidad" );
   ...
   public void e185X2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutEspecialidadId = A32EspecialidadId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutEspecialidadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutEspecialidadId), 4, 0));
      AV9InOutEspecialidadNombre = A71EspecialidadNombre ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutEspecialidadNombre", AV9InOutEspecialidadNombre);
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV8InOutEspecialidadId),AV9InOutEspecialidadNombre});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutEspecialidadId","AV9InOutEspecialidadNombre"});
   ...
   public void wb_table1_12_5X2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_EspecialidadPrompt.htm");
   ...
   {
      AV8InOutEspecialidadId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutEspecialidadId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutEspecialidadId), 4, 0));
      AV9InOutEspecialidadNombre = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutEspecialidadNombre", AV9InOutEspecialidadNombre);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110335761", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("especialidadprompt.js", "?20225110335761", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_242( )
   {
      ...
      edtEspecialidadDescripcion_Internalname = "ESPECIALIDADDESCRIPCION_"+sGXsfl_24_idx ;
      edtEspecialidadCodigo_Internalname = "ESPECIALIDADCODIGO_"+sGXsfl_24_idx ;
      edtEspecialidadFoto_Internalname = "ESPECIALIDADFOTO_"+sGXsfl_24_idx ;
      cmbEspecialidadEstado.setInternalname( "ESPECIALIDADESTADO_"+sGXsfl_24_idx );
   }
   ...
   public void subsflControlProps_fel_242( )
   {
      ...
      edtEspecialidadDescripcion_Internalname = "ESPECIALIDADDESCRIPCION_"+sGXsfl_24_fel_idx ;
      edtEspecialidadCodigo_Internalname = "ESPECIALIDADCODIGO_"+sGXsfl_24_fel_idx ;
      edtEspecialidadFoto_Internalname = "ESPECIALIDADFOTO_"+sGXsfl_24_fel_idx ;
      cmbEspecialidadEstado.setInternalname( "ESPECIALIDADESTADO_"+sGXsfl_24_fel_idx );
   }
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         {
            GXCCtl = "ESPECIALIDADESTADO_" + sGXsfl_24_idx ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbEspecialidadEstado.getInternalname(), "Values", cmbEspecialidadEstado.ToJavascriptSource(), !bGXsfl_24_Refreshing);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:EspecialidadId|2:EspecialidadNombre|3:EspecialidadDescripcion|4:EspecialidadCodigo|6:EspecialidadEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e115X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e125X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      ...
      setEventMetadata("ENTER","{handler:'e185X2',iparms:[{av:'A32EspecialidadId',fld:'ESPECIALIDADID',pic:'ZZZ9',hsh:true},{av:'A71EspecialidadNombre',fld:'ESPECIALIDADNOMBRE',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutEspecialidadId',fld:'vINOUTESPECIALIDADID',pic:'ZZZ9'},{av:'AV9InOutEspecialidadNombre',fld:'vINOUTESPECIALIDADNOMBRE',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e145X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
   ...
   {
      wcpOAV9InOutEspecialidadNombre = "" ;
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H005X2_A156EspecialidadEstado = new String[] {""} ;
      H005X2_A155EspecialidadFoto = new String[] {""} ;
      H005X2_A40000EspecialidadFoto_GXI = new String[] {""} ;
      H005X2_A140EspecialidadCodigo = new String[] {""} ;
      H005X2_A154EspecialidadDescripcion = new String[] {""} ;
      H005X2_A71EspecialidadNombre = new String[] {""} ;
      H005X2_A32EspecialidadId = new short[1] ;
      ...
      sImgUrl = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.especialidadprompt__default(),
         new Object[] {
             new Object[] {
            H005X2_A156EspecialidadEstado, H005X2_A155EspecialidadFoto, H005X2_A40000EspecialidadFoto_GXI, H005X2_A140EspecialidadCodigo, H005X2_A154EspecialidadDescripcion, H005X2_A71EspecialidadNombre, H005X2_A32EspecialidadId
            }
            , new Object[] {
   ...
   private short wcpOAV8InOutEspecialidadId ;
   private short AV8InOutEspecialidadId ;
   ...
   private String wcpOAV9InOutEspecialidadNombre ;
   private String AV13FilterFullText ;
   private String AV9InOutEspecialidadNombre ;
   ...
   private String[] H005X2_A156EspecialidadEstado ;
   private String[] H005X2_A155EspecialidadFoto ;
   private String[] H005X2_A40000EspecialidadFoto_GXI ;
   private String[] H005X2_A140EspecialidadCodigo ;
   private String[] H005X2_A154EspecialidadDescripcion ;
   private String[] H005X2_A71EspecialidadNombre ;
   private short[] H005X2_A32EspecialidadId ;
...
final  class especialidadprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005X2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
            case 1 :
                  return conditional_H005X3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
      }
