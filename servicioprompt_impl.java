...
public final  class servicioprompt_impl extends GXDataArea
{
   public servicioprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public servicioprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( servicioprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutServicioId") ;
         ...
         {
            AV8InOutServicioId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8InOutServicioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutServicioId), 4, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV9InOutServicioNombre = httpContext.GetPar( "InOutServicioNombre") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9InOutServicioNombre", AV9InOutServicioNombre);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511034256", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.servicioprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutServicioId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutServicioNombre))}, new String[] {"InOutServicioId","InOutServicioNombre"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTSERVICIOID", GXutil.ltrim( localUtil.ntoc( AV8InOutServicioId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTSERVICIONOMBRE", AV9InOutServicioNombre);
   ...
   {
      return formatLink("com.projectthani.servicioprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8InOutServicioId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV9InOutServicioNombre))}, new String[] {"InOutServicioId","InOutServicioNombre"})  ;
   }

   public String getPgmname( )
   {
      return "ServicioPrompt" ;
   }
   ...
   public void wb680( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_12_682( true) ;
      }
      else
      {
         wb_table1_12_682( false) ;
      }
      return  ;
   }

   public void wb_table1_12_682e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void start682( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona Servicio", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_SERVICIONOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A281ServicioNombre, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "SERVICIONOMBRE", A281ServicioNombre);
   }
   ...
   public void rf682( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.DECIMAL, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING,
         ...
         {
            A286ServicioEstado = H00682_A286ServicioEstado[0] ;
            A285ServicioObservacion = H00682_A285ServicioObservacion[0] ;
            A284ServicioComision = H00682_A284ServicioComision[0] ;
            A165LaboratorioNombre = H00682_A165LaboratorioNombre[0] ;
            A40LaboratorioId = H00682_A40LaboratorioId[0] ;
            A52ServicioCategId = H00682_A52ServicioCategId[0] ;
            A283ServicioCosto = H00682_A283ServicioCosto[0] ;
            A282ServicioDescripcion = H00682_A282ServicioDescripcion[0] ;
            A281ServicioNombre = H00682_A281ServicioNombre[0] ;
            A27ServicioId = H00682_A27ServicioId[0] ;
            A40LaboratorioId = H00682_A40LaboratorioId[0] ;
            A165LaboratorioNombre = H00682_A165LaboratorioNombre[0] ;
            e17682 ();
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_SERVICIOID"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, localUtil.format( DecimalUtil.doubleToDec(A27ServicioId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_SERVICIONOMBRE"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, GXutil.rtrim( localUtil.format( A281ServicioNombre, ""))));
   }
   ...
   public void e15682( )
   {
      ...
      Form.setCaption( "Selecciona Servicio" );
   ...
   public void e18682( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8InOutServicioId = A27ServicioId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutServicioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutServicioId), 4, 0));
      AV9InOutServicioNombre = A281ServicioNombre ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutServicioNombre", AV9InOutServicioNombre);
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV8InOutServicioId),AV9InOutServicioNombre});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8InOutServicioId","AV9InOutServicioNombre"});
   ...
   public void wb_table1_12_682( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_ServicioPrompt.htm");
   ...
   {
      AV8InOutServicioId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutServicioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8InOutServicioId), 4, 0));
      AV9InOutServicioNombre = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9InOutServicioNombre", AV9InOutServicioNombre);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511034339", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("servicioprompt.js", "?2022511034339", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_242( )
   {
      ...
      edtServicioId_Internalname = "SERVICIOID_"+sGXsfl_24_idx ;
      edtServicioNombre_Internalname = "SERVICIONOMBRE_"+sGXsfl_24_idx ;
      edtServicioDescripcion_Internalname = "SERVICIODESCRIPCION_"+sGXsfl_24_idx ;
      edtServicioCosto_Internalname = "SERVICIOCOSTO_"+sGXsfl_24_idx ;
      ...
      edtServicioComision_Internalname = "SERVICIOCOMISION_"+sGXsfl_24_idx ;
      edtServicioObservacion_Internalname = "SERVICIOOBSERVACION_"+sGXsfl_24_idx ;
      cmbServicioEstado.setInternalname( "SERVICIOESTADO_"+sGXsfl_24_idx );
   }

   public void subsflControlProps_fel_242( )
   {
      edtavSelect_Internalname = "vSELECT_"+sGXsfl_24_fel_idx ;
      edtServicioId_Internalname = "SERVICIOID_"+sGXsfl_24_fel_idx ;
      edtServicioNombre_Internalname = "SERVICIONOMBRE_"+sGXsfl_24_fel_idx ;
      edtServicioDescripcion_Internalname = "SERVICIODESCRIPCION_"+sGXsfl_24_fel_idx ;
      edtServicioCosto_Internalname = "SERVICIOCOSTO_"+sGXsfl_24_fel_idx ;
      ...
      edtServicioComision_Internalname = "SERVICIOCOMISION_"+sGXsfl_24_fel_idx ;
      edtServicioObservacion_Internalname = "SERVICIOOBSERVACION_"+sGXsfl_24_fel_idx ;
      cmbServicioEstado.setInternalname( "SERVICIOESTADO_"+sGXsfl_24_fel_idx );
   }
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtServicioNombre_Internalname,A281ServicioNombre,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtServicioNombre_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(40),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(24),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         {
            GXCCtl = "SERVICIOESTADO_" + sGXsfl_24_idx ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbServicioEstado.getInternalname(), "Values", cmbServicioEstado.ToJavascriptSource(), !bGXsfl_24_Refreshing);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:ServicioId|2:ServicioNombre|3:ServicioDescripcion|4:ServicioCosto|5:ServicioCategId|6:LaboratorioId|7:LaboratorioNombre|8:ServicioComision|9:ServicioObservacion|10:ServicioEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11682',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12682',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e17682',iparms:[]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e18682',iparms:[{av:'A27ServicioId',fld:'SERVICIOID',pic:'ZZZ9',hsh:true},{av:'A281ServicioNombre',fld:'SERVICIONOMBRE',pic:'',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8InOutServicioId',fld:'vINOUTSERVICIOID',pic:'ZZZ9'},{av:'AV9InOutServicioNombre',fld:'vINOUTSERVICIONOMBRE',pic:''}]}");
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e14682',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV13FilterFullText = "" ;
      H00682_A286ServicioEstado = new String[] {""} ;
      H00682_A285ServicioObservacion = new String[] {""} ;
      H00682_A284ServicioComision = new short[1] ;
      H00682_A165LaboratorioNombre = new String[] {""} ;
      H00682_A40LaboratorioId = new short[1] ;
      H00682_A52ServicioCategId = new short[1] ;
      H00682_A283ServicioCosto = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00682_A282ServicioDescripcion = new String[] {""} ;
      H00682_A281ServicioNombre = new String[] {""} ;
      H00682_A27ServicioId = new short[1] ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.servicioprompt__default(),
         new Object[] {
             new Object[] {
            H00682_A286ServicioEstado, H00682_A285ServicioObservacion, H00682_A284ServicioComision, H00682_A165LaboratorioNombre, H00682_A40LaboratorioId, H00682_A52ServicioCategId, H00682_A283ServicioCosto, H00682_A282ServicioDescripcion, H00682_A281ServicioNombre, H00682_A27ServicioId
            }
            , new Object[] {
   ...
   private short wcpOAV8InOutServicioId ;
   private short AV8InOutServicioId ;
   ...
   private String wcpOAV9InOutServicioNombre ;
   private String AV13FilterFullText ;
   private String AV9InOutServicioNombre ;
   ...
   private String[] H00682_A286ServicioEstado ;
   private String[] H00682_A285ServicioObservacion ;
   private short[] H00682_A284ServicioComision ;
   private String[] H00682_A165LaboratorioNombre ;
   private short[] H00682_A40LaboratorioId ;
   private short[] H00682_A52ServicioCategId ;
   private java.math.BigDecimal[] H00682_A283ServicioCosto ;
   private String[] H00682_A282ServicioDescripcion ;
   private String[] H00682_A281ServicioNombre ;
   private short[] H00682_A27ServicioId ;
...
final  class servicioprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00682( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H00683( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV13FilterFullText ,
                                          short A27ServicioId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00682(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (java.math.BigDecimal)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).shortValue() , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , (String)dynConstraints[9] , (String)dynConstraints[10] , ((Number) dynConstraints[11]).shortValue() , ((Boolean) dynConstraints[12]).booleanValue() );
            case 1 :
                  return conditional_H00683(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (java.math.BigDecimal)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).shortValue() , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , (String)dynConstraints[9] , (String)dynConstraints[10] , ((Number) dynConstraints[11]).shortValue() , ((Boolean) dynConstraints[12]).booleanValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00682", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00683", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
