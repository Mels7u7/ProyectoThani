...
@javax.xml.bind.annotation.XmlType(name = "petitorioloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class petitorioloaddvcombo_RESTInterfaceIN
{
   ...
   public short getPetitorioId( )
   {
      return AV27PetitorioId ;
   }

   @JsonProperty("PetitorioId")
   public void setPetitorioId(  short Value )
   {
      AV27PetitorioId= Value;
   }
