...
public final  class petitoriocategpetitoriosubcategwc_impl extends GXWebComponent
{
   public petitoriocategpetitoriosubcategwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public petitoriocategpetitoriosubcategwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( petitoriocategpetitoriosubcategwc_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = httpContext.GetFirstPar( "PetitorioCategId") ;
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8PetitorioCategId = (short)(GXutil.lval( httpContext.GetPar( "PetitorioCategId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PetitorioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PetitorioCategId), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(AV8PetitorioCategId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8PetitorioCategId, AV20ManageFiltersExecutionStep, AV34Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Petitorio Categ Petitorio Sub Categ WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511033019", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.petitoriocategpetitoriosubcategwc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8PetitorioCategId,4,0))}, new String[] {"PetitorioCategId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8PetitorioCategId", GXutil.ltrim( localUtil.ntoc( wcpOAV8PetitorioCategId, (byte)(4), (byte)(0), ",", "")));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPETITORIOCATEGID", GXutil.ltrim( localUtil.ntoc( AV8PetitorioCategId, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return "PetitorioCategPetitorioSubCategWC" ;
   }
   ...
   public void wb4A0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.petitoriocategpetitoriosubcategwc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_4A2( true) ;
      }
      else
      {
         wb_table1_22_4A2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_4A2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start4A2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Petitorio Categ Petitorio Sub Categ WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_PETITORIOSUBCATEGID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A48PetitorioSubCategId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"PETITORIOSUBCATEGID", GXutil.ltrim( localUtil.ntoc( A48PetitorioSubCategId, (byte)(4), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV34Pgmname = "PetitorioCategPetitorioSubCategWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf4A2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Short.valueOf(AV8PetitorioCategId) ,
                                              Short.valueOf(A49PetitorioCategId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT
                                              }
         });
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H004A2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8PetitorioCategId), lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A49PetitorioCategId = H004A2_A49PetitorioCategId[0] ;
            ...
            A265PetitorioSubCategNombre = H004A2_A265PetitorioSubCategNombre[0] ;
            A48PetitorioSubCategId = H004A2_A48PetitorioSubCategId[0] ;
            e184A2 ();
   ...
   public void send_integrity_lvl_hashes4A2( )
   {
      ...
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_DELETE", AV29IsAuthorized_Delete);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( sPrefix, AV29IsAuthorized_Delete));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_PETITORIOSUBCATEGID"+"_"+sGXsfl_37_idx, getSecureSignedToken( sPrefix+sGXsfl_37_idx, localUtil.format( DecimalUtil.doubleToDec(A48PetitorioSubCategId), "ZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H004A3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8PetitorioCategId), lV16FilterFullText, lV16FilterFullText});
   ...
   public void strup4A0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8PetitorioCategId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8PetitorioCategId"), ",", ".")) ;
   ...
   public void e164A2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtPetitorioCategId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtPetitorioCategId_Visible), 5, 0), true);
   ...
   public void e114A2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("PetitorioCategPetitorioSubCategWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV34Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("PetitorioCategPetitorioSubCategWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "PetitorioCategPetitorioSubCategWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         petitoriocategpetitoriosubcategwc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPetitorioSubCateg_Update", GXv_boolean7) ;
      petitoriocategpetitoriosubcategwc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPetitorioSubCateg_Delete", GXv_boolean7) ;
      petitoriocategpetitoriosubcategwc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPetitorioSubCateg_Insert", GXv_boolean7) ;
      petitoriocategpetitoriosubcategwc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "PetitorioCategPetitorioSubCategWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "PetitorioSubCateg" );
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "PetitorioCategId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8PetitorioCategId, 4, 0) );
   ...
   public void wb_table1_22_4A2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_4A2( true) ;
      }
      else
      {
         wb_table2_27_4A2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_4A2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_4A2e( true) ;
      }
      else
      {
         wb_table1_22_4A2e( false) ;
      }
   }

   public void wb_table2_27_4A2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8PetitorioCategId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PetitorioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PetitorioCategId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8PetitorioCategId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "petitoriocategpetitoriosubcategwc", GetJustCreated( ));
      ...
      {
         AV8PetitorioCategId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PetitorioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PetitorioCategId), 4, 0));
      }
      wcpOAV8PetitorioCategId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8PetitorioCategId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV8PetitorioCategId != wcpOAV8PetitorioCategId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8PetitorioCategId = AV8PetitorioCategId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8PetitorioCategId = httpContext.cgiGet( sPrefix+"AV8PetitorioCategId_CTRL") ;
      if ( GXutil.len( sCtrlAV8PetitorioCategId) > 0 )
      {
         AV8PetitorioCategId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV8PetitorioCategId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PetitorioCategId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PetitorioCategId), 4, 0));
      }
      else
      {
         AV8PetitorioCategId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8PetitorioCategId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8PetitorioCategId_PARM", GXutil.ltrim( localUtil.ntoc( AV8PetitorioCategId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8PetitorioCategId)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8PetitorioCategId_CTRL", GXutil.rtrim( sCtrlAV8PetitorioCategId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511033184", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("petitoriocategpetitoriosubcategwc.js", "?2022511033184", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtPetitorioSubCategNombre_Internalname = sPrefix+"PETITORIOSUBCATEGNOMBRE_"+sGXsfl_37_idx ;
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtPetitorioSubCategNombre_Internalname = sPrefix+"PETITORIOSUBCATEGNOMBRE_"+sGXsfl_37_fel_idx ;
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPetitorioSubCategNombre_Internalname,A265PetitorioSubCategNombre,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtPetitorioSubCategNombre_Link,"","","",edtPetitorioSubCategNombre_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(200),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:PetitorioSubCategId|3:PetitorioSubCategNombre" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e184A2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A48PetitorioSubCategId',fld:'PETITORIOSUBCATEGID',pic:'ZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV26Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV28Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtPetitorioSubCategNombre_Link',ctrl:'PETITORIOSUBCATEGNOMBRE',prop:'Link'}]}");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e154A2',iparms:[{av:'A48PetitorioSubCategId',fld:'PETITORIOSUBCATEGID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H004A2_A49PetitorioCategId = new short[1] ;
      H004A2_A265PetitorioSubCategNombre = new String[] {""} ;
      H004A2_A48PetitorioSubCategId = new short[1] ;
      ...
      sCtrlAV8PetitorioCategId = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.petitoriocategpetitoriosubcategwc__default(),
         new Object[] {
             new Object[] {
            H004A2_A49PetitorioCategId, H004A2_A265PetitorioSubCategNombre, H004A2_A48PetitorioSubCategId
            }
            , new Object[] {
   ...
   private short wcpOAV8PetitorioCategId ;
   private short AV8PetitorioCategId ;
   ...
   private String sCtrlAV8PetitorioCategId ;
   ...
   private short[] H004A2_A49PetitorioCategId ;
   private String[] H004A2_A265PetitorioSubCategNombre ;
   private short[] H004A2_A48PetitorioSubCategId ;
...
final  class petitoriocategpetitoriosubcategwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          short A49PetitorioCategId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [PetitorioCategId], [PetitorioSubCategNombre], [PetitorioSubCategId]" ;
      sFromString = " FROM [PetitorioSubCateg]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([PetitorioCategId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([PetitorioSubCategId] AS decimal(4,0))) like '%' + ?) or ( [PetitorioSubCategNombre] like '%' + ?))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [PetitorioCategId], [PetitorioSubCategNombre]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioCategId] DESC, [PetitorioSubCategNombre] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [PetitorioCategId], [PetitorioSubCategId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioCategId] DESC, [PetitorioSubCategId] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [PetitorioSubCategId]" ;
      }
                                          ...
                                          short A49PetitorioCategId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [PetitorioSubCateg]" ;
      addWhere(sWhereString, "([PetitorioCategId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([PetitorioSubCategId] AS decimal(4,0))) like '%' + ?) or ( [PetitorioSubCategNombre] like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H004A2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).shortValue() );
            case 1 :
                  return conditional_H004A3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Boolean) dynConstraints[4]).booleanValue() , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).shortValue() );
      }
