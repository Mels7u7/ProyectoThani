...
@javax.xml.bind.annotation.XmlType(name = "citaservicioloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class citaservicioloaddvcombo_RESTInterfaceIN
{
   ...
   String AV26CitaServicioId;
   @JsonProperty("CitaServicioId")
   public String getCitaServicioId( )
   {
      return AV26CitaServicioId ;
   }

   @JsonProperty("CitaServicioId")
   public void setCitaServicioId(  String Value )
   {
      AV26CitaServicioId= Value;
   }
