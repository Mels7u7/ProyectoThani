...
public final  class SdtTreeNodeCollection_TreeNode extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "Nodes") )
            {
               ...
               {
                  gxTv_SdtTreeNodeCollection_TreeNode_Nodes = new GXBaseCollection<com.projectthani.SdtTreeNodeCollection_TreeNode>(com.projectthani.SdtTreeNodeCollection_TreeNode.class, "TreeNode", "ProjectThani", remoteHandle);
               }
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("Id", GXutil.rtrim( gxTv_SdtTreeNodeCollection_TreeNode_Id));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("Name", GXutil.rtrim( gxTv_SdtTreeNodeCollection_TreeNode_Name));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("Link", GXutil.rtrim( gxTv_SdtTreeNodeCollection_TreeNode_Link));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("LinkTarget", GXutil.rtrim( gxTv_SdtTreeNodeCollection_TreeNode_Linktarget));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("Expanded", GXutil.rtrim( GXutil.booltostr( gxTv_SdtTreeNodeCollection_TreeNode_Expanded)));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("DynamicLoad", GXutil.rtrim( GXutil.booltostr( gxTv_SdtTreeNodeCollection_TreeNode_Dynamicload)));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("Icon", GXutil.rtrim( gxTv_SdtTreeNodeCollection_TreeNode_Icon));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("IconWhenSelected", GXutil.rtrim( gxTv_SdtTreeNodeCollection_TreeNode_Iconwhenselected));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
   ...
   {
      gxTv_SdtTreeNodeCollection_TreeNode_N = (byte)(0) ;
   ...
   public GXBaseCollection<com.projectthani.SdtTreeNodeCollection_TreeNode> getgxTv_SdtTreeNodeCollection_TreeNode_Nodes( )
   {
      if ( gxTv_SdtTreeNodeCollection_TreeNode_Nodes == null )
      {
         gxTv_SdtTreeNodeCollection_TreeNode_Nodes = new GXBaseCollection<com.projectthani.SdtTreeNodeCollection_TreeNode>(com.projectthani.SdtTreeNodeCollection_TreeNode.class, "TreeNode", "ProjectThani", remoteHandle);
   ...
   public void setgxTv_SdtTreeNodeCollection_TreeNode_Nodes( GXBaseCollection<com.projectthani.SdtTreeNodeCollection_TreeNode> value )
   {
      gxTv_SdtTreeNodeCollection_TreeNode_Nodes_N = (byte)(0) ;
      gxTv_SdtTreeNodeCollection_TreeNode_N = (byte)(0) ;
   ...
   public void initialize( )
   {
      ...
      gxTv_SdtTreeNodeCollection_TreeNode_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtTreeNodeCollection_TreeNode_N ;
   }

   public com.projectthani.SdtTreeNodeCollection_TreeNode Clone( )
   {
      return (com.projectthani.SdtTreeNodeCollection_TreeNode)(clone()) ;
   }

   public void setStruct( com.projectthani.StructSdtTreeNodeCollection_TreeNode struct )
   {
      ...
      GXBaseCollection<com.projectthani.SdtTreeNodeCollection_TreeNode> gxTv_SdtTreeNodeCollection_TreeNode_Nodes_aux = new GXBaseCollection<com.projectthani.SdtTreeNodeCollection_TreeNode>(com.projectthani.SdtTreeNodeCollection_TreeNode.class, "TreeNode", "ProjectThani", remoteHandle);
      Vector<com.projectthani.StructSdtTreeNodeCollection_TreeNode> gxTv_SdtTreeNodeCollection_TreeNode_Nodes_aux1 = struct.getNodes();
      if (gxTv_SdtTreeNodeCollection_TreeNode_Nodes_aux1 != null)
      {
         ...
         {
            gxTv_SdtTreeNodeCollection_TreeNode_Nodes_aux.add(new com.projectthani.SdtTreeNodeCollection_TreeNode(gxTv_SdtTreeNodeCollection_TreeNode_Nodes_aux1.elementAt(i)));
         }
      }
   ...
   public com.projectthani.StructSdtTreeNodeCollection_TreeNode getStruct( )
   {
      com.projectthani.StructSdtTreeNodeCollection_TreeNode struct = new com.projectthani.StructSdtTreeNodeCollection_TreeNode ();
   ...
   protected byte gxTv_SdtTreeNodeCollection_TreeNode_N ;
   ...
   protected GXBaseCollection<com.projectthani.SdtTreeNodeCollection_TreeNode> gxTv_SdtTreeNodeCollection_TreeNode_Nodes_aux ;
   protected GXBaseCollection<com.projectthani.SdtTreeNodeCollection_TreeNode> gxTv_SdtTreeNodeCollection_TreeNode_Nodes=null ;
}
