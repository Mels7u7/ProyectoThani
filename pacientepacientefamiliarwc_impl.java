...
public final  class pacientepacientefamiliarwc_impl extends GXWebComponent
{
   public pacientepacientefamiliarwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public pacientepacientefamiliarwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( pacientepacientefamiliarwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8PacienteId, AV20ManageFiltersExecutionStep, AV33Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Paciente Paciente Familiar WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110325488", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.pacientepacientefamiliarwc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8PacienteId,8,0))}, new String[] {"PacienteId"}) +"\">") ;
   ...
   {
      return "PacientePacienteFamiliarWC" ;
   }
   ...
   public void wb540( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.pacientepacientefamiliarwc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_542( true) ;
      }
      else
      {
         wb_table1_22_542( false) ;
      }
      return  ;
   }

   public void wb_table1_22_542e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeValue( "Familiar Id") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Paciente Id") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Hijo Nombres") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            ...
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Familiar Parentesco") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Familiar Estado") ;
            httpContext.writeTextNL( "</th>") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A45PacienteFamiliarId, (byte)(8), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A46SGPacienteHijoPacienteId, (byte)(8), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A232SGPacienteHijoNombres);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A233SGPacienteHijoApellidoPaterno);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A234SGPacienteHijoApellidoMaterno);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.rtrim( A235PacienteFamiliarParentesco));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.rtrim( A236PacienteFamiliarEstado));
            GridContainer.AddColumnProperties(GridColumn);
   ...
   public void start542( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Paciente Paciente Familiar WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           cmbPacienteFamiliarParentesco.setName( cmbPacienteFamiliarParentesco.getInternalname() );
                           ...
                           cmbPacienteFamiliarEstado.setName( cmbPacienteFamiliarEstado.getInternalname() );
   ...
   {
      /* GeneXus formulas. */
      AV33Pgmname = "PacientePacienteFamiliarWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf542( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV16FilterFullText ,
                                              Integer.valueOf(A45PacienteFamiliarId) ,
                                              Integer.valueOf(A46SGPacienteHijoPacienteId) ,
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.INT, TypeConstants.INT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN,
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H00542 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV8PacienteId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A20PacienteId = H00542_A20PacienteId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A20PacienteId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A20PacienteId), 8, 0));
            A236PacienteFamiliarEstado = H00542_A236PacienteFamiliarEstado[0] ;
            A235PacienteFamiliarParentesco = H00542_A235PacienteFamiliarParentesco[0] ;
            A234SGPacienteHijoApellidoMaterno = H00542_A234SGPacienteHijoApellidoMaterno[0] ;
            A233SGPacienteHijoApellidoPaterno = H00542_A233SGPacienteHijoApellidoPaterno[0] ;
            A232SGPacienteHijoNombres = H00542_A232SGPacienteHijoNombres[0] ;
            A46SGPacienteHijoPacienteId = H00542_A46SGPacienteHijoPacienteId[0] ;
            A45PacienteFamiliarId = H00542_A45PacienteFamiliarId[0] ;
            A234SGPacienteHijoApellidoMaterno = H00542_A234SGPacienteHijoApellidoMaterno[0] ;
            A233SGPacienteHijoApellidoPaterno = H00542_A233SGPacienteHijoApellidoPaterno[0] ;
            A232SGPacienteHijoNombres = H00542_A232SGPacienteHijoNombres[0] ;
            e18542 ();
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H00543 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV8PacienteId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   private void e18542( )
   {
      ...
      {
         edtavUpdate_Link = formatLink("com.projectthani.pacientefamiliar", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A45PacienteFamiliarId,8,0))}, new String[] {})  ;
      }
      AV28Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDelete_Internalname, AV28Delete);
      if ( AV29IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.projectthani.pacientefamiliar", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A45PacienteFamiliarId,8,0))}, new String[] {})  ;
      }
      /* Load Method */
      if ( wbStart != -1 )
      {
   ...
   public void e11542( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("PacientePacienteFamiliarWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV33Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("PacientePacienteFamiliarWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "PacientePacienteFamiliarWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         pacientepacientefamiliarwc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e15542( )
   {
      /* 'DoInsert' Routine */
      returnInSub = false ;
      callWebObject(formatLink("com.projectthani.pacientefamiliar", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {}) );
   ...
   public void S152( )
   {
      ...
      new com.projectthani.wwpbaseobjects.secisauthbyobjectname(remoteHandle, context).execute( "PacienteFamiliar", GXv_boolean7) ;
      pacientepacientefamiliarwc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "PacientePacienteFamiliarWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "PacienteFamiliar" );
   ...
   public void wb_table1_22_542( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_542( true) ;
      }
      else
      {
         wb_table2_27_542( false) ;
      }
      return  ;
   }

   public void wb_table2_27_542e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_542e( true) ;
      }
      else
      {
         wb_table1_22_542e( false) ;
      }
   }

   public void wb_table2_27_542( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "pacientepacientefamiliarwc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110325679", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("pacientepacientefamiliarwc.js", "?20225110325679", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtPacienteFamiliarId_Internalname = sPrefix+"PACIENTEFAMILIARID_"+sGXsfl_37_idx ;
      edtSGPacienteHijoPacienteId_Internalname = sPrefix+"SGPACIENTEHIJOPACIENTEID_"+sGXsfl_37_idx ;
      edtSGPacienteHijoNombres_Internalname = sPrefix+"SGPACIENTEHIJONOMBRES_"+sGXsfl_37_idx ;
      edtSGPacienteHijoApellidoPaterno_Internalname = sPrefix+"SGPACIENTEHIJOAPELLIDOPATERNO_"+sGXsfl_37_idx ;
      edtSGPacienteHijoApellidoMaterno_Internalname = sPrefix+"SGPACIENTEHIJOAPELLIDOMATERNO_"+sGXsfl_37_idx ;
      cmbPacienteFamiliarParentesco.setInternalname( sPrefix+"PACIENTEFAMILIARPARENTESCO_"+sGXsfl_37_idx );
      cmbPacienteFamiliarEstado.setInternalname( sPrefix+"PACIENTEFAMILIARESTADO_"+sGXsfl_37_idx );
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtPacienteFamiliarId_Internalname = sPrefix+"PACIENTEFAMILIARID_"+sGXsfl_37_fel_idx ;
      edtSGPacienteHijoPacienteId_Internalname = sPrefix+"SGPACIENTEHIJOPACIENTEID_"+sGXsfl_37_fel_idx ;
      edtSGPacienteHijoNombres_Internalname = sPrefix+"SGPACIENTEHIJONOMBRES_"+sGXsfl_37_fel_idx ;
      edtSGPacienteHijoApellidoPaterno_Internalname = sPrefix+"SGPACIENTEHIJOAPELLIDOPATERNO_"+sGXsfl_37_fel_idx ;
      edtSGPacienteHijoApellidoMaterno_Internalname = sPrefix+"SGPACIENTEHIJOAPELLIDOMATERNO_"+sGXsfl_37_fel_idx ;
      cmbPacienteFamiliarParentesco.setInternalname( sPrefix+"PACIENTEFAMILIARPARENTESCO_"+sGXsfl_37_fel_idx );
      cmbPacienteFamiliarEstado.setInternalname( sPrefix+"PACIENTEFAMILIARESTADO_"+sGXsfl_37_fel_idx );
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPacienteFamiliarId_Internalname,GXutil.ltrim( localUtil.ntoc( A45PacienteFamiliarId, (byte)(8), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A45PacienteFamiliarId), "ZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtPacienteFamiliarId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSGPacienteHijoPacienteId_Internalname,GXutil.ltrim( localUtil.ntoc( A46SGPacienteHijoPacienteId, (byte)(8), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A46SGPacienteHijoPacienteId), "ZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSGPacienteHijoPacienteId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSGPacienteHijoNombres_Internalname,A232SGPacienteHijoNombres,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSGPacienteHijoNombres_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSGPacienteHijoApellidoPaterno_Internalname,A233SGPacienteHijoApellidoPaterno,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSGPacienteHijoApellidoPaterno_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSGPacienteHijoApellidoMaterno_Internalname,A234SGPacienteHijoApellidoMaterno,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSGPacienteHijoApellidoMaterno_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         }
         if ( ( cmbPacienteFamiliarParentesco.getItemCount() == 0 ) && isAjaxCallMode( ) )
         {
            GXCCtl = "PACIENTEFAMILIARPARENTESCO_" + sGXsfl_37_idx ;
            cmbPacienteFamiliarParentesco.setName( GXCCtl );
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbPacienteFamiliarParentesco,cmbPacienteFamiliarParentesco.getInternalname(),GXutil.rtrim( A235PacienteFamiliarParentesco),Integer.valueOf(1),cmbPacienteFamiliarParentesco.getJsonclick(),Integer.valueOf(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","char","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","Attribute","WWColumn hidden-xs","","","",Boolean.valueOf(true),Integer.valueOf(1)});
         cmbPacienteFamiliarParentesco.setValue( GXutil.rtrim( A235PacienteFamiliarParentesco) );
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbPacienteFamiliarParentesco.getInternalname(), "Values", cmbPacienteFamiliarParentesco.ToJavascriptSource(), !bGXsfl_37_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         }
         if ( ( cmbPacienteFamiliarEstado.getItemCount() == 0 ) && isAjaxCallMode( ) )
         {
            GXCCtl = "PACIENTEFAMILIARESTADO_" + sGXsfl_37_idx ;
            cmbPacienteFamiliarEstado.setName( GXCCtl );
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbPacienteFamiliarEstado,cmbPacienteFamiliarEstado.getInternalname(),GXutil.rtrim( A236PacienteFamiliarEstado),Integer.valueOf(1),cmbPacienteFamiliarEstado.getJsonclick(),Integer.valueOf(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","char","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"px",Integer.valueOf(0),"px","","Attribute","WWColumn hidden-xs","","","",Boolean.valueOf(true),Integer.valueOf(1)});
         cmbPacienteFamiliarEstado.setValue( GXutil.rtrim( A236PacienteFamiliarEstado) );
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbPacienteFamiliarEstado.getInternalname(), "Values", cmbPacienteFamiliarEstado.ToJavascriptSource(), !bGXsfl_37_Refreshing);
   ...
   public void init_default_properties( )
   {
      ...
      edtPacienteFamiliarId_Internalname = sPrefix+"PACIENTEFAMILIARID" ;
      edtSGPacienteHijoPacienteId_Internalname = sPrefix+"SGPACIENTEHIJOPACIENTEID" ;
      edtSGPacienteHijoNombres_Internalname = sPrefix+"SGPACIENTEHIJONOMBRES" ;
      edtSGPacienteHijoApellidoPaterno_Internalname = sPrefix+"SGPACIENTEHIJOAPELLIDOPATERNO" ;
      edtSGPacienteHijoApellidoMaterno_Internalname = sPrefix+"SGPACIENTEHIJOAPELLIDOMATERNO" ;
      cmbPacienteFamiliarParentesco.setInternalname( sPrefix+"PACIENTEFAMILIARPARENTESCO" );
      cmbPacienteFamiliarEstado.setInternalname( sPrefix+"PACIENTEFAMILIARESTADO" );
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:PacienteFamiliarId|3:SGPacienteHijoPacienteId|4:SGPacienteHijoNombres|5:SGPacienteHijoApellidoPaterno|6:SGPacienteHijoApellidoMaterno|7:PacienteFamiliarParentesco|8:PacienteFamiliarEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e18542',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A45PacienteFamiliarId',fld:'PACIENTEFAMILIARID',pic:'ZZZZZZZ9'},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e15542',iparms:[{av:'A45PacienteFamiliarId',fld:'PACIENTEFAMILIARID',pic:'ZZZZZZZ9'}]");
      setEventMetadata("'DOINSERT'",",oparms:[{av:'A45PacienteFamiliarId',fld:'PACIENTEFAMILIARID',pic:'ZZZZZZZ9'}]}");
      setEventMetadata("VALID_SGPACIENTEHIJOPACIENTEID","{handler:'valid_Sgpacientehijopacienteid',iparms:[]");
      setEventMetadata("VALID_SGPACIENTEHIJOPACIENTEID",",oparms:[]}");
      setEventMetadata("NULL","{handler:'valid_Pacientefamiliarestado',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H00542_A20PacienteId = new int[1] ;
      H00542_A236PacienteFamiliarEstado = new String[] {""} ;
      H00542_A235PacienteFamiliarParentesco = new String[] {""} ;
      H00542_A234SGPacienteHijoApellidoMaterno = new String[] {""} ;
      H00542_A233SGPacienteHijoApellidoPaterno = new String[] {""} ;
      H00542_A232SGPacienteHijoNombres = new String[] {""} ;
      H00542_A46SGPacienteHijoPacienteId = new int[1] ;
      H00542_A45PacienteFamiliarId = new int[1] ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.pacientepacientefamiliarwc__default(),
         new Object[] {
             new Object[] {
            H00542_A20PacienteId, H00542_A236PacienteFamiliarEstado, H00542_A235PacienteFamiliarParentesco, H00542_A234SGPacienteHijoApellidoMaterno, H00542_A233SGPacienteHijoApellidoPaterno, H00542_A232SGPacienteHijoNombres, H00542_A46SGPacienteHijoPacienteId, H00542_A45PacienteFamiliarId
            }
            , new Object[] {
   ...
   private int[] H00542_A20PacienteId ;
   private String[] H00542_A236PacienteFamiliarEstado ;
   private String[] H00542_A235PacienteFamiliarParentesco ;
   private String[] H00542_A234SGPacienteHijoApellidoMaterno ;
   private String[] H00542_A233SGPacienteHijoApellidoPaterno ;
   private String[] H00542_A232SGPacienteHijoNombres ;
   private int[] H00542_A46SGPacienteHijoPacienteId ;
   private int[] H00542_A45PacienteFamiliarId ;
...
final  class pacientepacientefamiliarwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00542( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A45PacienteFamiliarId ,
                                          int A46SGPacienteHijoPacienteId ,
                                          String A232SGPacienteHijoNombres ,
                                          String A233SGPacienteHijoApellidoPaterno ,
                                          String A234SGPacienteHijoApellidoMaterno ,
                                          String A235PacienteFamiliarParentesco ,
                                          String A236PacienteFamiliarEstado ,
                                          short AV14OrderedBy ,
                                          boolean AV15OrderedDsc ,
                                          int AV8PacienteId ,
                                          int A20PacienteId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[PacienteId], T1.[PacienteFamiliarEstado], T1.[PacienteFamiliarParentesco], T2.[PacienteApellidoMaterno] AS SGPacienteHijoApellidoMaterno, T2.[PacienteApellidoPaterno]" ;
      sSelectString += " AS SGPacienteHijoApellidoPaterno, T2.[PacienteNombres] AS SGPacienteHijoNombres, T1.[SGPacienteHijoPacienteId] AS SGPacienteHijoPacienteId, T1.[PacienteFamiliarId]" ;
      sFromString = " FROM ([PacienteFamiliar] T1 INNER JOIN [Paciente] T2 ON T2.[PacienteId] = T1.[SGPacienteHijoPacienteId])" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.[PacienteId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST(T1.[PacienteFamiliarId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(8), CAST(T1.[SGPacienteHijoPacienteId] AS decimal(8,0))) like '%' + ?) or ( T2.[PacienteNombres] like '%' + ?) or ( T2.[PacienteApellidoPaterno] like '%' + ?) or ( T2.[PacienteApellidoMaterno] like '%' + ?) or ( 'hijo(a)' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'H') or ( 'padre' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'P') or ( 'madre' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'M') or ( 'hermano(a)' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'HM') or ( 'sobrino(a)' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'S') or ( 'tio(a)' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'T') or ( 'abuelo(a)' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'A') or ( 'nieto(a)' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'N') or ( 'otro' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'O') or ( 'activo' like '%' + LOWER(?) and T1.[PacienteFamiliarEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and T1.[PacienteFamiliarEstado] = 'I'))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY T1.[PacienteId], T1.[PacienteFamiliarId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PacienteId] DESC, T1.[PacienteFamiliarId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PacienteId], T1.[SGPacienteHijoPacienteId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PacienteId] DESC, T1.[SGPacienteHijoPacienteId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PacienteId], T2.[PacienteNombres]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PacienteId] DESC, T2.[PacienteNombres] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PacienteId], T2.[PacienteApellidoPaterno]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PacienteId] DESC, T2.[PacienteApellidoPaterno] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PacienteId], T2.[PacienteApellidoMaterno]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PacienteId] DESC, T2.[PacienteApellidoMaterno] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PacienteId], T1.[PacienteFamiliarParentesco]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PacienteId] DESC, T1.[PacienteFamiliarParentesco] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PacienteId], T1.[PacienteFamiliarEstado]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PacienteId] DESC, T1.[PacienteFamiliarEstado] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[PacienteFamiliarId]" ;
      }
   ...
   protected Object[] conditional_H00543( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A45PacienteFamiliarId ,
                                          ...
                                          int A20PacienteId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([PacienteFamiliar] T1 INNER JOIN [Paciente] T2 ON T2.[PacienteId] = T1.[SGPacienteHijoPacienteId])" ;
      addWhere(sWhereString, "(T1.[PacienteId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST(T1.[PacienteFamiliarId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(8), CAST(T1.[SGPacienteHijoPacienteId] AS decimal(8,0))) like '%' + ?) or ( T2.[PacienteNombres] like '%' + ?) or ( T2.[PacienteApellidoPaterno] like '%' + ?) or ( T2.[PacienteApellidoMaterno] like '%' + ?) or ( 'hijo(a)' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'H') or ( 'padre' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'P') or ( 'madre' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'M') or ( 'hermano(a)' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'HM') or ( 'sobrino(a)' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'S') or ( 'tio(a)' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'T') or ( 'abuelo(a)' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'A') or ( 'nieto(a)' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'N') or ( 'otro' like '%' + LOWER(?) and T1.[PacienteFamiliarParentesco] = 'O') or ( 'activo' like '%' + LOWER(?) and T1.[PacienteFamiliarEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and T1.[PacienteFamiliarEstado] = 'I'))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00542(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , ((Boolean) dynConstraints[9]).booleanValue() , ((Number) dynConstraints[10]).intValue() , ((Number) dynConstraints[11]).intValue() );
            case 1 :
                  return conditional_H00543(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , ((Boolean) dynConstraints[9]).booleanValue() , ((Number) dynConstraints[10]).intValue() , ((Number) dynConstraints[11]).intValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00542", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00543", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
