...
public final  class SdtDVelop_Menu_Item extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "subItems") )
            {
               ...
               {
                  gxTv_SdtDVelop_Menu_Item_Subitems = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item>(com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item.class, "Item", "ProjectThani", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("id", GXutil.rtrim( gxTv_SdtDVelop_Menu_Item_Id));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("tooltip", GXutil.rtrim( gxTv_SdtDVelop_Menu_Item_Tooltip));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("link", GXutil.rtrim( gxTv_SdtDVelop_Menu_Item_Link));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("linkTarget", GXutil.rtrim( gxTv_SdtDVelop_Menu_Item_Linktarget));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("iconClass", GXutil.rtrim( gxTv_SdtDVelop_Menu_Item_Iconclass));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("caption", GXutil.rtrim( gxTv_SdtDVelop_Menu_Item_Caption));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("authorizationKey", GXutil.rtrim( gxTv_SdtDVelop_Menu_Item_Authorizationkey));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("additionalData", GXutil.rtrim( gxTv_SdtDVelop_Menu_Item_Additionaldata));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("submenuImage", GXutil.rtrim( gxTv_SdtDVelop_Menu_Item_Submenuimage));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("submenuImage_GXI", GXutil.rtrim( gxTv_SdtDVelop_Menu_Item_Submenuimage_gxi));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
   ...
   public GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item> getgxTv_SdtDVelop_Menu_Item_Subitems( )
   {
      if ( gxTv_SdtDVelop_Menu_Item_Subitems == null )
      {
         gxTv_SdtDVelop_Menu_Item_Subitems = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item>(com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item.class, "Item", "ProjectThani", remoteHandle);
   ...
   public void setgxTv_SdtDVelop_Menu_Item_Subitems( GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item> value )
   {
      gxTv_SdtDVelop_Menu_Item_Subitems_N = (byte)(0) ;
      gxTv_SdtDVelop_Menu_Item_N = (byte)(0) ;
   ...
   public com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtDVelop_Menu_Item struct )
   {
      ...
      GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item> gxTv_SdtDVelop_Menu_Item_Subitems_aux = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item>(com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item.class, "Item", "ProjectThani", remoteHandle);
      Vector<com.projectthani.wwpbaseobjects.StructSdtDVelop_Menu_Item> gxTv_SdtDVelop_Menu_Item_Subitems_aux1 = struct.getSubitems();
      if (gxTv_SdtDVelop_Menu_Item_Subitems_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtDVelop_Menu_Item_Subitems_aux1.size(); i++)
         {
            gxTv_SdtDVelop_Menu_Item_Subitems_aux.add(new com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item(gxTv_SdtDVelop_Menu_Item_Subitems_aux1.elementAt(i)));
         }
      }
   ...
   public com.projectthani.wwpbaseobjects.StructSdtDVelop_Menu_Item getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtDVelop_Menu_Item struct = new com.projectthani.wwpbaseobjects.StructSdtDVelop_Menu_Item ();
   ...
   protected GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item> gxTv_SdtDVelop_Menu_Item_Subitems_aux ;
   protected GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item> gxTv_SdtDVelop_Menu_Item_Subitems=null ;
}
