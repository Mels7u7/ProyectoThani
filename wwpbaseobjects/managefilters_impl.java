...
public final  class managefilters_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Gridgridstatecollections") == 0 )
         {
            ...
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_Rows", GXutil.ltrim( localUtil.ntoc( subGridgridstatecollections_Rows, (byte)(6), (byte)(0), ".", "")));
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_EMPOWERER_Gridinternalname", GXutil.rtrim( Gridgridstatecollections_empowerer_Gridinternalname));
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vUSERKEY", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV14UserKey, ""))));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511033996", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim(AV14UserKey))}, new String[] {"UserKey"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vUSERKEY", AV14UserKey);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vUSERKEY", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV14UserKey, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage", GXutil.ltrim( localUtil.ntoc( GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage, (byte)(15), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_nEOF", GXutil.ltrim( localUtil.ntoc( GRIDGRIDSTATECOLLECTIONS_nEOF, (byte)(1), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_Rows", GXutil.ltrim( localUtil.ntoc( subGridgridstatecollections_Rows, (byte)(6), (byte)(0), ".", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "GRIDGRIDSTATECOLLECTIONS_EMPOWERER_Gridinternalname", GXutil.rtrim( Gridgridstatecollections_empowerer_Gridinternalname));
   }
   ...
   {
      return formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim(AV14UserKey))}, new String[] {"UserKey"})  ;
   }
   ...
   public void wb0D0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 PopupContentCell", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divTablecontent_Internalname, 1, 0, "px", 0, "px", "TableContent", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 EditableGridCell_LinedAtts HasGridEmpowerer", "left", "top", "", "", "div");
         /*  Grid Control  */
         ...
         if ( GridgridstatecollectionsContainer.GetWrapped() == 1 )
         {
            ...
            sStyleString = "" ;
            com.projectthani.GxWebStd.gx_table_start( httpContext, subGridgridstatecollections_Internalname, subGridgridstatecollections_Internalname, "", "GridNoBorder WorkWith", 0, "", "", 1, 2, sStyleString, "", "", 0);
            /* Subfile titles */
      ...
      if ( wbEnd == 15 )
      {
         ...
         else
         {
            ...
            httpContext.ajax_rsp_assign_grid("_"+"Gridgridstatecollections", GridgridstatecollectionsContainer);
            if ( ! httpContext.isAjaxRequest( ) && ! httpContext.isSpaRequest( ) )
            {
               com.projectthani.GxWebStd.gx_hidden_field( httpContext, "GridgridstatecollectionsContainerData", GridgridstatecollectionsContainer.ToJavascriptSource());
            }
            if ( httpContext.isAjaxRequest( ) || httpContext.isSpaRequest( ) )
            {
               com.projectthani.GxWebStd.gx_hidden_field( httpContext, "GridgridstatecollectionsContainerData"+"V", GridgridstatecollectionsContainer.GridValuesHidden());
            }
            else
            {
         ...
         StyleString = "" ;
         com.projectthani.GxWebStd.gx_button_ctrl( httpContext, bttBtnenter_Internalname, "gx.evt.setGridEvt("+GXutil.str( 15, 2, 0)+","+"null"+");", "Guardar", bttBtnenter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWPBaseObjects\\ManageFilters.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.projectthani.GxWebStd.gx_button_ctrl( httpContext, bttBtncancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 15, 2, 0)+","+"null"+");", "Cancelar", bttBtncancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWPBaseObjects\\ManageFilters.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divHtml_usertable_utpaneldummy_Internalname, 1, 0, "px", 0, "px", "Section", "left", "top", "", "", "div");
         wb_table1_31_0D2( true) ;
      }
      else
      {
         wb_table1_31_0D2( false) ;
      }
      return  ;
   }

   public void wb_table1_31_0D2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 29), "GRIDGRIDSTATECOLLECTIONS.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 13), "VMOVEUP.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 15), "VMOVEDOWN.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 14), "VUDELETE.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 13), "VMOVEUP.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 15), "VMOVEDOWN.CLICK") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 14), "VUDELETE.CLICK") == 0 ) )
                        {
                           ...
                           {
                              AV6GridStateCollection.currentItem( ((com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.elementAt(-1+AV19GXV1)) );
   ...
   public void e120D2( )
   {
      ...
      {
         AV6GridStateCollection.fromxml(new com.projectthani.wwpbaseobjects.loadmanagefiltersstate(remoteHandle, context).executeUdp( AV14UserKey), null, null);
         gx_BV15 = true ;
   ...
   {
      AV19GXV1 = (int)(nGXsfl_15_idx+GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage) ;
      if ( AV6GridStateCollection.size() >= AV19GXV1 )
      {
         AV6GridStateCollection.currentItem( ((com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.elementAt(-1+AV19GXV1)) );
      }
      /* Enter Routine */
      ...
      {
         AV7GridStateCollectionItem = (com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item)((com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.elementAt(-1+AV22GXV4));
      ...
      if ( AV10IsOK )
      {
         ...
         {
            AV6GridStateCollection = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item>(com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item.class, "Item", "", remoteHandle) ;
            gx_BV15 = true ;
         }
         new com.projectthani.wwpbaseobjects.savemanagefiltersstate(remoteHandle, context).execute( AV14UserKey, AV6GridStateCollection.toxml(false, true, "Items", "")) ;
         if ( GXutil.strcmp(GXutil.lower( AV14UserKey), "appbookmarks") == 0 )
         {
   ...
   public void e140D2( )
   {
      ...
      returnInSub = false ;
      AV9i = (short)(AV6GridStateCollection.indexof(((com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.currentItem()))) ;
      if ( AV9i > 1 )
      {
         AV7GridStateCollectionItem = (com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item)((com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.elementAt(-1+AV9i));
   ...
   public void wb_table1_31_0D2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.projectthani.GxWebStd.gx_table_start( httpContext, tblUtpaneldummy_Internalname, tblUtpaneldummy_Internalname, "", "Invisible", 0, "", "", 1, 2, sStyleString, "", "", 0);
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_31_0D2e( true) ;
      }
      else
      {
         wb_table1_31_0D2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110331049", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/managefilters.js", "?20225110331049", false, true);
      httpContext.AddJavascriptSource("Shared/jquery/jquery1.9.1.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/bootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDGRIDSTATECOLLECTIONS.LOAD","{handler:'e130D2',iparms:[{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]");
      ...
      setEventMetadata("ENTER","{handler:'e110D2',iparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'AV14UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'Rows'},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]}");
      setEventMetadata("VMOVEUP.CLICK","{handler:'e140D2',iparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'Rows'},{av:'AV14UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]");
      setEventMetadata("VMOVEUP.CLICK",",oparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]}");
      setEventMetadata("VMOVEDOWN.CLICK","{handler:'e150D2',iparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'Rows'},{av:'AV14UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]");
      setEventMetadata("VMOVEDOWN.CLICK",",oparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]}");
      setEventMetadata("VUDELETE.CLICK","{handler:'e160D2',iparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'Rows'},{av:'AV14UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]");
      setEventMetadata("VUDELETE.CLICK",",oparms:[{av:'AV6GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC',grid:15},{av:'AV5CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]}");
   ...
   public void initialize( )
   {
      ...
      AV7GridStateCollectionItem = new com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item(remoteHandle, context);
   ...
   private GXBaseCollection<com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item> AV6GridStateCollection ;
   private com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item AV7GridStateCollectionItem ;
}
