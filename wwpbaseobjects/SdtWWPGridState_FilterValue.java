...
public final  class SdtWWPGridState_FilterValue extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("Name", GXutil.rtrim( gxTv_SdtWWPGridState_FilterValue_Name));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("Value", GXutil.rtrim( gxTv_SdtWWPGridState_FilterValue_Value));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      ...
      oWriter.writeElement("ValueTo", GXutil.rtrim( gxTv_SdtWWPGridState_FilterValue_Valueto));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
   ...
   public com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtWWPGridState_FilterValue struct )
   {
   ...
   public com.projectthani.wwpbaseobjects.StructSdtWWPGridState_FilterValue getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtWWPGridState_FilterValue struct = new com.projectthani.wwpbaseobjects.StructSdtWWPGridState_FilterValue ();
