...
public final  class workwithplusmasterpageprompt_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm0J2( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageprompt.js", "?2022511033911", false, true);
   ...
   public void wb0J0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtavPickerdummyvariable_Internalname, localUtil.format(AV5PickerDummyVariable, "99/99/99"), localUtil.format( AV5PickerDummyVariable, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,25);\"", "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "", "", "", edtavPickerdummyvariable_Jsonclick, 0, "Invisible", "", "", "", "", 1, 1, 0, "text", "", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), false, "", "right", false, "", "HLP_WWPBaseObjects\\WorkWithPlusMasterPagePrompt.htm");
   ...
   {
      /* GeneXus formulas. */
      AV10Pgmname = "WWPBaseObjects.WorkWithPlusMasterPagePrompt" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void e110J2( )
   {
      ...
      workwithplusmasterpageprompt_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      if ( GXutil.strcmp(GXutil.lower( Contentholder.getPgmname()), "wwpbaseobjects.notauthorized") != 0 )
      {
         ...
         workwithplusmasterpageprompt_impl.this.AV6IsAuthorized = GXv_boolean2[0] ;
         if ( ! AV6IsAuthorized )
         {
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?2022511033965", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageprompt.js", "?2022511033965", false, true);
         httpContext.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
