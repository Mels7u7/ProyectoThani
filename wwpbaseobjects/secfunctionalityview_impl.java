...
public final  class secfunctionalityview_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSECFUNCTIONALITYID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10SecFunctionalityId), "ZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110331069", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vSECFUNCTIONALITYID", GXutil.ltrim( localUtil.ntoc( AV10SecFunctionalityId, (byte)(10), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSECFUNCTIONALITYID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10SecFunctionalityId), "ZZZZZZZZZ9")));
   ...
   {
      return formatLink("com.projectthani.wwpbaseobjects.secfunctionalityview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10SecFunctionalityId,10,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"SecFunctionalityId","TabCode"})  ;
   }
   ...
   public void wb0Y0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, "Ir a Functionality", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects\\SecFunctionalityView.htm");
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divSecfunctionalitygeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblSecfunctionalityrole_title_Internalname, "Roles", "", "", lblSecfunctionalityrole_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects\\SecFunctionalityView.htm");
         /* Div Control */
   ...
   public void start0Y2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Sec Functionality View", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup0Y0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10SecFunctionalityId = localUtil.ctol( httpContext.cgiGet( "vSECFUNCTIONALITYID"), ",", ".") ;
   ...
   public void e110Y2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.projectthani.wwpbaseobjects.secfunctionalityww", new String[] {}, new String[] {})  ;
      ...
      {
         A1SecFunctionalityId = H000Y2_A1SecFunctionalityId[0] ;
         A8SecFunctionalityDescription = H000Y2_A8SecFunctionalityDescription[0] ;
         AV19GXLvl9 = (byte)(1) ;
         Form.setCaption( A8SecFunctionalityDescription );
   ...
   public void S112( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( WebComp_Webcomponent_general_Component), GXutil.lower( "WWPBaseObjects.SecFunctionalityGeneral")) != 0 )
      {
         WebComp_Webcomponent_general = WebUtils.getWebComponent(getClass(), "com.projectthani.wwpbaseobjects.secfunctionalitygeneral_impl", remoteHandle, context);
         WebComp_Webcomponent_general_Component = "WWPBaseObjects.SecFunctionalityGeneral" ;
      }
      if ( GXutil.len( WebComp_Webcomponent_general_Component) != 0 )
      {
         WebComp_Webcomponent_general.setjustcreated();
         WebComp_Webcomponent_general.componentprepare(new Object[] {"W0019","",Long.valueOf(AV10SecFunctionalityId)});
   ...
   public void S122( )
   {
      ...
      if ( AV14LoadAllTabs || ( GXutil.strcmp(AV15SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV15SelectedTabCode, "SecFunctionalityRole") == 0 ) )
      {
         ...
         {
            WebComp_Secfunctionalityrolewc = WebUtils.getWebComponent(getClass(), "com.projectthani.wwpbaseobjects.secfunctionalitysecfunctionalityrolewc_impl", remoteHandle, context);
         ...
         if ( GXutil.len( WebComp_Secfunctionalityrolewc_Component) != 0 )
         {
            ...
            WebComp_Secfunctionalityrolewc.componentprepare(new Object[] {"W0033","",Long.valueOf(AV10SecFunctionalityId)});
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511033112", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/secfunctionalityview.js", "?2022511033112", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void init_default_properties( )
   {
      ...
      divSecfunctionalitygeneral_cell_Internalname = "SECFUNCTIONALITYGENERAL_CELL" ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Sec Functionality View" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H000Y2_A1SecFunctionalityId = new long[1] ;
      H000Y2_A8SecFunctionalityDescription = new String[] {""} ;
      A8SecFunctionalityDescription = "" ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.wwpbaseobjects.secfunctionalityview__default(),
         new Object[] {
             new Object[] {
            H000Y2_A1SecFunctionalityId, H000Y2_A8SecFunctionalityDescription
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String divSecfunctionalitygeneral_cell_Internalname ;
   ...
   private long[] H000Y2_A1SecFunctionalityId ;
   private String[] H000Y2_A8SecFunctionalityDescription ;
...
final  class secfunctionalityview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H000Y2", "SELECT [SecFunctionalityId], [SecFunctionalityDescription] FROM [SecFunctionality] WHERE [SecFunctionalityId] = ? ORDER BY [SecFunctionalityId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
