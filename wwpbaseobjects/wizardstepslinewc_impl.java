...
public final  class wizardstepslinewc_impl extends GXWebComponent
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110312560", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.wwpbaseobjects.wizardstepslinewc", new String[] {GXutil.URLEncode(GXutil.rtrim(AV6CurrentStep))}, new String[] {"WizardSteps","CurrentStep"}) +"\">") ;
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV8StepNumber), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV7SelectedStepNumber), "ZZZ9")));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSTEPNUMBER", GXutil.ltrim( localUtil.ntoc( AV8StepNumber, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV8StepNumber), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSELECTEDSTEPNUMBER", GXutil.ltrim( localUtil.ntoc( AV7SelectedStepNumber, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV7SelectedStepNumber), "ZZZ9")));
      if ( httpContext.isAjaxRequest( ) )
      {
   ...
   public void wb0N0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.wwpbaseobjects.wizardstepslinewc");
         }
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divTablemain_Internalname, 1, 0, "px", 0, "px", "TableWizardStepsLine", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblWizardsteptitle_Internalname, lblWizardsteptitle_Caption, "", "", lblWizardsteptitle_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "WizardStepTitleLine", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects\\WizardStepsLineWC.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divWizardstepdescriptioncell_Internalname, divWizardstepdescriptioncell_Visible, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblWizardstepdescription_Internalname, lblWizardstepdescription_Caption, "", "", lblWizardstepdescription_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "WizardStepDescriptionLine", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects\\WizardStepsLineWC.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( GridwizardstepsContainer.GetWrapped() == 1 )
         {
            ...
            sStyleString = "" ;
            com.projectthani.GxWebStd.gx_table_start( httpContext, subGridwizardsteps_Internalname, subGridwizardsteps_Internalname, "", "FreeStyleStepsLine", 0, "", "", 1, 2, sStyleString, "", "", 0);
   ...
   public void e110N2( )
   {
      ...
      {
         AV5WizardStep = (com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)((com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV9WizardSteps.elementAt(-1+AV14GXV1));
   ...
   private void e120N2( )
   {
      ...
      {
         AV9WizardSteps.currentItem( ((com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV9WizardSteps.elementAt(-1+AV15GXV2)) );
   ...
   {
      AV9WizardSteps = (GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)getParm(obj,0) ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      {
         AV9WizardSteps = (GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)getParm(obj,2) ;
   ...
   public void wcparametersget( )
   {
      ...
      {
         AV9WizardSteps = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>() ;
      }
      else
      {
   ...
   public void wcparametersset( )
   {
      ...
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV9WizardSteps_CTRL", GXutil.rtrim( sCtrlAV9WizardSteps));
      }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110312582", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("wwpbaseobjects/wizardstepslinewc.js", "?20225110312582", false, true);
      }
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRIDWIZARDSTEPS.LOAD","{handler:'e120N2',iparms:[{av:'AV8StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV7SelectedStepNumber',fld:'vSELECTEDSTEPNUMBER',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      gxfirstwebparm_bkp = "" ;
      sPrefix = "" ;
      AV9WizardSteps = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>(com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem.class, "WizardStepsItem", "ProjectThani", remoteHandle);
      AV6CurrentStep = "" ;
   ...
   private GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV9WizardSteps ;
