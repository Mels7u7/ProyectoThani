...
public final  class SdtWWPGridState extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "FilterValues") )
            {
               ...
               {
                  gxTv_SdtWWPGridState_Filtervalues = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue>(com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue.class, "WWPGridState.FilterValue", "ProjectThani", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "DynamicFilters") )
            {
               ...
               {
                  gxTv_SdtWWPGridState_Dynamicfilters = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_DynamicFilter>(com.projectthani.wwpbaseobjects.SdtWWPGridState_DynamicFilter.class, "WWPGridState.DynamicFilter", "ProjectThani", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("OrderedDsc", GXutil.rtrim( GXutil.booltostr( gxTv_SdtWWPGridState_Ordereddsc)));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      ...
      oWriter.writeElement("PageSize", GXutil.rtrim( gxTv_SdtWWPGridState_Pagesize));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("CollapsedRecords", GXutil.rtrim( gxTv_SdtWWPGridState_Collapsedrecords));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("GroupBy", GXutil.rtrim( gxTv_SdtWWPGridState_Groupby));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
   ...
   public GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue> getgxTv_SdtWWPGridState_Filtervalues( )
   {
      if ( gxTv_SdtWWPGridState_Filtervalues == null )
      {
         gxTv_SdtWWPGridState_Filtervalues = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue>(com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue.class, "WWPGridState.FilterValue", "ProjectThani", remoteHandle);
   ...
   public void setgxTv_SdtWWPGridState_Filtervalues( GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue> value )
   {
      gxTv_SdtWWPGridState_Filtervalues_N = (byte)(0) ;
      gxTv_SdtWWPGridState_N = (byte)(0) ;
   ...
   public GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_DynamicFilter> getgxTv_SdtWWPGridState_Dynamicfilters( )
   {
      if ( gxTv_SdtWWPGridState_Dynamicfilters == null )
      {
         gxTv_SdtWWPGridState_Dynamicfilters = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_DynamicFilter>(com.projectthani.wwpbaseobjects.SdtWWPGridState_DynamicFilter.class, "WWPGridState.DynamicFilter", "ProjectThani", remoteHandle);
   ...
   public void setgxTv_SdtWWPGridState_Dynamicfilters( GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_DynamicFilter> value )
   {
      gxTv_SdtWWPGridState_Dynamicfilters_N = (byte)(0) ;
      gxTv_SdtWWPGridState_N = (byte)(0) ;
   ...
   public com.projectthani.wwpbaseobjects.SdtWWPGridState Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtWWPGridState)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtWWPGridState struct )
   {
      ...
      GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue> gxTv_SdtWWPGridState_Filtervalues_aux = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue>(com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue.class, "WWPGridState.FilterValue", "ProjectThani", remoteHandle);
      Vector<com.projectthani.wwpbaseobjects.StructSdtWWPGridState_FilterValue> gxTv_SdtWWPGridState_Filtervalues_aux1 = struct.getFiltervalues();
      if (gxTv_SdtWWPGridState_Filtervalues_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtWWPGridState_Filtervalues_aux1.size(); i++)
         {
            gxTv_SdtWWPGridState_Filtervalues_aux.add(new com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue(gxTv_SdtWWPGridState_Filtervalues_aux1.elementAt(i)));
         }
      }
      setgxTv_SdtWWPGridState_Filtervalues(gxTv_SdtWWPGridState_Filtervalues_aux);
      GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_DynamicFilter> gxTv_SdtWWPGridState_Dynamicfilters_aux = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_DynamicFilter>(com.projectthani.wwpbaseobjects.SdtWWPGridState_DynamicFilter.class, "WWPGridState.DynamicFilter", "ProjectThani", remoteHandle);
      Vector<com.projectthani.wwpbaseobjects.StructSdtWWPGridState_DynamicFilter> gxTv_SdtWWPGridState_Dynamicfilters_aux1 = struct.getDynamicfilters();
      if (gxTv_SdtWWPGridState_Dynamicfilters_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtWWPGridState_Dynamicfilters_aux1.size(); i++)
         {
            gxTv_SdtWWPGridState_Dynamicfilters_aux.add(new com.projectthani.wwpbaseobjects.SdtWWPGridState_DynamicFilter(gxTv_SdtWWPGridState_Dynamicfilters_aux1.elementAt(i)));
         }
      }
   ...
   public com.projectthani.wwpbaseobjects.StructSdtWWPGridState getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtWWPGridState struct = new com.projectthani.wwpbaseobjects.StructSdtWWPGridState ();
   ...
   protected GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue> gxTv_SdtWWPGridState_Filtervalues_aux ;
   protected GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_DynamicFilter> gxTv_SdtWWPGridState_Dynamicfilters_aux ;
   protected GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_FilterValue> gxTv_SdtWWPGridState_Filtervalues=null ;
   protected GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPGridState_DynamicFilter> gxTv_SdtWWPGridState_Dynamicfilters=null ;
}
