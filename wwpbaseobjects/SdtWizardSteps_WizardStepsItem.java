...
public final  class SdtWizardSteps_WizardStepsItem extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("Code", GXutil.rtrim( gxTv_SdtWizardSteps_WizardStepsItem_Code));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("Title", GXutil.rtrim( gxTv_SdtWizardSteps_WizardStepsItem_Title));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("Description", GXutil.rtrim( gxTv_SdtWizardSteps_WizardStepsItem_Description));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
   ...
   public com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtWizardSteps_WizardStepsItem struct )
   {
   ...
   public com.projectthani.wwpbaseobjects.StructSdtWizardSteps_WizardStepsItem getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtWizardSteps_WizardStepsItem struct = new com.projectthani.wwpbaseobjects.StructSdtWizardSteps_WizardStepsItem ();
