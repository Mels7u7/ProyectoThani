...
public final  class SdtWWPTransactionContext extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "Attributes") )
            {
               ...
               {
                  gxTv_SdtWWPTransactionContext_Attributes = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPTransactionContext_Attribute>(com.projectthani.wwpbaseobjects.SdtWWPTransactionContext_Attribute.class, "WWPTransactionContext.Attribute", "ProjectThani", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("CallerObject", GXutil.rtrim( gxTv_SdtWWPTransactionContext_Callerobject));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("CallerOnDelete", GXutil.rtrim( GXutil.booltostr( gxTv_SdtWWPTransactionContext_Callerondelete)));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("CallerURL", GXutil.rtrim( gxTv_SdtWWPTransactionContext_Callerurl));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("TransactionName", GXutil.rtrim( gxTv_SdtWWPTransactionContext_Transactionname));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
   ...
   public GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPTransactionContext_Attribute> getgxTv_SdtWWPTransactionContext_Attributes( )
   {
      if ( gxTv_SdtWWPTransactionContext_Attributes == null )
      {
         gxTv_SdtWWPTransactionContext_Attributes = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPTransactionContext_Attribute>(com.projectthani.wwpbaseobjects.SdtWWPTransactionContext_Attribute.class, "WWPTransactionContext.Attribute", "ProjectThani", remoteHandle);
   ...
   public void setgxTv_SdtWWPTransactionContext_Attributes( GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPTransactionContext_Attribute> value )
   {
      gxTv_SdtWWPTransactionContext_Attributes_N = (byte)(0) ;
      gxTv_SdtWWPTransactionContext_N = (byte)(0) ;
   ...
   public com.projectthani.wwpbaseobjects.SdtWWPTransactionContext Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtWWPTransactionContext)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtWWPTransactionContext struct )
   {
      ...
      GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPTransactionContext_Attribute> gxTv_SdtWWPTransactionContext_Attributes_aux = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPTransactionContext_Attribute>(com.projectthani.wwpbaseobjects.SdtWWPTransactionContext_Attribute.class, "WWPTransactionContext.Attribute", "ProjectThani", remoteHandle);
      Vector<com.projectthani.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute> gxTv_SdtWWPTransactionContext_Attributes_aux1 = struct.getAttributes();
      if (gxTv_SdtWWPTransactionContext_Attributes_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtWWPTransactionContext_Attributes_aux1.size(); i++)
         {
            gxTv_SdtWWPTransactionContext_Attributes_aux.add(new com.projectthani.wwpbaseobjects.SdtWWPTransactionContext_Attribute(gxTv_SdtWWPTransactionContext_Attributes_aux1.elementAt(i)));
         }
      }
   ...
   public com.projectthani.wwpbaseobjects.StructSdtWWPTransactionContext getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtWWPTransactionContext struct = new com.projectthani.wwpbaseobjects.StructSdtWWPTransactionContext ();
   ...
   protected GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPTransactionContext_Attribute> gxTv_SdtWWPTransactionContext_Attributes_aux ;
   protected GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWWPTransactionContext_Attribute> gxTv_SdtWWPTransactionContext_Attributes=null ;
}
