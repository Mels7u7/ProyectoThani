...
public final  class getfilterbyname extends GXProcedure
{
   ...
   {
      AV10GridStateCollection.fromxml(new com.projectthani.wwpbaseobjects.loadmanagefiltersstate(remoteHandle, context).executeUdp( AV12UserCustomKey), null, null);
      AV15GXV1 = 1 ;
      while ( AV15GXV1 <= AV10GridStateCollection.size() )
      {
         AV11GridStateCollectionItem = (com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item)((com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item)AV10GridStateCollection.elementAt(-1+AV15GXV1));
