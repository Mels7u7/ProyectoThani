...
public final  class secisauthbyfunctionalityid extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      new com.projectthani.wwpbaseobjects.secgetrolesfromloggeduser(remoteHandle, context).execute( GXv_objcol_int2) ;
      ...
      while ( AV16GXV1 <= AV9SecRolIds.size() )
      {
         ...
         {
            A1SecFunctionalityId = P00232_A1SecFunctionalityId[0] ;
            A4SecRoleId = P00232_A4SecRoleId[0] ;
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      P00232_A1SecFunctionalityId = new long[1] ;
      P00232_A4SecRoleId = new short[1] ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.wwpbaseobjects.secisauthbyfunctionalityid__default(),
         new Object[] {
             new Object[] {
            P00232_A1SecFunctionalityId, P00232_A4SecRoleId
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private long[] P00232_A1SecFunctionalityId ;
   private short[] P00232_A4SecRoleId ;
}
...
final  class secisauthbyfunctionalityid__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P00232", "SELECT TOP 1 [SecFunctionalityId], [SecRoleId] FROM [SecFunctionalityRole] WHERE [SecFunctionalityId] = ? and [SecRoleId] = ? ORDER BY [SecFunctionalityId], [SecRoleId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
