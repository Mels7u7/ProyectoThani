...
public final  class StructSdtWWPTransactionContext implements Cloneable, java.io.Serializable
{
   ...
   public java.util.Vector<com.projectthani.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute> getAttributes( )
   {
      return gxTv_SdtWWPTransactionContext_Attributes ;
   }

   public void setAttributes( java.util.Vector<com.projectthani.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute> value )
   {
   ...
   protected java.util.Vector<com.projectthani.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute> gxTv_SdtWWPTransactionContext_Attributes=null ;
}
