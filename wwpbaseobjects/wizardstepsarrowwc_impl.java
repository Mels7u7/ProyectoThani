...
public final  class wizardstepsarrowwc_impl extends GXWebComponent
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110312695", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("com.projectthani.wwpbaseobjects.wizardstepsarrowwc", new String[] {GXutil.URLEncode(GXutil.rtrim(AV11SelectedStep))}, new String[] {"WizardSteps","SelectedStep"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vWIZARDSTEPSAUX", getSecureSignedToken( sPrefix, AV19WizardStepsAux));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPREVIOUSSELECTED", getSecureSignedToken( sPrefix, AV9PreviousSelected));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vFIRSTISDUMMY", getSecureSignedToken( sPrefix, AV5FirstIsDummy));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vLASTISDUMMY", getSecureSignedToken( sPrefix, AV6LastIsDummy));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSECONDISDUMMY", getSecureSignedToken( sPrefix, AV10SecondIsDummy));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPENULTIMATEISDUMMY", getSecureSignedToken( sPrefix, AV8PenultimateIsDummy));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_Wizardstepsaux", getSecureSignedToken( sPrefix, AV19WizardStepsAux));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV11SelectedStep", wcpOAV11SelectedStep);
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vWIZARDSTEPSAUX", getSecureSignedToken( sPrefix, AV19WizardStepsAux));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSELECTEDSTEP", AV11SelectedStep);
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vPREVIOUSSELECTED", AV9PreviousSelected);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPREVIOUSSELECTED", getSecureSignedToken( sPrefix, AV9PreviousSelected));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV14StepNumber), "ZZZ9")));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vFIRSTISDUMMY", AV5FirstIsDummy);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vFIRSTISDUMMY", getSecureSignedToken( sPrefix, AV5FirstIsDummy));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vLASTISDUMMY", AV6LastIsDummy);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vLASTISDUMMY", getSecureSignedToken( sPrefix, AV6LastIsDummy));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vSECONDISDUMMY", AV10SecondIsDummy);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSECONDISDUMMY", getSecureSignedToken( sPrefix, AV10SecondIsDummy));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vPENULTIMATEISDUMMY", AV8PenultimateIsDummy);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPENULTIMATEISDUMMY", getSecureSignedToken( sPrefix, AV8PenultimateIsDummy));
   }
   ...
   public void wb090( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.wwpbaseobjects.wizardstepsarrowwc");
         }
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 20), "GRIDWIZARDSTEPS.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           {
                              AV19WizardStepsAux.currentItem( ((com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.elementAt(-1+AV24GXV1)) );
                           }
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
   ...
   public void gxgrgridwizardsteps_refresh( short AV15StepRealNumber ,
                                            GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV19WizardStepsAux ,
                                            String AV11SelectedStep ,
                                            boolean AV9PreviousSelected ,
                                            short AV14StepNumber ,
                                            boolean AV5FirstIsDummy ,
                                            boolean AV6LastIsDummy ,
                                            GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV18WizardSteps ,
   ...
   public void e11092( )
   {
      ...
      if ( AV19WizardStepsAux.size() > AV7MaxStepsToShow )
      {
         ...
         {
            AV17WizardStep = (com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)((com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.elementAt(-1+AV26GXV3));
         ...
         if ( AV13StartIndex > 1 )
         {
            ...
            if ( AV13StartIndex > 2 )
            {
               ...
               com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSECONDISDUMMY", getSecureSignedToken( sPrefix, AV10SecondIsDummy));
               AV7MaxStepsToShow = (short)(AV7MaxStepsToShow+1) ;
               ((com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.elementAt(-1+2)).setgxTv_SdtWizardSteps_WizardStepsItem_Title( "..." );
         ...
         if ( AV19WizardStepsAux.size() > AV7MaxStepsToShow )
         {
            ...
            if ( AV19WizardStepsAux.size() > AV7MaxStepsToShow + 1 )
            {
               ...
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PenultimateIsDummy", AV8PenultimateIsDummy);
               com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPENULTIMATEISDUMMY", getSecureSignedToken( sPrefix, AV8PenultimateIsDummy));
               ((com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.elementAt(-1+AV19WizardStepsAux.size()-1)).setgxTv_SdtWizardSteps_WizardStepsItem_Title( "..." );
   ...
   private void e12092( )
   {
      ...
      while ( AV24GXV1 <= AV19WizardStepsAux.size() )
      {
         ...
         if ( GXutil.strcmp(((com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)(AV19WizardStepsAux.currentItem())).getgxTv_SdtWizardSteps_WizardStepsItem_Code(), AV11SelectedStep) == 0 )
         {
   ...
   public void wb_table1_2_092( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.projectthani.GxWebStd.gx_table_start( httpContext, tblTablemain_Internalname, tblTablemain_Internalname, "", "TableWizardStepsArrow", 0, "", "", 1, 2, sStyleString, "", "", 0);
         ...
         else
         {
            ...
            GridwizardstepsContainer.AddColumnProperties(GridwizardstepsColumn);
            GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridwizardstepsColumn.AddObjectProperty("Value", httpContext.convertURL( context.getHttpContext().getImagePath( "2fe377a7-df7d-42aa-84d4-4f1b853d50aa", "", context.getHttpContext().getTheme( ))));
            GridwizardstepsContainer.AddColumnProperties(GridwizardstepsColumn);
            GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridwizardstepsContainer.AddColumnProperties(GridwizardstepsColumn);
            GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
   ...
   {
      AV18WizardSteps = (GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)getParm(obj,0) ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      {
         AV18WizardSteps = (GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)getParm(obj,2) ;
   ...
   public void wcparametersget( )
   {
      ...
      {
         AV18WizardSteps = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>() ;
      }
      else
      {
   ...
   public void wcparametersset( )
   {
      ...
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV18WizardSteps_CTRL", GXutil.rtrim( sCtrlAV18WizardSteps));
      }
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV11SelectedStep_PARM", AV11SelectedStep);
      if ( GXutil.len( GXutil.rtrim( sCtrlAV11SelectedStep)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV11SelectedStep_CTRL", GXutil.rtrim( sCtrlAV11SelectedStep));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110312723", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("wwpbaseobjects/wizardstepsarrowwc.js", "?20225110312724", false, true);
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRIDWIZARDSTEPS_nFirstRecordOnPage'},{av:'GRIDWIZARDSTEPS_nEOF'},{av:'AV11SelectedStep',fld:'vSELECTEDSTEP',pic:''},{av:'AV18WizardSteps',fld:'vWIZARDSTEPS',pic:''},{av:'sPrefix'},{av:'AV19WizardStepsAux',fld:'vWIZARDSTEPSAUX',grid:5,pic:'',hsh:true},{av:'nRC_GXsfl_5',ctrl:'GRIDWIZARDSTEPS',prop:'GridRC',grid:5},{av:'AV15StepRealNumber',fld:'vSTEPREALNUMBER',pic:'ZZZ9',hsh:true},{av:'AV9PreviousSelected',fld:'vPREVIOUSSELECTED',pic:'',hsh:true},{av:'AV14StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV5FirstIsDummy',fld:'vFIRSTISDUMMY',pic:'',hsh:true},{av:'AV6LastIsDummy',fld:'vLASTISDUMMY',pic:'',hsh:true},{av:'AV10SecondIsDummy',fld:'vSECONDISDUMMY',pic:'',hsh:true},{av:'AV8PenultimateIsDummy',fld:'vPENULTIMATEISDUMMY',pic:'',hsh:true}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("GRIDWIZARDSTEPS.LOAD","{handler:'e12092',iparms:[{av:'AV15StepRealNumber',fld:'vSTEPREALNUMBER',pic:'ZZZ9',hsh:true},{av:'AV19WizardStepsAux',fld:'vWIZARDSTEPSAUX',grid:5,pic:'',hsh:true},{av:'GRIDWIZARDSTEPS_nFirstRecordOnPage'},{av:'nRC_GXsfl_5',ctrl:'GRIDWIZARDSTEPS',prop:'GridRC',grid:5},{av:'AV11SelectedStep',fld:'vSELECTEDSTEP',pic:''},{av:'AV9PreviousSelected',fld:'vPREVIOUSSELECTED',pic:'',hsh:true},{av:'AV14StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV5FirstIsDummy',fld:'vFIRSTISDUMMY',pic:'',hsh:true},{av:'AV6LastIsDummy',fld:'vLASTISDUMMY',pic:'',hsh:true},{av:'AV18WizardSteps',fld:'vWIZARDSTEPS',pic:''},{av:'AV10SecondIsDummy',fld:'vSECONDISDUMMY',pic:'',hsh:true},{av:'AV8PenultimateIsDummy',fld:'vPENULTIMATEISDUMMY',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      gxfirstwebparm_bkp = "" ;
      sPrefix = "" ;
      AV18WizardSteps = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>(com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem.class, "WizardStepsItem", "ProjectThani", remoteHandle);
      AV11SelectedStep = "" ;
      AV19WizardStepsAux = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>(com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem.class, "WizardStepsItem", "ProjectThani", remoteHandle);
      ...
      EvtRowId = "" ;
      sEvtType = "" ;
      AV17WizardStep = new com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(remoteHandle, context);
   ...
   private GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV18WizardSteps ;
   private GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV19WizardStepsAux ;
   private com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem AV17WizardStep ;
}
