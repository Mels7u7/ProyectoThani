...
public final  class getmenuauthorizedoptionsrecursive extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         AV9AuxDVelop_Menu_Item = (com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item)((com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item)AV10DVelop_Menu_Item.getgxTv_SdtDVelop_Menu_Item_Subitems().elementAt(-1+AV19GXV1));
         if ( AV9AuxDVelop_Menu_Item.getgxTv_SdtDVelop_Menu_Item_Subitems().size() > 0 )
         {
            GXv_char1[0] = AV15Result2Json ;
            new com.projectthani.wwpbaseobjects.getmenuauthorizedoptionsrecursive(remoteHandle, context).execute( AV9AuxDVelop_Menu_Item.toJSonString(false, true), GXv_char1) ;
         ...
         else
         {
            ...
            new com.projectthani.wwpbaseobjects.ismenuauthorizedoption(remoteHandle, context).execute( AV9AuxDVelop_Menu_Item, GXv_boolean3) ;
      ...
      while ( AV11i <= AV14RemoveIds.size() )
      {
         ...
         {
            AV9AuxDVelop_Menu_Item = (com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item)((com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item)AV10DVelop_Menu_Item.getgxTv_SdtDVelop_Menu_Item_Subitems().elementAt(-1+AV20GXV2));
            AV12j = (short)(AV12j+1) ;
   ...
   public void initialize( )
   {
      ...
      AV9AuxDVelop_Menu_Item = new com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item(remoteHandle, context);
      AV15Result2Json = "" ;
   ...
   private com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item AV9AuxDVelop_Menu_Item ;
}
