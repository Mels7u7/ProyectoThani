...
public final  class StructSdtDVB_SDTComboData_Item implements Cloneable, java.io.Serializable
{
   ...
   public java.util.Vector<com.projectthani.wwpbaseobjects.StructSdtDVB_SDTComboData_Item> getChildren( )
   {
      return gxTv_SdtDVB_SDTComboData_Item_Children ;
   }

   public void setChildren( java.util.Vector<com.projectthani.wwpbaseobjects.StructSdtDVB_SDTComboData_Item> value )
   {
   ...
   protected java.util.Vector<com.projectthani.wwpbaseobjects.StructSdtDVB_SDTComboData_Item> gxTv_SdtDVB_SDTComboData_Item_Children=null ;
}
