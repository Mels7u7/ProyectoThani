...
public final  class gethomesamplenamevaluedata_impl extends GXWebProcedure
{
   ...
   public void webExecute( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getMethod()), "get") == 0 )
      {
         if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getQuerystring()), "wsdl") == 0 )
         {
            ...
            GXSoapXMLWriter.writeAttribute("targetNamespace", "ProjectThani");
            GXSoapXMLWriter.writeAttribute("xmlns:wsdlns", "ProjectThani");
            ...
            GXSoapXMLWriter.writeAttribute("xmlns:tns", "ProjectThani");
            ...
            GXSoapXMLWriter.writeAttribute("soapAction", "ProjectThaniaction/"+"wwpbaseobjects.AGETHOMESAMPLENAMEVALUEDATA.Execute");
      ...
      if ( ( GXutil.strSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
      {
         ...
         GXSoapXMLWriter.writeAttribute("xmlns", "ProjectThani");
         if ( currSoapErr == 0 )
         {
            if ( Gxm3rootcol != null )
            {
               Gxm3rootcol.writexmlcollection(GXSoapXMLWriter, "ReturnValue", "ProjectThani", "HomeSampleNameValueDataItem", "ProjectThani");
            }
         }
         else
         {
   ...
   public void execute( GXBaseCollection<com.projectthani.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem>[] aP0 )
   {
      execute_int(aP0);
   }

   private void execute_int( GXBaseCollection<com.projectthani.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem>[] aP0 )
   {
   ...
   private void privateExecute( )
   {
      ...
      {
         AV6HomeSampleDataItem = (com.projectthani.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem)((com.projectthani.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem)AV5HomeSampleData.elementAt(-1+AV12GXV1));
         Gxv1skipcount = (int)(Gxv1skipcount+1) ;
         Gxm2homesamplenamevaluedata = (com.projectthani.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem)new com.projectthani.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem(remoteHandle, context);
   ...
   public void initialize( )
   {
      ...
      currSoapErrmsg = "" ;
      currMethod = "" ;
      Gxm3rootcol = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem>(com.projectthani.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem.class, "HomeSampleNameValueDataItem", "ProjectThani", remoteHandle);
      ...
      AV6HomeSampleDataItem = new com.projectthani.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem(remoteHandle, context);
      Gxm2homesamplenamevaluedata = new com.projectthani.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem(remoteHandle, context);
      /* GeneXus formulas. */
      Gx_err = (short)(0) ;
   }
   ...
   private GXBaseCollection<com.projectthani.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem>[] aP0 ;
   ...
   private GXBaseCollection<com.projectthani.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem> Gxm3rootcol ;
   private com.projectthani.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem AV6HomeSampleDataItem ;
   private com.projectthani.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem Gxm2homesamplenamevaluedata ;
}
