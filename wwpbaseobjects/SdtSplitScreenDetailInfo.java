...
public final  class SdtSplitScreenDetailInfo extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("Link", GXutil.rtrim( gxTv_SdtSplitScreenDetailInfo_Link));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("Title", GXutil.rtrim( gxTv_SdtSplitScreenDetailInfo_Title));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("Keys", GXutil.rtrim( gxTv_SdtSplitScreenDetailInfo_Keys));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
   ...
   public com.projectthani.wwpbaseobjects.SdtSplitScreenDetailInfo Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtSplitScreenDetailInfo)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtSplitScreenDetailInfo struct )
   {
   ...
   public com.projectthani.wwpbaseobjects.StructSdtSplitScreenDetailInfo getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtSplitScreenDetailInfo struct = new com.projectthani.wwpbaseobjects.StructSdtSplitScreenDetailInfo ();
