...
public final  class wizardstepsbulletwc_impl extends GXWebComponent
{
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Gridwizardsteps") == 0 )
            {
               ...
               gxgrgridwizardsteps_refresh( AV15StepRealNumber, AV14StepNumber, AV12SelectedStepNumber, AV7FirstIsDummy, AV18WizardStepsAux, AV8LastIsDummy, AV17WizardSteps, AV10PenultimateIsDummy, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110312654", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("com.projectthani.wwpbaseobjects.wizardstepsbulletwc", new String[] {GXutil.URLEncode(GXutil.rtrim(AV6CurrentStep))}, new String[] {"WizardSteps","CurrentStep"}) +"\">") ;
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPREALNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV15StepRealNumber), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV14StepNumber), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV12SelectedStepNumber), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vFIRSTISDUMMY", getSecureSignedToken( sPrefix, AV7FirstIsDummy));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vWIZARDSTEPSAUX", getSecureSignedToken( sPrefix, AV18WizardStepsAux));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vLASTISDUMMY", getSecureSignedToken( sPrefix, AV8LastIsDummy));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPENULTIMATEISDUMMY", getSecureSignedToken( sPrefix, AV10PenultimateIsDummy));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_Wizardstepsaux", getSecureSignedToken( sPrefix, AV18WizardStepsAux));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"nRC_GXsfl_5", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_5, (byte)(8), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV6CurrentStep", wcpOAV6CurrentStep);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSTEPREALNUMBER", GXutil.ltrim( localUtil.ntoc( AV15StepRealNumber, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPREALNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV15StepRealNumber), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSTEPNUMBER", GXutil.ltrim( localUtil.ntoc( AV14StepNumber, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV14StepNumber), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSELECTEDSTEPNUMBER", GXutil.ltrim( localUtil.ntoc( AV12SelectedStepNumber, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV12SelectedStepNumber), "ZZZ9")));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vFIRSTISDUMMY", AV7FirstIsDummy);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vFIRSTISDUMMY", getSecureSignedToken( sPrefix, AV7FirstIsDummy));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vWIZARDSTEPSAUX", getSecureSignedToken( sPrefix, AV18WizardStepsAux));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vLASTISDUMMY", AV8LastIsDummy);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vLASTISDUMMY", getSecureSignedToken( sPrefix, AV8LastIsDummy));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vPENULTIMATEISDUMMY", AV10PenultimateIsDummy);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPENULTIMATEISDUMMY", getSecureSignedToken( sPrefix, AV10PenultimateIsDummy));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vCURRENTSTEP", AV6CurrentStep);
   }
   ...
   public void wb0A0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.wwpbaseobjects.wizardstepsbulletwc");
         }
   ...
   public void wb_table1_2_0A2e( boolean wbgen )
   {
      ...
      if ( wbEnd == 5 )
      {
         ...
         if ( isFullAjaxMode( ) )
         {
            ...
            {
               AV28GXV1 = nGXsfl_5_idx ;
               sStyleString = "" ;
               httpContext.writeText( "<div id=\""+sPrefix+"GridwizardstepsContainer"+"Div\" "+sStyleString+">"+"</div>") ;
               httpContext.ajax_rsp_assign_grid(sPrefix+"_"+"Gridwizardsteps", GridwizardstepsContainer);
               if ( ! isAjaxCallMode( ) && ! httpContext.isSpaRequest( ) )
               {
                  com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GridwizardstepsContainerData", GridwizardstepsContainer.ToJavascriptSource());
               }
               if ( httpContext.isAjaxRequest( ) || httpContext.isSpaRequest( ) )
               {
                  com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GridwizardstepsContainerData"+"V", GridwizardstepsContainer.GridValuesHidden());
               }
               else
               {
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 20), "GRIDWIZARDSTEPS.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           AV28GXV1 = nGXsfl_5_idx ;
                           if ( ( AV18WizardStepsAux.size() >= AV28GXV1 ) && ( AV28GXV1 > 0 ) )
                           {
                              AV18WizardStepsAux.currentItem( ((com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV18WizardStepsAux.elementAt(-1+AV28GXV1)) );
                           }
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
   ...
   public void gxgrgridwizardsteps_refresh( short AV15StepRealNumber ,
                                            ...
                                            GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV18WizardStepsAux ,
                                            boolean AV8LastIsDummy ,
                                            GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV17WizardSteps ,
   ...
   public void e110A2( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(AV12SelectedStepNumber), "ZZZ9")));
      AV30GXV3 = 1 ;
      while ( AV30GXV3 <= AV17WizardSteps.size() )
      {
         AV5WizardStep = (com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)((com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV17WizardSteps.elementAt(-1+AV30GXV3));
      ...
      if ( AV18WizardStepsAux.size() > AV9MaxStepsToShow )
      {
         ...
         if ( AV13StartIndex > 3 )
         {
            ...
            ((com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV18WizardStepsAux.elementAt(-1+2)).setgxTv_SdtWizardSteps_WizardStepsItem_Title( "..." );
         ...
         if ( AV18WizardStepsAux.size() > AV9MaxStepsToShow )
         {
            ...
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV10PenultimateIsDummy", AV10PenultimateIsDummy);
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPENULTIMATEISDUMMY", getSecureSignedToken( sPrefix, AV10PenultimateIsDummy));
            ((com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV18WizardStepsAux.elementAt(-1+AV18WizardStepsAux.size()-1)).setgxTv_SdtWizardSteps_WizardStepsItem_Title( "" );
   ...
   private void e120A2( )
   {
      ...
      returnInSub = false ;
      AV28GXV1 = 1 ;
      while ( AV28GXV1 <= AV18WizardStepsAux.size() )
      {
         AV18WizardStepsAux.currentItem( ((com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV18WizardStepsAux.elementAt(-1+AV28GXV1)) );
         ...
         else if ( ( AV14StepNumber == AV18WizardStepsAux.size() ) && AV8LastIsDummy )
         {
            lblStepnumber_Caption = GXutil.trim( GXutil.str( AV17WizardSteps.size(), 9, 0)) ;
         }
         else if ( ( AV14StepNumber == AV18WizardStepsAux.size() - 1 ) && AV10PenultimateIsDummy )
         {
   ...
   public void wb_table1_2_0A2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.projectthani.GxWebStd.gx_table_start( httpContext, tblTablemain_Internalname, tblTablemain_Internalname, "", "TableWizardSteps TableAlignedCentered", 0, "", "", 1, 2, sStyleString, "", "", 0);
         ...
         if ( GridwizardstepsContainer.GetWrapped() == 1 )
         {
            ...
            sStyleString = "" ;
            com.projectthani.GxWebStd.gx_table_start( httpContext, subGridwizardsteps_Internalname, subGridwizardsteps_Internalname, "", "FreeStyleSteps", 0, "", "", 1, 2, sStyleString, "", "", 0);
            GridwizardstepsContainer.AddObjectProperty("GridName", "Gridwizardsteps");
         }
         else
         {
   ...
   {
      AV17WizardSteps = (GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)getParm(obj,0) ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      {
         AV17WizardSteps = (GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)getParm(obj,2) ;
   ...
   public void wcparametersget( )
   {
      ...
      {
         AV17WizardSteps = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>() ;
      }
      else
      {
   ...
   public void wcparametersset( )
   {
      ...
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV17WizardSteps_CTRL", GXutil.rtrim( sCtrlAV17WizardSteps));
      }
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6CurrentStep_PARM", AV6CurrentStep);
      if ( GXutil.len( GXutil.rtrim( sCtrlAV6CurrentStep)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6CurrentStep_CTRL", GXutil.rtrim( sCtrlAV6CurrentStep));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110312688", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("wwpbaseobjects/wizardstepsbulletwc.js", "?20225110312688", false, true);
      }
   ...
   public void sendrow_52( )
   {
      ...
      /* Table start */
      GridwizardstepsRow.AddColumnProperties("table", -1, isAjaxCallMode( ), new Object[] {tblTblcontainerstep_Internalname+"_"+sGXsfl_5_idx,Integer.valueOf(1),"TableContainerStepBullet","","","","","","",Integer.valueOf(0),Integer.valueOf(0),"","","","px","px",""});
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRIDWIZARDSTEPS_nFirstRecordOnPage'},{av:'GRIDWIZARDSTEPS_nEOF'},{av:'AV17WizardSteps',fld:'vWIZARDSTEPS',pic:''},{av:'sPrefix'},{av:'AV18WizardStepsAux',fld:'vWIZARDSTEPSAUX',grid:5,pic:'',hsh:true},{av:'nRC_GXsfl_5',ctrl:'GRIDWIZARDSTEPS',prop:'GridRC',grid:5},{av:'AV15StepRealNumber',fld:'vSTEPREALNUMBER',pic:'ZZZ9',hsh:true},{av:'AV14StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV12SelectedStepNumber',fld:'vSELECTEDSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV7FirstIsDummy',fld:'vFIRSTISDUMMY',pic:'',hsh:true},{av:'AV8LastIsDummy',fld:'vLASTISDUMMY',pic:'',hsh:true},{av:'AV10PenultimateIsDummy',fld:'vPENULTIMATEISDUMMY',pic:'',hsh:true}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("GRIDWIZARDSTEPS.LOAD","{handler:'e120A2',iparms:[{av:'AV15StepRealNumber',fld:'vSTEPREALNUMBER',pic:'ZZZ9',hsh:true},{av:'AV14StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV12SelectedStepNumber',fld:'vSELECTEDSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV7FirstIsDummy',fld:'vFIRSTISDUMMY',pic:'',hsh:true},{av:'AV18WizardStepsAux',fld:'vWIZARDSTEPSAUX',grid:5,pic:'',hsh:true},{av:'GRIDWIZARDSTEPS_nFirstRecordOnPage'},{av:'nRC_GXsfl_5',ctrl:'GRIDWIZARDSTEPS',prop:'GridRC',grid:5},{av:'AV8LastIsDummy',fld:'vLASTISDUMMY',pic:'',hsh:true},{av:'AV17WizardSteps',fld:'vWIZARDSTEPS',pic:''},{av:'AV10PenultimateIsDummy',fld:'vPENULTIMATEISDUMMY',pic:'',hsh:true}]");
      setEventMetadata("GRIDWIZARDSTEPS.LOAD",",oparms:[{av:'lblStepnumber_Visible',ctrl:'STEPNUMBER',prop:'Visible'},{av:'lblStepnumber_Caption',ctrl:'STEPNUMBER',prop:'Caption'},{av:'tblTablestepbulletlineleft_Class',ctrl:'TABLESTEPBULLETLINELEFT',prop:'Class'},{av:'tblTablestepbulletlineright_Class',ctrl:'TABLESTEPBULLETLINERIGHT',prop:'Class'},{av:'divTablestepitem_Class',ctrl:'TABLESTEPITEM',prop:'Class'},{ctrl:'WIZARDSTEPSAUX__TITLE',prop:'Class'},{av:'lblStepnumber_Class',ctrl:'STEPNUMBER',prop:'Class'},{av:'AV15StepRealNumber',fld:'vSTEPREALNUMBER',pic:'ZZZ9',hsh:true},{av:'AV14StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true}]}");
   ...
   public void initialize( )
   {
      ...
      gxfirstwebparm_bkp = "" ;
      sPrefix = "" ;
      AV17WizardSteps = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>(com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem.class, "WizardStepsItem", "ProjectThani", remoteHandle);
      AV6CurrentStep = "" ;
      AV18WizardStepsAux = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>(com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem.class, "WizardStepsItem", "ProjectThani", remoteHandle);
      ...
      EvtRowId = "" ;
      sEvtType = "" ;
      AV5WizardStep = new com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(remoteHandle, context);
   ...
   private GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV17WizardSteps ;
   private GXBaseCollection<com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV18WizardStepsAux ;
   private com.projectthani.wwpbaseobjects.SdtWizardSteps_WizardStepsItem AV5WizardStep ;
}
