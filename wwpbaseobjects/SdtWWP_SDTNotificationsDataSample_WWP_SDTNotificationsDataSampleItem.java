...
public final  class SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("NotificationIconClass", GXutil.rtrim( gxTv_SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem_Notificationiconclass));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("NotificationTitle", GXutil.rtrim( gxTv_SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem_Notificationtitle));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("NotificationDescription", GXutil.rtrim( gxTv_SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem_Notificationdescription));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      ...
      oWriter.writeElement("NotificationLink", GXutil.rtrim( gxTv_SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem_Notificationlink));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
   ...
   public com.projectthani.wwpbaseobjects.SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem struct )
   {
   ...
   public com.projectthani.wwpbaseobjects.StructSdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem struct = new com.projectthani.wwpbaseobjects.StructSdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem ();
