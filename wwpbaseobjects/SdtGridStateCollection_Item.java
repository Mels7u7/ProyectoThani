...
public final  class SdtGridStateCollection_Item extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("Title", GXutil.rtrim( gxTv_SdtGridStateCollection_Item_Title));
      if ( GXutil.strcmp(sNameSpace, "") != 0 )
      {
         oWriter.writeAttribute("xmlns", "");
      }
      oWriter.writeElement("GridStateXML", GXutil.rtrim( gxTv_SdtGridStateCollection_Item_Gridstatexml));
      if ( GXutil.strcmp(sNameSpace, "") != 0 )
      {
         oWriter.writeAttribute("xmlns", "");
      }
   ...
   public com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtGridStateCollection_Item struct )
   {
   ...
   public com.projectthani.wwpbaseobjects.StructSdtGridStateCollection_Item getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtGridStateCollection_Item struct = new com.projectthani.wwpbaseobjects.StructSdtGridStateCollection_Item ();
