...
public final  class dvmessagegetbasicnotificationmsg extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      new com.projectthani.wwpbaseobjects.dvmessagegetadvancednotificationmsg(remoteHandle, context).execute( AV14Title, AV13Text, AV15Type, AV10ControlSelector, AV11Hide, "false", "", AV9ClickRedirectURL, GXv_char2) ;
