...
public final  class workwithplusmasterpage_impl extends GXMasterPage
{
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      if ( httpContext.isAjaxRequest( ) )
      {
         httpContext.ajax_rsp_assign_sdt_attri("", true, "vDVELOP_MENU_MPAGE", AV24DVelop_Menu);
      }
      else
      {
         httpContext.ajax_rsp_assign_hidden_sdt("vDVELOP_MENU_MPAGE", AV24DVelop_Menu);
      }
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPROGRAMDESCRIPTION_MPAGE", getSecureSignedToken( "gxmpage_", GXutil.rtrim( localUtil.format( AV16ProgramDescription, ""))));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, "vDOREFRESH_MPAGE", AV21DoRefresh);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vWCTABLENAME_MPAGE", AV22WCTableName);
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "DDO_BOOKMARKS_MPAGE_Visible", GXutil.booltostr( Ddo_bookmarks_Visible));
   ...
   public void renderHtmlCloseForm1B2( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpage.js", "?20225110331526", false, true);
   ...
   public void wb1B0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         wb_table1_11_1B2( true) ;
      }
      else
      {
         wb_table1_11_1B2( false) ;
      }
      return  ;
   }

   public void wb_table1_11_1B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         wb_table2_16_1B2( true) ;
      }
      else
      {
         wb_table2_16_1B2( false) ;
      }
      return  ;
   }

   public void wb_table2_16_1B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.projectthani.GxWebStd.gx_button_ctrl( httpContext, bttBtnspanishlink_Internalname, "", "ES", bttBtnspanishlink_Jsonclick, 5, "ES", "", StyleString, ClassString, bttBtnspanishlink_Visible, 1, "standard", "'"+""+"'"+",true,"+"'"+"EDOSPANISHLINK_MPAGE."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWPBaseObjects\\WorkWithPlusMasterPage.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.projectthani.GxWebStd.gx_button_ctrl( httpContext, bttBtnenglishlink_Internalname, "", "EN", bttBtnenglishlink_Jsonclick, 5, "EN", "", StyleString, ClassString, bttBtnenglishlink_Visible, 1, "standard", "'"+""+"'"+",true,"+"'"+"EDOENGLISHLINK_MPAGE."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWPBaseObjects\\WorkWithPlusMasterPage.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         ucUcmenu.setProperty("SidebarMenuOptionsData", AV24DVelop_Menu);
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblTextblockfooter_Internalname, "Thani - copyright", "", "", lblTextblockfooter_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "FooterText", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects\\WorkWithPlusMasterPage.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtavPickerdummyvariable_Internalname, localUtil.format(AV35PickerDummyVariable, "99/99/99"), localUtil.format( AV35PickerDummyVariable, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "", "", "", edtavPickerdummyvariable_Jsonclick, 0, "Invisible", "", "", "", "", 1, 1, 0, "text", "", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_WWPBaseObjects\\WorkWithPlusMasterPage.htm");
         com.projectthani.GxWebStd.gx_bitmap( httpContext, edtavPickerdummyvariable_Internalname+"_dp_trigger", context.getHttpContext().getImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.getHttpContext().getTheme( )), "", "", "", "", ((1==0)||(1==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WWPBaseObjects\\WorkWithPlusMasterPage.htm");
   ...
   public void strup1B0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( "vDVELOP_MENU_MPAGE"), AV24DVelop_Menu);
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( "vDVELOP_MENU_USERDATA_MPAGE"), AV6DVelop_Menu_UserData);
         /* Read saved values. */
         AV21DoRefresh = GXutil.strtobool( httpContext.cgiGet( "vDOREFRESH_MPAGE")) ;
         AV22WCTableName = httpContext.cgiGet( "vWCTABLENAME_MPAGE") ;
         ...
         Ddo_bookmarks_Visible = GXutil.strtobool( httpContext.cgiGet( "DDO_BOOKMARKS_MPAGE_Visible")) ;
         ...
         if ( localUtil.vcdate( httpContext.cgiGet( edtavPickerdummyvariable_Internalname), (byte)(3)) == 0 )
         {
            ...
            httpContext.ajax_rsp_assign_attri("", true, "GX_FocusControl", GX_FocusControl);
            wbErr = true ;
            AV35PickerDummyVariable = GXutil.nullDate() ;
            httpContext.ajax_rsp_assign_attri("", true, "AV35PickerDummyVariable", localUtil.format(AV35PickerDummyVariable, "99/99/99"));
         }
         else
         {
            AV35PickerDummyVariable = localUtil.ctod( httpContext.cgiGet( edtavPickerdummyvariable_Internalname), 3) ;
            httpContext.ajax_rsp_assign_attri("", true, "AV35PickerDummyVariable", localUtil.format(AV35PickerDummyVariable, "99/99/99"));
         }
   ...
   public void e131B2( )
   {
      ...
      bttBtnspanishlink_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop("", true, bttBtnspanishlink_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(bttBtnspanishlink_Visible), 5, 0), true);
      bttBtnenglishlink_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop("", true, bttBtnenglishlink_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(bttBtnenglishlink_Visible), 5, 0), true);
      Ddo_bookmarks_Visible = false ;
      ucDdo_bookmarks.sendProperty(context, "", true, Ddo_bookmarks_Internalname, "Visible", GXutil.booltostr( Ddo_bookmarks_Visible));
      /* Using cursor H001B2 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV5WWPContext.getgxTv_SdtWWPContext_Userid())});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A6SecUserId = H001B2_A6SecUserId[0] ;
         A4SecRoleId = H001B2_A4SecRoleId[0] ;
      ...
      pr_default.close(0);
      GXt_objcol_SdtDVelop_Menu_Item2 = AV24DVelop_Menu ;
      ...
      AV24DVelop_Menu = GXt_objcol_SdtDVelop_Menu_Item2 ;
      GXv_objcol_SdtDVelop_Menu_Item3[0] = AV24DVelop_Menu ;
      ...
      AV24DVelop_Menu = GXv_objcol_SdtDVelop_Menu_Item3[0] ;
      ...
      new com.projectthani.wwpbaseobjects.loadwwpcontext(remoteHandle, context).execute( GXv_SdtWWPContext1) ;
      AV5WWPContext = GXv_SdtWWPContext1[0] ;
      AV25UserName = AV5WWPContext.getgxTv_SdtWWPContext_Username() ;
      ...
      AV40GXV1 = 1 ;
      while ( AV40GXV1 <= AV7SecRoleIdCollection.size() )
      {
         AV8SecRoleId = ((Number) AV7SecRoleIdCollection.elementAt(-1+AV40GXV1)).shortValue() ;
         httpContext.ajax_rsp_assign_attri("", true, "AV8SecRoleId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8SecRoleId), 4, 0));
         ...
         {
            A4SecRoleId = H001B3_A4SecRoleId[0] ;
            A13SecRoleName = H001B3_A13SecRoleName[0] ;
      ...
      AV6DVelop_Menu_UserData.setgxTv_SdtDVelop_Menu_UserData_Firstline( AV25UserName );
      ...
      workwithplusmasterpage_impl.this.AV27Language = GXv_char6[0] ;
      if ( Cond_result )
      {
      ...
      if ( GXutil.strcmp(GXutil.lower( Contentholder.getPgmname()), "wwpbaseobjects.notauthorized") != 0 )
      {
         ...
         workwithplusmasterpage_impl.this.AV32IsAuthorized = GXv_boolean7[0] ;
         if ( ! AV32IsAuthorized )
         {
   ...
   public void S132( )
   {
      ...
      AV42GXV2 = 1 ;
      while ( AV42GXV2 <= AV13GridStateCollection.size() )
      {
         AV14GridStateCollectionItem = (com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item)((com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item)AV13GridStateCollection.elementAt(-1+AV42GXV2));
      ...
      if ( AV13GridStateCollection.size() > 0 )
      {
         ...
         AV10BookmarksData.add(AV11BookmarksDataItem, 0);
         AV43GXV3 = 1 ;
         while ( AV43GXV3 <= AV13GridStateCollection.size() )
         {
            AV14GridStateCollectionItem = (com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item)((com.projectthani.wwpbaseobjects.SdtGridStateCollection_Item)AV13GridStateCollection.elementAt(-1+AV43GXV3));
            AV11BookmarksDataItem = (com.projectthani.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item)new com.projectthani.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(remoteHandle, context);
            ...
            new com.projectthani.wwpbaseobjects.getbookmarkfonticon(remoteHandle, context).execute( GXutil.strReplace( AV14GridStateCollectionItem.getgxTv_SdtGridStateCollection_Item_Gridstatexml(), AV31Httprequest.getBaseURL(), ""), AV24DVelop_Menu, GXv_char6) ;
            workwithplusmasterpage_impl.this.GXt_char8 = GXv_char6[0] ;
   ...
   public void wb_table2_16_1B2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblShowmenu_Internalname, "<i class=\"fas fa-bars FontIconMenu\"></i>", "", "", lblShowmenu_Jsonclick, "'"+""+"'"+",true,"+"'"+"e191b1_client"+"'", "", "TextBlock", 7, "", 1, 1, 0, (short)(1), "HLP_WWPBaseObjects\\WorkWithPlusMasterPage.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblTextblocktitle_Internalname, lblTextblocktitle_Caption, "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "TextBlockTitleMaterial", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects\\WorkWithPlusMasterPage.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_16_1B2e( true) ;
      }
      else
      {
         wb_table2_16_1B2e( false) ;
      }
   }

   public void wb_table1_11_1B2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         com.projectthani.GxWebStd.gx_bitmap( httpContext, imgHeader_Internalname, sImgUrl, "", "", "", context.getHttpContext().getTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.getHttpContext().getImageSrcSet( sImgUrl), "HLP_WWPBaseObjects\\WorkWithPlusMasterPage.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_11_1B2e( true) ;
      }
      else
      {
         wb_table1_11_1B2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?20225110331684", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpage.js", "?20225110331684", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      bttBtnenglishlink_Class = "ButtonAsLink" ;
      bttBtnenglishlink_Visible = 1 ;
      bttBtnspanishlink_Class = "ButtonAsLink" ;
      bttBtnspanishlink_Visible = 1 ;
      ...
      Ddo_bookmarks_Visible = GXutil.toBoolean( -1) ;
   ...
   {
      setEventMetadata("REFRESH_MPAGE","{handler:'refresh',iparms:[{ctrl:'FORM_MPAGE',prop:'Caption'},{av:'AV31Httprequest.getBaseURL()',ctrl:'vHTTPREQUEST_MPAGE',prop:'Baseurl'},{av:'AV24DVelop_Menu',fld:'vDVELOP_MENU_MPAGE',pic:''},{av:'AV16ProgramDescription',fld:'vPROGRAMDESCRIPTION_MPAGE',pic:'',hsh:true},{av:'AV15IndexToAddItems',fld:'vINDEXTOADDITEMS_MPAGE',pic:'ZZZ9',hsh:true}]");
      ...
      setEventMetadata("DOSPANISHLINK_MPAGE","{handler:'e141B2',iparms:[]");
      setEventMetadata("DOSPANISHLINK_MPAGE",",oparms:[]}");
      setEventMetadata("DOENGLISHLINK_MPAGE","{handler:'e151B2',iparms:[]");
      setEventMetadata("DOENGLISHLINK_MPAGE",",oparms:[]}");
      setEventMetadata("DDO_BOOKMARKS_MPAGE.ONOPTIONCLICKED_MPAGE","{handler:'e111B2',iparms:[{av:'Ddo_bookmarks_Activeeventkey',ctrl:'DDO_BOOKMARKS_MPAGE',prop:'ActiveEventKey'},{av:'AV31Httprequest.getBaseURL()',ctrl:'vHTTPREQUEST_MPAGE',prop:'Baseurl'},{av:'AV16ProgramDescription',fld:'vPROGRAMDESCRIPTION_MPAGE',pic:'',hsh:true}]");
      ...
      setEventMetadata("DDO_ADMINAG_MPAGE.ONOPTIONCLICKED_MPAGE","{handler:'e121B2',iparms:[{av:'Ddo_adminag_Activeeventkey',ctrl:'DDO_ADMINAG_MPAGE',prop:'ActiveEventKey'}]");
      setEventMetadata("DDO_ADMINAG_MPAGE.ONOPTIONCLICKED_MPAGE",",oparms:[{av:'AV5WWPContext',fld:'vWWPCONTEXT_MPAGE',pic:''}]}");
      setEventMetadata("DOSHOWMENU_MPAGE","{handler:'e191B1',iparms:[]");
      setEventMetadata("DOSHOWMENU_MPAGE",",oparms:[]}");
      setEventMetadata("GLOBALEVENTS_MPAGE.MASTER_REFRESHHEADER_MPAGE","{handler:'e171B2',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      AV10BookmarksData = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>(com.projectthani.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item.class, "Item", "", remoteHandle);
      AV18AdminAGData = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>(com.projectthani.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item.class, "Item", "", remoteHandle);
      AV24DVelop_Menu = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item>(com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item.class, "Item", "ProjectThani", remoteHandle);
      ...
      scmdbuf = "" ;
      H001B2_A6SecUserId = new short[1] ;
      H001B2_A4SecRoleId = new short[1] ;
      ...
      H001B3_A4SecRoleId = new short[1] ;
      H001B3_A13SecRoleName = new String[] {""} ;
      A13SecRoleName = "" ;
      AV27Language = "" ;
      ...
      sDynURL = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.wwpbaseobjects.workwithplusmasterpage__default(),
         new Object[] {
             new Object[] {
            H001B2_A6SecUserId, H001B2_A4SecRoleId
            }
            , new Object[] {
            H001B3_A4SecRoleId, H001B3_A13SecRoleName
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short AV36AdminAGDataIndex ;
   private int Ucmenu_Searchminchars ;
   private int Ucmenu_Scrollwidth ;
   private int bttBtnspanishlink_Visible ;
   private int bttBtnenglishlink_Visible ;
   ...
   private java.util.Date AV35PickerDummyVariable ;
   private boolean AV21DoRefresh ;
   private boolean Ddo_bookmarks_Visible ;
   ...
   private String AV22WCTableName ;
   ...
   private short[] H001B2_A6SecUserId ;
   private short[] H001B2_A4SecRoleId ;
   private short[] H001B3_A4SecRoleId ;
   private String[] H001B3_A13SecRoleName ;
   ...
   private GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item> AV24DVelop_Menu ;
...
final  class workwithplusmasterpage__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H001B2", "SELECT [SecUserId], [SecRoleId] FROM [SecUserRole] WHERE [SecUserId] = ? ORDER BY [SecUserId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H001B3", "SELECT [SecRoleId], [SecRoleName] FROM [SecRole] WHERE [SecRoleId] = ? ORDER BY [SecRoleId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
