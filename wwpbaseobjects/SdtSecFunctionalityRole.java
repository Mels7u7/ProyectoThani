...
public final  class SdtSecFunctionalityRole extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
                     ...
                     short AV4SecRoleId )
   {
      IGxSilentTrn obj;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {Long.valueOf(AV1SecFunctionalityId),Short.valueOf(AV4SecRoleId)});
   }
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("SecFunctionalityDescription", GXutil.rtrim( gxTv_SdtSecFunctionalityRole_Secfunctionalitydescription));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      ...
      if ( sIncludeState )
      {
         oWriter.writeElement("Mode", GXutil.rtrim( gxTv_SdtSecFunctionalityRole_Mode));
         if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
         {
            oWriter.writeAttribute("xmlns", "ProjectThani");
         }
         ...
         oWriter.writeElement("SecFunctionalityDescription_Z", GXutil.rtrim( gxTv_SdtSecFunctionalityRole_Secfunctionalitydescription_Z));
         if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
         {
            oWriter.writeAttribute("xmlns", "ProjectThani");
         }
   ...
   public void updateDirties( com.projectthani.wwpbaseobjects.SdtSecFunctionalityRole sdt )
   {
   ...
   {
      initialize( ) ;
      com.projectthani.wwpbaseobjects.secfunctionalityrole_bc obj;
      obj = new com.projectthani.wwpbaseobjects.secfunctionalityrole_bc( remoteHandle, context) ;
      obj.initialize();
   ...
   public com.projectthani.wwpbaseobjects.SdtSecFunctionalityRole Clone( )
   {
      com.projectthani.wwpbaseobjects.SdtSecFunctionalityRole sdt;
      com.projectthani.wwpbaseobjects.secfunctionalityrole_bc obj;
      sdt = (com.projectthani.wwpbaseobjects.SdtSecFunctionalityRole)(clone()) ;
      obj = (com.projectthani.wwpbaseobjects.secfunctionalityrole_bc)(sdt.getTransaction()) ;
      obj.SetSDT(sdt, (byte)(0));
      return sdt ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtSecFunctionalityRole struct )
   {
   ...
   public com.projectthani.wwpbaseobjects.StructSdtSecFunctionalityRole getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtSecFunctionalityRole struct = new com.projectthani.wwpbaseobjects.StructSdtSecFunctionalityRole ();
