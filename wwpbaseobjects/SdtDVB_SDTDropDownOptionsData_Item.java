...
public final  class SdtDVB_SDTDropDownOptionsData_Item extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("Icon", GXutil.rtrim( gxTv_SdtDVB_SDTDropDownOptionsData_Item_Icon));
      if ( GXutil.strcmp(sNameSpace, "") != 0 )
      {
         oWriter.writeAttribute("xmlns", "");
      }
      oWriter.writeElement("Icon_GXI", GXutil.rtrim( gxTv_SdtDVB_SDTDropDownOptionsData_Item_Icon_gxi));
      if ( GXutil.strcmp(sNameSpace, "") != 0 )
      {
         oWriter.writeAttribute("xmlns", "");
      }
      oWriter.writeElement("FontIcon", GXutil.rtrim( gxTv_SdtDVB_SDTDropDownOptionsData_Item_Fonticon));
      if ( GXutil.strcmp(sNameSpace, "") != 0 )
      {
         oWriter.writeAttribute("xmlns", "");
      }
      oWriter.writeElement("Title", GXutil.rtrim( gxTv_SdtDVB_SDTDropDownOptionsData_Item_Title));
      if ( GXutil.strcmp(sNameSpace, "") != 0 )
      {
         oWriter.writeAttribute("xmlns", "");
      }
      oWriter.writeElement("Tooltip", GXutil.rtrim( gxTv_SdtDVB_SDTDropDownOptionsData_Item_Tooltip));
      if ( GXutil.strcmp(sNameSpace, "") != 0 )
      {
         oWriter.writeAttribute("xmlns", "");
      }
      oWriter.writeElement("Link", GXutil.rtrim( gxTv_SdtDVB_SDTDropDownOptionsData_Item_Link));
      if ( GXutil.strcmp(sNameSpace, "") != 0 )
      {
         oWriter.writeAttribute("xmlns", "");
      }
      oWriter.writeElement("EventKey", GXutil.rtrim( gxTv_SdtDVB_SDTDropDownOptionsData_Item_Eventkey));
      if ( GXutil.strcmp(sNameSpace, "") != 0 )
      {
         oWriter.writeAttribute("xmlns", "");
      }
      oWriter.writeElement("IsDivider", GXutil.rtrim( GXutil.booltostr( gxTv_SdtDVB_SDTDropDownOptionsData_Item_Isdivider)));
      if ( GXutil.strcmp(sNameSpace, "") != 0 )
      {
         oWriter.writeAttribute("xmlns", "");
      }
      oWriter.writeElement("JSonclickEvent", GXutil.rtrim( gxTv_SdtDVB_SDTDropDownOptionsData_Item_Jsonclickevent));
      if ( GXutil.strcmp(sNameSpace, "") != 0 )
      {
         oWriter.writeAttribute("xmlns", "");
      }
      oWriter.writeElement("ThemeClass", GXutil.rtrim( gxTv_SdtDVB_SDTDropDownOptionsData_Item_Themeclass));
      if ( GXutil.strcmp(sNameSpace, "") != 0 )
      {
         oWriter.writeAttribute("xmlns", "");
      }
   ...
   public com.projectthani.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsData_Item struct )
   {
   ...
   public com.projectthani.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsData_Item getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsData_Item struct = new com.projectthani.wwpbaseobjects.StructSdtDVB_SDTDropDownOptionsData_Item ();
