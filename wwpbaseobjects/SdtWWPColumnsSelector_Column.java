...
public final  class SdtWWPColumnsSelector_Column extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("ColumnName", GXutil.rtrim( gxTv_SdtWWPColumnsSelector_Column_Columnname));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("IsVisible", GXutil.rtrim( GXutil.booltostr( gxTv_SdtWWPColumnsSelector_Column_Isvisible)));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("DisplayName", GXutil.rtrim( gxTv_SdtWWPColumnsSelector_Column_Displayname));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      ...
      oWriter.writeElement("Category", GXutil.rtrim( gxTv_SdtWWPColumnsSelector_Column_Category));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("Fixed", GXutil.rtrim( gxTv_SdtWWPColumnsSelector_Column_Fixed));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
   ...
   public com.projectthani.wwpbaseobjects.SdtWWPColumnsSelector_Column Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtWWPColumnsSelector_Column)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtWWPColumnsSelector_Column struct )
   {
   ...
   public com.projectthani.wwpbaseobjects.StructSdtWWPColumnsSelector_Column getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtWWPColumnsSelector_Column struct = new com.projectthani.wwpbaseobjects.StructSdtWWPColumnsSelector_Column ();
