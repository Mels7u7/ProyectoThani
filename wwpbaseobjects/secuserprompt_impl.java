...
public final  class secuserprompt_impl extends GXDataArea
{
   public secuserprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public secuserprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( secuserprompt_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "InOutSecUserId") ;
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            gxgrgrid_refresh( subGrid_Rows, AV48FilterFullText) ;
         ...
         {
            AV7InOutSecUserId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV7InOutSecUserId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV7InOutSecUserId), 4, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV8InOutSecUserName = httpContext.GetPar( "InOutSecUserName") ;
               httpContext.ajax_rsp_assign_attri("", false, "AV8InOutSecUserName", AV8InOutSecUserName);
            }
         }
         if ( toggleJsOutput )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110331226", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("com.projectthani.wwpbaseobjects.secuserprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV7InOutSecUserId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8InOutSecUserName))}, new String[] {"InOutSecUserId","InOutSecUserName"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "GXH_vFILTERFULLTEXT", AV48FilterFullText);
      /* Send saved values. */
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vGRIDCURRENTPAGE", GXutil.ltrim( localUtil.ntoc( AV45GridCurrentPage, (byte)(10), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vGRIDPAGECOUNT", GXutil.ltrim( localUtil.ntoc( AV46GridPageCount, (byte)(10), (byte)(0), ",", "")));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTSECUSERID", GXutil.ltrim( localUtil.ntoc( AV7InOutSecUserId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vINOUTSECUSERNAME", AV8InOutSecUserName);
   ...
   {
      return formatLink("com.projectthani.wwpbaseobjects.secuserprompt", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV7InOutSecUserId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8InOutSecUserName))}, new String[] {"InOutSecUserId","InOutSecUserName"})  ;
   }
   ...
   public void wb_table1_12_162e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXutil.rtrim( AV28Select));
   ...
   public void start162( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selecciona User", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           AV28Select = httpContext.cgiGet( edtavSelect_Internalname) ;
                           httpContext.ajax_rsp_assign_attri("", false, edtavSelect_Internalname, AV28Select);
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 if ( ! wbErr )
                                 {
                                    ...
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vFILTERFULLTEXT"), AV48FilterFullText) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_SECUSERNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A14SecUserName, ""))));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "SECUSERNAME", A14SecUserName);
   }
   ...
   public void rf162( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                              }
         });
         lV48FilterFullText = GXutil.concat( GXutil.rtrim( AV48FilterFullText), "%", "") ;
         lV48FilterFullText = GXutil.concat( GXutil.rtrim( AV48FilterFullText), "%", "") ;
         lV48FilterFullText = GXutil.concat( GXutil.rtrim( AV48FilterFullText), "%", "") ;
         lV48FilterFullText = GXutil.concat( GXutil.rtrim( AV48FilterFullText), "%", "") ;
         lV48FilterFullText = GXutil.concat( GXutil.rtrim( AV48FilterFullText), "%", "") ;
         lV48FilterFullText = GXutil.concat( GXutil.rtrim( AV48FilterFullText), "%", "") ;
         /* Using cursor H00162 */
         pr_default.execute(0, new Object[] {lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_24_idx = 1 ;
         sGXsfl_24_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_24_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_242( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A211SecUserEstadoR = H00162_A211SecUserEstadoR[0] ;
            A122SecUserEmail = H00162_A122SecUserEmail[0] ;
            A15SecUserPassword = H00162_A15SecUserPassword[0] ;
            A14SecUserName = H00162_A14SecUserName[0] ;
            A6SecUserId = H00162_A6SecUserId[0] ;
            e17162 ();
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_SECUSERID"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, localUtil.format( DecimalUtil.doubleToDec(A6SecUserId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_SECUSERNAME"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, GXutil.rtrim( localUtil.format( A14SecUserName, ""))));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV48FilterFullText = GXutil.concat( GXutil.rtrim( AV48FilterFullText), "%", "") ;
      /* Using cursor H00163 */
      pr_default.execute(1, new Object[] {lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText});
   ...
   public void strup160( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV45GridCurrentPage = localUtil.ctol( httpContext.cgiGet( "vGRIDCURRENTPAGE"), ",", ".") ;
         AV46GridPageCount = localUtil.ctol( httpContext.cgiGet( "vGRIDPAGECOUNT"), ",", ".") ;
   ...
   public void e15162( )
   {
      ...
      Form.setCaption( "Selecciona User" );
   ...
   public void e18162( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV8InOutSecUserName", AV8InOutSecUserName);
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV7InOutSecUserId),AV8InOutSecUserName});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV7InOutSecUserId","AV8InOutSecUserName"});
   ...
   public void wb_table1_12_162( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpiar filtros", 1, 1, 0, (short)(1), "HLP_WWPBaseObjects\\SecUserPrompt.htm");
         ...
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtavFilterfulltext_Internalname, AV48FilterFullText, GXutil.rtrim( localUtil.format( AV48FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Buscar", edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "WWPFullTextFilter", "left", true, "", "HLP_WWPBaseObjects\\SecUserPrompt.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         /* End of table */
   ...
   {
      AV7InOutSecUserId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV7InOutSecUserId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV7InOutSecUserId), 4, 0));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110331325", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/secuserprompt.js", "?20225110331325", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_242( )
   {
      ...
      edtSecUserName_Internalname = "SECUSERNAME_"+sGXsfl_24_idx ;
      edtSecUserPassword_Internalname = "SECUSERPASSWORD_"+sGXsfl_24_idx ;
      edtSecUserEmail_Internalname = "SECUSEREMAIL_"+sGXsfl_24_idx ;
      cmbSecUserEstadoR.setInternalname( "SECUSERESTADOR_"+sGXsfl_24_idx );
   }
   ...
   public void subsflControlProps_fel_242( )
   {
      ...
      edtSecUserName_Internalname = "SECUSERNAME_"+sGXsfl_24_fel_idx ;
      edtSecUserPassword_Internalname = "SECUSERPASSWORD_"+sGXsfl_24_fel_idx ;
      edtSecUserEmail_Internalname = "SECUSEREMAIL_"+sGXsfl_24_fel_idx ;
      cmbSecUserEstadoR.setInternalname( "SECUSERESTADOR_"+sGXsfl_24_fel_idx );
   }
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSecUserName_Internalname,A14SecUserName,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtSecUserName_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(24),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         {
            GXCCtl = "SECUSERESTADOR_" + sGXsfl_24_idx ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbSecUserEstadoR.getInternalname(), "Values", cmbSecUserEstadoR.ToJavascriptSource(), !bGXsfl_24_Refreshing);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "1:SecUserId|2:SecUserName|3:SecUserPassword|4:SecUserEmail|5:SecUserEstadoR" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV48FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
      setEventMetadata("REFRESH",",oparms:[{av:'AV45GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV46GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'}]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e11162',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV48FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e12162',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV48FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e13162',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV48FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      ...
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV28Select',fld:'vSELECT',pic:''}]}");
      setEventMetadata("ENTER","{handler:'e18162',iparms:[{av:'A6SecUserId',fld:'SECUSERID',pic:'ZZZ9',hsh:true},{av:'A14SecUserName',fld:'SECUSERNAME',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOCLEANFILTERS'","{handler:'e14162',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV48FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
      setEventMetadata("'DOCLEANFILTERS'",",oparms:[{av:'AV48FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV45GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV46GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'}]}");
   ...
   public void initialize( )
   {
      ...
      bodyStyle = "" ;
      GXKey = "" ;
      AV42DDO_TitleSettingsIcons = new com.projectthani.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(remoteHandle, context);
      GX_FocusControl = "" ;
      sPrefix = "" ;
      GridContainer = new com.genexus.webpanels.GXWebGrid(context);
      sStyleString = "" ;
      ...
      scmdbuf = "" ;
      lV48FilterFullText = "" ;
      H00162_A211SecUserEstadoR = new String[] {""} ;
      H00162_A122SecUserEmail = new String[] {""} ;
      H00162_A15SecUserPassword = new String[] {""} ;
      H00162_A14SecUserName = new String[] {""} ;
      H00162_A6SecUserId = new short[1] ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.wwpbaseobjects.secuserprompt__default(),
         new Object[] {
             new Object[] {
            H00162_A211SecUserEstadoR, H00162_A122SecUserEmail, H00162_A15SecUserPassword, H00162_A14SecUserName, H00162_A6SecUserId
            }
            , new Object[] {
   ...
   private String[] H00162_A211SecUserEstadoR ;
   private String[] H00162_A122SecUserEmail ;
   private String[] H00162_A15SecUserPassword ;
   private String[] H00162_A14SecUserName ;
   private short[] H00162_A6SecUserId ;
   ...
   private com.projectthani.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons AV42DDO_TitleSettingsIcons ;
...
final  class secuserprompt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00162(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
            case 1 :
                  return conditional_H00163(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() );
      }
