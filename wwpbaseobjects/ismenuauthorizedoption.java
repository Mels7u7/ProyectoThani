...
public final  class ismenuauthorizedoption extends GXProcedure
{
   ...
   public boolean executeUdp( com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item aP0 )
   {
   ...
   public void execute( com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item aP0 ,
                        boolean[] aP1 )
   {
      execute_int(aP0, aP1);
   }

   private void execute_int( com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item aP0 ,
                             boolean[] aP1 )
   {
   ...
   private void privateExecute( )
   {
      ...
      else if ( ! (GXutil.strcmp("", AV9DVelop_Menu_Item.getgxTv_SdtDVelop_Menu_Item_Authorizationkey())==0) )
      {
         ...
         new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( AV9DVelop_Menu_Item.getgxTv_SdtDVelop_Menu_Item_Authorizationkey(), GXv_boolean2) ;
      ...
      else
      {
         ...
         if ( ! (GXutil.strcmp("", AV13Url)==0) )
         {
            ...
            GXt_boolean1 = AV11IsAuthorized ;
            GXv_boolean2[0] = GXt_boolean1 ;
            new com.projectthani.wwpbaseobjects.secisauthbyobjectname(remoteHandle, context).execute( AV8AuthorizationKey, GXv_boolean2) ;
            ismenuauthorizedoption.this.GXt_boolean1 = GXv_boolean2[0] ;
            AV11IsAuthorized = GXt_boolean1 ;
         }
         else
   ...
   public void S111( )
   {
      ...
      if ( ! (GXutil.strcmp("", AV13Url)==0) )
      {
         ...
         if ( GxRegex.IsMatch(AV13Url,".aspx") )
         {
            AV15UrlResourceName = GXutil.strReplace( AV13Url, ".aspx", "") ;
         }
         else
         {
   ...
   private boolean[] aP1 ;
   private com.projectthani.wwpbaseobjects.SdtDVelop_Menu_Item AV9DVelop_Menu_Item ;
}
