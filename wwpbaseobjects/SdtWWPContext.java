...
public final  class SdtWWPContext extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("UserName", GXutil.rtrim( gxTv_SdtWWPContext_Username));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
   ...
   public com.projectthani.wwpbaseobjects.SdtWWPContext Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtWWPContext)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtWWPContext struct )
   {
   ...
   public com.projectthani.wwpbaseobjects.StructSdtWWPContext getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtWWPContext struct = new com.projectthani.wwpbaseobjects.StructSdtWWPContext ();
