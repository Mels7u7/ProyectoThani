...
public final  class SdtHomeSampleNameValueData_HomeSampleNameValueDataItem extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("Name", GXutil.rtrim( gxTv_SdtHomeSampleNameValueData_HomeSampleNameValueDataItem_Name));
      ...
      oWriter.writeElement("Check", GXutil.rtrim( GXutil.booltostr( gxTv_SdtHomeSampleNameValueData_HomeSampleNameValueDataItem_Check)));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
   ...
   public com.projectthani.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtHomeSampleNameValueData_HomeSampleNameValueDataItem struct )
   {
   ...
   public com.projectthani.wwpbaseobjects.StructSdtHomeSampleNameValueData_HomeSampleNameValueDataItem getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtHomeSampleNameValueData_HomeSampleNameValueDataItem struct = new com.projectthani.wwpbaseobjects.StructSdtHomeSampleNameValueData_HomeSampleNameValueDataItem ();
