...
public final  class wwp_columnsselector_add extends GXProcedure
{
   ...
   {
      AV14Column = (com.projectthani.wwpbaseobjects.SdtWWPColumnsSelector_Column)new com.projectthani.wwpbaseobjects.SdtWWPColumnsSelector_Column(remoteHandle, context);
   ...
   {
      AV14Column = new com.projectthani.wwpbaseobjects.SdtWWPColumnsSelector_Column(remoteHandle, context);
      /* GeneXus formulas. */
      Gx_err = (short)(0) ;
   }
   ...
   private com.projectthani.wwpbaseobjects.SdtWWPColumnsSelector AV8ColumnsSelector ;
   private com.projectthani.wwpbaseobjects.SdtWWPColumnsSelector_Column AV14Column ;
}
