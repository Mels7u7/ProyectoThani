...
public final  class secrolefunroleactionassociationww_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            gxgrgrid_refresh( subGrid_Rows, AV29SecParentFunctionalityId, AV13SecFunctionalityIdRemovedXml, AV12SecFunctionalityIdAddedXml, AV9SecRoleId, A4SecRoleId, AV21i, AV11SecFunctionalityIdRemoved, AV15SecFunctionalityIdToFind, AV10SecFunctionalityIdAdded, AV31SecRoleIdParm) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511033114", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSECROLEIDPARM", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV31SecRoleIdParm), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSECROLEID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV9SecRoleId), "ZZZ9")));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vGRIDCURRENTPAGE", GXutil.ltrim( localUtil.ntoc( AV78GridCurrentPage, (byte)(10), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vGRIDPAGECOUNT", GXutil.ltrim( localUtil.ntoc( AV79GridPageCount, (byte)(10), (byte)(0), ",", "")));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vORDEREDBY", GXutil.ltrim( localUtil.ntoc( AV35OrderedBy, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, "vORDEREDDSC", AV36OrderedDsc);
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vSECROLEIDPARM", GXutil.ltrim( localUtil.ntoc( AV31SecRoleIdParm, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSECROLEIDPARM", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV31SecRoleIdParm), "ZZZ9")));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vSECPARENTFUNCTIONALITYID", GXutil.ltrim( localUtil.ntoc( AV29SecParentFunctionalityId, (byte)(10), (byte)(0), ",", "")));
   ...
   {
      return formatLink("com.projectthani.wwpbaseobjects.secrolefunroleactionassociationww", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV9SecRoleId,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV29SecParentFunctionalityId,10,0))}, new String[] {"SecRoleId","SecParentFunctionalityId"})  ;
   }
   ...
   public void rf0V2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H000V2 */
         pr_default.execute(0, new Object[] {Long.valueOf(AV29SecParentFunctionalityId), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_15_idx = 1 ;
         sGXsfl_15_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_15_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_152( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A1SecFunctionalityId = H000V2_A1SecFunctionalityId[0] ;
            A7SecFunctionalityActive = H000V2_A7SecFunctionalityActive[0] ;
            A11SecParentFunctionalityDescription = H000V2_A11SecParentFunctionalityDescription[0] ;
            A2SecParentFunctionalityId = H000V2_A2SecParentFunctionalityId[0] ;
            n2SecParentFunctionalityId = H000V2_n2SecParentFunctionalityId[0] ;
            A9SecFunctionalityType = H000V2_A9SecFunctionalityType[0] ;
            A8SecFunctionalityDescription = H000V2_A8SecFunctionalityDescription[0] ;
            A3SecFunctionalityKey = H000V2_A3SecFunctionalityKey[0] ;
            A11SecParentFunctionalityDescription = H000V2_A11SecParentFunctionalityDescription[0] ;
            e170V2 ();
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      /* Using cursor H000V3 */
      pr_default.execute(1, new Object[] {Long.valueOf(AV29SecParentFunctionalityId)});
   ...
   public void strup0V0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV78GridCurrentPage = localUtil.ctol( httpContext.cgiGet( "vGRIDCURRENTPAGE"), ",", ".") ;
         AV79GridPageCount = localUtil.ctol( httpContext.cgiGet( "vGRIDPAGECOUNT"), ",", ".") ;
   ...
   public void e150V2( )
   {
      ...
      {
         A4SecRoleId = H000V4_A4SecRoleId[0] ;
         A12SecRoleDescription = H000V4_A12SecRoleDescription[0] ;
         Form.setCaption( GXutil.format( "Associate Functionalities to Role :: %1", A12SecRoleDescription, "", "", "", "", "", "", "", "") );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
   ...
   public void e160V2( )
   {
      ...
      /* Refresh Routine */
      returnInSub = false ;
      GXv_SdtWWPContext3[0] = AV74WWPContext;
      new com.projectthani.wwpbaseobjects.loadwwpcontext(remoteHandle, context).execute( GXv_SdtWWPContext3) ;
      AV74WWPContext = GXv_SdtWWPContext3[0] ;
   ...
   private void e170V2( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vISASSOCIATEDOLD"+"_"+sGXsfl_15_idx, getSecureSignedToken( sGXsfl_15_idx, AV19IsAssociatedOld));
      /* Using cursor H000V5 */
      pr_default.execute(3, new Object[] {Long.valueOf(A1SecFunctionalityId), Short.valueOf(AV31SecRoleIdParm)});
      while ( (pr_default.getStatus(3) != 101) )
      {
         A4SecRoleId = H000V5_A4SecRoleId[0] ;
   ...
   public void e140V2( )
   {
      ...
      AV84GXV1 = 1 ;
      while ( AV84GXV1 <= AV11SecFunctionalityIdRemoved.size() )
      {
         AV14SecFunctionalityId = ((Number) AV11SecFunctionalityIdRemoved.elementAt(-1+AV84GXV1)).longValue() ;
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV21i", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV21i), 10, 0));
      AV85GXV2 = 1 ;
      while ( AV85GXV2 <= AV10SecFunctionalityIdAdded.size() )
      {
         AV14SecFunctionalityId = ((Number) AV10SecFunctionalityIdAdded.elementAt(-1+AV85GXV2)).longValue() ;
         AV16SecFunctionalityRole = (com.projectthani.wwpbaseobjects.SdtSecFunctionalityRole)new com.projectthani.wwpbaseobjects.SdtSecFunctionalityRole( remoteHandle, context);
   ...
   public void S142( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV21i", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV21i), 10, 0));
      AV86GXV3 = 1 ;
      while ( AV86GXV3 <= AV10SecFunctionalityIdAdded.size() )
      {
         AV14SecFunctionalityId = ((Number) AV10SecFunctionalityIdAdded.elementAt(-1+AV86GXV3)).longValue() ;
   ...
   public void S132( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV21i", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV21i), 10, 0));
      AV87GXV4 = 1 ;
      while ( AV87GXV4 <= AV11SecFunctionalityIdRemoved.size() )
      {
         AV14SecFunctionalityId = ((Number) AV11SecFunctionalityIdRemoved.elementAt(-1+AV87GXV4)).longValue() ;
         if ( AV14SecFunctionalityId == AV15SecFunctionalityIdToFind )
         {
            if (true) break;
         }
   ...
   public void S152( )
   {
      ...
      returnInSub = false ;
      AV89GXV6 = 1 ;
      AV88GXV5 = AV16SecFunctionalityRole.GetMessages() ;
      while ( AV89GXV6 <= AV88GXV5.size() )
      {
         AV20Message = (com.genexus.SdtMessages_Message)((com.genexus.SdtMessages_Message)AV88GXV5.elementAt(-1+AV89GXV6));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110331261", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/secrolefunroleactionassociationww.js", "?20225110331261", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e170V2',iparms:[{av:'AV9SecRoleId',fld:'vSECROLEID',pic:'ZZZ9',hsh:true},{av:'A4SecRoleId',fld:'SECROLEID',pic:'ZZZ9'},{av:'A1SecFunctionalityId',fld:'SECFUNCTIONALITYID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV21i',fld:'vI',pic:'ZZZZZZZZZ9'},{av:'AV11SecFunctionalityIdRemoved',fld:'vSECFUNCTIONALITYIDREMOVED',pic:''},{av:'AV15SecFunctionalityIdToFind',fld:'vSECFUNCTIONALITYIDTOFIND',pic:'ZZZZZZZZZ9'},{av:'AV10SecFunctionalityIdAdded',fld:'vSECFUNCTIONALITYIDADDED',pic:''},{av:'AV31SecRoleIdParm',fld:'vSECROLEIDPARM',pic:'ZZZ9',hsh:true}]");
      ...
      setEventMetadata("ENTER","{handler:'e140V2',iparms:[{av:'AV11SecFunctionalityIdRemoved',fld:'vSECFUNCTIONALITYIDREMOVED',pic:''},{av:'AV9SecRoleId',fld:'vSECROLEID',pic:'ZZZ9',hsh:true},{av:'AV10SecFunctionalityIdAdded',fld:'vSECFUNCTIONALITYIDADDED',pic:''},{av:'AV13SecFunctionalityIdRemovedXml',fld:'vSECFUNCTIONALITYIDREMOVEDXML',pic:''},{av:'AV12SecFunctionalityIdAddedXml',fld:'vSECFUNCTIONALITYIDADDEDXML',pic:''},{av:'AV16SecFunctionalityRole',fld:'vSECFUNCTIONALITYROLE',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      sEvtType = "" ;
      scmdbuf = "" ;
      H000V2_A1SecFunctionalityId = new long[1] ;
      H000V2_A7SecFunctionalityActive = new boolean[] {false} ;
      H000V2_A11SecParentFunctionalityDescription = new String[] {""} ;
      H000V2_A2SecParentFunctionalityId = new long[1] ;
      H000V2_n2SecParentFunctionalityId = new boolean[] {false} ;
      H000V2_A9SecFunctionalityType = new byte[1] ;
      H000V2_A8SecFunctionalityDescription = new String[] {""} ;
      H000V2_A3SecFunctionalityKey = new String[] {""} ;
      ...
      H000V4_A4SecRoleId = new short[1] ;
      H000V4_A12SecRoleDescription = new String[] {""} ;
      A12SecRoleDescription = "" ;
      AV74WWPContext = new com.projectthani.wwpbaseobjects.SdtWWPContext(remoteHandle, context);
      GXv_SdtWWPContext3 = new com.projectthani.wwpbaseobjects.SdtWWPContext[1] ;
      H000V5_A1SecFunctionalityId = new long[1] ;
      H000V5_A4SecRoleId = new short[1] ;
      GridRow = new com.genexus.webpanels.GXWebRow();
      AV88GXV5 = new GXBaseCollection<com.genexus.SdtMessages_Message>(com.genexus.SdtMessages_Message.class, "Message", "GeneXus", remoteHandle);
      AV20Message = new com.genexus.SdtMessages_Message(remoteHandle, context);
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      GXCCtl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.wwpbaseobjects.secrolefunroleactionassociationww__default(),
         new Object[] {
             new Object[] {
            H000V2_A1SecFunctionalityId, H000V2_A7SecFunctionalityActive, H000V2_A11SecParentFunctionalityDescription, H000V2_A2SecParentFunctionalityId, H000V2_n2SecParentFunctionalityId, H000V2_A9SecFunctionalityType, H000V2_A8SecFunctionalityDescription, H000V2_A3SecFunctionalityKey
            }
            , new Object[] {
            H000V3_AGRID_nRecordCount
            }
            , new Object[] {
            H000V4_A4SecRoleId, H000V4_A12SecRoleDescription
            }
            , new Object[] {
            H000V5_A1SecFunctionalityId, H000V5_A4SecRoleId
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private long[] H000V2_A1SecFunctionalityId ;
   private boolean[] H000V2_A7SecFunctionalityActive ;
   private String[] H000V2_A11SecParentFunctionalityDescription ;
   private long[] H000V2_A2SecParentFunctionalityId ;
   private boolean[] H000V2_n2SecParentFunctionalityId ;
   private byte[] H000V2_A9SecFunctionalityType ;
   private String[] H000V2_A8SecFunctionalityDescription ;
   private String[] H000V2_A3SecFunctionalityKey ;
   private long[] H000V3_AGRID_nRecordCount ;
   private short[] H000V4_A4SecRoleId ;
   private String[] H000V4_A12SecRoleDescription ;
   private long[] H000V5_A1SecFunctionalityId ;
   private short[] H000V5_A4SecRoleId ;
   private com.genexus.webpanels.GXWebForm Form ;
   private GXBaseCollection<com.genexus.SdtMessages_Message> AV88GXV5 ;
...
final  class secrolefunroleactionassociationww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000V2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() );
            case 1 :
                  return conditional_H000V3(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).shortValue() , ((Boolean) dynConstraints[1]).booleanValue() , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() );
      }
   ...
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("H000V4", "SELECT [SecRoleId], [SecRoleDescription] FROM [SecRole] WHERE [SecRoleId] = ? ORDER BY [SecRoleId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H000V5", "SELECT [SecFunctionalityId], [SecRoleId] FROM [SecFunctionalityRole] WHERE [SecFunctionalityId] = ? and [SecRoleId] = ? ORDER BY [SecFunctionalityId], [SecRoleId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
