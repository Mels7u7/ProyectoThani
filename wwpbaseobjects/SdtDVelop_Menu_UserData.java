...
public final  class SdtDVelop_Menu_UserData extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("PhotoUri", GXutil.rtrim( gxTv_SdtDVelop_Menu_UserData_Photouri));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("FirstLine", GXutil.rtrim( gxTv_SdtDVelop_Menu_UserData_Firstline));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("SecondLine", GXutil.rtrim( gxTv_SdtDVelop_Menu_UserData_Secondline));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
   ...
   {
      gxTv_SdtDVelop_Menu_UserData_N = (byte)(0) ;
   ...
   public void initialize( )
   {
      ...
      gxTv_SdtDVelop_Menu_UserData_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtDVelop_Menu_UserData_N ;
   }

   public com.projectthani.wwpbaseobjects.SdtDVelop_Menu_UserData Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtDVelop_Menu_UserData)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtDVelop_Menu_UserData struct )
   {
   ...
   public com.projectthani.wwpbaseobjects.StructSdtDVelop_Menu_UserData getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtDVelop_Menu_UserData struct = new com.projectthani.wwpbaseobjects.StructSdtDVelop_Menu_UserData ();
   ...
   protected byte gxTv_SdtDVelop_Menu_UserData_N ;
