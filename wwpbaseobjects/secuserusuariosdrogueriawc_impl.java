...
public final  class secuserusuariosdrogueriawc_impl extends GXWebComponent
{
   public secuserusuariosdrogueriawc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public secuserusuariosdrogueriawc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( secuserusuariosdrogueriawc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Sec User Usuarios Drogueria WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110324211", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.wwpbaseobjects.secuserusuariosdrogueriawc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8SecUserId,4,0))}, new String[] {"SecUserId"}) +"\">") ;
   ...
   {
      return "WWPBaseObjects.SecUserUsuariosDrogueriaWC" ;
   }

   public String getPgmdesc( )
   {
      return "Sec User Usuarios Drogueria WC" ;
   }
   ...
   public void wb5J0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.wwpbaseobjects.secuserusuariosdrogueriawc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_5J2( true) ;
      }
      else
      {
         wb_table1_22_5J2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_5J2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtSecUserId_Internalname, GXutil.ltrim( localUtil.ntoc( A6SecUserId, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A6SecUserId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSecUserId_Jsonclick, 0, "Attribute", "", "", "", "", edtSecUserId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_WWPBaseObjects\\SecUserUsuariosDrogueriaWC.htm");
         /* User Defined Control */
   ...
   public void start5J2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Sec User Usuarios Drogueria WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_DROGUERIAID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A36DrogueriaId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"DROGUERIAID", GXutil.ltrim( localUtil.ntoc( A36DrogueriaId, (byte)(4), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV33Pgmname = "WWPBaseObjects.SecUserUsuariosDrogueriaWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf5J2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H005J2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8SecUserId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A6SecUserId = H005J2_A6SecUserId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A6SecUserId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A6SecUserId), 4, 0));
            A147DrogueriaEstado = H005J2_A147DrogueriaEstado[0] ;
            A145DrogueriaDireccion = H005J2_A145DrogueriaDireccion[0] ;
            A144DrogueriaNroDocumento = H005J2_A144DrogueriaNroDocumento[0] ;
            A143DrogueriaTipoDocumento = H005J2_A143DrogueriaTipoDocumento[0] ;
            A142DrogueriaDescripcion = H005J2_A142DrogueriaDescripcion[0] ;
            A141DrogueriaNombre = H005J2_A141DrogueriaNombre[0] ;
            A36DrogueriaId = H005J2_A36DrogueriaId[0] ;
            A147DrogueriaEstado = H005J2_A147DrogueriaEstado[0] ;
            A145DrogueriaDireccion = H005J2_A145DrogueriaDireccion[0] ;
            A144DrogueriaNroDocumento = H005J2_A144DrogueriaNroDocumento[0] ;
            A143DrogueriaTipoDocumento = H005J2_A143DrogueriaTipoDocumento[0] ;
   ...
   public void send_integrity_lvl_hashes5J2( )
   {
      ...
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_DELETE", AV29IsAuthorized_Delete);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( sPrefix, AV29IsAuthorized_Delete));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_DROGUERIAID"+"_"+sGXsfl_37_idx, getSecureSignedToken( sPrefix+sGXsfl_37_idx, localUtil.format( DecimalUtil.doubleToDec(A36DrogueriaId), "ZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H005J3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8SecUserId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void e115J2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("WWPBaseObjects.SecUserUsuariosDrogueriaWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV33Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("WWPBaseObjects.SecUserUsuariosDrogueriaWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "WWPBaseObjects.SecUserUsuariosDrogueriaWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         secuserusuariosdrogueriawc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWDrogueria_Update", GXv_boolean7) ;
      secuserusuariosdrogueriawc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWDrogueria_Delete", GXv_boolean7) ;
      secuserusuariosdrogueriawc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      ...
      GXv_boolean7[0] = GXt_boolean6 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWDrogueria_Insert", GXv_boolean7) ;
      secuserusuariosdrogueriawc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "WWPBaseObjects.SecUserUsuariosDrogueriaWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Drogueria" );
   ...
   public void wb_table1_22_5J2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_5J2( true) ;
      }
      else
      {
         wb_table2_27_5J2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_5J2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_5J2e( true) ;
      }
      else
      {
         wb_table1_22_5J2e( false) ;
      }
   }

   public void wb_table2_27_5J2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "wwpbaseobjects\\secuserusuariosdrogueriawc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110324418", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("wwpbaseobjects/secuserusuariosdrogueriawc.js", "?20225110324419", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtDrogueriaId_Internalname = sPrefix+"DROGUERIAID_"+sGXsfl_37_idx ;
      edtDrogueriaNombre_Internalname = sPrefix+"DROGUERIANOMBRE_"+sGXsfl_37_idx ;
      edtDrogueriaDescripcion_Internalname = sPrefix+"DROGUERIADESCRIPCION_"+sGXsfl_37_idx ;
      cmbDrogueriaTipoDocumento.setInternalname( sPrefix+"DROGUERIATIPODOCUMENTO_"+sGXsfl_37_idx );
      edtDrogueriaNroDocumento_Internalname = sPrefix+"DROGUERIANRODOCUMENTO_"+sGXsfl_37_idx ;
      edtDrogueriaDireccion_Internalname = sPrefix+"DROGUERIADIRECCION_"+sGXsfl_37_idx ;
      cmbDrogueriaEstado.setInternalname( sPrefix+"DROGUERIAESTADO_"+sGXsfl_37_idx );
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtDrogueriaId_Internalname = sPrefix+"DROGUERIAID_"+sGXsfl_37_fel_idx ;
      edtDrogueriaNombre_Internalname = sPrefix+"DROGUERIANOMBRE_"+sGXsfl_37_fel_idx ;
      edtDrogueriaDescripcion_Internalname = sPrefix+"DROGUERIADESCRIPCION_"+sGXsfl_37_fel_idx ;
      cmbDrogueriaTipoDocumento.setInternalname( sPrefix+"DROGUERIATIPODOCUMENTO_"+sGXsfl_37_fel_idx );
      edtDrogueriaNroDocumento_Internalname = sPrefix+"DROGUERIANRODOCUMENTO_"+sGXsfl_37_fel_idx ;
      edtDrogueriaDireccion_Internalname = sPrefix+"DROGUERIADIRECCION_"+sGXsfl_37_fel_idx ;
      cmbDrogueriaEstado.setInternalname( sPrefix+"DROGUERIAESTADO_"+sGXsfl_37_fel_idx );
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbDrogueriaTipoDocumento.getInternalname(), "Values", cmbDrogueriaTipoDocumento.ToJavascriptSource(), !bGXsfl_37_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDrogueriaDireccion_Internalname,A145DrogueriaDireccion,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtDrogueriaDireccion_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         }
         GXCCtl = "DROGUERIAESTADO_" + sGXsfl_37_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbDrogueriaEstado.getInternalname(), "Values", cmbDrogueriaEstado.ToJavascriptSource(), !bGXsfl_37_Refreshing);
   ...
   public void init_default_properties( )
   {
      ...
      edtDrogueriaDescripcion_Internalname = sPrefix+"DROGUERIADESCRIPCION" ;
      cmbDrogueriaTipoDocumento.setInternalname( sPrefix+"DROGUERIATIPODOCUMENTO" );
      edtDrogueriaNroDocumento_Internalname = sPrefix+"DROGUERIANRODOCUMENTO" ;
      edtDrogueriaDireccion_Internalname = sPrefix+"DROGUERIADIRECCION" ;
      cmbDrogueriaEstado.setInternalname( sPrefix+"DROGUERIAESTADO" );
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e185J2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A36DrogueriaId',fld:'DROGUERIAID',pic:'ZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV26Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV28Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtDrogueriaNombre_Link',ctrl:'DROGUERIANOMBRE',prop:'Link'}]}");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e155J2',iparms:[{av:'A36DrogueriaId',fld:'DROGUERIAID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H005J2_A6SecUserId = new short[1] ;
      H005J2_A147DrogueriaEstado = new String[] {""} ;
      H005J2_A145DrogueriaDireccion = new String[] {""} ;
      H005J2_A144DrogueriaNroDocumento = new String[] {""} ;
      H005J2_A143DrogueriaTipoDocumento = new String[] {""} ;
      H005J2_A142DrogueriaDescripcion = new String[] {""} ;
      H005J2_A141DrogueriaNombre = new String[] {""} ;
      H005J2_A36DrogueriaId = new short[1] ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.wwpbaseobjects.secuserusuariosdrogueriawc__default(),
         new Object[] {
             new Object[] {
            H005J2_A6SecUserId, H005J2_A147DrogueriaEstado, H005J2_A145DrogueriaDireccion, H005J2_A144DrogueriaNroDocumento, H005J2_A143DrogueriaTipoDocumento, H005J2_A142DrogueriaDescripcion, H005J2_A141DrogueriaNombre, H005J2_A36DrogueriaId
            }
            , new Object[] {
   ...
   private short[] H005J2_A6SecUserId ;
   private String[] H005J2_A147DrogueriaEstado ;
   private String[] H005J2_A145DrogueriaDireccion ;
   private String[] H005J2_A144DrogueriaNroDocumento ;
   private String[] H005J2_A143DrogueriaTipoDocumento ;
   private String[] H005J2_A142DrogueriaDescripcion ;
   private String[] H005J2_A141DrogueriaNombre ;
   private short[] H005J2_A36DrogueriaId ;
...
final  class secuserusuariosdrogueriawc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H005J2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          short A6SecUserId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[SecUserId], T2.[DrogueriaEstado], T2.[DrogueriaDireccion], T2.[DrogueriaNroDocumento], T2.[DrogueriaTipoDocumento], T2.[DrogueriaDescripcion], T2.[DrogueriaNombre]," ;
      sSelectString += " T1.[DrogueriaId]" ;
      sFromString = " FROM ([DrogueriaUsuarios] T1 INNER JOIN [Drogueria] T2 ON T2.[DrogueriaId] = T1.[DrogueriaId])" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.[SecUserId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST(T1.[DrogueriaId] AS decimal(4,0))) like '%' + ?) or ( T2.[DrogueriaNombre] like '%' + ?) or ( T2.[DrogueriaDescripcion] like '%' + ?) or ( 'dni' like '%' + LOWER(?) and T2.[DrogueriaTipoDocumento] = '1') or ( 'ruc' like '%' + LOWER(?) and T2.[DrogueriaTipoDocumento] = '6') or ( 'libreta electoral' like '%' + LOWER(?) and T2.[DrogueriaTipoDocumento] = '2') or ( 'carnet de extranjeria' like '%' + LOWER(?) and T2.[DrogueriaTipoDocumento] = '4') or ( 'pasaporte' like '%' + LOWER(?) and T2.[DrogueriaTipoDocumento] = '7') or ( 'sin documento' like '%' + LOWER(?) and T2.[DrogueriaTipoDocumento] = '0') or ( T2.[DrogueriaNroDocumento] like '%' + ?) or ( T2.[DrogueriaDireccion] like '%' + ?) or ( 'activo' like '%' + LOWER(?) and T2.[DrogueriaEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and T2.[DrogueriaEstado] = 'I'))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY T1.[SecUserId], T2.[DrogueriaNombre]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T2.[DrogueriaNombre] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[DrogueriaId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[DrogueriaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T2.[DrogueriaDescripcion]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T2.[DrogueriaDescripcion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T2.[DrogueriaTipoDocumento]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T2.[DrogueriaTipoDocumento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T2.[DrogueriaNroDocumento]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T2.[DrogueriaNroDocumento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T2.[DrogueriaDireccion]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T2.[DrogueriaDireccion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T2.[DrogueriaEstado]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T2.[DrogueriaEstado] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[DrogueriaId], T1.[SecUserId]" ;
      }
   ...
   protected Object[] conditional_H005J3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          short A36DrogueriaId ,
                                          ...
                                          short A6SecUserId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([DrogueriaUsuarios] T1 INNER JOIN [Drogueria] T2 ON T2.[DrogueriaId] = T1.[DrogueriaId])" ;
      addWhere(sWhereString, "(T1.[SecUserId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST(T1.[DrogueriaId] AS decimal(4,0))) like '%' + ?) or ( T2.[DrogueriaNombre] like '%' + ?) or ( T2.[DrogueriaDescripcion] like '%' + ?) or ( 'dni' like '%' + LOWER(?) and T2.[DrogueriaTipoDocumento] = '1') or ( 'ruc' like '%' + LOWER(?) and T2.[DrogueriaTipoDocumento] = '6') or ( 'libreta electoral' like '%' + LOWER(?) and T2.[DrogueriaTipoDocumento] = '2') or ( 'carnet de extranjeria' like '%' + LOWER(?) and T2.[DrogueriaTipoDocumento] = '4') or ( 'pasaporte' like '%' + LOWER(?) and T2.[DrogueriaTipoDocumento] = '7') or ( 'sin documento' like '%' + LOWER(?) and T2.[DrogueriaTipoDocumento] = '0') or ( T2.[DrogueriaNroDocumento] like '%' + ?) or ( T2.[DrogueriaDireccion] like '%' + ?) or ( 'activo' like '%' + LOWER(?) and T2.[DrogueriaEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and T2.[DrogueriaEstado] = 'I'))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005J2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , ((Boolean) dynConstraints[9]).booleanValue() , ((Number) dynConstraints[10]).shortValue() , ((Number) dynConstraints[11]).shortValue() );
            case 1 :
                  return conditional_H005J3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , ((Boolean) dynConstraints[9]).booleanValue() , ((Number) dynConstraints[10]).shortValue() , ((Number) dynConstraints[11]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H005J2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H005J3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
