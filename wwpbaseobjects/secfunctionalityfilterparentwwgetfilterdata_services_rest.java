...
public final  class secfunctionalityfilterparentwwgetfilterdata_services_rest extends GxRestService
{
   ...
   public javax.ws.rs.core.Response execute( com.projectthani.wwpbaseobjects.secfunctionalityfilterparentwwgetfilterdata_RESTInterfaceIN entity ) throws Exception
   {
      super.init( "POST" );
      String AV19DDOName;
      ...
      try
      {
         com.projectthani.wwpbaseobjects.secfunctionalityfilterparentwwgetfilterdata worker = new com.projectthani.wwpbaseobjects.secfunctionalityfilterparentwwgetfilterdata(remoteHandle, context);
         worker.execute(AV19DDOName,AV17SearchTxt,AV18SearchTxtTo,AV23OptionsJson,AV26OptionsDescJson,AV28OptionIndexesJson );
         com.projectthani.wwpbaseobjects.secfunctionalityfilterparentwwgetfilterdata_RESTInterfaceOUT data = new com.projectthani.wwpbaseobjects.secfunctionalityfilterparentwwgetfilterdata_RESTInterfaceOUT();
