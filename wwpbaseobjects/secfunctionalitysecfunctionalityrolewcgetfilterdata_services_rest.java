...
public final  class secfunctionalitysecfunctionalityrolewcgetfilterdata_services_rest extends GxRestService
{
   ...
   public javax.ws.rs.core.Response execute( com.projectthani.wwpbaseobjects.secfunctionalitysecfunctionalityrolewcgetfilterdata_RESTInterfaceIN entity ) throws Exception
   {
      super.init( "POST" );
      String AV16DDOName;
      ...
      try
      {
         com.projectthani.wwpbaseobjects.secfunctionalitysecfunctionalityrolewcgetfilterdata worker = new com.projectthani.wwpbaseobjects.secfunctionalitysecfunctionalityrolewcgetfilterdata(remoteHandle, context);
         worker.execute(AV16DDOName,AV14SearchTxt,AV15SearchTxtTo,AV20OptionsJson,AV23OptionsDescJson,AV25OptionIndexesJson );
         com.projectthani.wwpbaseobjects.secfunctionalitysecfunctionalityrolewcgetfilterdata_RESTInterfaceOUT data = new com.projectthani.wwpbaseobjects.secfunctionalitysecfunctionalityrolewcgetfilterdata_RESTInterfaceOUT();
