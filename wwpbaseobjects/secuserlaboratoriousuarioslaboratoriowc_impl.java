...
public final  class secuserlaboratoriousuarioslaboratoriowc_impl extends GXWebComponent
{
   public secuserlaboratoriousuarioslaboratoriowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public secuserlaboratoriousuarioslaboratoriowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( secuserlaboratoriousuarioslaboratoriowc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8SecUserId, AV20ManageFiltersExecutionStep, AV33Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Sec User Laboratorio Usuarios Laboratorio WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110325444", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.wwpbaseobjects.secuserlaboratoriousuarioslaboratoriowc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8SecUserId,4,0))}, new String[] {"SecUserId"}) +"\">") ;
   ...
   public void renderHtmlCloseForm5L2( )
   {
   ...
   {
      return "WWPBaseObjects.SecUserLaboratorioUsuariosLaboratorioWC" ;
   }
   ...
   public void wb5L0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.wwpbaseobjects.secuserlaboratoriousuarioslaboratoriowc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_5L2( true) ;
      }
      else
      {
         wb_table1_22_5L2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_5L2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtSecUserId_Internalname, GXutil.ltrim( localUtil.ntoc( A6SecUserId, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A6SecUserId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSecUserId_Jsonclick, 0, "Attribute", "", "", "", "", edtSecUserId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_WWPBaseObjects\\SecUserLaboratorioUsuariosLaboratorioWC.htm");
         /* User Defined Control */
   ...
   public void start5L2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Sec User Laboratorio Usuarios Laboratorio WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop(sPrefix, false, edtLaboratorioPhoto_Internalname, "Bitmap", ((GXutil.strcmp("", A169LaboratorioPhoto)==0) ? A40000LaboratorioPhoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A169LaboratorioPhoto))), !bGXsfl_37_Refreshing);
                           httpContext.ajax_rsp_assign_prop(sPrefix, false, edtLaboratorioPhoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A169LaboratorioPhoto), true);
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_LABORATORIOID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A40LaboratorioId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"LABORATORIOID", GXutil.ltrim( localUtil.ntoc( A40LaboratorioId, (byte)(4), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV33Pgmname = "WWPBaseObjects.SecUserLaboratorioUsuariosLaboratorioWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf5L2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN,
         ...
         {
            A6SecUserId = H005L2_A6SecUserId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A6SecUserId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A6SecUserId), 4, 0));
            A171LaboratorioEstado = H005L2_A171LaboratorioEstado[0] ;
            A170LaboratorioComision = H005L2_A170LaboratorioComision[0] ;
            A169LaboratorioPhoto = H005L2_A169LaboratorioPhoto[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtLaboratorioPhoto_Internalname, "Bitmap", ((GXutil.strcmp("", A169LaboratorioPhoto)==0) ? A40000LaboratorioPhoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A169LaboratorioPhoto))), !bGXsfl_37_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtLaboratorioPhoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A169LaboratorioPhoto), true);
            A40000LaboratorioPhoto_GXI = H005L2_A40000LaboratorioPhoto_GXI[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtLaboratorioPhoto_Internalname, "Bitmap", ((GXutil.strcmp("", A169LaboratorioPhoto)==0) ? A40000LaboratorioPhoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A169LaboratorioPhoto))), !bGXsfl_37_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtLaboratorioPhoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A169LaboratorioPhoto), true);
            A168LaboratorioNroDocumento = H005L2_A168LaboratorioNroDocumento[0] ;
            A167LaboratorioTipoDocumento = H005L2_A167LaboratorioTipoDocumento[0] ;
            A166LaboratorioDescripcion = H005L2_A166LaboratorioDescripcion[0] ;
            A165LaboratorioNombre = H005L2_A165LaboratorioNombre[0] ;
            A40LaboratorioId = H005L2_A40LaboratorioId[0] ;
            A171LaboratorioEstado = H005L2_A171LaboratorioEstado[0] ;
            A170LaboratorioComision = H005L2_A170LaboratorioComision[0] ;
            A169LaboratorioPhoto = H005L2_A169LaboratorioPhoto[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtLaboratorioPhoto_Internalname, "Bitmap", ((GXutil.strcmp("", A169LaboratorioPhoto)==0) ? A40000LaboratorioPhoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A169LaboratorioPhoto))), !bGXsfl_37_Refreshing);
   ...
   public void send_integrity_lvl_hashes5L2( )
   {
      ...
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_DELETE", AV29IsAuthorized_Delete);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( sPrefix, AV29IsAuthorized_Delete));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_LABORATORIOID"+"_"+sGXsfl_37_idx, getSecureSignedToken( sPrefix+sGXsfl_37_idx, localUtil.format( DecimalUtil.doubleToDec(A40LaboratorioId), "ZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H005L3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8SecUserId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void e115L2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("WWPBaseObjects.SecUserLaboratorioUsuariosLaboratorioWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV33Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("WWPBaseObjects.SecUserLaboratorioUsuariosLaboratorioWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "WWPBaseObjects.SecUserLaboratorioUsuariosLaboratorioWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         secuserlaboratoriousuarioslaboratoriowc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      secuserlaboratoriousuarioslaboratoriowc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "WWPBaseObjects.SecUserLaboratorioUsuariosLaboratorioWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Laboratorio" );
   ...
   public void wb_table1_22_5L2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_5L2( true) ;
      }
      else
      {
         wb_table2_27_5L2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_5L2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_5L2e( true) ;
      }
      else
      {
         wb_table1_22_5L2e( false) ;
      }
   }

   public void wb_table2_27_5L2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "wwpbaseobjects\\secuserlaboratoriousuarioslaboratoriowc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110325627", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("wwpbaseobjects/secuserlaboratoriousuarioslaboratoriowc.js", "?20225110325627", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtLaboratorioId_Internalname = sPrefix+"LABORATORIOID_"+sGXsfl_37_idx ;
      edtLaboratorioNombre_Internalname = sPrefix+"LABORATORIONOMBRE_"+sGXsfl_37_idx ;
      edtLaboratorioDescripcion_Internalname = sPrefix+"LABORATORIODESCRIPCION_"+sGXsfl_37_idx ;
      cmbLaboratorioTipoDocumento.setInternalname( sPrefix+"LABORATORIOTIPODOCUMENTO_"+sGXsfl_37_idx );
      edtLaboratorioNroDocumento_Internalname = sPrefix+"LABORATORIONRODOCUMENTO_"+sGXsfl_37_idx ;
      edtLaboratorioPhoto_Internalname = sPrefix+"LABORATORIOPHOTO_"+sGXsfl_37_idx ;
      edtLaboratorioComision_Internalname = sPrefix+"LABORATORIOCOMISION_"+sGXsfl_37_idx ;
      cmbLaboratorioEstado.setInternalname( sPrefix+"LABORATORIOESTADO_"+sGXsfl_37_idx );
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtLaboratorioId_Internalname = sPrefix+"LABORATORIOID_"+sGXsfl_37_fel_idx ;
      edtLaboratorioNombre_Internalname = sPrefix+"LABORATORIONOMBRE_"+sGXsfl_37_fel_idx ;
      edtLaboratorioDescripcion_Internalname = sPrefix+"LABORATORIODESCRIPCION_"+sGXsfl_37_fel_idx ;
      cmbLaboratorioTipoDocumento.setInternalname( sPrefix+"LABORATORIOTIPODOCUMENTO_"+sGXsfl_37_fel_idx );
      edtLaboratorioNroDocumento_Internalname = sPrefix+"LABORATORIONRODOCUMENTO_"+sGXsfl_37_fel_idx ;
      edtLaboratorioPhoto_Internalname = sPrefix+"LABORATORIOPHOTO_"+sGXsfl_37_fel_idx ;
      edtLaboratorioComision_Internalname = sPrefix+"LABORATORIOCOMISION_"+sGXsfl_37_fel_idx ;
      cmbLaboratorioEstado.setInternalname( sPrefix+"LABORATORIOESTADO_"+sGXsfl_37_fel_idx );
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLaboratorioId_Internalname,GXutil.ltrim( localUtil.ntoc( A40LaboratorioId, (byte)(4), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A40LaboratorioId), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLaboratorioId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id4","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLaboratorioDescripcion_Internalname,A166LaboratorioDescripcion,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLaboratorioDescripcion_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(500),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         }
         GXCCtl = "LABORATORIOTIPODOCUMENTO_" + sGXsfl_37_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbLaboratorioTipoDocumento.getInternalname(), "Values", cmbLaboratorioTipoDocumento.ToJavascriptSource(), !bGXsfl_37_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtLaboratorioComision_Internalname,GXutil.ltrim( localUtil.ntoc( A170LaboratorioComision, (byte)(4), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A170LaboratorioComision), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtLaboratorioComision_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         }
         GXCCtl = "LABORATORIOESTADO_" + sGXsfl_37_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbLaboratorioEstado.getInternalname(), "Values", cmbLaboratorioEstado.ToJavascriptSource(), !bGXsfl_37_Refreshing);
   ...
   public void init_default_properties( )
   {
      ...
      edtLaboratorioPhoto_Internalname = sPrefix+"LABORATORIOPHOTO" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:LaboratorioId|3:LaboratorioNombre|4:LaboratorioDescripcion|5:LaboratorioTipoDocumento|6:LaboratorioNroDocumento|8:LaboratorioComision|9:LaboratorioEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e185L2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A40LaboratorioId',fld:'LABORATORIOID',pic:'ZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV26Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV28Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtLaboratorioNombre_Link',ctrl:'LABORATORIONOMBRE',prop:'Link'}]}");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e155L2',iparms:[{av:'A40LaboratorioId',fld:'LABORATORIOID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H005L2_A6SecUserId = new short[1] ;
      H005L2_A171LaboratorioEstado = new String[] {""} ;
      H005L2_A170LaboratorioComision = new short[1] ;
      H005L2_A169LaboratorioPhoto = new String[] {""} ;
      H005L2_A40000LaboratorioPhoto_GXI = new String[] {""} ;
      H005L2_A168LaboratorioNroDocumento = new String[] {""} ;
      H005L2_A167LaboratorioTipoDocumento = new String[] {""} ;
      H005L2_A166LaboratorioDescripcion = new String[] {""} ;
      H005L2_A165LaboratorioNombre = new String[] {""} ;
      H005L2_A40LaboratorioId = new short[1] ;
      ...
      GXCCtl = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.wwpbaseobjects.secuserlaboratoriousuarioslaboratoriowc__default(),
         new Object[] {
             new Object[] {
            H005L2_A6SecUserId, H005L2_A171LaboratorioEstado, H005L2_A170LaboratorioComision, H005L2_A169LaboratorioPhoto, H005L2_A40000LaboratorioPhoto_GXI, H005L2_A168LaboratorioNroDocumento, H005L2_A167LaboratorioTipoDocumento, H005L2_A166LaboratorioDescripcion, H005L2_A165LaboratorioNombre, H005L2_A40LaboratorioId
            }
            , new Object[] {
   ...
   private short[] H005L2_A6SecUserId ;
   private String[] H005L2_A171LaboratorioEstado ;
   private short[] H005L2_A170LaboratorioComision ;
   private String[] H005L2_A169LaboratorioPhoto ;
   private String[] H005L2_A40000LaboratorioPhoto_GXI ;
   private String[] H005L2_A168LaboratorioNroDocumento ;
   private String[] H005L2_A167LaboratorioTipoDocumento ;
   private String[] H005L2_A166LaboratorioDescripcion ;
   private String[] H005L2_A165LaboratorioNombre ;
   private short[] H005L2_A40LaboratorioId ;
...
final  class secuserlaboratoriousuarioslaboratoriowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          short A6SecUserId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[SecUserId], T2.[LaboratorioEstado], T2.[LaboratorioComision], T2.[LaboratorioPhoto], T2.[LaboratorioPhoto_GXI], T2.[LaboratorioNroDocumento], T2.[LaboratorioTipoDocumento]," ;
      sSelectString += " T2.[LaboratorioDescripcion], T2.[LaboratorioNombre], T1.[LaboratorioId]" ;
      sFromString = " FROM ([LaboratorioLaboratorioUsuarios] T1 INNER JOIN [Laboratorio] T2 ON T2.[LaboratorioId] = T1.[LaboratorioId])" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.[SecUserId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST(T1.[LaboratorioId] AS decimal(4,0))) like '%' + ?) or ( T2.[LaboratorioNombre] like '%' + ?) or ( T2.[LaboratorioDescripcion] like '%' + ?) or ( 'ruc' like '%' + LOWER(?) and T2.[LaboratorioTipoDocumento] = '6') or ( 'dni' like '%' + LOWER(?) and T2.[LaboratorioTipoDocumento] = '1') or ( T2.[LaboratorioNroDocumento] like '%' + ?) or ( CONVERT( char(4), CAST(T2.[LaboratorioComision] AS decimal(4,0))) like '%' + ?) or ( 'activo' like '%' + LOWER(?) and T2.[LaboratorioEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and T2.[LaboratorioEstado] = 'I'))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY T1.[SecUserId], T2.[LaboratorioNombre]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T2.[LaboratorioNombre] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[LaboratorioId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[LaboratorioId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T2.[LaboratorioDescripcion]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T2.[LaboratorioDescripcion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T2.[LaboratorioTipoDocumento]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T2.[LaboratorioTipoDocumento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T2.[LaboratorioNroDocumento]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T2.[LaboratorioNroDocumento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T2.[LaboratorioComision]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T2.[LaboratorioComision] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T2.[LaboratorioEstado]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T2.[LaboratorioEstado] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY T1.[LaboratorioId], T1.[SecUserId]" ;
      }
                                          ...
                                          short A6SecUserId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([LaboratorioLaboratorioUsuarios] T1 INNER JOIN [Laboratorio] T2 ON T2.[LaboratorioId] = T1.[LaboratorioId])" ;
      addWhere(sWhereString, "(T1.[SecUserId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST(T1.[LaboratorioId] AS decimal(4,0))) like '%' + ?) or ( T2.[LaboratorioNombre] like '%' + ?) or ( T2.[LaboratorioDescripcion] like '%' + ?) or ( 'ruc' like '%' + LOWER(?) and T2.[LaboratorioTipoDocumento] = '6') or ( 'dni' like '%' + LOWER(?) and T2.[LaboratorioTipoDocumento] = '1') or ( T2.[LaboratorioNroDocumento] like '%' + ?) or ( CONVERT( char(4), CAST(T2.[LaboratorioComision] AS decimal(4,0))) like '%' + ?) or ( 'activo' like '%' + LOWER(?) and T2.[LaboratorioEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and T2.[LaboratorioEstado] = 'I'))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005L2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , ((Boolean) dynConstraints[9]).booleanValue() , ((Number) dynConstraints[10]).shortValue() , ((Number) dynConstraints[11]).shortValue() );
            case 1 :
                  return conditional_H005L3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , (String)dynConstraints[7] , ((Number) dynConstraints[8]).shortValue() , ((Boolean) dynConstraints[9]).booleanValue() , ((Number) dynConstraints[10]).shortValue() , ((Number) dynConstraints[11]).shortValue() );
      }
