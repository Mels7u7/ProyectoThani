...
public final  class SdtGoogleDocsResult_Doc extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("Type", GXutil.rtrim( gxTv_SdtGoogleDocsResult_Doc_Type));
      if ( GXutil.strcmp(sNameSpace, "DVelop.Extensions.GoogleDocs") != 0 )
      {
         oWriter.writeAttribute("xmlns", "DVelop.Extensions.GoogleDocs");
      }
      oWriter.writeElement("Title", GXutil.rtrim( gxTv_SdtGoogleDocsResult_Doc_Title));
      if ( GXutil.strcmp(sNameSpace, "DVelop.Extensions.GoogleDocs") != 0 )
      {
         oWriter.writeAttribute("xmlns", "DVelop.Extensions.GoogleDocs");
      }
      oWriter.writeElement("URL", GXutil.rtrim( gxTv_SdtGoogleDocsResult_Doc_Url));
      if ( GXutil.strcmp(sNameSpace, "DVelop.Extensions.GoogleDocs") != 0 )
      {
         oWriter.writeAttribute("xmlns", "DVelop.Extensions.GoogleDocs");
      }
   ...
   public com.projectthani.wwpbaseobjects.SdtGoogleDocsResult_Doc Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtGoogleDocsResult_Doc)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtGoogleDocsResult_Doc struct )
   {
   ...
   public com.projectthani.wwpbaseobjects.StructSdtGoogleDocsResult_Doc getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtGoogleDocsResult_Doc struct = new com.projectthani.wwpbaseobjects.StructSdtGoogleDocsResult_Doc ();
