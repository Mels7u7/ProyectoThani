...
public final  class StructSdtWWPGridState implements Cloneable, java.io.Serializable
{
   ...
   public java.util.Vector<com.projectthani.wwpbaseobjects.StructSdtWWPGridState_FilterValue> getFiltervalues( )
   {
      return gxTv_SdtWWPGridState_Filtervalues ;
   }

   public void setFiltervalues( java.util.Vector<com.projectthani.wwpbaseobjects.StructSdtWWPGridState_FilterValue> value )
   {
   ...
   public java.util.Vector<com.projectthani.wwpbaseobjects.StructSdtWWPGridState_DynamicFilter> getDynamicfilters( )
   {
      return gxTv_SdtWWPGridState_Dynamicfilters ;
   }

   public void setDynamicfilters( java.util.Vector<com.projectthani.wwpbaseobjects.StructSdtWWPGridState_DynamicFilter> value )
   {
   ...
   protected java.util.Vector<com.projectthani.wwpbaseobjects.StructSdtWWPGridState_FilterValue> gxTv_SdtWWPGridState_Filtervalues=null ;
   protected java.util.Vector<com.projectthani.wwpbaseobjects.StructSdtWWPGridState_DynamicFilter> gxTv_SdtWWPGridState_Dynamicfilters=null ;
}
