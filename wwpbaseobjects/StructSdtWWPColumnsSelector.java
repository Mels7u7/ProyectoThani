...
public final  class StructSdtWWPColumnsSelector implements Cloneable, java.io.Serializable
{
   ...
   public java.util.Vector<com.projectthani.wwpbaseobjects.StructSdtWWPColumnsSelector_Column> getColumns( )
   {
      return gxTv_SdtWWPColumnsSelector_Columns ;
   }

   public void setColumns( java.util.Vector<com.projectthani.wwpbaseobjects.StructSdtWWPColumnsSelector_Column> value )
   {
   ...
   protected java.util.Vector<com.projectthani.wwpbaseobjects.StructSdtWWPColumnsSelector_Column> gxTv_SdtWWPColumnsSelector_Columns=null ;
}
