...
public final  class secuserprofesionalwc_impl extends GXWebComponent
{
   public secuserprofesionalwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public secuserprofesionalwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( secuserprofesionalwc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Sec User Profesional WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110321960", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.wwpbaseobjects.secuserprofesionalwc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8SecUserId,4,0))}, new String[] {"SecUserId"}) +"\">") ;
   ...
   {
      return "WWPBaseObjects.SecUserProfesionalWC" ;
   }
   ...
   public void wb5N0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.wwpbaseobjects.secuserprofesionalwc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_5N2( true) ;
      }
      else
      {
         wb_table1_22_5N2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_5N2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtSecUserId_Internalname, GXutil.ltrim( localUtil.ntoc( A6SecUserId, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A6SecUserId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSecUserId_Jsonclick, 0, "Attribute", "", "", "", "", edtSecUserId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_WWPBaseObjects\\SecUserProfesionalWC.htm");
         /* User Defined Control */
   ...
   public void start5N2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Sec User Profesional WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV35Pgmname = "WWPBaseObjects.SecUserProfesionalWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf5N2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A6SecUserId = H005N2_A6SecUserId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A6SecUserId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A6SecUserId), 4, 0));
            A193ProfesionalLinkedin = H005N2_A193ProfesionalLinkedin[0] ;
            A192ProfesionalInstagram = H005N2_A192ProfesionalInstagram[0] ;
            A191ProfesionalFacebook = H005N2_A191ProfesionalFacebook[0] ;
            A190ProfesionalTwitter = H005N2_A190ProfesionalTwitter[0] ;
            A189ProfesionalFoto = H005N2_A189ProfesionalFoto[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtProfesionalFoto_Internalname, "Bitmap", ((GXutil.strcmp("", A189ProfesionalFoto)==0) ? A40000ProfesionalFoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A189ProfesionalFoto))), !bGXsfl_37_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtProfesionalFoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A189ProfesionalFoto), true);
            A40000ProfesionalFoto_GXI = H005N2_A40000ProfesionalFoto_GXI[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtProfesionalFoto_Internalname, "Bitmap", ((GXutil.strcmp("", A189ProfesionalFoto)==0) ? A40000ProfesionalFoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A189ProfesionalFoto))), !bGXsfl_37_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtProfesionalFoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A189ProfesionalFoto), true);
            A44UbigeoCode = H005N2_A44UbigeoCode[0] ;
            A184PaisDescripcion = H005N2_A184PaisDescripcion[0] ;
            A43PaisId = H005N2_A43PaisId[0] ;
            A183ProfesionalDireccion = H005N2_A183ProfesionalDireccion[0] ;
            A182ProfesionalTiempoCita = H005N2_A182ProfesionalTiempoCita[0] ;
            A181ProfesionalColorCita = H005N2_A181ProfesionalColorCita[0] ;
            A180ProfesionalColorDisponible = H005N2_A180ProfesionalColorDisponible[0] ;
            A88ProfesionalCOP = H005N2_A88ProfesionalCOP[0] ;
            A179ProfesionalCorreo = H005N2_A179ProfesionalCorreo[0] ;
            A178ProfesionalDescripcion = H005N2_A178ProfesionalDescripcion[0] ;
            A177ProfesionalSexo = H005N2_A177ProfesionalSexo[0] ;
            A176ProfesionalFechaNacimiento = H005N2_A176ProfesionalFechaNacimiento[0] ;
            A174ProfesionalNroDocumento = H005N2_A174ProfesionalNroDocumento[0] ;
            A173ProfesionalTipoDocumento = H005N2_A173ProfesionalTipoDocumento[0] ;
            A31ProfesionalId = H005N2_A31ProfesionalId[0] ;
            A84ProfesionalNombres = H005N2_A84ProfesionalNombres[0] ;
            A86ProfesionalApellidoMaterno = H005N2_A86ProfesionalApellidoMaterno[0] ;
            A85ProfesionalApellidoPaterno = H005N2_A85ProfesionalApellidoPaterno[0] ;
            A188UbigeoDistrito = H005N2_A188UbigeoDistrito[0] ;
            A187UbigeoProvincia = H005N2_A187UbigeoProvincia[0] ;
            A186UbigeoDepartamento = H005N2_A186UbigeoDepartamento[0] ;
            A188UbigeoDistrito = H005N2_A188UbigeoDistrito[0] ;
            A187UbigeoProvincia = H005N2_A187UbigeoProvincia[0] ;
            A186UbigeoDepartamento = H005N2_A186UbigeoDepartamento[0] ;
            A184PaisDescripcion = H005N2_A184PaisDescripcion[0] ;
   ...
   public void e165N2( )
   {
      ...
      secuserprofesionalwc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void e115N2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("WWPBaseObjects.SecUserProfesionalWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV35Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("WWPBaseObjects.SecUserProfesionalWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "WWPBaseObjects.SecUserProfesionalWCFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         secuserprofesionalwc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "WWPBaseObjects.SecUserProfesionalWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void wb_table1_22_5N2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_5N2( true) ;
      }
      else
      {
         wb_table2_27_5N2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_5N2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_5N2e( true) ;
      }
      else
      {
         wb_table1_22_5N2e( false) ;
      }
   }

   public void wb_table2_27_5N2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "wwpbaseobjects\\secuserprofesionalwc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110322260", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("wwpbaseobjects/secuserprofesionalwc.js", "?20225110322260", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e185N2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A31ProfesionalId',fld:'PROFESIONALID',pic:'ZZZZZZZ9'},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_PaisDescripcion',fld:'vISAUTHORIZED_PAISDESCRIPCION',pic:'',hsh:true},{av:'A43PaisId',fld:'PAISID',pic:'ZZZ9'},{av:'AV31IsAuthorized_UbigeoNombre',fld:'vISAUTHORIZED_UBIGEONOMBRE',pic:'',hsh:true},{av:'A44UbigeoCode',fld:'UBIGEOCODE',pic:''},{av:'A190ProfesionalTwitter',fld:'PROFESIONALTWITTER',pic:''},{av:'A191ProfesionalFacebook',fld:'PROFESIONALFACEBOOK',pic:''},{av:'A192ProfesionalInstagram',fld:'PROFESIONALINSTAGRAM',pic:''},{av:'A193ProfesionalLinkedin',fld:'PROFESIONALLINKEDIN',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e155N2',iparms:[{av:'A31ProfesionalId',fld:'PROFESIONALID',pic:'ZZZZZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H005N2_A6SecUserId = new short[1] ;
      H005N2_A193ProfesionalLinkedin = new String[] {""} ;
      H005N2_A192ProfesionalInstagram = new String[] {""} ;
      H005N2_A191ProfesionalFacebook = new String[] {""} ;
      H005N2_A190ProfesionalTwitter = new String[] {""} ;
      H005N2_A189ProfesionalFoto = new String[] {""} ;
      H005N2_A40000ProfesionalFoto_GXI = new String[] {""} ;
      H005N2_A44UbigeoCode = new String[] {""} ;
      H005N2_A184PaisDescripcion = new String[] {""} ;
      H005N2_A43PaisId = new short[1] ;
      H005N2_A183ProfesionalDireccion = new String[] {""} ;
      H005N2_A182ProfesionalTiempoCita = new byte[1] ;
      H005N2_A181ProfesionalColorCita = new String[] {""} ;
      H005N2_A180ProfesionalColorDisponible = new String[] {""} ;
      H005N2_A88ProfesionalCOP = new String[] {""} ;
      H005N2_A179ProfesionalCorreo = new String[] {""} ;
      H005N2_A178ProfesionalDescripcion = new String[] {""} ;
      H005N2_A177ProfesionalSexo = new String[] {""} ;
      H005N2_A176ProfesionalFechaNacimiento = new java.util.Date[] {GXutil.nullDate()} ;
      H005N2_A174ProfesionalNroDocumento = new String[] {""} ;
      H005N2_A173ProfesionalTipoDocumento = new String[] {""} ;
      H005N2_A31ProfesionalId = new int[1] ;
      H005N2_A84ProfesionalNombres = new String[] {""} ;
      H005N2_A86ProfesionalApellidoMaterno = new String[] {""} ;
      H005N2_A85ProfesionalApellidoPaterno = new String[] {""} ;
      H005N2_A188UbigeoDistrito = new String[] {""} ;
      H005N2_A187UbigeoProvincia = new String[] {""} ;
      H005N2_A186UbigeoDepartamento = new String[] {""} ;
      ...
      GXCCtl = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.wwpbaseobjects.secuserprofesionalwc__default(),
         new Object[] {
             new Object[] {
            H005N2_A6SecUserId, H005N2_A193ProfesionalLinkedin, H005N2_A192ProfesionalInstagram, H005N2_A191ProfesionalFacebook, H005N2_A190ProfesionalTwitter, H005N2_A189ProfesionalFoto, H005N2_A40000ProfesionalFoto_GXI, H005N2_A44UbigeoCode, H005N2_A184PaisDescripcion, H005N2_A43PaisId,
            H005N2_A183ProfesionalDireccion, H005N2_A182ProfesionalTiempoCita, H005N2_A181ProfesionalColorCita, H005N2_A180ProfesionalColorDisponible, H005N2_A88ProfesionalCOP, H005N2_A179ProfesionalCorreo, H005N2_A178ProfesionalDescripcion, H005N2_A177ProfesionalSexo, H005N2_A176ProfesionalFechaNacimiento, H005N2_A174ProfesionalNroDocumento,
            H005N2_A173ProfesionalTipoDocumento, H005N2_A31ProfesionalId, H005N2_A84ProfesionalNombres, H005N2_A86ProfesionalApellidoMaterno, H005N2_A85ProfesionalApellidoPaterno, H005N2_A188UbigeoDistrito, H005N2_A187UbigeoProvincia, H005N2_A186UbigeoDepartamento
            }
            , new Object[] {
   ...
   private short[] H005N2_A6SecUserId ;
   private String[] H005N2_A193ProfesionalLinkedin ;
   private String[] H005N2_A192ProfesionalInstagram ;
   private String[] H005N2_A191ProfesionalFacebook ;
   private String[] H005N2_A190ProfesionalTwitter ;
   private String[] H005N2_A189ProfesionalFoto ;
   private String[] H005N2_A40000ProfesionalFoto_GXI ;
   private String[] H005N2_A44UbigeoCode ;
   private String[] H005N2_A184PaisDescripcion ;
   private short[] H005N2_A43PaisId ;
   private String[] H005N2_A183ProfesionalDireccion ;
   private byte[] H005N2_A182ProfesionalTiempoCita ;
   private String[] H005N2_A181ProfesionalColorCita ;
   private String[] H005N2_A180ProfesionalColorDisponible ;
   private String[] H005N2_A88ProfesionalCOP ;
   private String[] H005N2_A179ProfesionalCorreo ;
   private String[] H005N2_A178ProfesionalDescripcion ;
   private String[] H005N2_A177ProfesionalSexo ;
   private java.util.Date[] H005N2_A176ProfesionalFechaNacimiento ;
   private String[] H005N2_A174ProfesionalNroDocumento ;
   private String[] H005N2_A173ProfesionalTipoDocumento ;
   private int[] H005N2_A31ProfesionalId ;
   private String[] H005N2_A84ProfesionalNombres ;
   private String[] H005N2_A86ProfesionalApellidoMaterno ;
   private String[] H005N2_A85ProfesionalApellidoPaterno ;
   private String[] H005N2_A188UbigeoDistrito ;
   private String[] H005N2_A187UbigeoProvincia ;
   private String[] H005N2_A186UbigeoDepartamento ;
...
final  class secuserprofesionalwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H005N2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          short A6SecUserId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[SecUserId], T1.[ProfesionalLinkedin], T1.[ProfesionalInstagram], T1.[ProfesionalFacebook], T1.[ProfesionalTwitter], T1.[ProfesionalFoto], T1.[ProfesionalFoto_GXI]," ;
      sSelectString += " T1.[UbigeoCode], T3.[PaisDescripcion], T1.[PaisId], T1.[ProfesionalDireccion], T1.[ProfesionalTiempoCita], T1.[ProfesionalColorCita], T1.[ProfesionalColorDisponible]," ;
      sSelectString += " T1.[ProfesionalCOP], T1.[ProfesionalCorreo], T1.[ProfesionalDescripcion], T1.[ProfesionalSexo], T1.[ProfesionalFechaNacimiento], T1.[ProfesionalNroDocumento], T1.[ProfesionalTipoDocumento]," ;
      ...
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalTipoDocumento]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalTipoDocumento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalNroDocumento]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalNroDocumento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalApellidoPaterno]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalApellidoPaterno] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalApellidoMaterno]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalApellidoMaterno] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalNombres]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalNombres] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalFechaNacimiento]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalFechaNacimiento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalSexo]" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalSexo] DESC" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalDescripcion]" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalDescripcion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalCorreo]" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalCorreo] DESC" ;
      }
      else if ( ( AV14OrderedBy == 11 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalCOP]" ;
      }
      else if ( ( AV14OrderedBy == 11 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalCOP] DESC" ;
      }
      else if ( ( AV14OrderedBy == 12 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalColorDisponible]" ;
      }
      else if ( ( AV14OrderedBy == 12 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalColorDisponible] DESC" ;
      }
      else if ( ( AV14OrderedBy == 13 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalColorCita]" ;
      }
      else if ( ( AV14OrderedBy == 13 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalColorCita] DESC" ;
      }
      else if ( ( AV14OrderedBy == 14 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalTiempoCita]" ;
      }
      else if ( ( AV14OrderedBy == 14 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalTiempoCita] DESC" ;
      }
      else if ( ( AV14OrderedBy == 15 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalDireccion]" ;
      }
      else if ( ( AV14OrderedBy == 15 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalDireccion] DESC" ;
      }
      ...
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalTwitter]" ;
      }
      else if ( ( AV14OrderedBy == 19 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalTwitter] DESC" ;
      }
      else if ( ( AV14OrderedBy == 20 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalFacebook]" ;
      }
      else if ( ( AV14OrderedBy == 20 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalFacebook] DESC" ;
      }
      else if ( ( AV14OrderedBy == 21 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalInstagram]" ;
      }
      else if ( ( AV14OrderedBy == 21 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalInstagram] DESC" ;
      }
      else if ( ( AV14OrderedBy == 22 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[SecUserId], T1.[ProfesionalLinkedin]" ;
      }
      else if ( ( AV14OrderedBy == 22 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[SecUserId] DESC, T1.[ProfesionalLinkedin] DESC" ;
      }
      else if ( true )
      {
   ...
   protected Object[] conditional_H005N3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A31ProfesionalId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005N2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (String)dynConstraints[8] , (String)dynConstraints[9] , (String)dynConstraints[10] , (String)dynConstraints[11] , (String)dynConstraints[12] , ((Number) dynConstraints[13]).byteValue() , (String)dynConstraints[14] , ((Number) dynConstraints[15]).shortValue() , (String)dynConstraints[16] , (String)dynConstraints[17] , (String)dynConstraints[18] , (String)dynConstraints[19] , (String)dynConstraints[20] , (String)dynConstraints[21] , (String)dynConstraints[22] , (String)dynConstraints[23] , (String)dynConstraints[24] , ((Number) dynConstraints[25]).shortValue() , ((Boolean) dynConstraints[26]).booleanValue() , ((Number) dynConstraints[27]).shortValue() , ((Number) dynConstraints[28]).shortValue() );
            case 1 :
                  return conditional_H005N3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (String)dynConstraints[8] , (String)dynConstraints[9] , (String)dynConstraints[10] , (String)dynConstraints[11] , (String)dynConstraints[12] , ((Number) dynConstraints[13]).byteValue() , (String)dynConstraints[14] , ((Number) dynConstraints[15]).shortValue() , (String)dynConstraints[16] , (String)dynConstraints[17] , (String)dynConstraints[18] , (String)dynConstraints[19] , (String)dynConstraints[20] , (String)dynConstraints[21] , (String)dynConstraints[22] , (String)dynConstraints[23] , (String)dynConstraints[24] , ((Number) dynConstraints[25]).shortValue() , ((Boolean) dynConstraints[26]).booleanValue() , ((Number) dynConstraints[27]).shortValue() , ((Number) dynConstraints[28]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H005N2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H005N3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
