...
public final  class homeprogressbarwc_impl extends GXWebComponent
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110312745", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV5OptionTitle", wcpOAV5OptionTitle);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV9BarDescription", wcpOAV9BarDescription);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV6Percentage", GXutil.ltrim( localUtil.ntoc( wcpOAV6Percentage, (byte)(2), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vBARDESCRIPTION", AV9BarDescription);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPERCENTAGE", GXutil.ltrim( localUtil.ntoc( AV6Percentage, (byte)(2), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"PROGRESSBAR1_Type", GXutil.rtrim( Progressbar1_Type));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"PROGRESSBAR1_Percentage", GXutil.ltrim( localUtil.ntoc( Progressbar1_Percentage, (byte)(9), (byte)(0), ".", "")));
   }
   ...
   public void wb0I0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.wwpbaseobjects.homeprogressbarwc");
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/DVProgressIndicator/DVProgressIndicatorRender.js", "", false, true);
         }
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divTablemain_Internalname, 1, 0, "px", 0, "px", "TableCardsMenuOptionWCPB", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblDescriptionprogressbar1_Internalname, lblDescriptionprogressbar1_Caption, "", "", lblDescriptionprogressbar1_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "ProgressBarCardsMenuDescription", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects\\HomeProgressBarWC.htm");
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 AttributeCardsMenuTitleCell", "Center", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
         /* Attribute/Variable Label */
         com.projectthani.GxWebStd.gx_label_element( httpContext, edtavOptiontitle_Internalname, "Option Title", "col-sm-3 AttributeCardsMenuTitleLabel", 0, true, "");
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtavOptiontitle_Internalname, AV5OptionTitle, GXutil.rtrim( localUtil.format( AV5OptionTitle, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOptiontitle_Jsonclick, 0, "AttributeCardsMenuTitle", "", "", "", "", 1, edtavOptiontitle_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), false, "", "left", true, "", "HLP_WWPBaseObjects\\HomeProgressBarWC.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV5OptionTitle_PARM", AV5OptionTitle);
      if ( GXutil.len( GXutil.rtrim( sCtrlAV5OptionTitle)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV5OptionTitle_CTRL", GXutil.rtrim( sCtrlAV5OptionTitle));
      }
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV9BarDescription_PARM", AV9BarDescription);
      if ( GXutil.len( GXutil.rtrim( sCtrlAV9BarDescription)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV9BarDescription_CTRL", GXutil.rtrim( sCtrlAV9BarDescription));
      }
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6Percentage_PARM", GXutil.ltrim( localUtil.ntoc( AV6Percentage, (byte)(2), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV6Percentage)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6Percentage_CTRL", GXutil.rtrim( sCtrlAV6Percentage));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110312769", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("wwpbaseobjects/homeprogressbarwc.js", "?20225110312769", false, true);
         httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/Bootstrap/DVProgressIndicator/DVProgressIndicatorRender.js", "", false, true);
      }
