...
public final  class SdtHomeSampleData_HomeSampleDataItem extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("ProductName", GXutil.rtrim( gxTv_SdtHomeSampleData_HomeSampleDataItem_Productname));
   ...
   public com.projectthani.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtHomeSampleData_HomeSampleDataItem struct )
   {
   ...
   public com.projectthani.wwpbaseobjects.StructSdtHomeSampleData_HomeSampleDataItem getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtHomeSampleData_HomeSampleDataItem struct = new com.projectthani.wwpbaseobjects.StructSdtHomeSampleData_HomeSampleDataItem ();
