...
public final  class SdtGoogleDocsResult extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "Docs") )
            {
               ...
               {
                  gxTv_SdtGoogleDocsResult_Docs = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtGoogleDocsResult_Doc>(com.projectthani.wwpbaseobjects.SdtGoogleDocsResult_Doc.class, "GoogleDocsResult.Doc", "DVelop.Extensions.GoogleDocs", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("Success", GXutil.rtrim( GXutil.booltostr( gxTv_SdtGoogleDocsResult_Success)));
      if ( GXutil.strcmp(sNameSpace, "DVelop.Extensions.GoogleDocs") != 0 )
      {
         oWriter.writeAttribute("xmlns", "DVelop.Extensions.GoogleDocs");
      }
      oWriter.writeElement("Error", GXutil.rtrim( gxTv_SdtGoogleDocsResult_Error));
      if ( GXutil.strcmp(sNameSpace, "DVelop.Extensions.GoogleDocs") != 0 )
      {
         oWriter.writeAttribute("xmlns", "DVelop.Extensions.GoogleDocs");
      }
   ...
   public GXBaseCollection<com.projectthani.wwpbaseobjects.SdtGoogleDocsResult_Doc> getgxTv_SdtGoogleDocsResult_Docs( )
   {
      if ( gxTv_SdtGoogleDocsResult_Docs == null )
      {
         gxTv_SdtGoogleDocsResult_Docs = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtGoogleDocsResult_Doc>(com.projectthani.wwpbaseobjects.SdtGoogleDocsResult_Doc.class, "GoogleDocsResult.Doc", "DVelop.Extensions.GoogleDocs", remoteHandle);
   ...
   public void setgxTv_SdtGoogleDocsResult_Docs( GXBaseCollection<com.projectthani.wwpbaseobjects.SdtGoogleDocsResult_Doc> value )
   {
      gxTv_SdtGoogleDocsResult_Docs_N = (byte)(0) ;
      gxTv_SdtGoogleDocsResult_N = (byte)(0) ;
   ...
   public com.projectthani.wwpbaseobjects.SdtGoogleDocsResult Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtGoogleDocsResult)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtGoogleDocsResult struct )
   {
      setgxTv_SdtGoogleDocsResult_Success(struct.getSuccess());
      setgxTv_SdtGoogleDocsResult_Error(struct.getError());
      GXBaseCollection<com.projectthani.wwpbaseobjects.SdtGoogleDocsResult_Doc> gxTv_SdtGoogleDocsResult_Docs_aux = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtGoogleDocsResult_Doc>(com.projectthani.wwpbaseobjects.SdtGoogleDocsResult_Doc.class, "GoogleDocsResult.Doc", "DVelop.Extensions.GoogleDocs", remoteHandle);
      Vector<com.projectthani.wwpbaseobjects.StructSdtGoogleDocsResult_Doc> gxTv_SdtGoogleDocsResult_Docs_aux1 = struct.getDocs();
      if (gxTv_SdtGoogleDocsResult_Docs_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtGoogleDocsResult_Docs_aux1.size(); i++)
         {
            gxTv_SdtGoogleDocsResult_Docs_aux.add(new com.projectthani.wwpbaseobjects.SdtGoogleDocsResult_Doc(gxTv_SdtGoogleDocsResult_Docs_aux1.elementAt(i)));
         }
      }
   ...
   public com.projectthani.wwpbaseobjects.StructSdtGoogleDocsResult getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtGoogleDocsResult struct = new com.projectthani.wwpbaseobjects.StructSdtGoogleDocsResult ();
   ...
   protected GXBaseCollection<com.projectthani.wwpbaseobjects.SdtGoogleDocsResult_Doc> gxTv_SdtGoogleDocsResult_Docs_aux ;
   protected GXBaseCollection<com.projectthani.wwpbaseobjects.SdtGoogleDocsResult_Doc> gxTv_SdtGoogleDocsResult_Docs=null ;
}
