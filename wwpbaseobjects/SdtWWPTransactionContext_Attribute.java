...
public final  class SdtWWPTransactionContext_Attribute extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("AttributeName", GXutil.rtrim( gxTv_SdtWWPTransactionContext_Attribute_Attributename));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
      oWriter.writeElement("AttributeValue", GXutil.rtrim( gxTv_SdtWWPTransactionContext_Attribute_Attributevalue));
      if ( GXutil.strcmp(sNameSpace, "ProjectThani") != 0 )
      {
         oWriter.writeAttribute("xmlns", "ProjectThani");
      }
   ...
   public com.projectthani.wwpbaseobjects.SdtWWPTransactionContext_Attribute Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtWWPTransactionContext_Attribute)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute struct )
   {
   ...
   public com.projectthani.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute struct = new com.projectthani.wwpbaseobjects.StructSdtWWPTransactionContext_Attribute ();
