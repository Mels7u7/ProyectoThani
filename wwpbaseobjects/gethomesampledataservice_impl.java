...
public final  class gethomesampledataservice_impl extends GXWebProcedure
{
   ...
   public void webExecute( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getMethod()), "get") == 0 )
      {
         if ( GXutil.strcmp(GXutil.lower( GXSoapHTTPRequest.getQuerystring()), "wsdl") == 0 )
         {
            ...
            GXSoapXMLWriter.writeAttribute("soapAction", "ProjectThaniaction/"+"wwpbaseobjects.AGETHOMESAMPLEDATASERVICE.Execute");
      ...
      if ( ( GXutil.strSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
      {
         ...
         if ( currSoapErr == 0 )
         {
            if ( Gxm2rootcol != null )
            {
               Gxm2rootcol.writexmlcollection(GXSoapXMLWriter, "ReturnValue", "ProjectThani", "HomeSampleDataItem", "ProjectThani");
            }
         }
         else
         {
   ...
   private void privateExecute( )
   {
      ...
      {
         AV6HomeSampleDataItem = (com.projectthani.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem)((com.projectthani.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem)AV5HomeSampleData.elementAt(-1+AV11GXV1));
