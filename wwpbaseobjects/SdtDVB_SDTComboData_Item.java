...
public final  class SdtDVB_SDTComboData_Item extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "Children") && ( oReader.getNodeType() != 2 ) && ( GXutil.strcmp(oReader.getNamespaceURI(), "") == 0 ) )
            {
               ...
               {
                  gxTv_SdtDVB_SDTComboData_Item_Children = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVB_SDTComboData_Item>(com.projectthani.wwpbaseobjects.SdtDVB_SDTComboData_Item.class, "Item", "", remoteHandle);
               }
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("ID", GXutil.rtrim( gxTv_SdtDVB_SDTComboData_Item_Id));
      if ( GXutil.strcmp(sNameSpace, "") != 0 )
      {
         oWriter.writeAttribute("xmlns", "");
      }
      oWriter.writeElement("Title", GXutil.rtrim( gxTv_SdtDVB_SDTComboData_Item_Title));
      if ( GXutil.strcmp(sNameSpace, "") != 0 )
      {
         oWriter.writeAttribute("xmlns", "");
      }
   ...
   public GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVB_SDTComboData_Item> getgxTv_SdtDVB_SDTComboData_Item_Children( )
   {
      if ( gxTv_SdtDVB_SDTComboData_Item_Children == null )
      {
         gxTv_SdtDVB_SDTComboData_Item_Children = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVB_SDTComboData_Item>(com.projectthani.wwpbaseobjects.SdtDVB_SDTComboData_Item.class, "Item", "", remoteHandle);
   ...
   public void setgxTv_SdtDVB_SDTComboData_Item_Children( GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVB_SDTComboData_Item> value )
   {
      gxTv_SdtDVB_SDTComboData_Item_Children_N = (byte)(0) ;
      gxTv_SdtDVB_SDTComboData_Item_N = (byte)(0) ;
   ...
   public com.projectthani.wwpbaseobjects.SdtDVB_SDTComboData_Item Clone( )
   {
      return (com.projectthani.wwpbaseobjects.SdtDVB_SDTComboData_Item)(clone()) ;
   }

   public void setStruct( com.projectthani.wwpbaseobjects.StructSdtDVB_SDTComboData_Item struct )
   {
      setgxTv_SdtDVB_SDTComboData_Item_Id(struct.getId());
      setgxTv_SdtDVB_SDTComboData_Item_Title(struct.getTitle());
      GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVB_SDTComboData_Item> gxTv_SdtDVB_SDTComboData_Item_Children_aux = new GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVB_SDTComboData_Item>(com.projectthani.wwpbaseobjects.SdtDVB_SDTComboData_Item.class, "Item", "", remoteHandle);
      Vector<com.projectthani.wwpbaseobjects.StructSdtDVB_SDTComboData_Item> gxTv_SdtDVB_SDTComboData_Item_Children_aux1 = struct.getChildren();
      if (gxTv_SdtDVB_SDTComboData_Item_Children_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtDVB_SDTComboData_Item_Children_aux1.size(); i++)
         {
            gxTv_SdtDVB_SDTComboData_Item_Children_aux.add(new com.projectthani.wwpbaseobjects.SdtDVB_SDTComboData_Item(gxTv_SdtDVB_SDTComboData_Item_Children_aux1.elementAt(i)));
         }
      }
   ...
   public com.projectthani.wwpbaseobjects.StructSdtDVB_SDTComboData_Item getStruct( )
   {
      com.projectthani.wwpbaseobjects.StructSdtDVB_SDTComboData_Item struct = new com.projectthani.wwpbaseobjects.StructSdtDVB_SDTComboData_Item ();
   ...
   protected GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVB_SDTComboData_Item> gxTv_SdtDVB_SDTComboData_Item_Children_aux ;
   protected GXBaseCollection<com.projectthani.wwpbaseobjects.SdtDVB_SDTComboData_Item> gxTv_SdtDVB_SDTComboData_Item_Children=null ;
}
