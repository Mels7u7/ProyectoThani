...
public final  class viewreclamo_impl extends GXDataArea
{
   public viewreclamo_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewreclamo_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewreclamo_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "ReclamoId") ;
         ...
         {
            AV12ReclamoId = (int)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV12ReclamoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12ReclamoId), 8, 0));
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vRECLAMOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12ReclamoId), "ZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110331453", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.viewreclamo", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12ReclamoId,8,0)),GXutil.URLEncode(GXutil.rtrim(AV6TabCode))}, new String[] {"ReclamoId","TabCode"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      forbiddenHiddens.add("hshsalt", "hsh"+"ViewReclamo");
      forbiddenHiddens.add("ReclamoFecha", localUtil.format( A275ReclamoFecha, "99/99/99 99:99"));
      ...
      GXutil.writeLogInfo("viewreclamo:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vRECLAMOID", GXutil.ltrim( localUtil.ntoc( AV12ReclamoId, (byte)(8), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vRECLAMOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12ReclamoId), "ZZZZZZZ9")));
   ...
   {
      return formatLink("com.projectthani.viewreclamo", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12ReclamoId,8,0)),GXutil.URLEncode(GXutil.rtrim(AV6TabCode))}, new String[] {"ReclamoId","TabCode"})  ;
   }
   ...
   public void wb1N0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "Reclamo Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, (short)(0), "HLP_ViewReclamo.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 WWActionsCell", "left", "top", "", "", "div");
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Reclamoes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlock", 0, "", lblViewall_Visible, 1, 0, (short)(0), "HLP_ViewReclamo.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.projectthani.GxWebStd.gx_label_element( httpContext, edtReclamoFecha_Internalname, "Fecha", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
         /* Div Control */
         ...
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtReclamoFecha_Internalname, localUtil.ttoc( A275ReclamoFecha, 10, 8, 0, 3, "/", ":", " "), localUtil.format( A275ReclamoFecha, "99/99/99 99:99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtReclamoFecha_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtReclamoFecha_Enabled, 0, "text", "", 14, "chr", 1, "row", 14, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_ViewReclamo.htm");
         com.projectthani.GxWebStd.gx_bitmap( httpContext, edtReclamoFecha_Internalname+"_dp_trigger", context.getHttpContext().getImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.getHttpContext().getTheme( )), "", "", "", "", ((1==0)||(edtReclamoFecha_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ViewReclamo.htm");
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ViewReclamo.htm");
         /* Div Control */
   ...
   public void start1N2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View Reclamo", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf1N2( )
   {
      ...
      {
         /* Using cursor H001N2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV12ReclamoId)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A51ReclamoId = H001N2_A51ReclamoId[0] ;
            A275ReclamoFecha = H001N2_A275ReclamoFecha[0] ;
   ...
   public void strup1N0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV12ReclamoId = (int)(localUtil.ctol( httpContext.cgiGet( "vRECLAMOID"), ",", ".")) ;
         ...
         {
            GXutil.writeLogError("viewreclamo:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e111N2( )
   {
      ...
      AV16GXLvl6 = (byte)(0) ;
      /* Using cursor H001N3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV12ReclamoId)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A51ReclamoId = H001N3_A51ReclamoId[0] ;
         A275ReclamoFecha = H001N3_A275ReclamoFecha[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A275ReclamoFecha", localUtil.ttoc( A275ReclamoFecha, 8, 5, 0, 3, "/", ":", " "));
         AV16GXLvl6 = (byte)(1) ;
         Form.setCaption( localUtil.ttoc( A275ReclamoFecha, 8, 5, 0, 3, "/", ":", " ") );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.projectthani.wwreclamo", new String[] {}, new String[] {})  ;
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV7SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV7SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ReclamoGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.projectthani.reclamogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ReclamoGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0024","",Integer.valueOf(AV12ReclamoId)});
   ...
   {
      AV12ReclamoId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12ReclamoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12ReclamoId), 8, 0));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vRECLAMOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12ReclamoId), "ZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110331477", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewreclamo.js", "?20225110331477", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV12ReclamoId',fld:'vRECLAMOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A275ReclamoFecha',fld:'RECLAMOFECHA',pic:'99/99/99 99:99'}]");
   ...
   public void initialize( )
   {
      ...
      AV15Pgmname = "" ;
      scmdbuf = "" ;
      H001N2_A51ReclamoId = new int[1] ;
      H001N2_A275ReclamoFecha = new java.util.Date[] {GXutil.nullDate()} ;
      hsh = "" ;
      H001N3_A51ReclamoId = new int[1] ;
      H001N3_A275ReclamoFecha = new java.util.Date[] {GXutil.nullDate()} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.viewreclamo__default(),
         new Object[] {
             new Object[] {
            H001N2_A51ReclamoId, H001N2_A275ReclamoFecha
            }
            , new Object[] {
            H001N3_A51ReclamoId, H001N3_A275ReclamoFecha
            }
         }
      );
      AV15Pgmname = "ViewReclamo" ;
   ...
   private int wcpOAV12ReclamoId ;
   private int AV12ReclamoId ;
   ...
   private int[] H001N2_A51ReclamoId ;
   private java.util.Date[] H001N2_A275ReclamoFecha ;
   private int[] H001N3_A51ReclamoId ;
   private java.util.Date[] H001N3_A275ReclamoFecha ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class viewreclamo__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001N2", "SELECT [ReclamoId], [ReclamoFecha] FROM [Reclamo] WHERE [ReclamoId] = ? ORDER BY [ReclamoId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H001N3", "SELECT [ReclamoId], [ReclamoFecha] FROM [Reclamo] WHERE [ReclamoId] = ? ORDER BY [ReclamoId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
