...
public final  class ubigeosedewc_impl extends GXWebComponent
{
   public ubigeosedewc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public ubigeosedewc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( ubigeosedewc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV32IsAuthorized_ClinicaRUC = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_ClinicaRUC")) ;
               sPrefix = httpContext.GetPar( "sPrefix") ;
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8UbigeoCode, AV20ManageFiltersExecutionStep, AV35Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, AV32IsAuthorized_ClinicaRUC, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Ubigeo Sede WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511032547", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.ubigeosedewc", new String[] {GXutil.URLEncode(GXutil.rtrim(AV8UbigeoCode))}, new String[] {"UbigeoCode"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_CLINICARUC", getSecureSignedToken( sPrefix, AV32IsAuthorized_ClinicaRUC));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( sPrefix, AV29IsAuthorized_Delete));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_CLINICARUC", AV32IsAuthorized_ClinicaRUC);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_CLINICARUC", getSecureSignedToken( sPrefix, AV32IsAuthorized_ClinicaRUC));
      if ( httpContext.isAjaxRequest( ) )
      {
   ...
   public void wb4K0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.ubigeosedewc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_4K2( true) ;
      }
      else
      {
         wb_table1_22_4K2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_4K2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtUbigeoCode_Internalname, GXutil.rtrim( A44UbigeoCode), GXutil.rtrim( localUtil.format( A44UbigeoCode, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtUbigeoCode_Jsonclick, 0, "Attribute", "", "", "", "", edtUbigeoCode_Visible, 0, 0, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_UbigeoSedeWC.htm");
         /* User Defined Control */
   ...
   public void start4K2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Ubigeo Sede WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 boolean AV32IsAuthorized_ClinicaRUC ,
                                 String sPrefix )
   {
      initialize_formulas( ) ;
      com.projectthani.GxWebStd.set_html_headers( httpContext, 0, "", "");
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_SEDEID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A30SedeId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"SEDEID", GXutil.ltrim( localUtil.ntoc( A30SedeId, (byte)(4), (byte)(0), ".", "")));
   }
   ...
   public void rf4K2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              A44UbigeoCode } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING,
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.STRING
                                              }
         });
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H004K2 */
         pr_default.execute(0, new Object[] {AV8UbigeoCode, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A44UbigeoCode = H004K2_A44UbigeoCode[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A44UbigeoCode", A44UbigeoCode);
            A280SedeSector = H004K2_A280SedeSector[0] ;
            A279SedeTipo = H004K2_A279SedeTipo[0] ;
            A278SedeEstado = H004K2_A278SedeEstado[0] ;
            A277SedeCorreo = H004K2_A277SedeCorreo[0] ;
            A276SedeDireccion = H004K2_A276SedeDireccion[0] ;
            A116ClinicaNombreComercial = H004K2_A116ClinicaNombreComercial[0] ;
            A118ClinicaRUC = H004K2_A118ClinicaRUC[0] ;
            A28ClinicaId = H004K2_A28ClinicaId[0] ;
            A75SedeNombre = H004K2_A75SedeNombre[0] ;
            A30SedeId = H004K2_A30SedeId[0] ;
            A116ClinicaNombreComercial = H004K2_A116ClinicaNombreComercial[0] ;
            A118ClinicaRUC = H004K2_A118ClinicaRUC[0] ;
            e184K2 ();
   ...
   public void send_integrity_lvl_hashes4K2( )
   {
      ...
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_CLINICARUC", AV32IsAuthorized_ClinicaRUC);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_CLINICARUC", getSecureSignedToken( sPrefix, AV32IsAuthorized_ClinicaRUC));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_SEDEID"+"_"+sGXsfl_37_idx, getSecureSignedToken( sPrefix+sGXsfl_37_idx, localUtil.format( DecimalUtil.doubleToDec(A30SedeId), "ZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H004K3 */
      pr_default.execute(1, new Object[] {AV8UbigeoCode, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void e164K2( )
   {
      ...
      S112 ();
      if (returnInSub) return;
      GXt_boolean1 = AV32IsAuthorized_ClinicaRUC ;
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWClinica", GXv_boolean2) ;
      ubigeosedewc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV32IsAuthorized_ClinicaRUC = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV32IsAuthorized_ClinicaRUC", AV32IsAuthorized_ClinicaRUC);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_CLINICARUC", getSecureSignedToken( sPrefix, AV32IsAuthorized_ClinicaRUC));
   ...
   private void e184K2( )
   {
      ...
      if ( AV32IsAuthorized_ClinicaRUC )
      {
   ...
   public void e114K2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("UbigeoSedeWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV35Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("UbigeoSedeWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "UbigeoSedeWCFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         ubigeosedewc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "UbigeoSedeWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "Sede" );
   ...
   public void wb_table1_22_4K2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_4K2( true) ;
      }
      else
      {
         wb_table2_27_4K2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_4K2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_4K2e( true) ;
      }
      else
      {
         wb_table1_22_4K2e( false) ;
      }
   }

   public void wb_table2_27_4K2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "ubigeosedewc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110325617", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("ubigeosedewc.js", "?20225110325617", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtSedeId_Internalname = sPrefix+"SEDEID_"+sGXsfl_37_idx ;
      edtSedeNombre_Internalname = sPrefix+"SEDENOMBRE_"+sGXsfl_37_idx ;
      edtClinicaId_Internalname = sPrefix+"CLINICAID_"+sGXsfl_37_idx ;
      edtClinicaRUC_Internalname = sPrefix+"CLINICARUC_"+sGXsfl_37_idx ;
      edtClinicaNombreComercial_Internalname = sPrefix+"CLINICANOMBRECOMERCIAL_"+sGXsfl_37_idx ;
      edtSedeDireccion_Internalname = sPrefix+"SEDEDIRECCION_"+sGXsfl_37_idx ;
      edtSedeCorreo_Internalname = sPrefix+"SEDECORREO_"+sGXsfl_37_idx ;
      cmbSedeEstado.setInternalname( sPrefix+"SEDEESTADO_"+sGXsfl_37_idx );
      cmbSedeTipo.setInternalname( sPrefix+"SEDETIPO_"+sGXsfl_37_idx );
      cmbSedeSector.setInternalname( sPrefix+"SEDESECTOR_"+sGXsfl_37_idx );
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtSedeId_Internalname = sPrefix+"SEDEID_"+sGXsfl_37_fel_idx ;
      edtSedeNombre_Internalname = sPrefix+"SEDENOMBRE_"+sGXsfl_37_fel_idx ;
      edtClinicaId_Internalname = sPrefix+"CLINICAID_"+sGXsfl_37_fel_idx ;
      edtClinicaRUC_Internalname = sPrefix+"CLINICARUC_"+sGXsfl_37_fel_idx ;
      edtClinicaNombreComercial_Internalname = sPrefix+"CLINICANOMBRECOMERCIAL_"+sGXsfl_37_fel_idx ;
      edtSedeDireccion_Internalname = sPrefix+"SEDEDIRECCION_"+sGXsfl_37_fel_idx ;
      edtSedeCorreo_Internalname = sPrefix+"SEDECORREO_"+sGXsfl_37_fel_idx ;
      cmbSedeEstado.setInternalname( sPrefix+"SEDEESTADO_"+sGXsfl_37_fel_idx );
      cmbSedeTipo.setInternalname( sPrefix+"SEDETIPO_"+sGXsfl_37_fel_idx );
      cmbSedeSector.setInternalname( sPrefix+"SEDESECTOR_"+sGXsfl_37_fel_idx );
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSedeId_Internalname,GXutil.ltrim( localUtil.ntoc( A30SedeId, (byte)(4), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A30SedeId), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSedeId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id4","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtClinicaId_Internalname,GXutil.ltrim( localUtil.ntoc( A28ClinicaId, (byte)(4), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A28ClinicaId), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtClinicaId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id4","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSedeDireccion_Internalname,A276SedeDireccion,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSedeDireccion_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSedeCorreo_Internalname,A277SedeCorreo,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","mailto:"+A277SedeCorreo,"","","",edtSedeCorreo_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"email","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"GeneXus\\Email","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         {
            GXCCtl = "SEDEESTADO_" + sGXsfl_37_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbSedeEstado.getInternalname(), "Values", cmbSedeEstado.ToJavascriptSource(), !bGXsfl_37_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         {
            GXCCtl = "SEDETIPO_" + sGXsfl_37_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbSedeTipo.getInternalname(), "Values", cmbSedeTipo.ToJavascriptSource(), !bGXsfl_37_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         {
            GXCCtl = "SEDESECTOR_" + sGXsfl_37_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbSedeSector.getInternalname(), "Values", cmbSedeSector.ToJavascriptSource(), !bGXsfl_37_Refreshing);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:SedeId|3:SedeNombre|4:ClinicaId|5:ClinicaRUC|6:ClinicaNombreComercial|7:SedeDireccion|8:SedeCorreo|9:SedeEstado|10:SedeTipo|11:SedeSector" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e184K2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A30SedeId',fld:'SEDEID',pic:'ZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_ClinicaRUC',fld:'vISAUTHORIZED_CLINICARUC',pic:'',hsh:true},{av:'A28ClinicaId',fld:'CLINICAID',pic:'ZZZ9'}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV26Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV28Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtSedeNombre_Link',ctrl:'SEDENOMBRE',prop:'Link'},{av:'edtClinicaRUC_Link',ctrl:'CLINICARUC',prop:'Link'}]}");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e154K2',iparms:[{av:'A30SedeId',fld:'SEDEID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H004K2_A44UbigeoCode = new String[] {""} ;
      H004K2_A280SedeSector = new String[] {""} ;
      H004K2_A279SedeTipo = new String[] {""} ;
      H004K2_A278SedeEstado = new String[] {""} ;
      H004K2_A277SedeCorreo = new String[] {""} ;
      H004K2_A276SedeDireccion = new String[] {""} ;
      H004K2_A116ClinicaNombreComercial = new String[] {""} ;
      H004K2_A118ClinicaRUC = new long[1] ;
      H004K2_A28ClinicaId = new short[1] ;
      H004K2_A75SedeNombre = new String[] {""} ;
      H004K2_A30SedeId = new short[1] ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.ubigeosedewc__default(),
         new Object[] {
             new Object[] {
            H004K2_A44UbigeoCode, H004K2_A280SedeSector, H004K2_A279SedeTipo, H004K2_A278SedeEstado, H004K2_A277SedeCorreo, H004K2_A276SedeDireccion, H004K2_A116ClinicaNombreComercial, H004K2_A118ClinicaRUC, H004K2_A28ClinicaId, H004K2_A75SedeNombre,
            H004K2_A30SedeId
            }
            , new Object[] {
   ...
   private boolean AV32IsAuthorized_ClinicaRUC ;
   ...
   private String[] H004K2_A44UbigeoCode ;
   private String[] H004K2_A280SedeSector ;
   private String[] H004K2_A279SedeTipo ;
   private String[] H004K2_A278SedeEstado ;
   private String[] H004K2_A277SedeCorreo ;
   private String[] H004K2_A276SedeDireccion ;
   private String[] H004K2_A116ClinicaNombreComercial ;
   private long[] H004K2_A118ClinicaRUC ;
   private short[] H004K2_A28ClinicaId ;
   private String[] H004K2_A75SedeNombre ;
   private short[] H004K2_A30SedeId ;
...
final  class ubigeosedewc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          String A44UbigeoCode )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[UbigeoCode], T1.[SedeSector], T1.[SedeTipo], T1.[SedeEstado], T1.[SedeCorreo], T1.[SedeDireccion], T2.[ClinicaNombreComercial], T2.[ClinicaRUC], T1.[ClinicaId]," ;
      sSelectString += " T1.[SedeNombre], T1.[SedeId]" ;
      sFromString = " FROM ([Sede] T1 INNER JOIN [Clinica] T2 ON T2.[ClinicaId] = T1.[ClinicaId])" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(T1.[UbigeoCode] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST(T1.[SedeId] AS decimal(4,0))) like '%' + ?) or ( T1.[SedeNombre] like '%' + ?) or ( CONVERT( char(4), CAST(T1.[ClinicaId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T2.[ClinicaRUC] AS decimal(11,0))) like '%' + ?) or ( T2.[ClinicaNombreComercial] like '%' + ?) or ( T1.[SedeDireccion] like '%' + ?) or ( T1.[SedeCorreo] like '%' + ?) or ( 'activo' like '%' + LOWER(?) and T1.[SedeEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and T1.[SedeEstado] = 'I') or ( 'seleccione' like '%' + LOWER(?) and (T1.[SedeTipo] = '')) or ( 'hospital' like '%' + LOWER(?) and T1.[SedeTipo] = 'H') or ( 'clínica' like '%' + LOWER(?) and T1.[SedeTipo] = 'C') or ( 'policlínico' like '%' + LOWER(?) and T1.[SedeTipo] = 'P') or ( 'independiente' like '%' + LOWER(?) and T1.[SedeTipo] = 'I') or ( 'seleccione' like '%' + LOWER(?) and (T1.[SedeSector] = '')) or ( 'publico' like '%' + LOWER(?) and T1.[SedeSector] = 'P') or ( 'privado' like '%' + LOWER(?) and T1.[SedeSector] = 'V'))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[SedeNombre]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[SedeNombre] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[SedeId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[SedeId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[ClinicaId]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[ClinicaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T2.[ClinicaRUC]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T2.[ClinicaRUC] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T2.[ClinicaNombreComercial]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T2.[ClinicaNombreComercial] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[SedeDireccion]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[SedeDireccion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[SedeCorreo]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[SedeCorreo] DESC" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[SedeEstado]" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[SedeEstado] DESC" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[SedeTipo]" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[SedeTipo] DESC" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode], T1.[SedeSector]" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[UbigeoCode] DESC, T1.[SedeSector] DESC" ;
      }
      else if ( true )
      {
                                          ...
                                          String A44UbigeoCode )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([Sede] T1 INNER JOIN [Clinica] T2 ON T2.[ClinicaId] = T1.[ClinicaId])" ;
      addWhere(sWhereString, "(T1.[UbigeoCode] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST(T1.[SedeId] AS decimal(4,0))) like '%' + ?) or ( T1.[SedeNombre] like '%' + ?) or ( CONVERT( char(4), CAST(T1.[ClinicaId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(11), CAST(T2.[ClinicaRUC] AS decimal(11,0))) like '%' + ?) or ( T2.[ClinicaNombreComercial] like '%' + ?) or ( T1.[SedeDireccion] like '%' + ?) or ( T1.[SedeCorreo] like '%' + ?) or ( 'activo' like '%' + LOWER(?) and T1.[SedeEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and T1.[SedeEstado] = 'I') or ( 'seleccione' like '%' + LOWER(?) and (T1.[SedeTipo] = '')) or ( 'hospital' like '%' + LOWER(?) and T1.[SedeTipo] = 'H') or ( 'clínica' like '%' + LOWER(?) and T1.[SedeTipo] = 'C') or ( 'policlínico' like '%' + LOWER(?) and T1.[SedeTipo] = 'P') or ( 'independiente' like '%' + LOWER(?) and T1.[SedeTipo] = 'I') or ( 'seleccione' like '%' + LOWER(?) and (T1.[SedeSector] = '')) or ( 'publico' like '%' + LOWER(?) and T1.[SedeSector] = 'P') or ( 'privado' like '%' + LOWER(?) and T1.[SedeSector] = 'V'))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H004K2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).longValue() , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (String)dynConstraints[8] , (String)dynConstraints[9] , (String)dynConstraints[10] , ((Number) dynConstraints[11]).shortValue() , ((Boolean) dynConstraints[12]).booleanValue() , (String)dynConstraints[13] , (String)dynConstraints[14] );
            case 1 :
                  return conditional_H004K3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).longValue() , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (String)dynConstraints[8] , (String)dynConstraints[9] , (String)dynConstraints[10] , ((Number) dynConstraints[11]).shortValue() , ((Boolean) dynConstraints[12]).booleanValue() , (String)dynConstraints[13] , (String)dynConstraints[14] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H004K2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H004K3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
