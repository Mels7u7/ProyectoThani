...
@javax.xml.bind.annotation.XmlType(name = "encuestaloaddvcombo_RESTInterfaceIN", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class encuestaloaddvcombo_RESTInterfaceIN
{
   ...
   @JsonProperty("EncuestaId")
   public short getEncuestaId( )
   {
      return AV25EncuestaId ;
   }

   @JsonProperty("EncuestaId")
   public void setEncuestaId(  short Value )
   {
      AV25EncuestaId= Value;
   }
