...
public final  class formafarmaceuticapetitoriowc_impl extends GXWebComponent
{
   public formafarmaceuticapetitoriowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public formafarmaceuticapetitoriowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( formafarmaceuticapetitoriowc_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = httpContext.GetFirstPar( "FormaFarmaceuticaId") ;
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8FormaFarmaceuticaId = (short)(GXutil.lval( httpContext.GetPar( "FormaFarmaceuticaId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8FormaFarmaceuticaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8FormaFarmaceuticaId), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(AV8FormaFarmaceuticaId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8FormaFarmaceuticaId, AV20ManageFiltersExecutionStep, AV33Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Forma Farmaceutica Petitorio WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110325758", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.formafarmaceuticapetitoriowc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8FormaFarmaceuticaId,4,0))}, new String[] {"FormaFarmaceuticaId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8FormaFarmaceuticaId", GXutil.ltrim( localUtil.ntoc( wcpOAV8FormaFarmaceuticaId, (byte)(4), (byte)(0), ",", "")));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vFORMAFARMACEUTICAID", GXutil.ltrim( localUtil.ntoc( AV8FormaFarmaceuticaId, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return "FormaFarmaceuticaPetitorioWC" ;
   }
   ...
   public void wb580( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.formafarmaceuticapetitoriowc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void wb_table1_22_582e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start582( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Forma Farmaceutica Petitorio WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV33Pgmname = "FormaFarmaceuticaPetitorioWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf582( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Short.valueOf(AV8FormaFarmaceuticaId) ,
                                              Short.valueOf(A39FormaFarmaceuticaId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.DECIMAL,
         ...
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            ...
            A264PetitorioPrecio = H00582_A264PetitorioPrecio[0] ;
            A261PetitorioPresentacion = H00582_A261PetitorioPresentacion[0] ;
            A260PetitorioConcentracion = H00582_A260PetitorioConcentracion[0] ;
            A48PetitorioSubCategId = H00582_A48PetitorioSubCategId[0] ;
            A49PetitorioCategId = H00582_A49PetitorioCategId[0] ;
            A263PetitorioProducto = H00582_A263PetitorioProducto[0] ;
            A262PetitorioPrincipioActivo = H00582_A262PetitorioPrincipioActivo[0] ;
            A36DrogueriaId = H00582_A36DrogueriaId[0] ;
            A25PetitorioId = H00582_A25PetitorioId[0] ;
            A49PetitorioCategId = H00582_A49PetitorioCategId[0] ;
            e18582 ();
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H00583 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8FormaFarmaceuticaId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void strup580( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8FormaFarmaceuticaId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8FormaFarmaceuticaId"), ",", ".")) ;
   ...
   public void e16582( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtFormaFarmaceuticaId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtFormaFarmaceuticaId_Visible), 5, 0), true);
   ...
   public void e11582( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("FormaFarmaceuticaPetitorioWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV33Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("FormaFarmaceuticaPetitorioWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "FormaFarmaceuticaPetitorioWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         formafarmaceuticapetitoriowc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      formafarmaceuticapetitoriowc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "FormaFarmaceuticaPetitorioWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "FormaFarmaceuticaId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8FormaFarmaceuticaId, 4, 0) );
   ...
   public void wb_table1_22_582( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void wb_table2_27_582e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table2_27_582( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8FormaFarmaceuticaId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8FormaFarmaceuticaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8FormaFarmaceuticaId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8FormaFarmaceuticaId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "formafarmaceuticapetitoriowc", GetJustCreated( ));
      ...
      {
         AV8FormaFarmaceuticaId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8FormaFarmaceuticaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8FormaFarmaceuticaId), 4, 0));
      }
      wcpOAV8FormaFarmaceuticaId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8FormaFarmaceuticaId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV8FormaFarmaceuticaId != wcpOAV8FormaFarmaceuticaId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8FormaFarmaceuticaId = AV8FormaFarmaceuticaId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8FormaFarmaceuticaId = httpContext.cgiGet( sPrefix+"AV8FormaFarmaceuticaId_CTRL") ;
      if ( GXutil.len( sCtrlAV8FormaFarmaceuticaId) > 0 )
      {
         AV8FormaFarmaceuticaId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV8FormaFarmaceuticaId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8FormaFarmaceuticaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8FormaFarmaceuticaId), 4, 0));
      }
      else
      {
         AV8FormaFarmaceuticaId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8FormaFarmaceuticaId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8FormaFarmaceuticaId_PARM", GXutil.ltrim( localUtil.ntoc( AV8FormaFarmaceuticaId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8FormaFarmaceuticaId)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8FormaFarmaceuticaId_CTRL", GXutil.rtrim( sCtrlAV8FormaFarmaceuticaId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110325951", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("formafarmaceuticapetitoriowc.js", "?20225110325952", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:PetitorioId|3:DrogueriaId|4:PetitorioPrincipioActivo|5:PetitorioProducto|6:PetitorioCategId|7:PetitorioSubCategId|8:PetitorioConcentracion|9:PetitorioPresentacion|10:PetitorioPrecio" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e18582',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A25PetitorioId',fld:'PETITORIOID',pic:'ZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e15582',iparms:[{av:'A25PetitorioId',fld:'PETITORIOID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H00582_A39FormaFarmaceuticaId = new short[1] ;
      H00582_A264PetitorioPrecio = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00582_A261PetitorioPresentacion = new String[] {""} ;
      H00582_A260PetitorioConcentracion = new String[] {""} ;
      H00582_A48PetitorioSubCategId = new short[1] ;
      H00582_A49PetitorioCategId = new short[1] ;
      H00582_A263PetitorioProducto = new String[] {""} ;
      H00582_A262PetitorioPrincipioActivo = new String[] {""} ;
      H00582_A36DrogueriaId = new short[1] ;
      H00582_A25PetitorioId = new short[1] ;
      ...
      sCtrlAV8FormaFarmaceuticaId = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.formafarmaceuticapetitoriowc__default(),
         new Object[] {
             new Object[] {
            H00582_A39FormaFarmaceuticaId, H00582_A264PetitorioPrecio, H00582_A261PetitorioPresentacion, H00582_A260PetitorioConcentracion, H00582_A48PetitorioSubCategId, H00582_A49PetitorioCategId, H00582_A263PetitorioProducto, H00582_A262PetitorioPrincipioActivo, H00582_A36DrogueriaId, H00582_A25PetitorioId
            }
            , new Object[] {
   ...
   private short wcpOAV8FormaFarmaceuticaId ;
   private short AV8FormaFarmaceuticaId ;
   ...
   private String sCtrlAV8FormaFarmaceuticaId ;
   ...
   private short[] H00582_A39FormaFarmaceuticaId ;
   private java.math.BigDecimal[] H00582_A264PetitorioPrecio ;
   private String[] H00582_A261PetitorioPresentacion ;
   private String[] H00582_A260PetitorioConcentracion ;
   private short[] H00582_A48PetitorioSubCategId ;
   private short[] H00582_A49PetitorioCategId ;
   private String[] H00582_A263PetitorioProducto ;
   private String[] H00582_A262PetitorioPrincipioActivo ;
   private short[] H00582_A36DrogueriaId ;
   private short[] H00582_A25PetitorioId ;
...
final  class formafarmaceuticapetitoriowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00582( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          short A39FormaFarmaceuticaId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[FormaFarmaceuticaId], T1.[PetitorioPrecio], T1.[PetitorioPresentacion], T1.[PetitorioConcentracion], T1.[PetitorioSubCategId], T2.[PetitorioCategId], T1.[PetitorioProducto]," ;
      ...
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST(T1.[PetitorioId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(4), CAST(T1.[DrogueriaId] AS decimal(4,0))) like '%' + ?) or ( T1.[PetitorioPrincipioActivo] like '%' + ?) or ( T1.[PetitorioProducto] like '%' + ?) or ( CONVERT( char(4), CAST(T2.[PetitorioCategId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(4), CAST(T1.[PetitorioSubCategId] AS decimal(4,0))) like '%' + ?) or ( T1.[PetitorioConcentracion] like '%' + ?) or ( T1.[PetitorioPresentacion] like '%' + ?) or ( CONVERT( char(7), CAST(T1.[PetitorioPrecio] AS decimal(7,2))) like '%' + ?))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId], T1.[PetitorioPrincipioActivo]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId] DESC, T1.[PetitorioPrincipioActivo] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId], T1.[PetitorioId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId] DESC, T1.[PetitorioId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId], T1.[DrogueriaId]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId] DESC, T1.[DrogueriaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId], T1.[PetitorioProducto]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId] DESC, T1.[PetitorioProducto] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId], T2.[PetitorioCategId]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId] DESC, T2.[PetitorioCategId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId], T1.[PetitorioSubCategId]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId] DESC, T1.[PetitorioSubCategId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId], T1.[PetitorioConcentracion]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId] DESC, T1.[PetitorioConcentracion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId], T1.[PetitorioPresentacion]" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId] DESC, T1.[PetitorioPresentacion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId], T1.[PetitorioPrecio]" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[FormaFarmaceuticaId] DESC, T1.[PetitorioPrecio] DESC" ;
      }
      else if ( true )
      {
   ...
   protected Object[] conditional_H00583( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          short A25PetitorioId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00582(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).shortValue() , (String)dynConstraints[7] , (String)dynConstraints[8] , (java.math.BigDecimal)dynConstraints[9] , ((Number) dynConstraints[10]).shortValue() , ((Boolean) dynConstraints[11]).booleanValue() , ((Number) dynConstraints[12]).shortValue() , ((Number) dynConstraints[13]).shortValue() );
            case 1 :
                  return conditional_H00583(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Number) dynConstraints[6]).shortValue() , (String)dynConstraints[7] , (String)dynConstraints[8] , (java.math.BigDecimal)dynConstraints[9] , ((Number) dynConstraints[10]).shortValue() , ((Boolean) dynConstraints[11]).booleanValue() , ((Number) dynConstraints[12]).shortValue() , ((Number) dynConstraints[13]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00582", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00583", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
