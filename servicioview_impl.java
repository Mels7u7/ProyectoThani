...
public final  class servicioview_impl extends GXDataArea
{
   public servicioview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public servicioview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( servicioview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10ServicioId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10ServicioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10ServicioId), 4, 0));
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSERVICIOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10ServicioId), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110335032", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.servicioview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10ServicioId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"ServicioId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vSERVICIOID", GXutil.ltrim( localUtil.ntoc( AV10ServicioId, (byte)(4), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSERVICIOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10ServicioId), "ZZZ9")));
   ...
   {
      return formatLink("com.projectthani.servicioview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10ServicioId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"ServicioId","TabCode"})  ;
   }
   ...
   public void wb4G0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, "Ir a Servicio", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_ServicioView.htm");
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divServiciogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblCitaservicio_title_Internalname, "Cita Servicio", "", "", lblCitaservicio_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ServicioView.htm");
         /* Div Control */
         ...
         {
            /* WebComponent */
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "W0033"+"", GXutil.rtrim( WebComp_Citaserviciowc_Component));
            httpContext.writeText( "<div") ;
            com.projectthani.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
   ...
   public void start4G2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Servicio View", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldCitaserviciowc = httpContext.cgiGet( "W0033") ;
                        ...
                        if ( GXutil.len( WebComp_Citaserviciowc_Component) != 0 )
                        {
                           WebComp_Citaserviciowc.componentprocess("W0033", "", sEvt);
                        }
                        WebComp_Citaserviciowc_Component = OldCitaserviciowc ;
                     }
                  }
   ...
   public void strup4G0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV10ServicioId = (short)(localUtil.ctol( httpContext.cgiGet( "vSERVICIOID"), ",", ".")) ;
   ...
   public void e114G2( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.projectthani.servicioww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H004G2 */
      pr_default.execute(0, new Object[] {Short.valueOf(AV10ServicioId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A27ServicioId = H004G2_A27ServicioId[0] ;
         A281ServicioNombre = H004G2_A281ServicioNombre[0] ;
         AV16GXLvl9 = (byte)(1) ;
         Form.setCaption( A281ServicioNombre );
   ...
   public void S112( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( WebComp_Webcomponent_general_Component), GXutil.lower( "ServicioGeneral")) != 0 )
      {
         WebComp_Webcomponent_general = WebUtils.getWebComponent(getClass(), "com.projectthani.serviciogeneral_impl", remoteHandle, context);
         WebComp_Webcomponent_general_Component = "ServicioGeneral" ;
      }
      if ( GXutil.len( WebComp_Webcomponent_general_Component) != 0 )
      {
         WebComp_Webcomponent_general.setjustcreated();
         WebComp_Webcomponent_general.componentprepare(new Object[] {"W0019","",Short.valueOf(AV10ServicioId)});
   ...
   public void S122( )
   {
      /* 'LOADTABS' Routine */
      returnInSub = false ;
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV12SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV12SelectedTabCode, "CitaServicio") == 0 ) )
      {
         /* Object Property */
         if ( true )
         {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Citaserviciowc_Component), GXutil.lower( "ServicioCitaServicioWC")) != 0 )
         {
            WebComp_Citaserviciowc = WebUtils.getWebComponent(getClass(), "com.projectthani.serviciocitaserviciowc_impl", remoteHandle, context);
            WebComp_Citaserviciowc_Component = "ServicioCitaServicioWC" ;
         }
         if ( GXutil.len( WebComp_Citaserviciowc_Component) != 0 )
         {
            WebComp_Citaserviciowc.setjustcreated();
            WebComp_Citaserviciowc.componentprepare(new Object[] {"W0033","",Short.valueOf(AV10ServicioId)});
   ...
   {
      AV10ServicioId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10ServicioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10ServicioId), 4, 0));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vSERVICIOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10ServicioId), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110335055", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("servicioview.js", "?20225110335056", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   public void init_default_properties( )
   {
      ...
      divServiciogeneral_cell_Internalname = "SERVICIOGENERAL_CELL" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10ServicioId',fld:'vSERVICIOID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H004G2_A27ServicioId = new short[1] ;
      H004G2_A281ServicioNombre = new String[] {""} ;
      A281ServicioNombre = "" ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.servicioview__default(),
         new Object[] {
             new Object[] {
            H004G2_A27ServicioId, H004G2_A281ServicioNombre
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short wcpOAV10ServicioId ;
   private short nRcdExists_3 ;
   private short nIsMod_3 ;
   private short AV10ServicioId ;
   private short wbEnd ;
   ...
   private String divServiciogeneral_cell_Internalname ;
   ...
   private short[] H004G2_A27ServicioId ;
   private String[] H004G2_A281ServicioNombre ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class servicioview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H004G2", "SELECT [ServicioId], [ServicioNombre] FROM [Servicio] WHERE [ServicioId] = ? ORDER BY [ServicioId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
