...
public final  class prcbienvenidapaciente extends GXProcedure
{
   public prcbienvenidapaciente( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( prcbienvenidapaciente.class ), "" );
   }
   ...
   {
      prcbienvenidapaciente.this.AV16PacienteId = aP0;
      initialize();
      /* GeneXus formulas */
   ...
   private void privateExecute( )
   {
      ...
      prcbienvenidapaciente.this.GXt_char1 = GXv_char2[0] ;
      ...
      if ( ! (GXutil.strcmp("", AV15PacienteCorreo)==0) && ( AV16PacienteId > 0 ) )
      {
         ...
         GXv_char2[0] = GXt_char1 ;
         new com.projectthani.prcgettemplatecontent(remoteHandle, context).execute( "CorreoDeBienvenidaPaciente", GXv_char2) ;
         prcbienvenidapaciente.this.GXt_char1 = GXv_char2[0] ;
   ...
   public void initialize( )
   {
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.prcbienvenidapaciente__default(),
         new Object[] {
         }
      );
      /* GeneXus formulas. */
...
final  class prcbienvenidapaciente__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
