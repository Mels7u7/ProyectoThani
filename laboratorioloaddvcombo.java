...
public final  class laboratorioloaddvcombo extends GXProcedure
{
   public laboratorioloaddvcombo( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( laboratorioloaddvcombo.class ), "" );
   }
   ...
   public String executeUdp( String aP0 ,
                             ...
                             String[] aP6 )
   {
      laboratorioloaddvcombo.this.aP7 = new String[] {""};
   ...
   private void execute_int( String aP0 ,
                             ...
                             String[] aP7 )
   {
      laboratorioloaddvcombo.this.AV17ComboName = aP0;
      laboratorioloaddvcombo.this.AV19TrnMode = aP1;
      laboratorioloaddvcombo.this.AV21IsDynamicCall = aP2;
      laboratorioloaddvcombo.this.AV24LaboratorioId = aP3;
      laboratorioloaddvcombo.this.AV12SearchTxt = aP4;
      laboratorioloaddvcombo.this.aP5 = aP5;
      laboratorioloaddvcombo.this.aP6 = aP6;
      laboratorioloaddvcombo.this.aP7 = aP7;
      initialize();
      /* GeneXus formulas */
   ...
   private void privateExecute( )
   {
      ...
      laboratorioloaddvcombo.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      if ( AV21IsDynamicCall )
      {
         if ( GXutil.strcmp(AV19TrnMode, "GET_DSC") == 0 )
         {
            ...
            while ( AV31GXV1 <= AV26ValuesCollection.size() )
            {
               ...
               {
                  A6SecUserId = P00352_A6SecUserId[0] ;
                  A14SecUserName = P00352_A14SecUserName[0] ;
                  AV32GXLvl32 = (byte)(1) ;
         ...
         else
         {
            ...
            {
               A14SecUserName = P00353_A14SecUserName[0] ;
               A6SecUserId = P00353_A6SecUserId[0] ;
   ...
   {
      this.aP5[0] = laboratorioloaddvcombo.this.AV16SelectedValue;
      this.aP6[0] = laboratorioloaddvcombo.this.AV22SelectedText;
      this.aP7[0] = laboratorioloaddvcombo.this.AV13Combo_DataJson;
      CloseOpenCursors();
      exitApp();
   }
   ...
   public void initialize( )
   {
      ...
      AV27ValueItem = "" ;
      scmdbuf = "" ;
      P00352_A6SecUserId = new short[1] ;
      P00352_A14SecUserName = new String[] {""} ;
      lV12SearchTxt = "" ;
      P00353_A14SecUserName = new String[] {""} ;
      P00353_A6SecUserId = new short[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.laboratorioloaddvcombo__default(),
         new Object[] {
             new Object[] {
            P00352_A6SecUserId, P00352_A14SecUserName
            }
            , new Object[] {
            P00353_A14SecUserName, P00353_A6SecUserId
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private short[] P00352_A6SecUserId ;
   private String[] P00352_A14SecUserName ;
   private String[] P00353_A14SecUserName ;
   private short[] P00353_A6SecUserId ;
...
final  class laboratorioloaddvcombo__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_P00353( ModelContext context ,
                                          int remoteHandle ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 1 :
                  return conditional_P00353(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P00352", "SELECT TOP 1 [SecUserId], [SecUserName] FROM [SecUser] WHERE [SecUserId] = ? ORDER BY [SecUserId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("P00353", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100, GxCacheFrequency.OFF,false )
      };
   }
