...
public final  class laboratorioserviciocategwc_impl extends GXWebComponent
{
   public laboratorioserviciocategwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public laboratorioserviciocategwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( laboratorioserviciocategwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8LaboratorioId = (short)(GXutil.lval( httpContext.GetPar( "LaboratorioId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8LaboratorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8LaboratorioId), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(AV8LaboratorioId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8LaboratorioId, AV20ManageFiltersExecutionStep, AV34Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV28IsAuthorized_Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Laboratorio Servicio Categ WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511033642", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.laboratorioserviciocategwc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8LaboratorioId,4,0))}, new String[] {"LaboratorioId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8LaboratorioId", GXutil.ltrim( localUtil.ntoc( wcpOAV8LaboratorioId, (byte)(4), (byte)(0), ",", "")));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vLABORATORIOID", GXutil.ltrim( localUtil.ntoc( AV8LaboratorioId, (byte)(4), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm3M2( )
   {
   ...
   {
      return "LaboratorioServicioCategWC" ;
   }

   public String getPgmdesc( )
   {
      return "Laboratorio Servicio Categ WC" ;
   }
   ...
   public void wb3M0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.laboratorioserviciocategwc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void wb_table1_22_3M2e( boolean wbgen )
   {
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtLaboratorioId_Internalname, GXutil.ltrim( localUtil.ntoc( A40LaboratorioId, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A40LaboratorioId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLaboratorioId_Jsonclick, 0, "Attribute", "", "", "", "", edtLaboratorioId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id4", "right", false, "", "HLP_LaboratorioServicioCategWC.htm");
         /* User Defined Control */
   ...
   public void start3M2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Laboratorio Servicio Categ WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop(sPrefix, false, edtServicioCategImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A289ServicioCategImagen)==0) ? A40000ServicioCategImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A289ServicioCategImagen))), !bGXsfl_37_Refreshing);
                           httpContext.ajax_rsp_assign_prop(sPrefix, false, edtServicioCategImagen_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A289ServicioCategImagen), true);
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_SERVICIOCATEGID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A52ServicioCategId), "ZZZ9")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"SERVICIOCATEGID", GXutil.ltrim( localUtil.ntoc( A52ServicioCategId, (byte)(4), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV34Pgmname = "LaboratorioServicioCategWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf3M2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Short.valueOf(AV8LaboratorioId) ,
                                              Short.valueOf(A40LaboratorioId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT
                                              }
         });
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H003M2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8LaboratorioId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A40LaboratorioId = H003M2_A40LaboratorioId[0] ;
            ...
            A290ServicioCategEstado = H003M2_A290ServicioCategEstado[0] ;
            A289ServicioCategImagen = H003M2_A289ServicioCategImagen[0] ;
            n289ServicioCategImagen = H003M2_n289ServicioCategImagen[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtServicioCategImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A289ServicioCategImagen)==0) ? A40000ServicioCategImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A289ServicioCategImagen))), !bGXsfl_37_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtServicioCategImagen_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A289ServicioCategImagen), true);
            A40000ServicioCategImagen_GXI = H003M2_A40000ServicioCategImagen_GXI[0] ;
            n40000ServicioCategImagen_GXI = H003M2_n40000ServicioCategImagen_GXI[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtServicioCategImagen_Internalname, "Bitmap", ((GXutil.strcmp("", A289ServicioCategImagen)==0) ? A40000ServicioCategImagen_GXI : httpContext.convertURL( httpContext.getResourceRelative(A289ServicioCategImagen))), !bGXsfl_37_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtServicioCategImagen_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A289ServicioCategImagen), true);
            A288ServicioCategDescripcion = H003M2_A288ServicioCategDescripcion[0] ;
            n288ServicioCategDescripcion = H003M2_n288ServicioCategDescripcion[0] ;
            A287ServicioCategNombre = H003M2_A287ServicioCategNombre[0] ;
            A52ServicioCategId = H003M2_A52ServicioCategId[0] ;
            e183M2 ();
   ...
   public void send_integrity_lvl_hashes3M2( )
   {
      ...
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_DELETE", AV28IsAuthorized_Delete);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( sPrefix, AV28IsAuthorized_Delete));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_SERVICIOCATEGID"+"_"+sGXsfl_37_idx, getSecureSignedToken( sPrefix+sGXsfl_37_idx, localUtil.format( DecimalUtil.doubleToDec(A52ServicioCategId), "ZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H003M3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8LaboratorioId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
      GRID_nRecordCount = H003M3_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void strup3M0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8LaboratorioId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8LaboratorioId"), ",", ".")) ;
   ...
   public void e163M2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtLaboratorioId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtLaboratorioId_Visible), 5, 0), true);
   ...
   public void e113M2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("LaboratorioServicioCategWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV34Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("LaboratorioServicioCategWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "LaboratorioServicioCategWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         laboratorioserviciocategwc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      laboratorioserviciocategwc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "LaboratorioServicioCategWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "ServicioCateg" );
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "LaboratorioId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8LaboratorioId, 4, 0) );
   ...
   {
      AV8LaboratorioId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8LaboratorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8LaboratorioId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8LaboratorioId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "laboratorioserviciocategwc", GetJustCreated( ));
      ...
      {
         AV8LaboratorioId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8LaboratorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8LaboratorioId), 4, 0));
      }
      wcpOAV8LaboratorioId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8LaboratorioId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV8LaboratorioId != wcpOAV8LaboratorioId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8LaboratorioId = AV8LaboratorioId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8LaboratorioId = httpContext.cgiGet( sPrefix+"AV8LaboratorioId_CTRL") ;
      if ( GXutil.len( sCtrlAV8LaboratorioId) > 0 )
      {
         AV8LaboratorioId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV8LaboratorioId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8LaboratorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8LaboratorioId), 4, 0));
      }
      else
      {
         AV8LaboratorioId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8LaboratorioId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8LaboratorioId_PARM", GXutil.ltrim( localUtil.ntoc( AV8LaboratorioId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8LaboratorioId)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8LaboratorioId_CTRL", GXutil.rtrim( sCtrlAV8LaboratorioId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511033837", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("laboratorioserviciocategwc.js", "?2022511033837", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtServicioCategId_Internalname = sPrefix+"SERVICIOCATEGID_"+sGXsfl_37_idx ;
      edtServicioCategNombre_Internalname = sPrefix+"SERVICIOCATEGNOMBRE_"+sGXsfl_37_idx ;
      edtServicioCategDescripcion_Internalname = sPrefix+"SERVICIOCATEGDESCRIPCION_"+sGXsfl_37_idx ;
      edtServicioCategImagen_Internalname = sPrefix+"SERVICIOCATEGIMAGEN_"+sGXsfl_37_idx ;
      cmbServicioCategEstado.setInternalname( sPrefix+"SERVICIOCATEGESTADO_"+sGXsfl_37_idx );
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtServicioCategId_Internalname = sPrefix+"SERVICIOCATEGID_"+sGXsfl_37_fel_idx ;
      edtServicioCategNombre_Internalname = sPrefix+"SERVICIOCATEGNOMBRE_"+sGXsfl_37_fel_idx ;
      edtServicioCategDescripcion_Internalname = sPrefix+"SERVICIOCATEGDESCRIPCION_"+sGXsfl_37_fel_idx ;
      edtServicioCategImagen_Internalname = sPrefix+"SERVICIOCATEGIMAGEN_"+sGXsfl_37_fel_idx ;
      cmbServicioCategEstado.setInternalname( sPrefix+"SERVICIOCATEGESTADO_"+sGXsfl_37_fel_idx );
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtServicioCategDescripcion_Internalname,A288ServicioCategDescripcion,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtServicioCategDescripcion_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(500),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         {
            GXCCtl = "SERVICIOCATEGESTADO_" + sGXsfl_37_idx ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbServicioCategEstado.getInternalname(), "Values", cmbServicioCategEstado.ToJavascriptSource(), !bGXsfl_37_Refreshing);
   ...
   public void init_default_properties( )
   {
      ...
      edtServicioCategImagen_Internalname = sPrefix+"SERVICIOCATEGIMAGEN" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:ServicioCategId|3:ServicioCategNombre|4:ServicioCategDescripcion|6:ServicioCategEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e183M2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A52ServicioCategId',fld:'SERVICIOCATEGID',pic:'ZZZ9',hsh:true},{av:'AV28IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'AV30Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV31Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtServicioCategNombre_Link',ctrl:'SERVICIOCATEGNOMBRE',prop:'Link'}]}");
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e113M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8LaboratorioId',fld:'vLABORATORIOID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV34Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV28IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e153M2',iparms:[{av:'A52ServicioCategId',fld:'SERVICIOCATEGID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H003M2_A40LaboratorioId = new short[1] ;
      H003M2_A290ServicioCategEstado = new String[] {""} ;
      H003M2_A289ServicioCategImagen = new String[] {""} ;
      H003M2_n289ServicioCategImagen = new boolean[] {false} ;
      H003M2_A40000ServicioCategImagen_GXI = new String[] {""} ;
      H003M2_n40000ServicioCategImagen_GXI = new boolean[] {false} ;
      H003M2_A288ServicioCategDescripcion = new String[] {""} ;
      H003M2_n288ServicioCategDescripcion = new boolean[] {false} ;
      H003M2_A287ServicioCategNombre = new String[] {""} ;
      H003M2_A52ServicioCategId = new short[1] ;
      H003M3_AGRID_nRecordCount = new long[1] ;
      ...
      sCtrlAV8LaboratorioId = "" ;
      ROClassString = "" ;
      sImgUrl = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.laboratorioserviciocategwc__default(),
         new Object[] {
             new Object[] {
            H003M2_A40LaboratorioId, H003M2_A290ServicioCategEstado, H003M2_A289ServicioCategImagen, H003M2_n289ServicioCategImagen, H003M2_A40000ServicioCategImagen_GXI, H003M2_n40000ServicioCategImagen_GXI, H003M2_A288ServicioCategDescripcion, H003M2_n288ServicioCategDescripcion, H003M2_A287ServicioCategNombre, H003M2_A52ServicioCategId
            }
            , new Object[] {
            H003M3_AGRID_nRecordCount
            }
         }
      );
      AV34Pgmname = "LaboratorioServicioCategWC" ;
   ...
   private short wcpOAV8LaboratorioId ;
   private short AV8LaboratorioId ;
   ...
   private String sCtrlAV8LaboratorioId ;
   ...
   private short[] H003M2_A40LaboratorioId ;
   private String[] H003M2_A290ServicioCategEstado ;
   private String[] H003M2_A289ServicioCategImagen ;
   private boolean[] H003M2_n289ServicioCategImagen ;
   private String[] H003M2_A40000ServicioCategImagen_GXI ;
   private boolean[] H003M2_n40000ServicioCategImagen_GXI ;
   private String[] H003M2_A288ServicioCategDescripcion ;
   private boolean[] H003M2_n288ServicioCategDescripcion ;
   private String[] H003M2_A287ServicioCategNombre ;
   private short[] H003M2_A52ServicioCategId ;
   private long[] H003M3_AGRID_nRecordCount ;
...
final  class laboratorioserviciocategwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H003M2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          short A40LaboratorioId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [LaboratorioId], [ServicioCategEstado], [ServicioCategImagen], [ServicioCategImagen_GXI], [ServicioCategDescripcion], [ServicioCategNombre], [ServicioCategId]" ;
      sFromString = " FROM [ServicioCateg]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([LaboratorioId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([ServicioCategId] AS decimal(4,0))) like '%' + ?) or ( [ServicioCategNombre] like '%' + ?) or ( [ServicioCategDescripcion] like '%' + ?) or ( 'activo' like '%' + LOWER(?) and [ServicioCategEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and [ServicioCategEstado] = 'I'))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [LaboratorioId], [ServicioCategNombre]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [LaboratorioId] DESC, [ServicioCategNombre] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [LaboratorioId], [ServicioCategId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [LaboratorioId] DESC, [ServicioCategId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [LaboratorioId], [ServicioCategDescripcion]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [LaboratorioId] DESC, [ServicioCategDescripcion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [LaboratorioId], [ServicioCategEstado]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [LaboratorioId] DESC, [ServicioCategEstado] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [ServicioCategId]" ;
      }
   ...
   protected Object[] conditional_H003M3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          short A52ServicioCategId ,
                                          ...
                                          short A40LaboratorioId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [ServicioCateg]" ;
      addWhere(sWhereString, "([LaboratorioId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(4), CAST([ServicioCategId] AS decimal(4,0))) like '%' + ?) or ( [ServicioCategNombre] like '%' + ?) or ( [ServicioCategDescripcion] like '%' + ?) or ( 'activo' like '%' + LOWER(?) and [ServicioCategEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and [ServicioCategEstado] = 'I'))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H003M2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() , ((Number) dynConstraints[7]).shortValue() , ((Number) dynConstraints[8]).shortValue() );
            case 1 :
                  return conditional_H003M3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , ((Boolean) dynConstraints[6]).booleanValue() , ((Number) dynConstraints[7]).shortValue() , ((Number) dynConstraints[8]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H003M2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H003M3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
