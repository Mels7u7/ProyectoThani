...
public final  class StructSdtQueryViewerElements_Element_ExpandCollapse implements Cloneable, java.io.Serializable
{
   public StructSdtQueryViewerElements_Element_ExpandCollapse( )
   {
      this( -1, new ModelContext( StructSdtQueryViewerElements_Element_ExpandCollapse.class ));
   }

   public StructSdtQueryViewerElements_Element_ExpandCollapse( int remoteHandle ,
   ...
   protected java.util.Vector gxTv_SdtQueryViewerElements_Element_ExpandCollapse_Values=null ;
}
