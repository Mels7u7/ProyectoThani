...
public final  class SdtTransactionContext extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "Attributes") )
            {
               ...
               {
                  gxTv_SdtTransactionContext_Attributes = new GXBaseCollection<com.projectthani.SdtTransactionContext_Attribute>(com.projectthani.SdtTransactionContext_Attribute.class, "TransactionContext.Attribute", "ProjectThani", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
   ...
   public GXBaseCollection<com.projectthani.SdtTransactionContext_Attribute> getgxTv_SdtTransactionContext_Attributes( )
   {
      if ( gxTv_SdtTransactionContext_Attributes == null )
      {
         gxTv_SdtTransactionContext_Attributes = new GXBaseCollection<com.projectthani.SdtTransactionContext_Attribute>(com.projectthani.SdtTransactionContext_Attribute.class, "TransactionContext.Attribute", "ProjectThani", remoteHandle);
   ...
   public void setgxTv_SdtTransactionContext_Attributes( GXBaseCollection<com.projectthani.SdtTransactionContext_Attribute> value )
   {
      gxTv_SdtTransactionContext_Attributes_N = (byte)(0) ;
      gxTv_SdtTransactionContext_N = (byte)(0) ;
   ...
   public com.projectthani.SdtTransactionContext Clone( )
   {
      return (com.projectthani.SdtTransactionContext)(clone()) ;
   }

   public void setStruct( com.projectthani.StructSdtTransactionContext struct )
   {
      ...
      GXBaseCollection<com.projectthani.SdtTransactionContext_Attribute> gxTv_SdtTransactionContext_Attributes_aux = new GXBaseCollection<com.projectthani.SdtTransactionContext_Attribute>(com.projectthani.SdtTransactionContext_Attribute.class, "TransactionContext.Attribute", "ProjectThani", remoteHandle);
      Vector<com.projectthani.StructSdtTransactionContext_Attribute> gxTv_SdtTransactionContext_Attributes_aux1 = struct.getAttributes();
      if (gxTv_SdtTransactionContext_Attributes_aux1 != null)
      {
         for (int i = 0; i < gxTv_SdtTransactionContext_Attributes_aux1.size(); i++)
         {
            gxTv_SdtTransactionContext_Attributes_aux.add(new com.projectthani.SdtTransactionContext_Attribute(gxTv_SdtTransactionContext_Attributes_aux1.elementAt(i)));
         }
      }
   ...
   public com.projectthani.StructSdtTransactionContext getStruct( )
   {
      com.projectthani.StructSdtTransactionContext struct = new com.projectthani.StructSdtTransactionContext ();
   ...
   protected GXBaseCollection<com.projectthani.SdtTransactionContext_Attribute> gxTv_SdtTransactionContext_Attributes_aux ;
   protected GXBaseCollection<com.projectthani.SdtTransactionContext_Attribute> gxTv_SdtTransactionContext_Attributes=null ;
}
