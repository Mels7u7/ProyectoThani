...
public final  class wptestcalendar_impl extends GXDataArea
{
   public wptestcalendar_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wptestcalendar_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wptestcalendar_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2022511034982", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.wptestcalendar", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.projectthani.wptestcalendar", new String[] {}, new String[] {})  ;
   }

   public String getPgmname( )
   {
      return "WPTestCalendar" ;
   }

   public String getPgmdesc( )
   {
      return "WPTest Calendar" ;
   }
   ...
   public void start712( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "WPTest Calendar", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void send_integrity_lvl_hashes712( )
   {
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2022511034988", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wptestcalendar.js", "?2022511034988", false, true);
      httpContext.AddJavascriptSource("GXScheduler/dhtmlxscheduler.js", "", false, true);
      httpContext.AddJavascriptSource("GXScheduler/GXSchedulerRender.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "WPTest Calendar" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GXSCHEDULER1.EVENTSELECTED","{handler:'e11712',iparms:[{av:'AV5currentEvent',fld:'vCURRENTEVENT',pic:''}]");
