...
public final  class pacienteratingplataformawc_impl extends GXWebComponent
{
   public pacienteratingplataformawc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public pacienteratingplataformawc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( pacienteratingplataformawc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Paciente Rating Plataforma WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110321972", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   public void renderHtmlCloseForm7I2( )
   {
   ...
   {
      return "PacienteRatingPlataformaWC" ;
   }
   ...
   public void wb7I0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.pacienteratingplataformawc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void wb_table1_22_7I2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A398RatingPlataformaId, (byte)(8), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A405RatingPlataformaCitaId, (byte)(4), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.format(A406RatingPlataformaFechaRegistro, "99/99/99"));
            GridContainer.AddColumnProperties(GridColumn);
   ...
   public void start7I2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Paciente Rating Plataforma WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           GXCCtl = "RATINGPLATAFORMARATING_Enabled_" + sGXsfl_37_idx ;
                           Ratingplataformarating_Enabled = GXutil.strtobool( httpContext.cgiGet( sPrefix+GXCCtl)) ;
                           httpContext.ajax_rsp_assign_prop(sPrefix, false, Ratingplataformarating_Internalname, "Enabled", GXutil.booltostr( Ratingplataformarating_Enabled), true);
                           ...
                           A406RatingPlataformaFechaRegistro = GXutil.resetTime(localUtil.ctot( httpContext.cgiGet( edtRatingPlataformaFechaRegistro_Internalname), 0)) ;
                           GXCCtl = "RATINGPLATAFORMARATING_" + sGXsfl_37_idx ;
                           A401RatingPlataformaRating = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+GXCCtl), ",", ".")) ;
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
   ...
   {
      /* GeneXus formulas. */
      AV33Pgmname = "PacienteRatingPlataformaWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf7I2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV16FilterFullText ,
                                              Integer.valueOf(A398RatingPlataformaId) ,
                                              Short.valueOf(A405RatingPlataformaCitaId) ,
                                              Short.valueOf(A401RatingPlataformaRating) ,
                                              Short.valueOf(AV14OrderedBy) ,
                                              Boolean.valueOf(AV15OrderedDsc) ,
                                              Integer.valueOf(AV8SGPacientePacienteId) ,
                                              Integer.valueOf(A61SGPacientePacienteId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.INT
                                              }
         });
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H007I2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV8SGPacientePacienteId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A61SGPacientePacienteId = H007I2_A61SGPacientePacienteId[0] ;
            ...
            A401RatingPlataformaRating = H007I2_A401RatingPlataformaRating[0] ;
            A406RatingPlataformaFechaRegistro = H007I2_A406RatingPlataformaFechaRegistro[0] ;
            A405RatingPlataformaCitaId = H007I2_A405RatingPlataformaCitaId[0] ;
            A398RatingPlataformaId = H007I2_A398RatingPlataformaId[0] ;
            e187I2 ();
   ...
   public void send_integrity_lvl_hashes7I2( )
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV33Pgmname));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV33Pgmname, ""))));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_UPDATE", AV27IsAuthorized_Update);
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H007I3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV8SGPacientePacienteId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
      GRID_nRecordCount = H007I3_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void e117I2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("PacienteRatingPlataformaWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV33Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("PacienteRatingPlataformaWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "PacienteRatingPlataformaWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         pacienteratingplataformawc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      pacienteratingplataformawc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "PacienteRatingPlataformaWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void wb_table1_22_7I2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_7I2( true) ;
      }
      else
      {
         wb_table2_27_7I2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_7I2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table2_27_7I2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "pacienteratingplataformawc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110322150", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("pacienteratingplataformawc.js", "?20225110322150", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtRatingPlataformaId_Internalname = sPrefix+"RATINGPLATAFORMAID_"+sGXsfl_37_idx ;
      edtRatingPlataformaCitaId_Internalname = sPrefix+"RATINGPLATAFORMACITAID_"+sGXsfl_37_idx ;
      Ratingplataformarating_Internalname = sPrefix+"RATINGPLATAFORMARATING_"+sGXsfl_37_idx ;
      edtRatingPlataformaFechaRegistro_Internalname = sPrefix+"RATINGPLATAFORMAFECHAREGISTRO_"+sGXsfl_37_idx ;
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtRatingPlataformaId_Internalname = sPrefix+"RATINGPLATAFORMAID_"+sGXsfl_37_fel_idx ;
      edtRatingPlataformaCitaId_Internalname = sPrefix+"RATINGPLATAFORMACITAID_"+sGXsfl_37_fel_idx ;
      Ratingplataformarating_Internalname = sPrefix+"RATINGPLATAFORMARATING_"+sGXsfl_37_fel_idx ;
      edtRatingPlataformaFechaRegistro_Internalname = sPrefix+"RATINGPLATAFORMAFECHAREGISTRO_"+sGXsfl_37_fel_idx ;
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRatingPlataformaId_Internalname,GXutil.ltrim( localUtil.ntoc( A398RatingPlataformaId, (byte)(8), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A398RatingPlataformaId), "ZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRatingPlataformaId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRatingPlataformaCitaId_Internalname,GXutil.ltrim( localUtil.ntoc( A405RatingPlataformaCitaId, (byte)(4), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A405RatingPlataformaCitaId), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRatingPlataformaCitaId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td>") ;
         ...
         /* User Defined Control */
         GridRow.AddColumnProperties("usercontrol", -1, isAjaxCallMode( ), new Object[] {sPrefix+"RATINGPLATAFORMARATINGContainer"+"_"+sGXsfl_37_idx,Integer.valueOf(1)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRatingPlataformaFechaRegistro_Internalname,localUtil.format(A406RatingPlataformaFechaRegistro, "99/99/99"),localUtil.format( A406RatingPlataformaFechaRegistro, "99/99/99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRatingPlataformaFechaRegistro_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         send_integrity_lvl_hashes7I2( ) ;
         GXCCtl = "RATINGPLATAFORMARATING_" + sGXsfl_37_idx ;
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+GXCCtl, GXutil.ltrim( localUtil.ntoc( A401RatingPlataformaRating, (byte)(4), (byte)(0), ",", "")));
         GXCCtl = "RATINGPLATAFORMARATING_Enabled_" + sGXsfl_37_idx ;
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+GXCCtl, GXutil.booltostr( Ratingplataformarating_Enabled));
   ...
   public void init_default_properties( )
   {
      ...
      edtRatingPlataformaId_Internalname = sPrefix+"RATINGPLATAFORMAID" ;
      edtRatingPlataformaCitaId_Internalname = sPrefix+"RATINGPLATAFORMACITAID" ;
      Ratingplataformarating_Internalname = sPrefix+"RATINGPLATAFORMARATING" ;
      edtRatingPlataformaFechaRegistro_Internalname = sPrefix+"RATINGPLATAFORMAFECHAREGISTRO" ;
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:RatingPlataformaId|3:RatingPlataformaCitaId|4:RatingPlataformaRating|5:RatingPlataformaFechaRegistro" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e187I2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A20PacienteId',fld:'PACIENTEID',pic:'ZZZZZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e157I2',iparms:[{av:'A20PacienteId',fld:'PACIENTEID',pic:'ZZZZZZZ9',hsh:true}]");
      setEventMetadata("'DOINSERT'",",oparms:[]}");
      setEventMetadata("NULL","{handler:'valid_Ratingplataformafecharegistro',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H007I2_A61SGPacientePacienteId = new int[1] ;
      H007I2_A401RatingPlataformaRating = new short[1] ;
      H007I2_A406RatingPlataformaFechaRegistro = new java.util.Date[] {GXutil.nullDate()} ;
      H007I2_A405RatingPlataformaCitaId = new short[1] ;
      H007I2_A398RatingPlataformaId = new int[1] ;
      H007I3_AGRID_nRecordCount = new long[1] ;
      ...
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.pacienteratingplataformawc__default(),
         new Object[] {
             new Object[] {
            H007I2_A61SGPacientePacienteId, H007I2_A401RatingPlataformaRating, H007I2_A406RatingPlataformaFechaRegistro, H007I2_A405RatingPlataformaCitaId, H007I2_A398RatingPlataformaId
            }
            , new Object[] {
            H007I3_AGRID_nRecordCount
            }
         }
      );
      AV33Pgmname = "PacienteRatingPlataformaWC" ;
   ...
   private int[] H007I2_A61SGPacientePacienteId ;
   private short[] H007I2_A401RatingPlataformaRating ;
   private java.util.Date[] H007I2_A406RatingPlataformaFechaRegistro ;
   private short[] H007I2_A405RatingPlataformaCitaId ;
   private int[] H007I2_A398RatingPlataformaId ;
   private long[] H007I3_AGRID_nRecordCount ;
...
final  class pacienteratingplataformawc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H007I2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A398RatingPlataformaId ,
                                          short A405RatingPlataformaCitaId ,
                                          short A401RatingPlataformaRating ,
                                          short AV14OrderedBy ,
                                          boolean AV15OrderedDsc ,
                                          int AV8SGPacientePacienteId ,
                                          int A61SGPacientePacienteId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [SGPacientePacienteId], [RatingPlataformaRating], [RatingPlataformaFechaRegistro], [RatingPlataformaCitaId], [RatingPlataformaId]" ;
      sFromString = " FROM [RatingPlataforma]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([SGPacientePacienteId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([RatingPlataformaId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(4), CAST([RatingPlataformaCitaId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(4), CAST([RatingPlataformaRating] AS decimal(4,0))) like '%' + ?))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [RatingPlataformaCitaId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [RatingPlataformaCitaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [RatingPlataformaId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [RatingPlataformaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [RatingPlataformaRating]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [RatingPlataformaRating] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId], [RatingPlataformaFechaRegistro]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [SGPacientePacienteId] DESC, [RatingPlataformaFechaRegistro] DESC" ;
      }
      else if ( true )
      {
         sOrderString += " ORDER BY [RatingPlataformaId]" ;
      }
   ...
   protected Object[] conditional_H007I3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A398RatingPlataformaId ,
                                          ...
                                          int A61SGPacientePacienteId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM [RatingPlataforma]" ;
      addWhere(sWhereString, "([SGPacientePacienteId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([RatingPlataformaId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(4), CAST([RatingPlataformaCitaId] AS decimal(4,0))) like '%' + ?) or ( CONVERT( char(4), CAST([RatingPlataformaRating] AS decimal(4,0))) like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H007I2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).shortValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).intValue() );
            case 1 :
                  return conditional_H007I3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).shortValue() , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).intValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H007I2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H007I3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
