...
public final  class petitoriocitarecetawc_impl extends GXWebComponent
{
   public petitoriocitarecetawc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public petitoriocitarecetawc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( petitoriocitarecetawc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8PetitorioId = (short)(GXutil.lval( httpContext.GetPar( "PetitorioId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PetitorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PetitorioId), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(AV8PetitorioId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8PetitorioId, AV20ManageFiltersExecutionStep, AV34Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV28IsAuthorized_Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Petitorio Cita Receta WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110323383", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.petitoriocitarecetawc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8PetitorioId,4,0))}, new String[] {"PetitorioId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8PetitorioId", GXutil.ltrim( localUtil.ntoc( wcpOAV8PetitorioId, (byte)(4), (byte)(0), ",", "")));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPETITORIOID", GXutil.ltrim( localUtil.ntoc( AV8PetitorioId, (byte)(4), (byte)(0), ",", "")));
   ...
   public void wb3Q0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.petitoriocitarecetawc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_3Q2( true) ;
      }
      else
      {
         wb_table1_22_3Q2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_3Q2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtPetitorioId_Internalname, GXutil.ltrim( localUtil.ntoc( A25PetitorioId, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A25PetitorioId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPetitorioId_Jsonclick, 0, "Attribute", "", "", "", "", edtPetitorioId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id4", "right", false, "", "HLP_PetitorioCitaRecetaWC.htm");
         /* User Defined Control */
   ...
   public void start3Q2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Petitorio Cita Receta WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV34Pgmname = "PetitorioCitaRecetaWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf3Q2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Short.valueOf(AV8PetitorioId) ,
                                              Short.valueOf(A25PetitorioId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.INT, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT
                                              }
         });
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H003Q2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8PetitorioId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A25PetitorioId = H003Q2_A25PetitorioId[0] ;
            ...
            A112CitaRecetaFecha = H003Q2_A112CitaRecetaFecha[0] ;
            A111CitaRecetaEstado = H003Q2_A111CitaRecetaEstado[0] ;
            A110CitaRecetaIndicaciones = H003Q2_A110CitaRecetaIndicaciones[0] ;
            A113CitaRecetaCantidad = H003Q2_A113CitaRecetaCantidad[0] ;
            A19CitaId = H003Q2_A19CitaId[0] ;
            A24CitaRecetaId = H003Q2_A24CitaRecetaId[0] ;
            e183Q2 ();
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H003Q3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8PetitorioId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void strup3Q0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8PetitorioId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8PetitorioId"), ",", ".")) ;
   ...
   public void e163Q2( )
   {
      ...
      edtPetitorioId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtPetitorioId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtPetitorioId_Visible), 5, 0), true);
   ...
   public void e113Q2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("PetitorioCitaRecetaWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV34Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("PetitorioCitaRecetaWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "PetitorioCitaRecetaWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         petitoriocitarecetawc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void S152( )
   {
      ...
      petitoriocitarecetawc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "PetitorioCitaRecetaWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "PetitorioId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8PetitorioId, 4, 0) );
   ...
   public void wb_table1_22_3Q2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_3Q2( true) ;
      }
      else
      {
         wb_table2_27_3Q2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_3Q2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_3Q2e( true) ;
      }
      else
      {
         wb_table1_22_3Q2e( false) ;
      }
   }

   public void wb_table2_27_3Q2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8PetitorioId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PetitorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PetitorioId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8PetitorioId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "petitoriocitarecetawc", GetJustCreated( ));
      ...
      {
         AV8PetitorioId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PetitorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PetitorioId), 4, 0));
      }
      wcpOAV8PetitorioId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8PetitorioId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV8PetitorioId != wcpOAV8PetitorioId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8PetitorioId = AV8PetitorioId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8PetitorioId = httpContext.cgiGet( sPrefix+"AV8PetitorioId_CTRL") ;
      if ( GXutil.len( sCtrlAV8PetitorioId) > 0 )
      {
         AV8PetitorioId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV8PetitorioId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PetitorioId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PetitorioId), 4, 0));
      }
      else
      {
         AV8PetitorioId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8PetitorioId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8PetitorioId_PARM", GXutil.ltrim( localUtil.ntoc( AV8PetitorioId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8PetitorioId)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8PetitorioId_CTRL", GXutil.rtrim( sCtrlAV8PetitorioId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110323581", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("petitoriocitarecetawc.js", "?20225110323581", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:CitaRecetaId|3:CitaId|4:CitaRecetaCantidad|5:CitaRecetaIndicaciones|6:CitaRecetaEstado|7:CitaRecetaFecha" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e183Q2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A24CitaRecetaId',fld:'CITARECETAID',pic:'ZZZZZZZ9'},{av:'AV28IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e153Q2',iparms:[{av:'A24CitaRecetaId',fld:'CITARECETAID',pic:'ZZZZZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H003Q2_A25PetitorioId = new short[1] ;
      H003Q2_A112CitaRecetaFecha = new java.util.Date[] {GXutil.nullDate()} ;
      H003Q2_A111CitaRecetaEstado = new String[] {""} ;
      H003Q2_A110CitaRecetaIndicaciones = new String[] {""} ;
      H003Q2_A113CitaRecetaCantidad = new short[1] ;
      H003Q2_A19CitaId = new int[1] ;
      H003Q2_A24CitaRecetaId = new int[1] ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.petitoriocitarecetawc__default(),
         new Object[] {
             new Object[] {
            H003Q2_A25PetitorioId, H003Q2_A112CitaRecetaFecha, H003Q2_A111CitaRecetaEstado, H003Q2_A110CitaRecetaIndicaciones, H003Q2_A113CitaRecetaCantidad, H003Q2_A19CitaId, H003Q2_A24CitaRecetaId
            }
            , new Object[] {
   ...
   private short wcpOAV8PetitorioId ;
   private short AV8PetitorioId ;
   ...
   private String sCtrlAV8PetitorioId ;
   ...
   private short[] H003Q2_A25PetitorioId ;
   private java.util.Date[] H003Q2_A112CitaRecetaFecha ;
   private String[] H003Q2_A111CitaRecetaEstado ;
   private String[] H003Q2_A110CitaRecetaIndicaciones ;
   private short[] H003Q2_A113CitaRecetaCantidad ;
   private int[] H003Q2_A19CitaId ;
   private int[] H003Q2_A24CitaRecetaId ;
...
final  class petitoriocitarecetawc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H003Q2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          short A25PetitorioId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [PetitorioId], [CitaRecetaFecha], [CitaRecetaEstado], [CitaRecetaIndicaciones], [CitaRecetaCantidad], [CitaId], [CitaRecetaId]" ;
      sFromString = " FROM [CitaReceta]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([PetitorioId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([CitaRecetaId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(8), CAST([CitaId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(4), CAST([CitaRecetaCantidad] AS decimal(4,0))) like '%' + ?) or ( [CitaRecetaIndicaciones] like '%' + ?) or ( 'activo' like '%' + LOWER(?) and [CitaRecetaEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and [CitaRecetaEstado] = 'I'))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [PetitorioId], [CitaRecetaCantidad]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioId] DESC, [CitaRecetaCantidad] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [PetitorioId], [CitaRecetaId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioId] DESC, [CitaRecetaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [PetitorioId], [CitaId]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioId] DESC, [CitaId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [PetitorioId], [CitaRecetaIndicaciones]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioId] DESC, [CitaRecetaIndicaciones] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [PetitorioId], [CitaRecetaEstado]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioId] DESC, [CitaRecetaEstado] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [PetitorioId], [CitaRecetaFecha]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [PetitorioId] DESC, [CitaRecetaFecha] DESC" ;
      }
      else if ( true )
      {
   ...
   protected Object[] conditional_H003Q3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A24CitaRecetaId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H003Q2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() , ((Number) dynConstraints[8]).shortValue() , ((Number) dynConstraints[9]).shortValue() );
            case 1 :
                  return conditional_H003Q3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , ((Number) dynConstraints[3]).shortValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).shortValue() , ((Boolean) dynConstraints[7]).booleanValue() , ((Number) dynConstraints[8]).shortValue() , ((Number) dynConstraints[9]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H003Q2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H003Q3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
