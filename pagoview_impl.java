...
public final  class pagoview_impl extends GXDataArea
{
   public pagoview_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public pagoview_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( pagoview_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV10PagoId = (int)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10PagoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10PagoId), 8, 0));
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAGOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PagoId), "ZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110332371", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.pagoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PagoId,8,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PagoId","TabCode"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "vPAGOID", GXutil.ltrim( localUtil.ntoc( AV10PagoId, (byte)(8), (byte)(0), ",", "")));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAGOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PagoId), "ZZZZZZZ9")));
   ...
   {
      return formatLink("com.projectthani.pagoview", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV10PagoId,8,0)),GXutil.URLEncode(GXutil.rtrim(AV8TabCode))}, new String[] {"PagoId","TabCode"})  ;
   }
   ...
   public void wb250( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.projectthani.GxWebStd.gx_label_ctrl( httpContext, lblWorkwithlink_Internalname, "Ir a Pago", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, (short)(0), "HLP_PagoView.htm");
         ...
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, divPagogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
   ...
   public void start252( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Pago View", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void e11252( )
   {
      ...
      lblWorkwithlink_Link = formatLink("com.projectthani.pagoww", new String[] {}, new String[] {})  ;
      httpContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
      AV16GXLvl9 = (byte)(0) ;
      /* Using cursor H00252 */
      pr_default.execute(0, new Object[] {Integer.valueOf(AV10PagoId)});
      while ( (pr_default.getStatus(0) != 101) )
      {
         A47PagoId = H00252_A47PagoId[0] ;
         A242PagoMonto = H00252_A242PagoMonto[0] ;
         AV16GXLvl9 = (byte)(1) ;
         Form.setCaption( GXutil.str( A242PagoMonto, 6, 2) );
   ...
   public void S112( )
   {
      ...
      if ( GXutil.strcmp(GXutil.lower( WebComp_Webcomponent_general_Component), GXutil.lower( "PagoGeneral")) != 0 )
      {
         WebComp_Webcomponent_general = WebUtils.getWebComponent(getClass(), "com.projectthani.pagogeneral_impl", remoteHandle, context);
         WebComp_Webcomponent_general_Component = "PagoGeneral" ;
      }
      if ( GXutil.len( WebComp_Webcomponent_general_Component) != 0 )
      {
         WebComp_Webcomponent_general.setjustcreated();
         WebComp_Webcomponent_general.componentprepare(new Object[] {"W0019","",Integer.valueOf(AV10PagoId)});
   ...
   {
      AV10PagoId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10PagoId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV10PagoId), 8, 0));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPAGOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV10PagoId), "ZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110332393", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("pagoview.js", "?20225110332393", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
   ...
   public void init_default_properties( )
   {
      ...
      divPagogeneral_cell_Internalname = "PAGOGENERAL_CELL" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV10PagoId',fld:'vPAGOID',pic:'ZZZZZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00252_A47PagoId = new int[1] ;
      H00252_A242PagoMonto = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      A242PagoMonto = DecimalUtil.ZERO ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.pagoview__default(),
         new Object[] {
             new Object[] {
            H00252_A47PagoId, H00252_A242PagoMonto
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int wcpOAV10PagoId ;
   private int AV10PagoId ;
   ...
   private String divPagogeneral_cell_Internalname ;
   ...
   private int[] H00252_A47PagoId ;
   private java.math.BigDecimal[] H00252_A242PagoMonto ;
   private com.genexus.webpanels.GXWebForm Form ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   private com.projectthani.wwpbaseobjects.SdtWWPContext GXv_SdtWWPContext1[] ;
}

final  class pagoview__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00252", "SELECT [PagoId], [PagoMonto] FROM [Pago] WHERE [PagoId] = ? ORDER BY [PagoId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
