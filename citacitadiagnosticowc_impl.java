...
public final  class citacitadiagnosticowc_impl extends GXWebComponent
{
   public citacitadiagnosticowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public citacitadiagnosticowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( citacitadiagnosticowc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Cita Cita Diagnostico WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110323144", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.citacitadiagnosticowc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8CitaId,8,0))}, new String[] {"CitaId"}) +"\">") ;
   ...
   public void wb3B0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.citacitadiagnosticowc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_3B2( true) ;
      }
      else
      {
         wb_table1_22_3B2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_3B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start3B2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Cita Cita Diagnostico WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV34Pgmname = "CitaCitaDiagnosticoWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf3B2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H003B2 */
         pr_default.execute(0, new Object[] {Integer.valueOf(AV8CitaId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A19CitaId = H003B2_A19CitaId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A19CitaId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A19CitaId), 8, 0));
            A109CitaDiagnosticoEstado = H003B2_A109CitaDiagnosticoEstado[0] ;
            A23DiagnosticoId = H003B2_A23DiagnosticoId[0] ;
            A22CitaDiagnosticoId = H003B2_A22CitaDiagnosticoId[0] ;
            e183B2 ();
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H003B3 */
      pr_default.execute(1, new Object[] {Integer.valueOf(AV8CitaId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   private void e183B2( )
   {
      ...
      {
         edtavUpdate_Link = formatLink("com.projectthani.citadiagnostico", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A22CitaDiagnosticoId,8,0))}, new String[] {})  ;
      }
      AV31Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDelete_Internalname, AV31Delete);
      if ( AV28IsAuthorized_Delete )
      {
         edtavDelete_Link = formatLink("com.projectthani.citadiagnostico", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A22CitaDiagnosticoId,8,0))}, new String[] {})  ;
      }
      /* Load Method */
      if ( wbStart != -1 )
      {
   ...
   public void e113B2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("CitaCitaDiagnosticoWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV34Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("CitaCitaDiagnosticoWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "CitaCitaDiagnosticoWCFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         citacitadiagnosticowc_impl.this.GXt_char4 = GXv_char5[0] ;
   ...
   public void e153B2( )
   {
      /* 'DoInsert' Routine */
      returnInSub = false ;
      callWebObject(formatLink("com.projectthani.citadiagnostico", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {}) );
   ...
   public void S152( )
   {
      ...
      new com.projectthani.wwpbaseobjects.secisauthbyobjectname(remoteHandle, context).execute( "CitaDiagnostico", GXv_boolean7) ;
      citacitadiagnosticowc_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "CitaCitaDiagnosticoWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV10TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "CitaDiagnostico" );
   ...
   public void wb_table1_22_3B2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_3B2( true) ;
      }
      else
      {
         wb_table2_27_3B2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_3B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_3B2e( true) ;
      }
      else
      {
         wb_table1_22_3B2e( false) ;
      }
   }

   public void wb_table2_27_3B2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "citacitadiagnosticowc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20225110323343", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("citacitadiagnosticowc.js", "?20225110323344", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtDiagnosticoId_Internalname = sPrefix+"DIAGNOSTICOID_"+sGXsfl_37_idx ;
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtDiagnosticoId_Internalname = sPrefix+"DIAGNOSTICOID_"+sGXsfl_37_fel_idx ;
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDiagnosticoId_Internalname,GXutil.ltrim( localUtil.ntoc( A23DiagnosticoId, (byte)(8), (byte)(0), ",", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A23DiagnosticoId), "ZZZZZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtDiagnosticoId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(8),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:CitaDiagnosticoId|3:DiagnosticoId|4:CitaDiagnosticoEstado" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e183B2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A22CitaDiagnosticoId',fld:'CITADIAGNOSTICOID',pic:'ZZZZZZZ9'},{av:'AV28IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e153B2',iparms:[{av:'A22CitaDiagnosticoId',fld:'CITADIAGNOSTICOID',pic:'ZZZZZZZ9'}]");
      setEventMetadata("'DOINSERT'",",oparms:[{av:'A22CitaDiagnosticoId',fld:'CITADIAGNOSTICOID',pic:'ZZZZZZZ9'}]}");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H003B2_A19CitaId = new int[1] ;
      H003B2_A109CitaDiagnosticoEstado = new String[] {""} ;
      H003B2_A23DiagnosticoId = new int[1] ;
      H003B2_A22CitaDiagnosticoId = new int[1] ;
      ...
      ROClassString = "" ;
      GXCCtl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.citacitadiagnosticowc__default(),
         new Object[] {
             new Object[] {
            H003B2_A19CitaId, H003B2_A109CitaDiagnosticoEstado, H003B2_A23DiagnosticoId, H003B2_A22CitaDiagnosticoId
            }
            , new Object[] {
   ...
   private int[] H003B2_A19CitaId ;
   private String[] H003B2_A109CitaDiagnosticoEstado ;
   private int[] H003B2_A23DiagnosticoId ;
   private int[] H003B2_A22CitaDiagnosticoId ;
...
final  class citacitadiagnosticowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H003B2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          int A19CitaId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " [CitaId], [CitaDiagnosticoEstado], [DiagnosticoId], [CitaDiagnosticoId]" ;
      sFromString = " FROM [CitaDiagnostico]" ;
      sOrderString = "" ;
      addWhere(sWhereString, "([CitaId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST([CitaDiagnosticoId] AS decimal(8,0))) like '%' + ?) or ( CONVERT( char(8), CAST([DiagnosticoId] AS decimal(8,0))) like '%' + ?) or ( 'activo' like '%' + LOWER(?) and [CitaDiagnosticoEstado] = 'A') or ( 'inactivo' like '%' + LOWER(?) and [CitaDiagnosticoEstado] = 'I'))");
      }
      else
      {
         GXv_int11[1] = (byte)(1) ;
      ...
      {
         sOrderString += " ORDER BY [CitaId], [CitaDiagnosticoId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [CitaDiagnosticoId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [DiagnosticoId]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [DiagnosticoId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY [CitaId], [CitaDiagnosticoEstado]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY [CitaId] DESC, [CitaDiagnosticoEstado] DESC" ;
      }
      else if ( true )
      {
   ...
   protected Object[] conditional_H003B3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.IHttpContext httpContext ,
                                          String AV16FilterFullText ,
                                          int A22CitaDiagnosticoId ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H003B2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).intValue() );
            case 1 :
                  return conditional_H003B3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).intValue() , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() , ((Number) dynConstraints[6]).intValue() , ((Number) dynConstraints[7]).intValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H003B2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H003B3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
