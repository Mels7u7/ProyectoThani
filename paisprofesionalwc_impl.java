...
public final  class paisprofesionalwc_impl extends GXWebComponent
{
   public paisprofesionalwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public paisprofesionalwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( paisprofesionalwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV8PaisId = (short)(GXutil.lval( httpContext.GetPar( "PaisId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PaisId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PaisId), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(AV8PaisId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV30IsAuthorized_UbigeoNombre = GXutil.strtobool( httpContext.GetPar( "IsAuthorized_UbigeoNombre")) ;
               ...
               gxgrgrid_refresh( subGrid_Rows, AV16FilterFullText, AV8PaisId, AV20ManageFiltersExecutionStep, AV34Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, AV30IsAuthorized_UbigeoNombre, A43PaisId, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Pais Profesional WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20225110325812", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.projectthani.paisprofesionalwc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8PaisId,4,0))}, new String[] {"PaisId"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_UBIGEONOMBRE", getSecureSignedToken( sPrefix, AV30IsAuthorized_UbigeoNombre));
      GXKey = httpContext.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
      forbiddenHiddens = new com.genexus.util.GXProperties() ;
      forbiddenHiddens.add("hshsalt", sPrefix+"hsh"+"PaisProfesionalWC");
      ...
      GXutil.writeLogInfo("paisprofesionalwc:[ SendSecurityCheck value for]"+forbiddenHiddens.toJSonString());
   }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV8PaisId", GXutil.ltrim( localUtil.ntoc( wcpOAV8PaisId, (byte)(4), (byte)(0), ",", "")));
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_DELETE", getSecureSignedToken( sPrefix, AV29IsAuthorized_Delete));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_UBIGEONOMBRE", AV30IsAuthorized_UbigeoNombre);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_UBIGEONOMBRE", getSecureSignedToken( sPrefix, AV30IsAuthorized_UbigeoNombre));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPAISID", GXutil.ltrim( localUtil.ntoc( AV8PaisId, (byte)(4), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm7L2( )
   {
   ...
   public void wb7L0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.projectthani.paisprofesionalwc");
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         StyleString = "" ;
         com.projectthani.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 37, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 7, "Agregar", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e117l1_client"+"'", TempTags, "", 2, "HLP_PaisProfesionalWC.htm");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Div Control */
         com.projectthani.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
         wb_table1_22_7L2( true) ;
      }
      else
      {
         wb_table1_22_7L2( false) ;
      }
      return  ;
   }

   public void wb_table1_22_7L2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.projectthani.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      if ( wbEnd == 37 )
      {
         ...
         /* Single line edit */
         com.projectthani.GxWebStd.gx_single_line_edit( httpContext, edtPaisId_Internalname, GXutil.ltrim( localUtil.ntoc( A43PaisId, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A43PaisId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisId_Jsonclick, 0, "Attribute", "", "", "", "", edtPaisId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id4", "right", false, "", "HLP_PaisProfesionalWC.htm");
         /* User Defined Control */
   ...
   public void start7L2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Pais Profesional WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 boolean AV30IsAuthorized_UbigeoNombre ,
                                 short A43PaisId ,
                                 String sPrefix )
   {
      initialize_formulas( ) ;
   ...
   public void rf7L2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BYTE, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING,
                                              TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT
                                              }
         });
         ...
         lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
         /* Using cursor H007L2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV8PaisId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_37_idx = 1 ;
         sGXsfl_37_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_37_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_372( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A43PaisId = H007L2_A43PaisId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A43PaisId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A43PaisId), 4, 0));
            A6SecUserId = H007L2_A6SecUserId[0] ;
            A194ProfesionalTelefono = H007L2_A194ProfesionalTelefono[0] ;
            A193ProfesionalLinkedin = H007L2_A193ProfesionalLinkedin[0] ;
            A192ProfesionalInstagram = H007L2_A192ProfesionalInstagram[0] ;
            A191ProfesionalFacebook = H007L2_A191ProfesionalFacebook[0] ;
            A190ProfesionalTwitter = H007L2_A190ProfesionalTwitter[0] ;
            A189ProfesionalFoto = H007L2_A189ProfesionalFoto[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtProfesionalFoto_Internalname, "Bitmap", ((GXutil.strcmp("", A189ProfesionalFoto)==0) ? A40000ProfesionalFoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A189ProfesionalFoto))), !bGXsfl_37_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtProfesionalFoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A189ProfesionalFoto), true);
            A40000ProfesionalFoto_GXI = H007L2_A40000ProfesionalFoto_GXI[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtProfesionalFoto_Internalname, "Bitmap", ((GXutil.strcmp("", A189ProfesionalFoto)==0) ? A40000ProfesionalFoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A189ProfesionalFoto))), !bGXsfl_37_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtProfesionalFoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A189ProfesionalFoto), true);
            A44UbigeoCode = H007L2_A44UbigeoCode[0] ;
            A183ProfesionalDireccion = H007L2_A183ProfesionalDireccion[0] ;
            A182ProfesionalTiempoCita = H007L2_A182ProfesionalTiempoCita[0] ;
            A181ProfesionalColorCita = H007L2_A181ProfesionalColorCita[0] ;
            A180ProfesionalColorDisponible = H007L2_A180ProfesionalColorDisponible[0] ;
            A88ProfesionalCOP = H007L2_A88ProfesionalCOP[0] ;
            A179ProfesionalCorreo = H007L2_A179ProfesionalCorreo[0] ;
            A178ProfesionalDescripcion = H007L2_A178ProfesionalDescripcion[0] ;
            A177ProfesionalSexo = H007L2_A177ProfesionalSexo[0] ;
            A176ProfesionalFechaNacimiento = H007L2_A176ProfesionalFechaNacimiento[0] ;
            A174ProfesionalNroDocumento = H007L2_A174ProfesionalNroDocumento[0] ;
            A173ProfesionalTipoDocumento = H007L2_A173ProfesionalTipoDocumento[0] ;
            A31ProfesionalId = H007L2_A31ProfesionalId[0] ;
            A84ProfesionalNombres = H007L2_A84ProfesionalNombres[0] ;
            A86ProfesionalApellidoMaterno = H007L2_A86ProfesionalApellidoMaterno[0] ;
            A85ProfesionalApellidoPaterno = H007L2_A85ProfesionalApellidoPaterno[0] ;
            A188UbigeoDistrito = H007L2_A188UbigeoDistrito[0] ;
            A187UbigeoProvincia = H007L2_A187UbigeoProvincia[0] ;
            A186UbigeoDepartamento = H007L2_A186UbigeoDepartamento[0] ;
            A188UbigeoDistrito = H007L2_A188UbigeoDistrito[0] ;
            A187UbigeoProvincia = H007L2_A187UbigeoProvincia[0] ;
            A186UbigeoDepartamento = H007L2_A186UbigeoDepartamento[0] ;
   ...
   public void send_integrity_lvl_hashes7L2( )
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPGMNAME", GXutil.rtrim( AV34Pgmname));
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vPGMNAME", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( AV34Pgmname, ""))));
      com.projectthani.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vISAUTHORIZED_UPDATE", AV27IsAuthorized_Update);
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV16FilterFullText = GXutil.concat( GXutil.rtrim( AV16FilterFullText), "%", "") ;
      /* Using cursor H007L3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV8PaisId), lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
   ...
   public void strup7L0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV8PaisId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8PaisId"), ",", ".")) ;
         AV8PaisId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"vPAISID"), ",", ".")) ;
         ...
         {
            GXutil.writeLogError("paisprofesionalwc:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.toJSonString());
            GxWebError = (byte)(1) ;
   ...
   public void e167L2( )
   {
      ...
      S112 ();
      if (returnInSub) return;
      GXt_boolean1 = AV30IsAuthorized_UbigeoNombre ;
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWUbigeo", GXv_boolean2) ;
      paisprofesionalwc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      AV30IsAuthorized_UbigeoNombre = GXt_boolean1 ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV30IsAuthorized_UbigeoNombre", AV30IsAuthorized_UbigeoNombre);
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_vISAUTHORIZED_UBIGEONOMBRE", getSecureSignedToken( sPrefix, AV30IsAuthorized_UbigeoNombre));
      Ddo_grid_Gridinternalname = subGrid_Internalname ;
      ucDdo_grid.sendProperty(context, sPrefix, false, Ddo_grid_Internalname, "GridInternalName", Ddo_grid_Gridinternalname);
      edtPaisId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtPaisId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtPaisId_Visible), 5, 0), true);
   ...
   private void e187L2( )
   {
      ...
      if ( AV30IsAuthorized_UbigeoNombre )
      {
   ...
   public void e127L2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S162 ();
         if (returnInSub) return;
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("PaisProfesionalWCFilters")),GXutil.URLEncode(GXutil.rtrim(AV34Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      ...
      {
         httpContext.popup(formatLink("com.projectthani.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("PaisProfesionalWCFilters"))}, new String[] {"UserKey"}) , new Object[] {});
         AV20ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV20ManageFiltersExecutionStep", GXutil.str( AV20ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefreshCmp(sPrefix);
      }
      else
      {
         ...
         new com.projectthani.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "PaisProfesionalWCFilters", Ddo_managefilters_Activeeventkey, GXv_char7) ;
         paisprofesionalwc_impl.this.GXt_char6 = GXv_char7[0] ;
   ...
   public void S152( )
   {
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPais_Update", GXv_boolean2) ;
      paisprofesionalwc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPais_Delete", GXv_boolean2) ;
      paisprofesionalwc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
      ...
      GXv_boolean2[0] = GXt_boolean1 ;
      new com.projectthani.wwpbaseobjects.secisauthbyfunctionalitykey(remoteHandle, context).execute( "WWPais_Insert", GXv_boolean2) ;
      paisprofesionalwc_impl.this.GXt_boolean1 = GXv_boolean2[0] ;
   ...
   public void S112( )
   {
      ...
      new com.projectthani.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "PaisProfesionalWCFilters", "", "", GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item9) ;
   ...
   public void S122( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributename( "PaisId" );
      AV11TrnContextAtt.setgxTv_SdtWWPTransactionContext_Attribute_Attributevalue( GXutil.str( AV8PaisId, 4, 0) );
   ...
   public void wb_table1_22_7L2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_27_7L2( true) ;
      }
      else
      {
         wb_table2_27_7L2( false) ;
      }
      return  ;
   }

   public void wb_table2_27_7L2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_22_7L2e( true) ;
      }
      else
      {
         wb_table1_22_7L2e( false) ;
      }
   }

   public void wb_table2_27_7L2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   {
      AV8PaisId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PaisId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PaisId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV8PaisId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "paisprofesionalwc", GetJustCreated( ));
      ...
      {
         AV8PaisId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PaisId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PaisId), 4, 0));
      }
      wcpOAV8PaisId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV8PaisId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV8PaisId != wcpOAV8PaisId ) ) )
      {
         setjustcreated();
      }
      wcpOAV8PaisId = AV8PaisId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV8PaisId = httpContext.cgiGet( sPrefix+"AV8PaisId_CTRL") ;
      if ( GXutil.len( sCtrlAV8PaisId) > 0 )
      {
         AV8PaisId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV8PaisId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV8PaisId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8PaisId), 4, 0));
      }
      else
      {
         AV8PaisId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV8PaisId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8PaisId_PARM", GXutil.ltrim( localUtil.ntoc( AV8PaisId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV8PaisId)) > 0 )
      {
         com.projectthani.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV8PaisId_CTRL", GXutil.rtrim( sCtrlAV8PaisId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202251103314", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("paisprofesionalwc.js", "?202251103314", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_372( )
   {
      ...
      edtProfesionalTelefono_Internalname = sPrefix+"PROFESIONALTELEFONO_"+sGXsfl_37_idx ;
      edtSecUserId_Internalname = sPrefix+"SECUSERID_"+sGXsfl_37_idx ;
   }
   ...
   public void subsflControlProps_fel_372( )
   {
      ...
      edtProfesionalTelefono_Internalname = sPrefix+"PROFESIONALTELEFONO_"+sGXsfl_37_fel_idx ;
      edtSecUserId_Internalname = sPrefix+"SECUSERID_"+sGXsfl_37_fel_idx ;
   }
   ...
   public void sendrow_372( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtProfesionalTelefono_Internalname,GXutil.rtrim( A194ProfesionalTelefono),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",gxphoneLink,"","","",edtProfesionalTelefono_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn hidden-xs","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"tel","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(37),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"GeneXus\\Phone","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
   ...
   public void init_default_properties( )
   {
      ...
      edtProfesionalTelefono_Internalname = sPrefix+"PROFESIONALTELEFONO" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8PaisId',fld:'vPAISID',pic:'ZZZ9'},{av:'sPrefix'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV34Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_UbigeoNombre',fld:'vISAUTHORIZED_UBIGEONOMBRE',pic:'',hsh:true},{av:'A43PaisId',fld:'PAISID',pic:'ZZZ9'}]");
      ...
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e137L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8PaisId',fld:'vPAISID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV34Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_UbigeoNombre',fld:'vISAUTHORIZED_UBIGEONOMBRE',pic:'',hsh:true},{av:'A43PaisId',fld:'PAISID',pic:'ZZZ9'},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e147L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8PaisId',fld:'vPAISID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV34Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_UbigeoNombre',fld:'vISAUTHORIZED_UBIGEONOMBRE',pic:'',hsh:true},{av:'A43PaisId',fld:'PAISID',pic:'ZZZ9'},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e157L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8PaisId',fld:'vPAISID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV34Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_UbigeoNombre',fld:'vISAUTHORIZED_UBIGEONOMBRE',pic:'',hsh:true},{av:'A43PaisId',fld:'PAISID',pic:'ZZZ9'},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e187L2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A43PaisId',fld:'PAISID',pic:'ZZZ9'},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_UbigeoNombre',fld:'vISAUTHORIZED_UBIGEONOMBRE',pic:'',hsh:true},{av:'A44UbigeoCode',fld:'UBIGEOCODE',pic:''},{av:'A190ProfesionalTwitter',fld:'PROFESIONALTWITTER',pic:''},{av:'A191ProfesionalFacebook',fld:'PROFESIONALFACEBOOK',pic:''},{av:'A192ProfesionalInstagram',fld:'PROFESIONALINSTAGRAM',pic:''},{av:'A193ProfesionalLinkedin',fld:'PROFESIONALLINKEDIN',pic:''}]");
      ...
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e127L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8PaisId',fld:'vPAISID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV34Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_UbigeoNombre',fld:'vISAUTHORIZED_UBIGEONOMBRE',pic:'',hsh:true},{av:'A43PaisId',fld:'PAISID',pic:'ZZZ9'},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e117L1',iparms:[{av:'AV8PaisId',fld:'vPAISID',pic:'ZZZ9'}]");
      ...
      setEventMetadata("NULL","{handler:'valid_Secuserid',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV16FilterFullText = "" ;
      H007L2_A43PaisId = new short[1] ;
      H007L2_A6SecUserId = new short[1] ;
      H007L2_A194ProfesionalTelefono = new String[] {""} ;
      H007L2_A193ProfesionalLinkedin = new String[] {""} ;
      H007L2_A192ProfesionalInstagram = new String[] {""} ;
      H007L2_A191ProfesionalFacebook = new String[] {""} ;
      H007L2_A190ProfesionalTwitter = new String[] {""} ;
      H007L2_A189ProfesionalFoto = new String[] {""} ;
      H007L2_A40000ProfesionalFoto_GXI = new String[] {""} ;
      H007L2_A44UbigeoCode = new String[] {""} ;
      H007L2_A183ProfesionalDireccion = new String[] {""} ;
      H007L2_A182ProfesionalTiempoCita = new byte[1] ;
      H007L2_A181ProfesionalColorCita = new String[] {""} ;
      H007L2_A180ProfesionalColorDisponible = new String[] {""} ;
      H007L2_A88ProfesionalCOP = new String[] {""} ;
      H007L2_A179ProfesionalCorreo = new String[] {""} ;
      H007L2_A178ProfesionalDescripcion = new String[] {""} ;
      H007L2_A177ProfesionalSexo = new String[] {""} ;
      H007L2_A176ProfesionalFechaNacimiento = new java.util.Date[] {GXutil.nullDate()} ;
      H007L2_A174ProfesionalNroDocumento = new String[] {""} ;
      H007L2_A173ProfesionalTipoDocumento = new String[] {""} ;
      H007L2_A31ProfesionalId = new int[1] ;
      H007L2_A84ProfesionalNombres = new String[] {""} ;
      H007L2_A86ProfesionalApellidoMaterno = new String[] {""} ;
      H007L2_A85ProfesionalApellidoPaterno = new String[] {""} ;
      H007L2_A188UbigeoDistrito = new String[] {""} ;
      H007L2_A187UbigeoProvincia = new String[] {""} ;
      H007L2_A186UbigeoDepartamento = new String[] {""} ;
      ...
      sImgUrl = "" ;
      gxphoneLink = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.projectthani.paisprofesionalwc__default(),
         new Object[] {
             new Object[] {
            H007L2_A43PaisId, H007L2_A6SecUserId, H007L2_A194ProfesionalTelefono, H007L2_A193ProfesionalLinkedin, H007L2_A192ProfesionalInstagram, H007L2_A191ProfesionalFacebook, H007L2_A190ProfesionalTwitter, H007L2_A189ProfesionalFoto, H007L2_A40000ProfesionalFoto_GXI, H007L2_A44UbigeoCode,
            H007L2_A183ProfesionalDireccion, H007L2_A182ProfesionalTiempoCita, H007L2_A181ProfesionalColorCita, H007L2_A180ProfesionalColorDisponible, H007L2_A88ProfesionalCOP, H007L2_A179ProfesionalCorreo, H007L2_A178ProfesionalDescripcion, H007L2_A177ProfesionalSexo, H007L2_A176ProfesionalFechaNacimiento, H007L2_A174ProfesionalNroDocumento,
            H007L2_A173ProfesionalTipoDocumento, H007L2_A31ProfesionalId, H007L2_A84ProfesionalNombres, H007L2_A86ProfesionalApellidoMaterno, H007L2_A85ProfesionalApellidoPaterno, H007L2_A188UbigeoDistrito, H007L2_A187UbigeoProvincia, H007L2_A186UbigeoDepartamento
            }
            , new Object[] {
   ...
   private short wcpOAV8PaisId ;
   private short AV8PaisId ;
   ...
   private boolean AV30IsAuthorized_UbigeoNombre ;
   ...
   private short[] H007L2_A43PaisId ;
   private short[] H007L2_A6SecUserId ;
   private String[] H007L2_A194ProfesionalTelefono ;
   private String[] H007L2_A193ProfesionalLinkedin ;
   private String[] H007L2_A192ProfesionalInstagram ;
   private String[] H007L2_A191ProfesionalFacebook ;
   private String[] H007L2_A190ProfesionalTwitter ;
   private String[] H007L2_A189ProfesionalFoto ;
   private String[] H007L2_A40000ProfesionalFoto_GXI ;
   private String[] H007L2_A44UbigeoCode ;
   private String[] H007L2_A183ProfesionalDireccion ;
   private byte[] H007L2_A182ProfesionalTiempoCita ;
   private String[] H007L2_A181ProfesionalColorCita ;
   private String[] H007L2_A180ProfesionalColorDisponible ;
   private String[] H007L2_A88ProfesionalCOP ;
   private String[] H007L2_A179ProfesionalCorreo ;
   private String[] H007L2_A178ProfesionalDescripcion ;
   private String[] H007L2_A177ProfesionalSexo ;
   private java.util.Date[] H007L2_A176ProfesionalFechaNacimiento ;
   private String[] H007L2_A174ProfesionalNroDocumento ;
   private String[] H007L2_A173ProfesionalTipoDocumento ;
   private int[] H007L2_A31ProfesionalId ;
   private String[] H007L2_A84ProfesionalNombres ;
   private String[] H007L2_A86ProfesionalApellidoMaterno ;
   private String[] H007L2_A85ProfesionalApellidoPaterno ;
   private String[] H007L2_A188UbigeoDistrito ;
   private String[] H007L2_A187UbigeoProvincia ;
   private String[] H007L2_A186UbigeoDepartamento ;
...
final  class paisprofesionalwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          short A43PaisId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.[PaisId], T1.[SecUserId], T1.[ProfesionalTelefono], T1.[ProfesionalLinkedin], T1.[ProfesionalInstagram], T1.[ProfesionalFacebook], T1.[ProfesionalTwitter], T1.[ProfesionalFoto]," ;
      sSelectString += " T1.[ProfesionalFoto_GXI], T1.[UbigeoCode], T1.[ProfesionalDireccion], T1.[ProfesionalTiempoCita], T1.[ProfesionalColorCita], T1.[ProfesionalColorDisponible], T1.[ProfesionalCOP]," ;
      ...
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalId]" ;
      }
      else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalId] DESC" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalTipoDocumento]" ;
      }
      else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalTipoDocumento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalNroDocumento]" ;
      }
      else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalNroDocumento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalApellidoPaterno]" ;
      }
      else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalApellidoPaterno] DESC" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalApellidoMaterno]" ;
      }
      else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalApellidoMaterno] DESC" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalNombres]" ;
      }
      else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalNombres] DESC" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalFechaNacimiento]" ;
      }
      else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalFechaNacimiento] DESC" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalSexo]" ;
      }
      else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalSexo] DESC" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalDescripcion]" ;
      }
      else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalDescripcion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalCorreo]" ;
      }
      else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalCorreo] DESC" ;
      }
      else if ( ( AV14OrderedBy == 11 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalCOP]" ;
      }
      else if ( ( AV14OrderedBy == 11 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalCOP] DESC" ;
      }
      else if ( ( AV14OrderedBy == 12 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalColorDisponible]" ;
      }
      else if ( ( AV14OrderedBy == 12 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalColorDisponible] DESC" ;
      }
      else if ( ( AV14OrderedBy == 13 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalColorCita]" ;
      }
      else if ( ( AV14OrderedBy == 13 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalColorCita] DESC" ;
      }
      else if ( ( AV14OrderedBy == 14 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalTiempoCita]" ;
      }
      else if ( ( AV14OrderedBy == 14 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalTiempoCita] DESC" ;
      }
      else if ( ( AV14OrderedBy == 15 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalDireccion]" ;
      }
      else if ( ( AV14OrderedBy == 15 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalDireccion] DESC" ;
      }
      else if ( ( AV14OrderedBy == 16 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[UbigeoCode]" ;
      }
      else if ( ( AV14OrderedBy == 16 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[UbigeoCode] DESC" ;
      }
      else if ( ( AV14OrderedBy == 17 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalTwitter]" ;
      }
      else if ( ( AV14OrderedBy == 17 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalTwitter] DESC" ;
      }
      else if ( ( AV14OrderedBy == 18 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalFacebook]" ;
      }
      else if ( ( AV14OrderedBy == 18 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalFacebook] DESC" ;
      }
      else if ( ( AV14OrderedBy == 19 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalInstagram]" ;
      }
      else if ( ( AV14OrderedBy == 19 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalInstagram] DESC" ;
      }
      else if ( ( AV14OrderedBy == 20 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalLinkedin]" ;
      }
      else if ( ( AV14OrderedBy == 20 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalLinkedin] DESC" ;
      }
      else if ( ( AV14OrderedBy == 21 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[ProfesionalTelefono]" ;
      }
      else if ( ( AV14OrderedBy == 21 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[ProfesionalTelefono] DESC" ;
      }
      else if ( ( AV14OrderedBy == 22 ) && ! AV15OrderedDsc )
      {
         sOrderString += " ORDER BY T1.[PaisId], T1.[SecUserId]" ;
      }
      else if ( ( AV14OrderedBy == 22 ) && ( AV15OrderedDsc ) )
      {
         sOrderString += " ORDER BY T1.[PaisId] DESC, T1.[SecUserId] DESC" ;
      }
      else if ( true )
      {
                                          ...
                                          short A43PaisId )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ([Profesional] T1 INNER JOIN [Ubigeo] T2 ON T2.[UbigeoCode] = T1.[UbigeoCode])" ;
      addWhere(sWhereString, "(T1.[PaisId] = ?)");
      if ( ! (GXutil.strcmp("", AV16FilterFullText)==0) )
      {
         addWhere(sWhereString, "(( CONVERT( char(8), CAST(T1.[ProfesionalId] AS decimal(8,0))) like '%' + ?) or ( 'dni' like '%' + LOWER(?) and T1.[ProfesionalTipoDocumento] = '1') or ( 'ruc' like '%' + LOWER(?) and T1.[ProfesionalTipoDocumento] = '6') or ( 'libreta electoral' like '%' + LOWER(?) and T1.[ProfesionalTipoDocumento] = '2') or ( 'carnet de extranjeria' like '%' + LOWER(?) and T1.[ProfesionalTipoDocumento] = '4') or ( 'pasaporte' like '%' + LOWER(?) and T1.[ProfesionalTipoDocumento] = '7') or ( 'sin documento' like '%' + LOWER(?) and T1.[ProfesionalTipoDocumento] = '0') or ( T1.[ProfesionalNroDocumento] like '%' + ?) or ( T1.[ProfesionalApellidoPaterno] like '%' + ?) or ( T1.[ProfesionalApellidoMaterno] like '%' + ?) or ( T1.[ProfesionalNombres] like '%' + ?) or ( T1.[ProfesionalApellidoPaterno] + ' ' + T1.[ProfesionalApellidoMaterno] + ', ' + T1.[ProfesionalNombres] like '%' + ?) or ( 'masculino' like '%' + LOWER(?) and T1.[ProfesionalSexo] = 'M') or ( 'femenino' like '%' + LOWER(?) and T1.[ProfesionalSexo] = 'F') or ( T1.[ProfesionalDescripcion] like '%' + ?) or ( T1.[ProfesionalCorreo] like '%' + ?) or ( T1.[ProfesionalCOP] like '%' + ?) or ( T1.[ProfesionalColorDisponible] like '%' + ?) or ( T1.[ProfesionalColorCita] like '%' + ?) or ( '30 minutos' like '%' + LOWER(?) and T1.[ProfesionalTiempoCita] = 30) or ( '1 hora' like '%' + LOWER(?) and T1.[ProfesionalTiempoCita] = 60) or ( T1.[ProfesionalDireccion] like '%' + ?) or ( T1.[UbigeoCode] like '%' + ?) or ( T2.[UbigeoDepartamento] + ' / ' + T2.[UbigeoProvincia] + ' / ' + T2.[UbigeoDistrito] like '%' + ?) or ( T1.[ProfesionalTwitter] like '%' + ?) or ( T1.[ProfesionalFacebook] like '%' + ?) or ( T1.[ProfesionalInstagram] like '%' + ?) or ( T1.[ProfesionalLinkedin] like '%' + ?) or ( T1.[ProfesionalTelefono] like '%' + ?) or ( CONVERT( char(4), CAST(T1.[SecUserId] AS decimal(4,0))) like '%' + ?))");
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H007L2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (String)dynConstraints[8] , (String)dynConstraints[9] , (String)dynConstraints[10] , (String)dynConstraints[11] , (String)dynConstraints[12] , ((Number) dynConstraints[13]).byteValue() , (String)dynConstraints[14] , (String)dynConstraints[15] , (String)dynConstraints[16] , (String)dynConstraints[17] , (String)dynConstraints[18] , (String)dynConstraints[19] , (String)dynConstraints[20] , (String)dynConstraints[21] , (String)dynConstraints[22] , (String)dynConstraints[23] , ((Number) dynConstraints[24]).shortValue() , ((Number) dynConstraints[25]).shortValue() , ((Boolean) dynConstraints[26]).booleanValue() , ((Number) dynConstraints[27]).shortValue() , ((Number) dynConstraints[28]).shortValue() );
            case 1 :
                  return conditional_H007L3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (String)dynConstraints[8] , (String)dynConstraints[9] , (String)dynConstraints[10] , (String)dynConstraints[11] , (String)dynConstraints[12] , ((Number) dynConstraints[13]).byteValue() , (String)dynConstraints[14] , (String)dynConstraints[15] , (String)dynConstraints[16] , (String)dynConstraints[17] , (String)dynConstraints[18] , (String)dynConstraints[19] , (String)dynConstraints[20] , (String)dynConstraints[21] , (String)dynConstraints[22] , (String)dynConstraints[23] , ((Number) dynConstraints[24]).shortValue() , ((Number) dynConstraints[25]).shortValue() , ((Boolean) dynConstraints[26]).booleanValue() , ((Number) dynConstraints[27]).shortValue() , ((Number) dynConstraints[28]).shortValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H007L2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H007L3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
